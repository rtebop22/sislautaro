...
$historial_atencion_grid = NULL; // Initialize page object first

class chistorial_atencion_grid extends chistorial_atencion {
	...
	// Page object name
	var $PageObjName = 'historial_atencion_grid';

	// Grid form hidden field names
	var $FormName = 'fhistorial_atenciongrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["historial_atencion"];
