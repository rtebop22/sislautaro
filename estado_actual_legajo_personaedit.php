...
class cestado_actual_legajo_persona_edit extends cestado_actual_legajo_persona {
	...
	function RenderRow() {
		...
		$this->Usuario->ViewCustomAttributes = "";
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->Archivos_Varios);
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Archivos Varios
			if ($this->Archivos_Varios->Visible && !$this->Archivos_Varios->ReadOnly && !$this->Archivos_Varios->Upload->KeepFile) {
...
// Multi-Page
festado_actual_legajo_personaedit.MultiPage = new ew_MultiPage("festado_actual_legajo_personaedit");
...
<div class="panel-group" id="estado_actual_legajo_persona_edit">
	<div class="panel panel-default<?php echo $estado_actual_legajo_persona_edit->MultiPages->PageStyle("1") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#estado_actual_legajo_persona_edit" href="#tab_estado_actual_legajo_persona1"><?php echo $estado_actual_legajo_persona->PageCaption(1) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $estado_actual_legajo_persona_edit->MultiPages->PageStyle("1") ?>" id="tab_estado_actual_legajo_persona1">
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $estado_actual_legajo_persona_edit->MultiPages->PageStyle("2") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#estado_actual_legajo_persona_edit" href="#tab_estado_actual_legajo_persona2"><?php echo $estado_actual_legajo_persona->PageCaption(2) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $estado_actual_legajo_persona_edit->MultiPages->PageStyle("2") ?>" id="tab_estado_actual_legajo_persona2">
			<div class="panel-body">
<div>
