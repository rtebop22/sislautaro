...
$modelo_edit = NULL; // Initialize page object first

class cmodelo_edit extends cmodelo {
	...
	function Page_Main() {
		...
		if ($this->Id_Modelo->CurrentValue == "") {
			$this->Page_Terminate("modelolist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($modelo_edit)) $modelo_edit = new cmodelo_edit();

// Page init
$modelo_edit->Page_Init();

// Page main
$modelo_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$modelo_edit->Page_Render();
?>
...
var CurrentForm = fmodeloedit = new ew_Form("fmodeloedit", "edit");

// Validate form
fmodeloedit.Validate = function() {
...
fmodeloedit.Form_CustomValidate = 
...
fmodeloedit.ValidateRequired = true;
<?php } else { ?>
fmodeloedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmodeloedit.Lists["x_Id_Marca"] = {"LinkField":"x_Id_Marca","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"marca"};
...
<?php } ?>
<?php $modelo_edit->ShowPageHeader(); ?>
<?php
$modelo_edit->ShowMessage();
?>
<form name="fmodeloedit" id="fmodeloedit" class="<?php echo $modelo_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($modelo_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $modelo_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="modelo" data-field="x_Id_Modelo" name="x_Id_Modelo" id="x_Id_Modelo" value="<?php echo ew_HtmlEncode($modelo->Id_Modelo->CurrentValue) ?>">
<?php if (!$modelo_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $modelo_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
