...
$lista_espera_prestamo_edit = NULL; // Initialize page object first

class clista_espera_prestamo_edit extends clista_espera_prestamo {
	...
	// Page object name
	var $PageObjName = 'lista_espera_prestamo_edit';
	...
	function Page_Main() {
		...
		if ($this->Dni->CurrentValue == "") {
			$this->Page_Terminate("lista_espera_prestamolist.php"); // Invalid key, return to list
		}
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("lista_espera_prestamolist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "lista_espera_prestamolist.php")
...
// Create page object
if (!isset($lista_espera_prestamo_edit)) $lista_espera_prestamo_edit = new clista_espera_prestamo_edit();

// Page init
$lista_espera_prestamo_edit->Page_Init();

// Page main
$lista_espera_prestamo_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$lista_espera_prestamo_edit->Page_Render();
?>
...
var CurrentForm = flista_espera_prestamoedit = new ew_Form("flista_espera_prestamoedit", "edit");

// Validate form
flista_espera_prestamoedit.Validate = function() {
...
flista_espera_prestamoedit.Form_CustomValidate = 
...
flista_espera_prestamoedit.ValidateRequired = true;
<?php } else { ?>
flista_espera_prestamoedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
flista_espera_prestamoedit.Lists["x_Apellidos_Nombres"] = {"LinkField":"x_Apellidos_Nombres","Ajax":true,"AutoFill":true,"DisplayFields":["x_Apellidos_Nombres","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
flista_espera_prestamoedit.Lists["x_Id_Motivo_Prestamo"] = {"LinkField":"x_Id_Motivo_Prestamo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"motivo_prestamo_equipo"};
flista_espera_prestamoedit.Lists["x_Id_Curso"] = {"LinkField":"x_Id_Curso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cursos"};
flista_espera_prestamoedit.Lists["x_Id_Division"] = {"LinkField":"x_Id_Division","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"division"};
flista_espera_prestamoedit.Lists["x_Id_Estado_Espera"] = {"LinkField":"x_Id_Estado_Espera","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_espera_prestamo"};
...
<?php if (!$lista_espera_prestamo_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $lista_espera_prestamo_edit->ShowPageHeader(); ?>
<?php
$lista_espera_prestamo_edit->ShowMessage();
?>
<form name="flista_espera_prestamoedit" id="flista_espera_prestamoedit" class="<?php echo $lista_espera_prestamo_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($lista_espera_prestamo_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $lista_espera_prestamo_edit->Token ?>">
<?php } ?>
...
<?php if ($lista_espera_prestamo->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
	<div id="r_Apellidos_Nombres" class="form-group">
		<label id="elh_lista_espera_prestamo_Apellidos_Nombres" class="col-sm-2 control-label ewLabel"><?php echo $lista_espera_prestamo->Apellidos_Nombres->FldCaption() ?></label>
...
<?php if ($lista_espera_prestamo->Dni->Visible) { // Dni ?>
	<div id="r_Dni" class="form-group">
		<label id="elh_lista_espera_prestamo_Dni" for="x_Dni" class="col-sm-2 control-label ewLabel"><?php echo $lista_espera_prestamo->Dni->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $lista_espera_prestamo->Dni->CellAttributes() ?>>
...
<input type="hidden" data-table="lista_espera_prestamo" data-field="x_Dni" name="x_Dni" id="x_Dni" value="<?php echo ew_HtmlEncode($lista_espera_prestamo->Dni->CurrentValue) ?>">
<?php echo $lista_espera_prestamo->Dni->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($lista_espera_prestamo->Id_Motivo_Prestamo->Visible) { // Id_Motivo_Prestamo ?>
	<div id="r_Id_Motivo_Prestamo" class="form-group">
		<label id="elh_lista_espera_prestamo_Id_Motivo_Prestamo" for="x_Id_Motivo_Prestamo" class="col-sm-2 control-label ewLabel"><?php echo $lista_espera_prestamo->Id_Motivo_Prestamo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($lista_espera_prestamo->Observacion->Visible) { // Observacion ?>
	<div id="r_Observacion" class="form-group">
		<label id="elh_lista_espera_prestamo_Observacion" for="x_Observacion" class="col-sm-2 control-label ewLabel"><?php echo $lista_espera_prestamo->Observacion->FldCaption() ?></label>
...
<?php if ($lista_espera_prestamo->Id_Curso->Visible) { // Id_Curso ?>
	<div id="r_Id_Curso" class="form-group">
		<label id="elh_lista_espera_prestamo_Id_Curso" for="x_Id_Curso" class="col-sm-2 control-label ewLabel"><?php echo $lista_espera_prestamo->Id_Curso->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($lista_espera_prestamo->Id_Division->Visible) { // Id_Division ?>
	<div id="r_Id_Division" class="form-group">
		<label id="elh_lista_espera_prestamo_Id_Division" for="x_Id_Division" class="col-sm-2 control-label ewLabel"><?php echo $lista_espera_prestamo->Id_Division->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($lista_espera_prestamo->Id_Estado_Espera->Visible) { // Id_Estado_Espera ?>
	<div id="r_Id_Estado_Espera" class="form-group">
		<label id="elh_lista_espera_prestamo_Id_Estado_Espera" for="x_Id_Estado_Espera" class="col-sm-2 control-label ewLabel"><?php echo $lista_espera_prestamo->Id_Estado_Espera->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $lista_espera_prestamo_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
flista_espera_prestamoedit.Init();
</script>
<?php
$lista_espera_prestamo_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$lista_espera_prestamo_edit->Page_Terminate();
?>
