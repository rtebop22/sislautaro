...
$seguimientodepersonas = NULL;

//
// Table class for seguimientodepersonas
//
class cseguimientodepersonas extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'seguimientodepersonas';
		$this->TableName = 'seguimientodepersonas';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`seguimientodepersonas`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Apellidos_Nombres
		$this->Apellidos_Nombres = new cField('seguimientodepersonas', 'seguimientodepersonas', 'x_Apellidos_Nombres', 'Apellidos_Nombres', '`Apellidos_Nombres`', '`Apellidos_Nombres`', 201, -1, FALSE, '`Apellidos_Nombres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellidos_Nombres->Sortable = TRUE; // Allow sort
		$this->fields['Apellidos_Nombres'] = &$this->Apellidos_Nombres;

		// Dni
		$this->Dni = new cField('seguimientodepersonas', 'seguimientodepersonas', 'x_Dni', 'Dni', '`Dni`', '`Dni`', 3, -1, FALSE, '`Dni`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Dni->Sortable = TRUE; // Allow sort
		$this->Dni->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Dni'] = &$this->Dni;

		// Detalle
		$this->Detalle = new cField('seguimientodepersonas', 'seguimientodepersonas', 'x_Detalle', 'Detalle', '`Detalle`', '`Detalle`', 201, -1, FALSE, '`Detalle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Detalle->Sortable = TRUE; // Allow sort
		$this->fields['Detalle'] = &$this->Detalle;

		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('seguimientodepersonas', 'seguimientodepersonas', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, -1, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`seguimientodepersonas`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "seguimientodepersonaslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("seguimientodepersonasview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("seguimientodepersonasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "seguimientodepersonasadd.php?" . $this->UrlParm($parm);
		else
			$url = "seguimientodepersonasadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("seguimientodepersonasedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("seguimientodepersonasadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("seguimientodepersonasdelete.php", $this->UrlParm());
	}
