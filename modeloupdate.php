...
$modelo_update = NULL; // Initialize page object first

class cmodelo_update extends cmodelo {
	...
	function Page_Main() {
		...
		if (count($this->RecKeys) <= 0)
			$this->Page_Terminate("modelolist.php"); // No records selected, return to list
...
// Create page object
if (!isset($modelo_update)) $modelo_update = new cmodelo_update();

// Page init
$modelo_update->Page_Init();

// Page main
$modelo_update->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$modelo_update->Page_Render();
?>
...
var CurrentForm = fmodeloupdate = new ew_Form("fmodeloupdate", "update");

// Validate form
fmodeloupdate.Validate = function() {
...
fmodeloupdate.Form_CustomValidate = 
...
fmodeloupdate.ValidateRequired = true;
<?php } else { ?>
fmodeloupdate.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmodeloupdate.Lists["x_Id_Marca"] = {"LinkField":"x_Id_Marca","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"marca"};
...
<?php } ?>
<?php $modelo_update->ShowPageHeader(); ?>
<?php
$modelo_update->ShowMessage();
?>
<form name="fmodeloupdate" id="fmodeloupdate" class="<?php echo $modelo_update->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($modelo_update->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $modelo_update->Token ?>">
<?php } ?>
...
<?php } ?>
<?php foreach ($modelo_update->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<div id="tbl_modeloupdate">
	<div class="checkbox">
...
<input type="checkbox" name="u_Descripcion" id="u_Descripcion" value="1"<?php echo ($modelo->Descripcion->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $modelo->Descripcion->FldCaption() ?></label>
...
<input type="checkbox" name="u_Id_Marca" id="u_Id_Marca" value="1"<?php echo ($modelo->Id_Marca->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $modelo->Id_Marca->FldCaption() ?></label>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $modelo_update->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
		</div>
	</div>
<?php } ?>
</div>
