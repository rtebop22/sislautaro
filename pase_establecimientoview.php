...
fpase_establecimientoview.Lists["x_Nombre_Tutor"] = {"LinkField":"x_Apellidos_Nombres","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tutores"};
...
<?php if ($pase_establecimiento->Tel_Rte_Alta->Visible) { // Tel_Rte_Alta ?>
	<tr id="r_Tel_Rte_Alta">
		<td><span id="elh_pase_establecimiento_Tel_Rte_Alta"><?php echo $pase_establecimiento->Tel_Rte_Alta->FldCaption() ?></span></td>
		<td data-name="Tel_Rte_Alta"<?php echo $pase_establecimiento->Tel_Rte_Alta->CellAttributes() ?>>
<span id="el_pase_establecimiento_Tel_Rte_Alta" data-page="5">
<span<?php echo $pase_establecimiento->Tel_Rte_Alta->ViewAttributes() ?>>
<?php echo $pase_establecimiento->Tel_Rte_Alta->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
