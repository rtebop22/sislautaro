...
$observacion_tutor_update = NULL; // Initialize page object first

class cobservacion_tutor_update extends cobservacion_tutor {
	...
	// Page object name
	var $PageObjName = 'observacion_tutor_update';
	...
	function Page_Main() {
		...
		if (count($this->RecKeys) <= 0)
			$this->Page_Terminate("observacion_tutorlist.php"); // No records selected, return to list
	...
	function SetupKeyValues($key) {
		...
		if (!is_numeric($sKeyFld))
			return FALSE;
		$this->Id_Observacion->CurrentValue = $sKeyFld;
		return TRUE;
	}
...
// Create page object
if (!isset($observacion_tutor_update)) $observacion_tutor_update = new cobservacion_tutor_update();

// Page init
$observacion_tutor_update->Page_Init();

// Page main
$observacion_tutor_update->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$observacion_tutor_update->Page_Render();
?>
...
var CurrentForm = fobservacion_tutorupdate = new ew_Form("fobservacion_tutorupdate", "update");

// Validate form
fobservacion_tutorupdate.Validate = function() {
...
fobservacion_tutorupdate.Form_CustomValidate = 
...
fobservacion_tutorupdate.ValidateRequired = true;
<?php } else { ?>
fobservacion_tutorupdate.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$observacion_tutor_update->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $observacion_tutor_update->ShowPageHeader(); ?>
<?php
$observacion_tutor_update->ShowMessage();
?>
<form name="fobservacion_tutorupdate" id="fobservacion_tutorupdate" class="<?php echo $observacion_tutor_update->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($observacion_tutor_update->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $observacion_tutor_update->Token ?>">
<?php } ?>
...
<?php } ?>
<?php foreach ($observacion_tutor_update->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<div id="tbl_observacion_tutorupdate">
	<div class="checkbox">
...
<input type="checkbox" name="u_Detalle" id="u_Detalle" value="1"<?php echo ($observacion_tutor->Detalle->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $observacion_tutor->Detalle->FldCaption() ?></label>
...
<input type="checkbox" name="u_Fecha_Actualizacion" id="u_Fecha_Actualizacion" value="1"<?php echo ($observacion_tutor->Fecha_Actualizacion->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $observacion_tutor->Fecha_Actualizacion->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $observacion_tutor->Fecha_Actualizacion->CellAttributes() ?>>
<?php echo $observacion_tutor->Fecha_Actualizacion->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if (!$observacion_tutor_update->IsModal) { ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $observacion_tutor_update->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
		</div>
	</div>
<?php } ?>
</div>
...
<script type="text/javascript">
fobservacion_tutorupdate.Init();
</script>
<?php
$observacion_tutor_update->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$observacion_tutor_update->Page_Terminate();
?>
