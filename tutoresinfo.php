...
class ctutores extends cTable {
	...
	function __construct() {
		...
		$this->Tel_Contacto->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		...
		// Id_Ocupacion
		$this->Id_Ocupacion = new cField('tutores', 'tutores', 'x_Id_Ocupacion', 'Id_Ocupacion', '`Id_Ocupacion`', '`Id_Ocupacion`', 3, -1, FALSE, '`Id_Ocupacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->Id_Ocupacion->Sortable = TRUE; // Allow sort
		$this->Id_Ocupacion->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->Id_Ocupacion->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		...
		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('tutores', 'tutores', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 7, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fecha_Actualizacion->Sortable = TRUE; // Allow sort
		$this->fields['Fecha_Actualizacion'] = &$this->Fecha_Actualizacion;

		// Usuario
		$this->Usuario = new cField('tutores', 'tutores', 'x_Usuario', 'Usuario', '`Usuario`', '`Usuario`', 200, -1, FALSE, '`Usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
