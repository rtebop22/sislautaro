...
if ($atencion_para_st->CurrentAction == "gridadd") {
	...
	if ($atencion_para_st->CurrentAction == "" && $atencion_para_st_grid->TotalRecs == 0) {
		if (!$Security->CanList())
			$atencion_para_st_grid->setWarningMessage(ew_DeniedMsg());
...
<?php if ($atencion_para_st->Id_Atencion->Visible) { // Id_Atencion ?>
	...
	<?php } else { ?>
		<th data-name="Id_Atencion"><div><div id="elh_atencion_para_st_Id_Atencion" class="atencion_para_st_Id_Atencion">
...
<?php if ($atencion_para_st->NroSerie->Visible) { // NroSerie ?>
	...
	<?php } else { ?>
		<th data-name="NroSerie"><div><div id="elh_atencion_para_st_NroSerie" class="atencion_para_st_NroSerie">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $atencion_para_st->NroSerie->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($atencion_para_st->NroSerie->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($atencion_para_st->NroSerie->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($atencion_para_st->Referencia_Tipo_Retiro->Visible) { // Referencia_Tipo_Retiro ?>
	...
	<?php } else { ?>
		<th data-name="Referencia_Tipo_Retiro"><div><div id="elh_atencion_para_st_Referencia_Tipo_Retiro" class="atencion_para_st_Referencia_Tipo_Retiro">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $atencion_para_st->Referencia_Tipo_Retiro->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($atencion_para_st->Referencia_Tipo_Retiro->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($atencion_para_st->Referencia_Tipo_Retiro->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<input type="hidden" id="x<?php echo $atencion_para_st_grid->RowIndex ?>_Id_Atencion" name="x<?php echo $atencion_para_st_grid->RowIndex ?>_Id_Atencion" value="<?php echo ew_HtmlEncode($atencion_para_st->Id_Atencion->CurrentValue) ?>">
<?php } else { ?>
<span id="el<?php echo $atencion_para_st_grid->RowCnt ?>_atencion_para_st_Id_Atencion" class="form-group atencion_para_st_Id_Atencion">
...
<span id="el<?php echo $atencion_para_st_grid->RowCnt ?>_atencion_para_st_Id_Atencion" class="atencion_para_st_Id_Atencion">
<span<?php echo $atencion_para_st->Id_Atencion->ViewAttributes() ?>>
<?php echo $atencion_para_st->Id_Atencion->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="atencion_para_st" data-field="x_Id_Atencion" name="x<?php echo $atencion_para_st_grid->RowIndex ?>_Id_Atencion" id="x<?php echo $atencion_para_st_grid->RowIndex ?>_Id_Atencion" value="<?php echo ew_HtmlEncode($atencion_para_st->Id_Atencion->FormValue) ?>">
<input type="hidden" data-table="atencion_para_st" data-field="x_Id_Atencion" name="o<?php echo $atencion_para_st_grid->RowIndex ?>_Id_Atencion" id="o<?php echo $atencion_para_st_grid->RowIndex ?>_Id_Atencion" value="<?php echo ew_HtmlEncode($atencion_para_st->Id_Atencion->OldValue) ?>">
<?php } ?>
...
<span id="el<?php echo $atencion_para_st_grid->RowCnt ?>_atencion_para_st_NroSerie" class="form-group atencion_para_st_NroSerie">
...
<input type="hidden" id="x<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" name="x<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($atencion_para_st->NroSerie->CurrentValue) ?>">
<?php } else { ?>
<span id="el<?php echo $atencion_para_st_grid->RowCnt ?>_atencion_para_st_NroSerie" class="form-group atencion_para_st_NroSerie">
<input type="text" data-table="atencion_para_st" data-field="x_NroSerie" name="x<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" id="x<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($atencion_para_st->NroSerie->getPlaceHolder()) ?>" value="<?php echo $atencion_para_st->NroSerie->EditValue ?>"<?php echo $atencion_para_st->NroSerie->EditAttributes() ?>>
</span>
<?php } ?>
<input type="hidden" data-table="atencion_para_st" data-field="x_NroSerie" name="o<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" id="o<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($atencion_para_st->NroSerie->OldValue) ?>">
<?php } ?>
<?php if ($atencion_para_st->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $atencion_para_st_grid->RowCnt ?>_atencion_para_st_NroSerie" class="form-group atencion_para_st_NroSerie">
<span<?php echo $atencion_para_st->NroSerie->ViewAttributes() ?>>
...
<input type="hidden" data-table="atencion_para_st" data-field="x_NroSerie" name="x<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" id="x<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($atencion_para_st->NroSerie->CurrentValue) ?>">
<?php } ?>
<?php if ($atencion_para_st->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $atencion_para_st_grid->RowCnt ?>_atencion_para_st_NroSerie" class="atencion_para_st_NroSerie">
<span<?php echo $atencion_para_st->NroSerie->ViewAttributes() ?>>
<?php echo $atencion_para_st->NroSerie->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="atencion_para_st" data-field="x_NroSerie" name="x<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" id="x<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($atencion_para_st->NroSerie->FormValue) ?>">
<input type="hidden" data-table="atencion_para_st" data-field="x_NroSerie" name="o<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" id="o<?php echo $atencion_para_st_grid->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($atencion_para_st->NroSerie->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($atencion_para_st->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $atencion_para_st_grid->RowCnt ?>_atencion_para_st_Referencia_Tipo_Retiro" class="form-group atencion_para_st_Referencia_Tipo_Retiro">
<input type="text" data-table="atencion_para_st" data-field="x_Referencia_Tipo_Retiro" name="x<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" id="x<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" size="5" maxlength="50" placeholder="<?php echo ew_HtmlEncode($atencion_para_st->Referencia_Tipo_Retiro->getPlaceHolder()) ?>" value="<?php echo $atencion_para_st->Referencia_Tipo_Retiro->EditValue ?>"<?php echo $atencion_para_st->Referencia_Tipo_Retiro->EditAttributes() ?>>
</span>
<input type="hidden" data-table="atencion_para_st" data-field="x_Referencia_Tipo_Retiro" name="o<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" id="o<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" value="<?php echo ew_HtmlEncode($atencion_para_st->Referencia_Tipo_Retiro->OldValue) ?>">
<?php } ?>
<?php if ($atencion_para_st->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $atencion_para_st_grid->RowCnt ?>_atencion_para_st_Referencia_Tipo_Retiro" class="form-group atencion_para_st_Referencia_Tipo_Retiro">
<input type="text" data-table="atencion_para_st" data-field="x_Referencia_Tipo_Retiro" name="x<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" id="x<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" size="5" maxlength="50" placeholder="<?php echo ew_HtmlEncode($atencion_para_st->Referencia_Tipo_Retiro->getPlaceHolder()) ?>" value="<?php echo $atencion_para_st->Referencia_Tipo_Retiro->EditValue ?>"<?php echo $atencion_para_st->Referencia_Tipo_Retiro->EditAttributes() ?>>
...
<?php } ?>
<?php if ($atencion_para_st->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $atencion_para_st_grid->RowCnt ?>_atencion_para_st_Referencia_Tipo_Retiro" class="atencion_para_st_Referencia_Tipo_Retiro">
...
<input type="hidden" data-table="atencion_para_st" data-field="x_Referencia_Tipo_Retiro" name="x<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" id="x<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" value="<?php echo ew_HtmlEncode($atencion_para_st->Referencia_Tipo_Retiro->FormValue) ?>">
<input type="hidden" data-table="atencion_para_st" data-field="x_Referencia_Tipo_Retiro" name="o<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" id="o<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" value="<?php echo ew_HtmlEncode($atencion_para_st->Referencia_Tipo_Retiro->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<span id="el$rowindex$_atencion_para_st_Referencia_Tipo_Retiro" class="form-group atencion_para_st_Referencia_Tipo_Retiro">
<span<?php echo $atencion_para_st->Referencia_Tipo_Retiro->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $atencion_para_st->Referencia_Tipo_Retiro->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="atencion_para_st" data-field="x_Referencia_Tipo_Retiro" name="x<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" id="x<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" value="<?php echo ew_HtmlEncode($atencion_para_st->Referencia_Tipo_Retiro->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="atencion_para_st" data-field="x_Referencia_Tipo_Retiro" name="o<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" id="o<?php echo $atencion_para_st_grid->RowIndex ?>_Referencia_Tipo_Retiro" value="<?php echo ew_HtmlEncode($atencion_para_st->Referencia_Tipo_Retiro->OldValue) ?>">
