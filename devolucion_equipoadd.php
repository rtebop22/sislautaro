...
$devolucion_equipo_add = NULL; // Initialize page object first

class cdevolucion_equipo_add extends cdevolucion_equipo {
	...
	// Page object name
	var $PageObjName = 'devolucion_equipo_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "devolucion_equipoview.php")
	...
	function LoadDefaultValues() {
		...
		$this->Id_Autoridad->CurrentValue = 1;
		...
		$this->Devuelve_Cargador->CurrentValue = 'NO';
	...
	function ValidateForm() {
		...
		if (!$this->Admin_Que_Recibe->FldIsDetailKey && !is_null($this->Admin_Que_Recibe->FormValue) && $this->Admin_Que_Recibe->FormValue == "") {
		...
		if ($this->Devuelve_Cargador->FormValue == "") {
	...
	function AddRow($rsold = NULL) {
		...
		// Devuelve_Cargador
		$this->Devuelve_Cargador->SetDbValueDef($rsnew, $this->Devuelve_Cargador->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($devolucion_equipo_add)) $devolucion_equipo_add = new cdevolucion_equipo_add();

// Page init
$devolucion_equipo_add->Page_Init();

// Page main
$devolucion_equipo_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$devolucion_equipo_add->Page_Render();
?>
...
var CurrentForm = fdevolucion_equipoadd = new ew_Form("fdevolucion_equipoadd", "add");

// Validate form
fdevolucion_equipoadd.Validate = function() {
...
fdevolucion_equipoadd.Form_CustomValidate = 
...
fdevolucion_equipoadd.ValidateRequired = true;
<?php } else { ?>
fdevolucion_equipoadd.ValidateRequired = false; 
<?php } ?>

// Multi-Page
fdevolucion_equipoadd.MultiPage = new ew_MultiPage("fdevolucion_equipoadd");

// Dynamic selection lists
fdevolucion_equipoadd.Lists["x_Dni"] = {"LinkField":"x_Dni","Ajax":true,"AutoFill":true,"DisplayFields":["x_Apellidos_Nombres","x_Dni","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
fdevolucion_equipoadd.Lists["x_NroSerie"] = {"LinkField":"x_NroSerie","Ajax":true,"AutoFill":false,"DisplayFields":["x_NroSerie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};
fdevolucion_equipoadd.Lists["x_Dni_Tutor"] = {"LinkField":"x_Dni_Tutor","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","x_Dni_Tutor","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tutores"};
fdevolucion_equipoadd.Lists["x_Admin_Que_Recibe"] = {"LinkField":"x_DniRte","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellido_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"referente_tecnico"};
fdevolucion_equipoadd.Lists["x_Id_Autoridad"] = {"LinkField":"x_Id_Autoridad","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellido_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"autoridades_escolares"};
fdevolucion_equipoadd.Lists["x_Id_Motivo"] = {"LinkField":"x_Id_Motivo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"motivo_devolucion"};
fdevolucion_equipoadd.Lists["x_Id_Estado_Devol"] = {"LinkField":"x_Id_Estado_Devol","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipo_devuelto"};
fdevolucion_equipoadd.Lists["x_Devuelve_Cargador"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdevolucion_equipoadd.Lists["x_Devuelve_Cargador"].Options = <?php echo json_encode($devolucion_equipo->Devuelve_Cargador->Options()) ?>;
...
<?php if (!$devolucion_equipo_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $devolucion_equipo_add->ShowPageHeader(); ?>
<?php
$devolucion_equipo_add->ShowMessage();
?>
<form name="fdevolucion_equipoadd" id="fdevolucion_equipoadd" class="<?php echo $devolucion_equipo_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($devolucion_equipo_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $devolucion_equipo_add->Token ?>">
<?php } ?>
...
<div class="panel-group" id="devolucion_equipo_add">
	<div class="panel panel-default<?php echo $devolucion_equipo_add->MultiPages->PageStyle("1") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#devolucion_equipo_add" href="#tab_devolucion_equipo1"><?php echo $devolucion_equipo->PageCaption(1) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $devolucion_equipo_add->MultiPages->PageStyle("1") ?>" id="tab_devolucion_equipo1">
			<div class="panel-body">
<div>
<?php if ($devolucion_equipo->Dni->Visible) { // Dni ?>
	<div id="r_Dni" class="form-group">
		<label id="elh_devolucion_equipo_Dni" class="col-sm-2 control-label ewLabel"><?php echo $devolucion_equipo->Dni->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($devolucion_equipo->NroSerie->Visible) { // NroSerie ?>
	<div id="r_NroSerie" class="form-group">
		<label id="elh_devolucion_equipo_NroSerie" class="col-sm-2 control-label ewLabel"><?php echo $devolucion_equipo->NroSerie->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $devolucion_equipo->NroSerie->CellAttributes() ?>>
<span id="el_devolucion_equipo_NroSerie">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_NroSerie"><?php echo (strval($devolucion_equipo->NroSerie->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $devolucion_equipo->NroSerie->ViewValue); ?></span>
</span>
...
<input type="hidden" data-table="devolucion_equipo" data-field="x_NroSerie" data-page="1" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $devolucion_equipo->NroSerie->DisplayValueSeparatorAttribute() ?>" name="x_NroSerie" id="x_NroSerie" value="<?php echo $devolucion_equipo->NroSerie->CurrentValue ?>"<?php echo $devolucion_equipo->NroSerie->EditAttributes() ?>>
...
<?php if ($devolucion_equipo->Dni_Tutor->Visible) { // Dni_Tutor ?>
	<div id="r_Dni_Tutor" class="form-group">
		<label id="elh_devolucion_equipo_Dni_Tutor" class="col-sm-2 control-label ewLabel"><?php echo $devolucion_equipo->Dni_Tutor->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<button type="button" title="<?php echo ew_HtmlTitle($Language->Phrase("AddLink")) . "&nbsp;" . $devolucion_equipo->Dni_Tutor->FldCaption() ?>" onclick="ew_AddOptDialogShow({lnk:this,el:'x_Dni_Tutor',url:'tutoresaddopt.php'});" class="ewAddOptBtn btn btn-default btn-sm" id="aol_x_Dni_Tutor"><span class="glyphicon glyphicon-plus ewIcon"></span><span class="hide"><?php echo $Language->Phrase("AddLink") ?>&nbsp;<?php echo $devolucion_equipo->Dni_Tutor->FldCaption() ?></span></button>
<?php } ?>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $devolucion_equipo_add->MultiPages->PageStyle("2") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#devolucion_equipo_add" href="#tab_devolucion_equipo2"><?php echo $devolucion_equipo->PageCaption(2) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $devolucion_equipo_add->MultiPages->PageStyle("2") ?>" id="tab_devolucion_equipo2">
			<div class="panel-body">
<div>
<?php if ($devolucion_equipo->Admin_Que_Recibe->Visible) { // Admin_Que_Recibe ?>
	<div id="r_Admin_Que_Recibe" class="form-group">
		<label id="elh_devolucion_equipo_Admin_Que_Recibe" for="x_Admin_Que_Recibe" class="col-sm-2 control-label ewLabel"><?php echo $devolucion_equipo->Admin_Que_Recibe->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<select data-table="devolucion_equipo" data-field="x_Id_Motivo" data-page="2" data-value-separator="<?php echo $devolucion_equipo->Id_Motivo->DisplayValueSeparatorAttribute() ?>" id="x_Id_Motivo" name="x_Id_Motivo"<?php echo $devolucion_equipo->Id_Motivo->EditAttributes() ?>>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $devolucion_equipo_add->MultiPages->PageStyle("3") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#devolucion_equipo_add" href="#tab_devolucion_equipo3"><?php echo $devolucion_equipo->PageCaption(3) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $devolucion_equipo_add->MultiPages->PageStyle("3") ?>" id="tab_devolucion_equipo3">
			<div class="panel-body">
<div>
...
<?php if ($devolucion_equipo->Devuelve_Cargador->Visible) { // Devuelve_Cargador ?>
	<div id="r_Devuelve_Cargador" class="form-group">
		<label id="elh_devolucion_equipo_Devuelve_Cargador" class="col-sm-2 control-label ewLabel"><?php echo $devolucion_equipo->Devuelve_Cargador->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $devolucion_equipo_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fdevolucion_equipoadd.Init();
</script>
<?php
$devolucion_equipo_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$devolucion_equipo_add->Page_Terminate();
?>
