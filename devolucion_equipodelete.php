...
fdevolucion_equipodelete.Lists["x_Id_Estado_Devol"] = {"LinkField":"x_Id_Estado_Devol","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipo_devuelto"};
...
<?php if ($devolucion_equipo->Usuario->Visible) { // Usuario ?>
		<th><span id="elh_devolucion_equipo_Usuario" class="devolucion_equipo_Usuario"><?php echo $devolucion_equipo->Usuario->FldCaption() ?></span></th>
<?php } ?>
<?php if ($devolucion_equipo->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<th><span id="elh_devolucion_equipo_Fecha_Actualizacion" class="devolucion_equipo_Fecha_Actualizacion"><?php echo $devolucion_equipo->Fecha_Actualizacion->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($devolucion_equipo->Usuario->Visible) { // Usuario ?>
		<td<?php echo $devolucion_equipo->Usuario->CellAttributes() ?>>
<span id="el<?php echo $devolucion_equipo_delete->RowCnt ?>_devolucion_equipo_Usuario" class="devolucion_equipo_Usuario">
...
<?php } ?>
<?php if ($devolucion_equipo->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<td<?php echo $devolucion_equipo->Fecha_Actualizacion->CellAttributes() ?>>
<span id="el<?php echo $devolucion_equipo_delete->RowCnt ?>_devolucion_equipo_Fecha_Actualizacion" class="devolucion_equipo_Fecha_Actualizacion">
