...
// Multi-Page
fdenuncia_robo_equipoedit.MultiPage = new ew_MultiPage("fdenuncia_robo_equipoedit");

// Dynamic selection lists
fdenuncia_robo_equipoedit.Lists["x_Dni"] = {"LinkField":"x_Dni","Ajax":true,"AutoFill":true,"DisplayFields":["x_Apellidos_Nombres","x_Dni","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
fdenuncia_robo_equipoedit.Lists["x_NroSerie"] = {"LinkField":"x_NroSerie","Ajax":true,"AutoFill":false,"DisplayFields":["x_NroSerie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};
fdenuncia_robo_equipoedit.Lists["x_Dni_Tutor"] = {"LinkField":"x_Dni_Tutor","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","x_Dni_Tutor","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tutores"};
fdenuncia_robo_equipoedit.Lists["x_Id_Estado_Den"] = {"LinkField":"x_Id_Estado_Den","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_denuncia"};
...
<div class="panel-group" id="denuncia_robo_equipo_edit">
	<div class="panel panel-default<?php echo $denuncia_robo_equipo_edit->MultiPages->PageStyle("1") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#denuncia_robo_equipo_edit" href="#tab_denuncia_robo_equipo1"><?php echo $denuncia_robo_equipo->PageCaption(1) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $denuncia_robo_equipo_edit->MultiPages->PageStyle("1") ?>" id="tab_denuncia_robo_equipo1">
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $denuncia_robo_equipo_edit->MultiPages->PageStyle("2") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#denuncia_robo_equipo_edit" href="#tab_denuncia_robo_equipo2"><?php echo $denuncia_robo_equipo->PageCaption(2) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $denuncia_robo_equipo_edit->MultiPages->PageStyle("2") ?>" id="tab_denuncia_robo_equipo2">
			<div class="panel-body">
<div>
...
<script type="text/javascript">
ew_CreateCalendar("fdenuncia_robo_equipoedit", "x_Fecha_Denuncia", 7);
</script>
<?php } ?>
</span>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $denuncia_robo_equipo_edit->MultiPages->PageStyle("3") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#denuncia_robo_equipo_edit" href="#tab_denuncia_robo_equipo3"><?php echo $denuncia_robo_equipo->PageCaption(3) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $denuncia_robo_equipo_edit->MultiPages->PageStyle("3") ?>" id="tab_denuncia_robo_equipo3">
			<div class="panel-body">
<div>
