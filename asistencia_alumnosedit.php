...
$asistencia_alumnos_edit = NULL; // Initialize page object first

class casistencia_alumnos_edit extends casistencia_alumnos {
	...
	// Page object name
	var $PageObjName = 'asistencia_alumnos_edit';
	...
	function Page_Main() {
		...
		if ($this->Dni->CurrentValue == "") {
			$this->Page_Terminate("asistencia_alumnoslist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($asistencia_alumnos_edit)) $asistencia_alumnos_edit = new casistencia_alumnos_edit();

// Page init
$asistencia_alumnos_edit->Page_Init();

// Page main
$asistencia_alumnos_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$asistencia_alumnos_edit->Page_Render();
?>
...
var CurrentForm = fasistencia_alumnosedit = new ew_Form("fasistencia_alumnosedit", "edit");

// Validate form
fasistencia_alumnosedit.Validate = function() {
...
fasistencia_alumnosedit.Form_CustomValidate = 
...
fasistencia_alumnosedit.ValidateRequired = true;
<?php } else { ?>
fasistencia_alumnosedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$asistencia_alumnos_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $asistencia_alumnos_edit->ShowPageHeader(); ?>
<?php
$asistencia_alumnos_edit->ShowMessage();
?>
<form name="fasistencia_alumnosedit" id="fasistencia_alumnosedit" class="<?php echo $asistencia_alumnos_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($asistencia_alumnos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $asistencia_alumnos_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="asistencia_alumnos" data-field="x_Dni" name="x_Dni" id="x_Dni" value="<?php echo ew_HtmlEncode($asistencia_alumnos->Dni->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $asistencia_alumnos_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fasistencia_alumnosedit.Init();
</script>
<?php
$asistencia_alumnos_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$asistencia_alumnos_edit->Page_Terminate();
?>
