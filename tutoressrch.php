...
class ctutores_search extends ctutores {
	...
	function RenderRow() {
		...
		$this->Usuario->ViewCustomAttributes = "";
			...
			if (trim(strval($this->Id_Ocupacion->AdvancedSearch->SearchValue)) == "") {
				$sFilterWrk = "0=1";
			} else {
	...
	function ValidateSearch() {
		...
		if (!ew_CheckInteger($this->Edad->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->Edad->FldErrMsg());
		}
		if (!ew_CheckInteger($this->Tel_Contacto->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->Tel_Contacto->FldErrMsg());
		}
...
<?php if ($tutores->Id_Ocupacion->Visible) { // Id_Ocupacion ?>
	<div id="r_Id_Ocupacion" class="form-group">
		<label for="x_Id_Ocupacion" class="<?php echo $tutores_search->SearchLabelClass ?>"><span id="elh_tutores_Id_Ocupacion"><?php echo $tutores->Id_Ocupacion->FldCaption() ?></span>	
...
<?php if ($tutores->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<div id="r_Fecha_Actualizacion" class="form-group">
		<label for="x_Fecha_Actualizacion" class="<?php echo $tutores_search->SearchLabelClass ?>"><span id="elh_tutores_Fecha_Actualizacion"><?php echo $tutores->Fecha_Actualizacion->FldCaption() ?></span>	
...
<input type="text" data-table="tutores" data-field="x_Fecha_Actualizacion" data-format="7" name="x_Fecha_Actualizacion" id="x_Fecha_Actualizacion" size="30" maxlength="60" placeholder="<?php echo ew_HtmlEncode($tutores->Fecha_Actualizacion->getPlaceHolder()) ?>" value="<?php echo $tutores->Fecha_Actualizacion->EditValue ?>"<?php echo $tutores->Fecha_Actualizacion->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($tutores->Usuario->Visible) { // Usuario ?>
	<div id="r_Usuario" class="form-group">
		<label for="x_Usuario" class="<?php echo $tutores_search->SearchLabelClass ?>"><span id="elh_tutores_Usuario"><?php echo $tutores->Usuario->FldCaption() ?></span>	
		...
		<div class="<?php echo $tutores_search->SearchRightColumnClass ?>"><div<?php echo $tutores->Usuario->CellAttributes() ?>>
			<span id="el_tutores_Usuario">
<input type="text" data-table="tutores" data-field="x_Usuario" name="x_Usuario" id="x_Usuario" size="30" maxlength="60" placeholder="<?php echo ew_HtmlEncode($tutores->Usuario->getPlaceHolder()) ?>" value="<?php echo $tutores->Usuario->EditValue ?>"<?php echo $tutores->Usuario->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
