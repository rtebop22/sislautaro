...
<?php if ($detalle_atencion->Id_Atencion->Visible) { // Id_Atencion ?>
	<tr id="r_Id_Atencion">
		<td><span id="elh_detalle_atencion_Id_Atencion"><?php echo $detalle_atencion->Id_Atencion->FldCaption() ?></span></td>
...
<?php echo $detalle_atencion->Id_Atencion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detalle_atencion->NroSerie->Visible) { // NroSerie ?>
	<tr id="r_NroSerie">
		<td><span id="elh_detalle_atencion_NroSerie"><?php echo $detalle_atencion->NroSerie->FldCaption() ?></span></td>
		<td data-name="NroSerie"<?php echo $detalle_atencion->NroSerie->CellAttributes() ?>>
<span id="el_detalle_atencion_NroSerie">
<span<?php echo $detalle_atencion->NroSerie->ViewAttributes() ?>>
<?php echo $detalle_atencion->NroSerie->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
