...
$paquetes_provision_edit = NULL; // Initialize page object first

class cpaquetes_provision_edit extends cpaquetes_provision {
	...
	// Page object name
	var $PageObjName = 'paquetes_provision_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->NroPedido->CurrentValue == "") {
			$this->Page_Terminate("paquetes_provisionlist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($paquetes_provision_edit)) $paquetes_provision_edit = new cpaquetes_provision_edit();

// Page init
$paquetes_provision_edit->Page_Init();

// Page main
$paquetes_provision_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$paquetes_provision_edit->Page_Render();
?>
...
var CurrentForm = fpaquetes_provisionedit = new ew_Form("fpaquetes_provisionedit", "edit");

// Validate form
fpaquetes_provisionedit.Validate = function() {
...
fpaquetes_provisionedit.Form_CustomValidate = 
...
fpaquetes_provisionedit.ValidateRequired = true;
<?php } else { ?>
fpaquetes_provisionedit.ValidateRequired = false; 
<?php } ?>

// Multi-Page
fpaquetes_provisionedit.MultiPage = new ew_MultiPage("fpaquetes_provisionedit");

// Dynamic selection lists
fpaquetes_provisionedit.Lists["x_Serie_Netbook"] = {"LinkField":"x_NroSerie","Ajax":true,"AutoFill":true,"DisplayFields":["x_NroSerie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};
fpaquetes_provisionedit.Lists["x_Id_Hardware"] = {"LinkField":"x_NroMac","Ajax":true,"AutoFill":false,"DisplayFields":["x_NroMac","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};
fpaquetes_provisionedit.Lists["x_Serie_Server"] = {"LinkField":"x_Nro_Serie","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nro_Serie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"servidor_escolar"};
fpaquetes_provisionedit.Lists["x_Id_Motivo"] = {"LinkField":"x_Id_Motivo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"motivo_pedido_paquetes"};
fpaquetes_provisionedit.Lists["x_Id_Tipo_Extraccion"] = {"LinkField":"x_Id_Tipo_Extraccion","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_extraccion"};
fpaquetes_provisionedit.Lists["x_Id_Estado_Paquete"] = {"LinkField":"x_Id_Estado_Paquete","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_paquete"};
fpaquetes_provisionedit.Lists["x_Id_Tipo_Paquete"] = {"LinkField":"x_Id_Tipo_Paquete","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_paquete"};
fpaquetes_provisionedit.Lists["x_Apellido_Nombre_Solicitante"] = {"LinkField":"x_Apellido_Nombre","Ajax":true,"AutoFill":true,"DisplayFields":["x_Apellido_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"referente_tecnico"};
...
<?php if (!$paquetes_provision_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $paquetes_provision_edit->ShowPageHeader(); ?>
<?php
$paquetes_provision_edit->ShowMessage();
?>
<form name="fpaquetes_provisionedit" id="fpaquetes_provisionedit" class="<?php echo $paquetes_provision_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($paquetes_provision_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $paquetes_provision_edit->Token ?>">
<?php } ?>
...
<div class="panel-group" id="paquetes_provision_edit">
	<div class="panel panel-default<?php echo $paquetes_provision_edit->MultiPages->PageStyle("1") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#paquetes_provision_edit" href="#tab_paquetes_provision1"><?php echo $paquetes_provision->PageCaption(1) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $paquetes_provision_edit->MultiPages->PageStyle("1") ?>" id="tab_paquetes_provision1">
...
<script type="text/javascript">
fpaquetes_provisionedit.CreateAutoSuggest({"id":"x_Id_Hardware","forceSelect":false});
</script>
</span>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $paquetes_provision_edit->MultiPages->PageStyle("2") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#paquetes_provision_edit" href="#tab_paquetes_provision2"><?php echo $paquetes_provision->PageCaption(2) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $paquetes_provision_edit->MultiPages->PageStyle("2") ?>" id="tab_paquetes_provision2">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $paquetes_provision_edit->MultiPages->PageStyle("3") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#paquetes_provision_edit" href="#tab_paquetes_provision3"><?php echo $paquetes_provision->PageCaption(3) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $paquetes_provision_edit->MultiPages->PageStyle("3") ?>" id="tab_paquetes_provision3">
			<div class="panel-body">
<div>
...
<input type="hidden" data-table="paquetes_provision" data-field="x_NroPedido" name="x_NroPedido" id="x_NroPedido" value="<?php echo ew_HtmlEncode($paquetes_provision->NroPedido->CurrentValue) ?>">
<?php if (!$paquetes_provision_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $paquetes_provision_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fpaquetes_provisionedit.Init();
</script>
<?php
$paquetes_provision_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$paquetes_provision_edit->Page_Terminate();
?>
