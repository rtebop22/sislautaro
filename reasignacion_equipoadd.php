...
class creasignacion_equipo_add extends creasignacion_equipo {
	...
	function LoadDefaultValues() {
		...
		$this->Fecha_Reasignacion->CurrentValue = ew_CurrentDate();
	...
	function AddRow($rsold = NULL) {
		...
		// Fecha_Reasignacion
		$this->Fecha_Reasignacion->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->Fecha_Reasignacion->CurrentValue, 7), NULL, FALSE);
...
// Multi-Page
freasignacion_equipoadd.MultiPage = new ew_MultiPage("freasignacion_equipoadd");

// Dynamic selection lists
freasignacion_equipoadd.Lists["x_Titular_Original"] = {"LinkField":"x_Apellidos_Nombres","Ajax":true,"AutoFill":true,"DisplayFields":["x_Apellidos_Nombres","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
freasignacion_equipoadd.Lists["x_NroSerie"] = {"LinkField":"x_NroSerie","Ajax":true,"AutoFill":false,"DisplayFields":["x_NroSerie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};
freasignacion_equipoadd.Lists["x_Nuevo_Titular"] = {"LinkField":"x_Apellidos_Nombres","Ajax":true,"AutoFill":true,"DisplayFields":["x_Apellidos_Nombres","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
freasignacion_equipoadd.Lists["x_Id_Motivo_Reasig"] = {"LinkField":"x_Id_Motivo_Reasig","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"motivo_reasignacion"};
...
<div class="panel-group" id="reasignacion_equipo_add">
	<div class="panel panel-default<?php echo $reasignacion_equipo_add->MultiPages->PageStyle("1") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#reasignacion_equipo_add" href="#tab_reasignacion_equipo1"><?php echo $reasignacion_equipo->PageCaption(1) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $reasignacion_equipo_add->MultiPages->PageStyle("1") ?>" id="tab_reasignacion_equipo1">
...
<?php if ($reasignacion_equipo->Id_Reasignacion->Visible) { // Id_Reasignacion ?>
	<div id="r_Id_Reasignacion" class="form-group">
		...
		<div class="col-sm-10"><div<?php echo $reasignacion_equipo->Id_Reasignacion->CellAttributes() ?>><?php echo $reasignacion_equipo->Id_Reasignacion->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $reasignacion_equipo_add->MultiPages->PageStyle("2") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#reasignacion_equipo_add" href="#tab_reasignacion_equipo2"><?php echo $reasignacion_equipo->PageCaption(2) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $reasignacion_equipo_add->MultiPages->PageStyle("2") ?>" id="tab_reasignacion_equipo2">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $reasignacion_equipo_add->MultiPages->PageStyle("3") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#reasignacion_equipo_add" href="#tab_reasignacion_equipo3"><?php echo $reasignacion_equipo->PageCaption(3) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $reasignacion_equipo_add->MultiPages->PageStyle("3") ?>" id="tab_reasignacion_equipo3">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $reasignacion_equipo_add->MultiPages->PageStyle("4") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#reasignacion_equipo_add" href="#tab_reasignacion_equipo4"><?php echo $reasignacion_equipo->PageCaption(4) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $reasignacion_equipo_add->MultiPages->PageStyle("4") ?>" id="tab_reasignacion_equipo4">
			<div class="panel-body">
<div>
...
<script type="text/javascript">
ew_CreateCalendar("freasignacion_equipoadd", "x_Fecha_Reasignacion", 7);
</script>
<?php } ?>
</span>
