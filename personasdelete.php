...
<?php if ($personas->Foto->Visible) { // Foto ?>
		<th><span id="elh_personas_Foto" class="personas_Foto"><?php echo $personas->Foto->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($personas->Usuario->Visible) { // Usuario ?>
		<th><span id="elh_personas_Usuario" class="personas_Usuario"><?php echo $personas->Usuario->FldCaption() ?></span></th>
<?php } ?>
<?php if ($personas->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<th><span id="elh_personas_Fecha_Actualizacion" class="personas_Fecha_Actualizacion"><?php echo $personas->Fecha_Actualizacion->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $personas_delete->RowCnt ?>_personas_Foto" class="personas_Foto">
<span>
...
<span id="el<?php echo $personas_delete->RowCnt ?>_personas_Usuario" class="personas_Usuario">
...
<span id="el<?php echo $personas_delete->RowCnt ?>_personas_Fecha_Actualizacion" class="personas_Fecha_Actualizacion">
