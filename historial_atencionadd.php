...
$historial_atencion_add = NULL; // Initialize page object first

class chistorial_atencion_add extends chistorial_atencion {
	...
	// Page object name
	var $PageObjName = 'historial_atencion_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "historial_atencionview.php")
...
// Create page object
if (!isset($historial_atencion_add)) $historial_atencion_add = new chistorial_atencion_add();

// Page init
$historial_atencion_add->Page_Init();

// Page main
$historial_atencion_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$historial_atencion_add->Page_Render();
?>
...
var CurrentForm = fhistorial_atencionadd = new ew_Form("fhistorial_atencionadd", "add");

// Validate form
fhistorial_atencionadd.Validate = function() {
...
fhistorial_atencionadd.Form_CustomValidate = 
...
fhistorial_atencionadd.ValidateRequired = true;
<?php } else { ?>
fhistorial_atencionadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$historial_atencion_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $historial_atencion_add->ShowPageHeader(); ?>
<?php
$historial_atencion_add->ShowMessage();
?>
<form name="fhistorial_atencionadd" id="fhistorial_atencionadd" class="<?php echo $historial_atencion_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($historial_atencion_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $historial_atencion_add->Token ?>">
<?php } ?>
...
<?php if (strval($historial_atencion->Id_Atencion->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_Id_Atencion" id="x_Id_Atencion" value="<?php echo ew_HtmlEncode(strval($historial_atencion->Id_Atencion->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($historial_atencion->NroSerie->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_NroSerie" id="x_NroSerie" value="<?php echo ew_HtmlEncode(strval($historial_atencion->NroSerie->getSessionValue())) ?>">
<?php } ?>
<?php if (!$historial_atencion_add->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $historial_atencion_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fhistorial_atencionadd.Init();
</script>
<?php
$historial_atencion_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$historial_atencion_add->Page_Terminate();
?>
