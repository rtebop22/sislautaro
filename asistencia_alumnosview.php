...
$asistencia_alumnos_view = NULL; // Initialize page object first

class casistencia_alumnos_view extends casistencia_alumnos {
	...
	// Page object name
	var $PageObjName = 'asistencia_alumnos_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Dni"] <> "") {
				...
				$sReturnUrl = "asistencia_alumnoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "asistencia_alumnoslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "asistencia_alumnoslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($asistencia_alumnos_view)) $asistencia_alumnos_view = new casistencia_alumnos_view();

// Page init
$asistencia_alumnos_view->Page_Init();

// Page main
$asistencia_alumnos_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$asistencia_alumnos_view->Page_Render();
?>
...
var CurrentForm = fasistencia_alumnosview = new ew_Form("fasistencia_alumnosview", "view");

// Form_CustomValidate event
fasistencia_alumnosview.Form_CustomValidate = 
...
fasistencia_alumnosview.ValidateRequired = true;
<?php } else { ?>
fasistencia_alumnosview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($asistencia_alumnos->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$asistencia_alumnos_view->IsModal) { ?>
<?php if ($asistencia_alumnos->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $asistencia_alumnos_view->ExportOptions->Render("body") ?>
<?php
	foreach ($asistencia_alumnos_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$asistencia_alumnos_view->IsModal) { ?>
<?php if ($asistencia_alumnos->Export == "") { ?>
...
<?php } ?>
<?php $asistencia_alumnos_view->ShowPageHeader(); ?>
<?php
$asistencia_alumnos_view->ShowMessage();
?>
<form name="fasistencia_alumnosview" id="fasistencia_alumnosview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($asistencia_alumnos_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $asistencia_alumnos_view->Token ?>">
<?php } ?>
...
<?php if ($asistencia_alumnos->Dni->Visible) { // Dni ?>
	<tr id="r_Dni">
		<td><span id="elh_asistencia_alumnos_Dni"><?php echo $asistencia_alumnos->Dni->FldCaption() ?></span></td>
...
<?php echo $asistencia_alumnos->Dni->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($asistencia_alumnos->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
	<tr id="r_Apellidos_Nombres">
		<td><span id="elh_asistencia_alumnos_Apellidos_Nombres"><?php echo $asistencia_alumnos->Apellidos_Nombres->FldCaption() ?></span></td>
...
<?php echo $asistencia_alumnos->Apellidos_Nombres->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($asistencia_alumnos->Fecha->Visible) { // Fecha ?>
	<tr id="r_Fecha">
		<td><span id="elh_asistencia_alumnos_Fecha"><?php echo $asistencia_alumnos->Fecha->FldCaption() ?></span></td>
...
<?php echo $asistencia_alumnos->Fecha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($asistencia_alumnos->Usuario->Visible) { // Usuario ?>
	<tr id="r_Usuario">
		<td><span id="elh_asistencia_alumnos_Usuario"><?php echo $asistencia_alumnos->Usuario->FldCaption() ?></span></td>
...
<?php echo $asistencia_alumnos->Usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($asistencia_alumnos->Estado_Asistencia->Visible) { // Estado_Asistencia ?>
	<tr id="r_Estado_Asistencia">
		<td><span id="elh_asistencia_alumnos_Estado_Asistencia"><?php echo $asistencia_alumnos->Estado_Asistencia->FldCaption() ?></span></td>
...
<?php echo $asistencia_alumnos->Estado_Asistencia->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($asistencia_alumnos->Export == "") { ?>
<script type="text/javascript">
fasistencia_alumnosview.Init();
</script>
<?php } ?>
<?php
$asistencia_alumnos_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($asistencia_alumnos->Export == "") { ?>
...
<?php
$asistencia_alumnos_view->Page_Terminate();
?>
