...
$lista_espera_prestamo_view = NULL; // Initialize page object first

class clista_espera_prestamo_view extends clista_espera_prestamo {
	...
	// Page object name
	var $PageObjName = 'lista_espera_prestamo_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Dni"] <> "") {
				...
				$sReturnUrl = "lista_espera_prestamolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "lista_espera_prestamolist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "lista_espera_prestamolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($lista_espera_prestamo_view)) $lista_espera_prestamo_view = new clista_espera_prestamo_view();

// Page init
$lista_espera_prestamo_view->Page_Init();

// Page main
$lista_espera_prestamo_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$lista_espera_prestamo_view->Page_Render();
?>
...
var CurrentForm = flista_espera_prestamoview = new ew_Form("flista_espera_prestamoview", "view");

// Form_CustomValidate event
flista_espera_prestamoview.Form_CustomValidate = 
...
flista_espera_prestamoview.ValidateRequired = true;
<?php } else { ?>
flista_espera_prestamoview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
flista_espera_prestamoview.Lists["x_Apellidos_Nombres"] = {"LinkField":"x_Apellidos_Nombres","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
flista_espera_prestamoview.Lists["x_Id_Motivo_Prestamo"] = {"LinkField":"x_Id_Motivo_Prestamo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"motivo_prestamo_equipo"};
flista_espera_prestamoview.Lists["x_Id_Curso"] = {"LinkField":"x_Id_Curso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cursos"};
flista_espera_prestamoview.Lists["x_Id_Division"] = {"LinkField":"x_Id_Division","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"division"};
flista_espera_prestamoview.Lists["x_Id_Estado_Espera"] = {"LinkField":"x_Id_Estado_Espera","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_espera_prestamo"};
...
<?php if ($lista_espera_prestamo->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$lista_espera_prestamo_view->IsModal) { ?>
<?php if ($lista_espera_prestamo->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $lista_espera_prestamo_view->ExportOptions->Render("body") ?>
<?php
	foreach ($lista_espera_prestamo_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$lista_espera_prestamo_view->IsModal) { ?>
<?php if ($lista_espera_prestamo->Export == "") { ?>
...
<?php } ?>
<?php $lista_espera_prestamo_view->ShowPageHeader(); ?>
<?php
$lista_espera_prestamo_view->ShowMessage();
?>
<form name="flista_espera_prestamoview" id="flista_espera_prestamoview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($lista_espera_prestamo_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $lista_espera_prestamo_view->Token ?>">
<?php } ?>
...
<?php if ($lista_espera_prestamo->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
	<tr id="r_Apellidos_Nombres">
		<td><span id="elh_lista_espera_prestamo_Apellidos_Nombres"><?php echo $lista_espera_prestamo->Apellidos_Nombres->FldCaption() ?></span></td>
...
<?php echo $lista_espera_prestamo->Apellidos_Nombres->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lista_espera_prestamo->Dni->Visible) { // Dni ?>
	<tr id="r_Dni">
		<td><span id="elh_lista_espera_prestamo_Dni"><?php echo $lista_espera_prestamo->Dni->FldCaption() ?></span></td>
...
<?php echo $lista_espera_prestamo->Dni->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lista_espera_prestamo->Id_Motivo_Prestamo->Visible) { // Id_Motivo_Prestamo ?>
	<tr id="r_Id_Motivo_Prestamo">
		<td><span id="elh_lista_espera_prestamo_Id_Motivo_Prestamo"><?php echo $lista_espera_prestamo->Id_Motivo_Prestamo->FldCaption() ?></span></td>
...
<?php echo $lista_espera_prestamo->Id_Motivo_Prestamo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lista_espera_prestamo->Observacion->Visible) { // Observacion ?>
	<tr id="r_Observacion">
		<td><span id="elh_lista_espera_prestamo_Observacion"><?php echo $lista_espera_prestamo->Observacion->FldCaption() ?></span></td>
		<td data-name="Observacion"<?php echo $lista_espera_prestamo->Observacion->CellAttributes() ?>>
<span id="el_lista_espera_prestamo_Observacion">
<span<?php echo $lista_espera_prestamo->Observacion->ViewAttributes() ?>>
<?php echo $lista_espera_prestamo->Observacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lista_espera_prestamo->Id_Curso->Visible) { // Id_Curso ?>
	<tr id="r_Id_Curso">
		<td><span id="elh_lista_espera_prestamo_Id_Curso"><?php echo $lista_espera_prestamo->Id_Curso->FldCaption() ?></span></td>
...
<?php echo $lista_espera_prestamo->Id_Curso->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lista_espera_prestamo->Id_Division->Visible) { // Id_Division ?>
	<tr id="r_Id_Division">
		<td><span id="elh_lista_espera_prestamo_Id_Division"><?php echo $lista_espera_prestamo->Id_Division->FldCaption() ?></span></td>
...
<?php echo $lista_espera_prestamo->Id_Division->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lista_espera_prestamo->Id_Estado_Espera->Visible) { // Id_Estado_Espera ?>
	<tr id="r_Id_Estado_Espera">
		<td><span id="elh_lista_espera_prestamo_Id_Estado_Espera"><?php echo $lista_espera_prestamo->Id_Estado_Espera->FldCaption() ?></span></td>
...
<?php echo $lista_espera_prestamo->Id_Estado_Espera->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lista_espera_prestamo->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<tr id="r_Fecha_Actualizacion">
		<td><span id="elh_lista_espera_prestamo_Fecha_Actualizacion"><?php echo $lista_espera_prestamo->Fecha_Actualizacion->FldCaption() ?></span></td>
...
<?php echo $lista_espera_prestamo->Fecha_Actualizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lista_espera_prestamo->Usuario->Visible) { // Usuario ?>
	<tr id="r_Usuario">
		<td><span id="elh_lista_espera_prestamo_Usuario"><?php echo $lista_espera_prestamo->Usuario->FldCaption() ?></span></td>
...
<?php echo $lista_espera_prestamo->Usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($lista_espera_prestamo->Export == "") { ?>
<script type="text/javascript">
flista_espera_prestamoview.Init();
</script>
<?php } ?>
<?php
$lista_espera_prestamo_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($lista_espera_prestamo->Export == "") { ?>
...
<?php
$lista_espera_prestamo_view->Page_Terminate();
?>
