...
class cpiso_tecnologico_search extends cpiso_tecnologico {
	...
	function LoadSearchValues() {
		...
		// Bocas_Switch
		$this->Bocas_Switch->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_Bocas_Switch"));
		$this->Bocas_Switch->AdvancedSearch->SearchOperator = $objForm->GetValue("z_Bocas_Switch");
		...
		// Cantidad_Ap_Func
		$this->Cantidad_Ap_Func->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_Cantidad_Ap_Func"));
		$this->Cantidad_Ap_Func->AdvancedSearch->SearchOperator = $objForm->GetValue("z_Cantidad_Ap_Func");
		...
		$this->Marca_Modelo_Serie_Ups->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_Marca_Modelo_Serie_Ups"));
		$this->Marca_Modelo_Serie_Ups->AdvancedSearch->SearchOperator = $objForm->GetValue("z_Marca_Modelo_Serie_Ups");
	...
	function RenderRow() {
		...
		$this->Usuario->ViewCustomAttributes = "";
			...
			$this->Bocas_Switch->EditValue = ew_HtmlEncode($this->Bocas_Switch->AdvancedSearch->SearchValue);
			...
			$this->Cantidad_Ap_Func->EditValue = ew_HtmlEncode($this->Cantidad_Ap_Func->AdvancedSearch->SearchValue);
			...
			$this->Marca_Modelo_Serie_Ups->EditValue = ew_HtmlEncode($this->Marca_Modelo_Serie_Ups->AdvancedSearch->SearchValue);
	...
	function ValidateSearch() {
		...
		if (!EW_SERVER_VALIDATE)
			return TRUE;
		if (!ew_CheckInteger($this->Bocas_Switch->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->Bocas_Switch->FldErrMsg());
		}
		if (!ew_CheckInteger($this->Cantidad_Ap->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->Cantidad_Ap->FldErrMsg());
		}
		if (!ew_CheckInteger($this->Cantidad_Ap_Func->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->Cantidad_Ap_Func->FldErrMsg());
		}
...
<?php if ($piso_tecnologico->Bocas_Switch->Visible) { // Bocas_Switch ?>
	<div id="r_Bocas_Switch" class="form-group">
		<label for="x_Bocas_Switch" class="<?php echo $piso_tecnologico_search->SearchLabelClass ?>"><span id="elh_piso_tecnologico_Bocas_Switch"><?php echo $piso_tecnologico->Bocas_Switch->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_Bocas_Switch" id="z_Bocas_Switch" value="="></p>
		</label>
		<div class="<?php echo $piso_tecnologico_search->SearchRightColumnClass ?>"><div<?php echo $piso_tecnologico->Bocas_Switch->CellAttributes() ?>>
...
<?php if ($piso_tecnologico->Cantidad_Ap_Func->Visible) { // Cantidad_Ap_Func ?>
	<div id="r_Cantidad_Ap_Func" class="form-group">
		<label for="x_Cantidad_Ap_Func" class="<?php echo $piso_tecnologico_search->SearchLabelClass ?>"><span id="elh_piso_tecnologico_Cantidad_Ap_Func"><?php echo $piso_tecnologico->Cantidad_Ap_Func->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_Cantidad_Ap_Func" id="z_Cantidad_Ap_Func" value="="></p>
		</label>
		<div class="<?php echo $piso_tecnologico_search->SearchRightColumnClass ?>"><div<?php echo $piso_tecnologico->Cantidad_Ap_Func->CellAttributes() ?>>
...
<?php if ($piso_tecnologico->Marca_Modelo_Serie_Ups->Visible) { // Marca_Modelo_Serie_Ups ?>
	<div id="r_Marca_Modelo_Serie_Ups" class="form-group">
		<label for="x_Marca_Modelo_Serie_Ups" class="<?php echo $piso_tecnologico_search->SearchLabelClass ?>"><span id="elh_piso_tecnologico_Marca_Modelo_Serie_Ups"><?php echo $piso_tecnologico->Marca_Modelo_Serie_Ups->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Marca_Modelo_Serie_Ups" id="z_Marca_Modelo_Serie_Ups" value="LIKE"></p>
		</label>
		<div class="<?php echo $piso_tecnologico_search->SearchRightColumnClass ?>"><div<?php echo $piso_tecnologico->Marca_Modelo_Serie_Ups->CellAttributes() ?>>
