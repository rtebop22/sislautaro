...
class cprestamo_equipo extends cTable {
	...
	function __construct() {
		...
		// Dni
		$this->Dni = new cField('prestamo_equipo', 'prestamo_equipo', 'x_Dni', 'Dni', '`Dni`', '`Dni`', 3, -1, FALSE, '`Dni`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Fecha_Prestamo
		$this->Fecha_Prestamo = new cField('prestamo_equipo', 'prestamo_equipo', 'x_Fecha_Prestamo', 'Fecha_Prestamo', '`Fecha_Prestamo`', '`Fecha_Prestamo`', 200, 7, FALSE, '`Fecha_Prestamo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('prestamo_equipo', 'prestamo_equipo', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 5, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
		$this->Fecha_Actualizacion->Sortable = TRUE; // Allow sort
		$this->Fecha_Actualizacion->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateYMD"));
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Fecha_Prestamo->EditValue = $this->Fecha_Prestamo->CurrentValue;
	...
	$MyResult = ew_Execute("UPDATE Equipos SET Id_Ubicacion=1, Id_Estado=1, Id_Sit_Estado=13 WHERE NroSerie='$Serie'");
