...
$devolucion_equipo_delete = NULL; // Initialize page object first

class cdevolucion_equipo_delete extends cdevolucion_equipo {
	...
	// Page object name
	var $PageObjName = 'devolucion_equipo_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("devolucion_equipolist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in devolucion_equipo class, devolucion_equipoinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("devolucion_equipolist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($devolucion_equipo_delete)) $devolucion_equipo_delete = new cdevolucion_equipo_delete();

// Page init
$devolucion_equipo_delete->Page_Init();

// Page main
$devolucion_equipo_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$devolucion_equipo_delete->Page_Render();
?>
...
var CurrentForm = fdevolucion_equipodelete = new ew_Form("fdevolucion_equipodelete", "delete");

// Form_CustomValidate event
fdevolucion_equipodelete.Form_CustomValidate = 
...
fdevolucion_equipodelete.ValidateRequired = true;
<?php } else { ?>
fdevolucion_equipodelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdevolucion_equipodelete.Lists["x_Dni"] = {"LinkField":"x_Dni","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","x_Dni","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
fdevolucion_equipodelete.Lists["x_NroSerie"] = {"LinkField":"x_NroSerie","Ajax":true,"AutoFill":false,"DisplayFields":["x_NroSerie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};
fdevolucion_equipodelete.Lists["x_Admin_Que_Recibe"] = {"LinkField":"x_DniRte","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apelldio_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"referente_tecnico"};
fdevolucion_equipodelete.Lists["x_Id_Motivo"] = {"LinkField":"x_Id_Motivo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"motivo_devolucion"};
fdevolucion_equipodelete.Lists["x_Id_Estado_Devol"] = {"LinkField":"x_Id_Estado_Devol","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipo_devuleto"};
...
<?php $devolucion_equipo_delete->ShowPageHeader(); ?>
<?php
$devolucion_equipo_delete->ShowMessage();
?>
<form name="fdevolucion_equipodelete" id="fdevolucion_equipodelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($devolucion_equipo_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $devolucion_equipo_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="devolucion_equipo">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($devolucion_equipo_delete->RecKeys as $key) { ?>
...
<?php if ($devolucion_equipo->Dni->Visible) { // Dni ?>
		<th><span id="elh_devolucion_equipo_Dni" class="devolucion_equipo_Dni"><?php echo $devolucion_equipo->Dni->FldCaption() ?></span></th>
<?php } ?>
<?php if ($devolucion_equipo->NroSerie->Visible) { // NroSerie ?>
		<th><span id="elh_devolucion_equipo_NroSerie" class="devolucion_equipo_NroSerie"><?php echo $devolucion_equipo->NroSerie->FldCaption() ?></span></th>
<?php } ?>
<?php if ($devolucion_equipo->Admin_Que_Recibe->Visible) { // Admin_Que_Recibe ?>
		<th><span id="elh_devolucion_equipo_Admin_Que_Recibe" class="devolucion_equipo_Admin_Que_Recibe"><?php echo $devolucion_equipo->Admin_Que_Recibe->FldCaption() ?></span></th>
<?php } ?>
<?php if ($devolucion_equipo->Fecha_Devolucion->Visible) { // Fecha_Devolucion ?>
		<th><span id="elh_devolucion_equipo_Fecha_Devolucion" class="devolucion_equipo_Fecha_Devolucion"><?php echo $devolucion_equipo->Fecha_Devolucion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($devolucion_equipo->Id_Motivo->Visible) { // Id_Motivo ?>
		<th><span id="elh_devolucion_equipo_Id_Motivo" class="devolucion_equipo_Id_Motivo"><?php echo $devolucion_equipo->Id_Motivo->FldCaption() ?></span></th>
<?php } ?>
<?php if ($devolucion_equipo->Id_Estado_Devol->Visible) { // Id_Estado_Devol ?>
		<th><span id="elh_devolucion_equipo_Id_Estado_Devol" class="devolucion_equipo_Id_Estado_Devol"><?php echo $devolucion_equipo->Id_Estado_Devol->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$devolucion_equipo_delete->RecCnt = 0;
$i = 0;
while (!$devolucion_equipo_delete->Recordset->EOF) {
	$devolucion_equipo_delete->RecCnt++;
	$devolucion_equipo_delete->RowCnt++;

	// Set row properties
	$devolucion_equipo->ResetAttrs();
	$devolucion_equipo->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$devolucion_equipo_delete->LoadRowValues($devolucion_equipo_delete->Recordset);

	// Render row
	$devolucion_equipo_delete->RenderRow();
?>
	<tr<?php echo $devolucion_equipo->RowAttributes() ?>>
<?php if ($devolucion_equipo->Dni->Visible) { // Dni ?>
		<td<?php echo $devolucion_equipo->Dni->CellAttributes() ?>>
<span id="el<?php echo $devolucion_equipo_delete->RowCnt ?>_devolucion_equipo_Dni" class="devolucion_equipo_Dni">
...
<?php } ?>
<?php if ($devolucion_equipo->NroSerie->Visible) { // NroSerie ?>
		<td<?php echo $devolucion_equipo->NroSerie->CellAttributes() ?>>
<span id="el<?php echo $devolucion_equipo_delete->RowCnt ?>_devolucion_equipo_NroSerie" class="devolucion_equipo_NroSerie">
...
<?php } ?>
<?php if ($devolucion_equipo->Admin_Que_Recibe->Visible) { // Admin_Que_Recibe ?>
		<td<?php echo $devolucion_equipo->Admin_Que_Recibe->CellAttributes() ?>>
<span id="el<?php echo $devolucion_equipo_delete->RowCnt ?>_devolucion_equipo_Admin_Que_Recibe" class="devolucion_equipo_Admin_Que_Recibe">
...
<?php } ?>
<?php if ($devolucion_equipo->Fecha_Devolucion->Visible) { // Fecha_Devolucion ?>
		<td<?php echo $devolucion_equipo->Fecha_Devolucion->CellAttributes() ?>>
<span id="el<?php echo $devolucion_equipo_delete->RowCnt ?>_devolucion_equipo_Fecha_Devolucion" class="devolucion_equipo_Fecha_Devolucion">
...
<?php } ?>
<?php if ($devolucion_equipo->Id_Motivo->Visible) { // Id_Motivo ?>
		<td<?php echo $devolucion_equipo->Id_Motivo->CellAttributes() ?>>
<span id="el<?php echo $devolucion_equipo_delete->RowCnt ?>_devolucion_equipo_Id_Motivo" class="devolucion_equipo_Id_Motivo">
...
<?php } ?>
<?php if ($devolucion_equipo->Id_Estado_Devol->Visible) { // Id_Estado_Devol ?>
		<td<?php echo $devolucion_equipo->Id_Estado_Devol->CellAttributes() ?>>
<span id="el<?php echo $devolucion_equipo_delete->RowCnt ?>_devolucion_equipo_Id_Estado_Devol" class="devolucion_equipo_Id_Estado_Devol">
...
<?php
	$devolucion_equipo_delete->Recordset->MoveNext();
}
$devolucion_equipo_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $devolucion_equipo_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fdevolucion_equipodelete.Init();
</script>
<?php
$devolucion_equipo_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$devolucion_equipo_delete->Page_Terminate();
?>
