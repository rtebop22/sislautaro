...
class ctutores_list extends ctutores {
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_Cuil") && $objForm->HasValue("o_Cuil") && $this->Cuil->CurrentValue <> $this->Cuil->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_MasHijos") && $objForm->HasValue("o_MasHijos") && $this->MasHijos->CurrentValue <> $this->MasHijos->OldValue)
			return FALSE;
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->MasHijos); // MasHijos
	...
	function RenderListOptions() {
		...
		if ($Security->IsLoggedIn()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewCopy\" title=\"" . $copycaption . "\" data-table=\"tutores\" data-caption=\"" . $copycaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->CopyUrl) . "',caption:'" . $copycaption . "'});\">" . $Language->Phrase("CopyLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
		...
		if ($Security->IsLoggedIn()) {
			...
			$links = "";
			if ($GLOBALS["observacion_tutor_grid"]->DetailView && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["observacion_tutor_grid"]->DetailEdit && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["observacion_tutor_grid"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
	...
	function SetupOtherOptions() {
		...
		if (ew_IsMobile())
			...
			$item->Body = "<a class=\"ewAddEdit ewAdd\" title=\"" . $addcaption . "\" data-table=\"tutores\" data-caption=\"" . $addcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->AddUrl) . "',caption:'" . $addcaption . "'});\">" . $Language->Phrase("AddLink") . "</a>";
		...
		$item->Visible = ($GLOBALS["observacion_tutor"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn());
		if ($item->Visible) {
	...
	function LoadDefaultValues() {
		...
		$this->MasHijos->OldValue = $this->MasHijos->CurrentValue;
	...
	function LoadFormValues() {
		...
		$this->MasHijos->setOldValue($objForm->GetValue("o_MasHijos"));
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.ftutoreslist,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.ftutoreslist,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.ftutoreslist,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = TRUE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.ftutoreslist,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = FALSE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.ftutoreslist,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = TRUE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.ftutoreslist,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = TRUE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.ftutoreslist,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;

		// Export to Email
		$item = &$this->ExportOptions->Add("email");
		$url = "";
		$item->Body = "<button id=\"emf_tutores\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tutores',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.ftutoreslist,sel:true" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
ftutoreslist.Lists["x_MasHijos"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftutoreslist.Lists["x_MasHijos"].Options = <?php echo json_encode($tutores->MasHijos->Options()) ?>;
...
ftutoreslist.Lists["x_Id_Departamento"] = {"LinkField":"x_Id_Departamento","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":["x_Id_Localidad"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
...
<?php if ($tutores_list->TotalRecs > 0) { ?>
...
<?php if ($tutores->Domicilio->Visible) { // Domicilio ?>
	...
	<?php } else { ?>
		<th data-name="Domicilio"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tutores->SortUrl($tutores->Domicilio) ?>',1);"><div id="elh_tutores_Domicilio" class="tutores_Domicilio">
...
<?php if ($tutores->MasHijos->Visible) { // MasHijos ?>
	...
	<?php } else { ?>
		<th data-name="MasHijos"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tutores->SortUrl($tutores->MasHijos) ?>',1);"><div id="elh_tutores_MasHijos" class="tutores_MasHijos">
...
<?php if ($tutores->Id_Departamento->Visible) { // Id_Departamento ?>
	...
	<?php } else { ?>
		<th data-name="Id_Departamento"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tutores->SortUrl($tutores->Id_Departamento) ?>',1);"><div id="elh_tutores_Id_Departamento" class="tutores_Id_Departamento">
...
<?php if ($tutores->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $tutores_list->RowCnt ?>_tutores_Domicilio" class="form-group tutores_Domicilio">
<input type="text" data-table="tutores" data-field="x_Domicilio" name="x<?php echo $tutores_list->RowIndex ?>_Domicilio" id="x<?php echo $tutores_list->RowIndex ?>_Domicilio" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($tutores->Domicilio->getPlaceHolder()) ?>" value="<?php echo $tutores->Domicilio->EditValue ?>"<?php echo $tutores->Domicilio->EditAttributes() ?>>
</span>
<input type="hidden" data-table="tutores" data-field="x_Domicilio" name="o<?php echo $tutores_list->RowIndex ?>_Domicilio" id="o<?php echo $tutores_list->RowIndex ?>_Domicilio" value="<?php echo ew_HtmlEncode($tutores->Domicilio->OldValue) ?>">
<?php } ?>
<?php if ($tutores->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $tutores_list->RowCnt ?>_tutores_Domicilio" class="form-group tutores_Domicilio">
<input type="text" data-table="tutores" data-field="x_Domicilio" name="x<?php echo $tutores_list->RowIndex ?>_Domicilio" id="x<?php echo $tutores_list->RowIndex ?>_Domicilio" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($tutores->Domicilio->getPlaceHolder()) ?>" value="<?php echo $tutores->Domicilio->EditValue ?>"<?php echo $tutores->Domicilio->EditAttributes() ?>>
...
<?php } ?>
<?php if ($tutores->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $tutores_list->RowCnt ?>_tutores_Domicilio" class="tutores_Domicilio">
...
<?php if ($tutores->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $tutores_list->RowCnt ?>_tutores_MasHijos" class="form-group tutores_MasHijos">
<div id="tp_x<?php echo $tutores_list->RowIndex ?>_MasHijos" class="ewTemplate"><input type="radio" data-table="tutores" data-field="x_MasHijos" data-value-separator="<?php echo $tutores->MasHijos->DisplayValueSeparatorAttribute() ?>" name="x<?php echo $tutores_list->RowIndex ?>_MasHijos" id="x<?php echo $tutores_list->RowIndex ?>_MasHijos" value="{value}"<?php echo $tutores->MasHijos->EditAttributes() ?>></div>
<div id="dsl_x<?php echo $tutores_list->RowIndex ?>_MasHijos" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $tutores->MasHijos->RadioButtonListHtml(FALSE, "x{$tutores_list->RowIndex}_MasHijos") ?>
</div></div>
</span>
<input type="hidden" data-table="tutores" data-field="x_MasHijos" name="o<?php echo $tutores_list->RowIndex ?>_MasHijos" id="o<?php echo $tutores_list->RowIndex ?>_MasHijos" value="<?php echo ew_HtmlEncode($tutores->MasHijos->OldValue) ?>">
<?php } ?>
<?php if ($tutores->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $tutores_list->RowCnt ?>_tutores_MasHijos" class="form-group tutores_MasHijos">
<div id="tp_x<?php echo $tutores_list->RowIndex ?>_MasHijos" class="ewTemplate"><input type="radio" data-table="tutores" data-field="x_MasHijos" data-value-separator="<?php echo $tutores->MasHijos->DisplayValueSeparatorAttribute() ?>" name="x<?php echo $tutores_list->RowIndex ?>_MasHijos" id="x<?php echo $tutores_list->RowIndex ?>_MasHijos" value="{value}"<?php echo $tutores->MasHijos->EditAttributes() ?>></div>
...
<?php } ?>
<?php if ($tutores->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $tutores_list->RowCnt ?>_tutores_MasHijos" class="tutores_MasHijos">
...
<?php if ($tutores->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $tutores_list->RowCnt ?>_tutores_Id_Departamento" class="form-group tutores_Id_Departamento">
<select data-table="tutores" data-field="x_Id_Departamento" data-value-separator="<?php echo $tutores->Id_Departamento->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $tutores_list->RowIndex ?>_Id_Departamento" name="x<?php echo $tutores_list->RowIndex ?>_Id_Departamento"<?php echo $tutores->Id_Departamento->EditAttributes() ?>>
<?php echo $tutores->Id_Departamento->SelectOptionListHtml("x<?php echo $tutores_list->RowIndex ?>_Id_Departamento") ?>
</select>
<input type="hidden" name="s_x<?php echo $tutores_list->RowIndex ?>_Id_Departamento" id="s_x<?php echo $tutores_list->RowIndex ?>_Id_Departamento" value="<?php echo $tutores->Id_Departamento->LookupFilterQuery() ?>">
</span>
<input type="hidden" data-table="tutores" data-field="x_Id_Departamento" name="o<?php echo $tutores_list->RowIndex ?>_Id_Departamento" id="o<?php echo $tutores_list->RowIndex ?>_Id_Departamento" value="<?php echo ew_HtmlEncode($tutores->Id_Departamento->OldValue) ?>">
<?php } ?>
<?php if ($tutores->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $tutores_list->RowCnt ?>_tutores_Id_Departamento" class="form-group tutores_Id_Departamento">
<select data-table="tutores" data-field="x_Id_Departamento" data-value-separator="<?php echo $tutores->Id_Departamento->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $tutores_list->RowIndex ?>_Id_Departamento" name="x<?php echo $tutores_list->RowIndex ?>_Id_Departamento"<?php echo $tutores->Id_Departamento->EditAttributes() ?>>
...
<?php } ?>
<?php if ($tutores->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $tutores_list->RowCnt ?>_tutores_Id_Departamento" class="tutores_Id_Departamento">
