...
<?php if ($referente_tecnico->Apelldio_Nombre->Visible) { // Apelldio_Nombre ?>
		<th><span id="elh_referente_tecnico_Apelldio_Nombre" class="referente_tecnico_Apelldio_Nombre"><?php echo $referente_tecnico->Apelldio_Nombre->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($referente_tecnico->Apelldio_Nombre->Visible) { // Apelldio_Nombre ?>
		<td<?php echo $referente_tecnico->Apelldio_Nombre->CellAttributes() ?>>
<span id="el<?php echo $referente_tecnico_delete->RowCnt ?>_referente_tecnico_Apelldio_Nombre" class="referente_tecnico_Apelldio_Nombre">
