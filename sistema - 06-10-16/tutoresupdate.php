...
class ctutores_update extends ctutores {
	...
	function RenderRow() {
		...
		$this->User_Actualiz->ViewCustomAttributes = "";
			...
			$this->Id_Ocupacion->EditValue = ew_HtmlEncode($this->Id_Ocupacion->CurrentValue);
			if (strval($this->Id_Ocupacion->CurrentValue) <> "") {
				$sFilterWrk = "`Id_Ocupacion`" . ew_SearchString("=", $this->Id_Ocupacion->CurrentValue, EW_DATATYPE_NUMBER, "");
			$sSqlWrk = "SELECT `Id_Ocupacion`, `Descripcion` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld` FROM `ocupacion_tutor`";
			$sWhereWrk = "";
...
<?php if ($tutores->CurrentAction == "F") { // Confirm page ?>
...
<div id="tbl_tutoresupdate">
	<div class="checkbox">
		<label><input type="checkbox" name="u" id="u" onclick="ew_SelectAll(this);"<?php echo $tutores_update->Disabled ?>> <?php echo $Language->Phrase("UpdateSelectAll") ?></label>
	</div>
...
<?php } else { ?>
<input type="checkbox" disabled<?php echo ($tutores->Id_Estado_Civil->MultiUpdate == "1") ? " checked" : "" ?>>
<input type="hidden" name="u_Id_Estado_Civil" id="u_Id_Estado_Civil" value="<?php echo $tutores->Id_Estado_Civil->MultiUpdate ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $tutores->Id_Estado_Civil->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="tutores" data-field="x_Id_Estado_Civil" name="x_Id_Estado_Civil" id="x_Id_Estado_Civil" value="<?php echo ew_HtmlEncode($tutores->Id_Estado_Civil->FormValue) ?>">
<?php } ?>
...
<?php } else { ?>
<input type="checkbox" disabled<?php echo ($tutores->Id_Sexo->MultiUpdate == "1") ? " checked" : "" ?>>
<input type="hidden" name="u_Id_Sexo" id="u_Id_Sexo" value="<?php echo $tutores->Id_Sexo->MultiUpdate ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $tutores->Id_Sexo->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="tutores" data-field="x_Id_Sexo" name="x_Id_Sexo" id="x_Id_Sexo" value="<?php echo ew_HtmlEncode($tutores->Id_Sexo->FormValue) ?>">
<?php } ?>
...
<?php } else { ?>
<input type="checkbox" disabled<?php echo ($tutores->Id_Relacion->MultiUpdate == "1") ? " checked" : "" ?>>
<input type="hidden" name="u_Id_Relacion" id="u_Id_Relacion" value="<?php echo $tutores->Id_Relacion->MultiUpdate ?>">
<?php } ?>
...
<input type="hidden" data-table="tutores" data-field="x_Id_Relacion" name="x_Id_Relacion" id="x_Id_Relacion" value="<?php echo ew_HtmlEncode($tutores->Id_Relacion->FormValue) ?>">
<?php } ?>
...
<?php } else { ?>
<input type="checkbox" disabled<?php echo ($tutores->Id_Ocupacion->MultiUpdate == "1") ? " checked" : "" ?>>
<input type="hidden" name="u_Id_Ocupacion" id="u_Id_Ocupacion" value="<?php echo $tutores->Id_Ocupacion->MultiUpdate ?>">
<?php } ?>
...
<input type="hidden" data-table="tutores" data-field="x_Id_Ocupacion" data-value-separator="<?php echo $tutores->Id_Ocupacion->DisplayValueSeparatorAttribute() ?>" name="x_Id_Ocupacion" id="x_Id_Ocupacion" value="<?php echo ew_HtmlEncode($tutores->Id_Ocupacion->CurrentValue) ?>"<?php echo $wrkonchange ?>>
<input type="hidden" name="q_x_Id_Ocupacion" id="q_x_Id_Ocupacion" value="<?php echo $tutores->Id_Ocupacion->LookupFilterQuery(true) ?>">
<script type="text/javascript">
ftutoresupdate.CreateAutoSuggest({"id":"x_Id_Ocupacion","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_tutores_Id_Ocupacion">
<span<?php echo $tutores->Id_Ocupacion->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $tutores->Id_Ocupacion->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="tutores" data-field="x_Id_Ocupacion" name="x_Id_Ocupacion" id="x_Id_Ocupacion" value="<?php echo ew_HtmlEncode($tutores->Id_Ocupacion->FormValue) ?>">
<?php } ?>
...
<?php } else { ?>
<input type="checkbox" disabled<?php echo ($tutores->Id_Provincia->MultiUpdate == "1") ? " checked" : "" ?>>
<input type="hidden" name="u_Id_Provincia" id="u_Id_Provincia" value="<?php echo $tutores->Id_Provincia->MultiUpdate ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $tutores->Id_Provincia->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="tutores" data-field="x_Id_Provincia" name="x_Id_Provincia" id="x_Id_Provincia" value="<?php echo ew_HtmlEncode($tutores->Id_Provincia->FormValue) ?>">
<?php } ?>
...
<?php } else { ?>
<input type="checkbox" disabled<?php echo ($tutores->Id_Departamento->MultiUpdate == "1") ? " checked" : "" ?>>
<input type="hidden" name="u_Id_Departamento" id="u_Id_Departamento" value="<?php echo $tutores->Id_Departamento->MultiUpdate ?>">
<?php } ?>
...
<input type="hidden" data-table="tutores" data-field="x_Id_Departamento" name="x_Id_Departamento" id="x_Id_Departamento" value="<?php echo ew_HtmlEncode($tutores->Id_Departamento->FormValue) ?>">
<?php } ?>
...
<?php } else { ?>
<input type="checkbox" disabled<?php echo ($tutores->Id_Localidad->MultiUpdate == "1") ? " checked" : "" ?>>
<input type="hidden" name="u_Id_Localidad" id="u_Id_Localidad" value="<?php echo $tutores->Id_Localidad->MultiUpdate ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $tutores->Id_Localidad->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="tutores" data-field="x_Id_Localidad" name="x_Id_Localidad" id="x_Id_Localidad" value="<?php echo ew_HtmlEncode($tutores->Id_Localidad->FormValue) ?>">
<?php } ?>
