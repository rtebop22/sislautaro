...
class ctutores_view extends ctutores {
	...
	function SetupOtherOptions() {
		...
		$links = "";
		if ($GLOBALS["observacion_tutor_grid"] && $GLOBALS["observacion_tutor_grid"]->DetailView && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
		...
		if ($GLOBALS["observacion_tutor_grid"] && $GLOBALS["observacion_tutor_grid"]->DetailEdit && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
		...
		if ($GLOBALS["observacion_tutor_grid"] && $GLOBALS["observacion_tutor_grid"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
...
<?php if ($tutores->User_Actualiz->Visible) { // User_Actualiz ?>
	<tr id="r_User_Actualiz">
		<td><span id="elh_tutores_User_Actualiz"><?php echo $tutores->User_Actualiz->FldCaption() ?></span></td>
		<td data-name="User_Actualiz"<?php echo $tutores->User_Actualiz->CellAttributes() ?>>
<span id="el_tutores_User_Actualiz">
<span<?php echo $tutores->User_Actualiz->ViewAttributes() ?>>
<?php echo $tutores->User_Actualiz->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
