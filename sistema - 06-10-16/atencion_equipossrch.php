...
<?php if ($atencion_equipos->NroSerie->Visible) { // NroSerie ?>
	<div id="r_NroSerie" class="form-group">
		<label for="x_NroSerie" class="<?php echo $atencion_equipos_search->SearchLabelClass ?>"><span id="elh_atencion_equipos_NroSerie"><?php echo $atencion_equipos->NroSerie->FldCaption() ?></span>	
