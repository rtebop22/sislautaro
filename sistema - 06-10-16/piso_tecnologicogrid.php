...
fpiso_tecnologicogrid.Lists["x_Estado_Ap"] = {"LinkField":"x_Id_Estado_Equipo_piso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipos_piso"};
...
<?php if ($piso_tecnologico->Estado_Ap->Visible) { // Estado_Ap ?>
	...
	<?php } else { ?>
		<th data-name="Estado_Ap"><div><div id="elh_piso_tecnologico_Estado_Ap" class="piso_tecnologico_Estado_Ap">
...
<?php if ($piso_tecnologico->Porcent_Estado_Ap->Visible) { // Porcent_Estado_Ap ?>
	...
	<?php } else { ?>
		<th data-name="Porcent_Estado_Ap"><div><div id="elh_piso_tecnologico_Porcent_Estado_Ap" class="piso_tecnologico_Porcent_Estado_Ap">
...
<?php if ($piso_tecnologico->Ultima_Actualizacion->Visible) { // Ultima_Actualizacion ?>
	...
	<?php } else { ?>
		<th data-name="Ultima_Actualizacion"><div><div id="elh_piso_tecnologico_Ultima_Actualizacion" class="piso_tecnologico_Ultima_Actualizacion">
...
<a id="<?php echo $piso_tecnologico_grid->PageObjName . "_row_" . $piso_tecnologico_grid->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($piso_tecnologico->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="piso_tecnologico" data-field="x_Id_Piso" name="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Id_Piso" id="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Id_Piso" value="<?php echo ew_HtmlEncode($piso_tecnologico->Id_Piso->CurrentValue) ?>">
<input type="hidden" data-table="piso_tecnologico" data-field="x_Id_Piso" name="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Id_Piso" id="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Id_Piso" value="<?php echo ew_HtmlEncode($piso_tecnologico->Id_Piso->OldValue) ?>">
<?php } ?>
...
<?php if ($piso_tecnologico->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $piso_tecnologico_grid->RowCnt ?>_piso_tecnologico_Estado_Ap" class="form-group piso_tecnologico_Estado_Ap">
<select data-table="piso_tecnologico" data-field="x_Estado_Ap" data-value-separator="<?php echo $piso_tecnologico->Estado_Ap->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" name="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap"<?php echo $piso_tecnologico->Estado_Ap->EditAttributes() ?>>
<?php echo $piso_tecnologico->Estado_Ap->SelectOptionListHtml("x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap") ?>
</select>
<input type="hidden" name="s_x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" id="s_x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" value="<?php echo $piso_tecnologico->Estado_Ap->LookupFilterQuery() ?>">
</span>
<input type="hidden" data-table="piso_tecnologico" data-field="x_Estado_Ap" name="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" id="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" value="<?php echo ew_HtmlEncode($piso_tecnologico->Estado_Ap->OldValue) ?>">
<?php } ?>
<?php if ($piso_tecnologico->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $piso_tecnologico_grid->RowCnt ?>_piso_tecnologico_Estado_Ap" class="form-group piso_tecnologico_Estado_Ap">
<select data-table="piso_tecnologico" data-field="x_Estado_Ap" data-value-separator="<?php echo $piso_tecnologico->Estado_Ap->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" name="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap"<?php echo $piso_tecnologico->Estado_Ap->EditAttributes() ?>>
...
<?php } ?>
<?php if ($piso_tecnologico->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $piso_tecnologico_grid->RowCnt ?>_piso_tecnologico_Estado_Ap" class="piso_tecnologico_Estado_Ap">
<span<?php echo $piso_tecnologico->Estado_Ap->ViewAttributes() ?>>
<?php echo $piso_tecnologico->Estado_Ap->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="piso_tecnologico" data-field="x_Estado_Ap" name="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" id="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" value="<?php echo ew_HtmlEncode($piso_tecnologico->Estado_Ap->FormValue) ?>">
<input type="hidden" data-table="piso_tecnologico" data-field="x_Estado_Ap" name="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" id="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" value="<?php echo ew_HtmlEncode($piso_tecnologico->Estado_Ap->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($piso_tecnologico->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $piso_tecnologico_grid->RowCnt ?>_piso_tecnologico_Porcent_Estado_Ap" class="form-group piso_tecnologico_Porcent_Estado_Ap">
<input type="text" data-table="piso_tecnologico" data-field="x_Porcent_Estado_Ap" name="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" id="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" size="30" maxlength="3" placeholder="<?php echo ew_HtmlEncode($piso_tecnologico->Porcent_Estado_Ap->getPlaceHolder()) ?>" value="<?php echo $piso_tecnologico->Porcent_Estado_Ap->EditValue ?>"<?php echo $piso_tecnologico->Porcent_Estado_Ap->EditAttributes() ?>>
</span>
<input type="hidden" data-table="piso_tecnologico" data-field="x_Porcent_Estado_Ap" name="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" id="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" value="<?php echo ew_HtmlEncode($piso_tecnologico->Porcent_Estado_Ap->OldValue) ?>">
<?php } ?>
<?php if ($piso_tecnologico->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $piso_tecnologico_grid->RowCnt ?>_piso_tecnologico_Porcent_Estado_Ap" class="form-group piso_tecnologico_Porcent_Estado_Ap">
<input type="text" data-table="piso_tecnologico" data-field="x_Porcent_Estado_Ap" name="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" id="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" size="30" maxlength="3" placeholder="<?php echo ew_HtmlEncode($piso_tecnologico->Porcent_Estado_Ap->getPlaceHolder()) ?>" value="<?php echo $piso_tecnologico->Porcent_Estado_Ap->EditValue ?>"<?php echo $piso_tecnologico->Porcent_Estado_Ap->EditAttributes() ?>>
...
<?php } ?>
<?php if ($piso_tecnologico->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $piso_tecnologico_grid->RowCnt ?>_piso_tecnologico_Porcent_Estado_Ap" class="piso_tecnologico_Porcent_Estado_Ap">
...
<input type="hidden" data-table="piso_tecnologico" data-field="x_Porcent_Estado_Ap" name="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" id="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" value="<?php echo ew_HtmlEncode($piso_tecnologico->Porcent_Estado_Ap->FormValue) ?>">
<input type="hidden" data-table="piso_tecnologico" data-field="x_Porcent_Estado_Ap" name="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" id="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" value="<?php echo ew_HtmlEncode($piso_tecnologico->Porcent_Estado_Ap->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" name="fs_x<?php echo $piso_tecnologico_grid->RowIndex ?>_Plano_Escuela" id= "fs_x<?php echo $piso_tecnologico_grid->RowIndex ?>_Plano_Escuela" value="200">
...
<?php if ($piso_tecnologico->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="piso_tecnologico" data-field="x_Ultima_Actualizacion" name="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Ultima_Actualizacion" id="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Ultima_Actualizacion" value="<?php echo ew_HtmlEncode($piso_tecnologico->Ultima_Actualizacion->OldValue) ?>">
<?php } ?>
<?php if ($piso_tecnologico->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<?php } ?>
<?php if ($piso_tecnologico->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $piso_tecnologico_grid->RowCnt ?>_piso_tecnologico_Ultima_Actualizacion" class="piso_tecnologico_Ultima_Actualizacion">
...
<input type="hidden" data-table="piso_tecnologico" data-field="x_Ultima_Actualizacion" name="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Ultima_Actualizacion" id="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Ultima_Actualizacion" value="<?php echo ew_HtmlEncode($piso_tecnologico->Ultima_Actualizacion->FormValue) ?>">
<input type="hidden" data-table="piso_tecnologico" data-field="x_Ultima_Actualizacion" name="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Ultima_Actualizacion" id="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Ultima_Actualizacion" value="<?php echo ew_HtmlEncode($piso_tecnologico->Ultima_Actualizacion->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<span id="el$rowindex$_piso_tecnologico_Estado_Ap" class="form-group piso_tecnologico_Estado_Ap">
<span<?php echo $piso_tecnologico->Estado_Ap->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $piso_tecnologico->Estado_Ap->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="piso_tecnologico" data-field="x_Estado_Ap" name="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" id="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" value="<?php echo ew_HtmlEncode($piso_tecnologico->Estado_Ap->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="piso_tecnologico" data-field="x_Estado_Ap" name="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" id="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Estado_Ap" value="<?php echo ew_HtmlEncode($piso_tecnologico->Estado_Ap->OldValue) ?>">
...
<span id="el$rowindex$_piso_tecnologico_Porcent_Estado_Ap" class="form-group piso_tecnologico_Porcent_Estado_Ap">
<span<?php echo $piso_tecnologico->Porcent_Estado_Ap->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $piso_tecnologico->Porcent_Estado_Ap->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="piso_tecnologico" data-field="x_Porcent_Estado_Ap" name="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" id="x<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" value="<?php echo ew_HtmlEncode($piso_tecnologico->Porcent_Estado_Ap->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="piso_tecnologico" data-field="x_Porcent_Estado_Ap" name="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" id="o<?php echo $piso_tecnologico_grid->RowIndex ?>_Porcent_Estado_Ap" value="<?php echo ew_HtmlEncode($piso_tecnologico->Porcent_Estado_Ap->OldValue) ?>">
