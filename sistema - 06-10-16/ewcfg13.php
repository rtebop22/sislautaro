...
define("EW_RANDOM_KEY", 'OsJ7eygIhi9B86uB', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "lautaro34657338", "db" => "sistemadecontrol", "qs" => "`", "qe" => "`");
...
// Security
define("EW_ADMIN_USER_NAME", "lautaro", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "lauta1989", TRUE); // Administrator password
