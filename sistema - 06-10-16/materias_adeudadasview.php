...
<?php if ($materias_adeudadas->Dni->Visible) { // Dni ?>
	<tr id="r_Dni">
		<td><span id="elh_materias_adeudadas_Dni"><?php echo $materias_adeudadas->Dni->FldCaption() ?></span></td>
...
<?php echo $materias_adeudadas->Dni->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($materias_adeudadas->User_Actualiz->Visible) { // User_Actualiz ?>
	<tr id="r_User_Actualiz">
		<td><span id="elh_materias_adeudadas_User_Actualiz"><?php echo $materias_adeudadas->User_Actualiz->FldCaption() ?></span></td>
		<td data-name="User_Actualiz"<?php echo $materias_adeudadas->User_Actualiz->CellAttributes() ?>>
<span id="el_materias_adeudadas_User_Actualiz">
<span<?php echo $materias_adeudadas->User_Actualiz->ViewAttributes() ?>>
<?php echo $materias_adeudadas->User_Actualiz->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
