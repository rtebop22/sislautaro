...
<input type="hidden" data-table="servidor_escolar" data-field="x_Nro_Serie" name="x<?php echo $servidor_escolar_grid->RowIndex ?>_Nro_Serie" id="x<?php echo $servidor_escolar_grid->RowIndex ?>_Nro_Serie" value="<?php echo ew_HtmlEncode($servidor_escolar->Nro_Serie->CurrentValue) ?>">
<?php } ?>
