...
<select data-table="estado_actual_legajo_persona" data-field="x_Matricula" data-value-separator="<?php echo $estado_actual_legajo_persona->Matricula->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Matricula" name="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Matricula"<?php echo $estado_actual_legajo_persona->Matricula->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Matricula->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Matricula") ?>
</select>
</span>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Certificado_Pase" data-value-separator="<?php echo $estado_actual_legajo_persona->Certificado_Pase->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Certificado_Pase" name="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Certificado_Pase"<?php echo $estado_actual_legajo_persona->Certificado_Pase->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Certificado_Pase->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Certificado_Pase") ?>
</select>
</span>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Tiene_DNI" data-value-separator="<?php echo $estado_actual_legajo_persona->Tiene_DNI->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Tiene_DNI" name="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Tiene_DNI"<?php echo $estado_actual_legajo_persona->Tiene_DNI->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Tiene_DNI->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Tiene_DNI") ?>
</select>
</span>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Certificado_Medico" data-value-separator="<?php echo $estado_actual_legajo_persona->Certificado_Medico->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Certificado_Medico" name="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Certificado_Medico"<?php echo $estado_actual_legajo_persona->Certificado_Medico->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Certificado_Medico->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Certificado_Medico") ?>
</select>
</span>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Posee_Autorizacion" data-value-separator="<?php echo $estado_actual_legajo_persona->Posee_Autorizacion->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Posee_Autorizacion" name="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Posee_Autorizacion"<?php echo $estado_actual_legajo_persona->Posee_Autorizacion->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Posee_Autorizacion->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Posee_Autorizacion") ?>
</select>
</span>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Cooperadora" data-value-separator="<?php echo $estado_actual_legajo_persona->Cooperadora->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Cooperadora" name="x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Cooperadora"<?php echo $estado_actual_legajo_persona->Cooperadora->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Cooperadora->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_grid->RowIndex ?>_Cooperadora") ?>
</select>
</span>
