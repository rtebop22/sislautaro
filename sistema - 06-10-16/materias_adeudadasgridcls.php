...
$materias_adeudadas_grid = NULL; // Initialize page object first

class cmaterias_adeudadas_grid extends cmaterias_adeudadas {
	...
	// Page object name
	var $PageObjName = 'materias_adeudadas_grid';

	// Grid form hidden field names
	var $FormName = 'fmaterias_adeudadasgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["materias_adeudadas"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->Id_Mat_Adeuda->CurrentValue = strval($arKeys[0]); // Id_Mat_Adeuda
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
