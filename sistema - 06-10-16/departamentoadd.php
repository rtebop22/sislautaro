		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "departamentoview.php")
...
var CurrentForm = fdepartamentoadd = new ew_Form("fdepartamentoadd", "add");
...
fdepartamentoadd.Lists["x_Id_Provincia"] = {"LinkField":"x_Id_Provincia","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincias"};
...
<?php if (!$departamento_add->IsModal) { ?>
<div class="ewToolbar">
...
?>
<form name="fdepartamentoadd" id="fdepartamentoadd" class="<?php echo $departamento_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($departamento->Id_Provincia->Visible) { // Id_Provincia ?>
	<div id="r_Id_Provincia" class="form-group">
		<label id="elh_departamento_Id_Provincia" for="x_Id_Provincia" class="col-sm-2 control-label ewLabel"><?php echo $departamento->Id_Provincia->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $departamento_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
