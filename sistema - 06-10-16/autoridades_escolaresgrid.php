...
<?php if ($autoridades_escolares->Celular->Visible) { // Celular ?>
	...
	<?php } else { ?>
		<th data-name="Celular"><div><div id="elh_autoridades_escolares_Celular" class="autoridades_escolares_Celular">
...
<?php if ($autoridades_escolares->Maill->Visible) { // Maill ?>
	...
	<?php } else { ?>
		<th data-name="Maill"><div><div id="elh_autoridades_escolares_Maill" class="autoridades_escolares_Maill">
...
<?php if ($autoridades_escolares->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $autoridades_escolares_grid->RowCnt ?>_autoridades_escolares_Celular" class="form-group autoridades_escolares_Celular">
<input type="text" data-table="autoridades_escolares" data-field="x_Celular" name="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" id="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" size="30" placeholder="<?php echo ew_HtmlEncode($autoridades_escolares->Celular->getPlaceHolder()) ?>" value="<?php echo $autoridades_escolares->Celular->EditValue ?>"<?php echo $autoridades_escolares->Celular->EditAttributes() ?>>
</span>
<input type="hidden" data-table="autoridades_escolares" data-field="x_Celular" name="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" id="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" value="<?php echo ew_HtmlEncode($autoridades_escolares->Celular->OldValue) ?>">
<?php } ?>
<?php if ($autoridades_escolares->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $autoridades_escolares_grid->RowCnt ?>_autoridades_escolares_Celular" class="form-group autoridades_escolares_Celular">
<input type="text" data-table="autoridades_escolares" data-field="x_Celular" name="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" id="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" size="30" placeholder="<?php echo ew_HtmlEncode($autoridades_escolares->Celular->getPlaceHolder()) ?>" value="<?php echo $autoridades_escolares->Celular->EditValue ?>"<?php echo $autoridades_escolares->Celular->EditAttributes() ?>>
...
<?php } ?>
<?php if ($autoridades_escolares->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $autoridades_escolares_grid->RowCnt ?>_autoridades_escolares_Celular" class="autoridades_escolares_Celular">
<span<?php echo $autoridades_escolares->Celular->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Celular->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="autoridades_escolares" data-field="x_Celular" name="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" id="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" value="<?php echo ew_HtmlEncode($autoridades_escolares->Celular->FormValue) ?>">
<input type="hidden" data-table="autoridades_escolares" data-field="x_Celular" name="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" id="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" value="<?php echo ew_HtmlEncode($autoridades_escolares->Celular->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($autoridades_escolares->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $autoridades_escolares_grid->RowCnt ?>_autoridades_escolares_Maill" class="form-group autoridades_escolares_Maill">
<input type="text" data-table="autoridades_escolares" data-field="x_Maill" name="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" id="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($autoridades_escolares->Maill->getPlaceHolder()) ?>" value="<?php echo $autoridades_escolares->Maill->EditValue ?>"<?php echo $autoridades_escolares->Maill->EditAttributes() ?>>
</span>
<input type="hidden" data-table="autoridades_escolares" data-field="x_Maill" name="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" id="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" value="<?php echo ew_HtmlEncode($autoridades_escolares->Maill->OldValue) ?>">
<?php } ?>
<?php if ($autoridades_escolares->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $autoridades_escolares_grid->RowCnt ?>_autoridades_escolares_Maill" class="form-group autoridades_escolares_Maill">
<input type="text" data-table="autoridades_escolares" data-field="x_Maill" name="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" id="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($autoridades_escolares->Maill->getPlaceHolder()) ?>" value="<?php echo $autoridades_escolares->Maill->EditValue ?>"<?php echo $autoridades_escolares->Maill->EditAttributes() ?>>
...
<?php } ?>
<?php if ($autoridades_escolares->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $autoridades_escolares_grid->RowCnt ?>_autoridades_escolares_Maill" class="autoridades_escolares_Maill">
<span<?php echo $autoridades_escolares->Maill->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Maill->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="autoridades_escolares" data-field="x_Maill" name="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" id="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" value="<?php echo ew_HtmlEncode($autoridades_escolares->Maill->FormValue) ?>">
<input type="hidden" data-table="autoridades_escolares" data-field="x_Maill" name="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" id="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" value="<?php echo ew_HtmlEncode($autoridades_escolares->Maill->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<span id="el$rowindex$_autoridades_escolares_Celular" class="form-group autoridades_escolares_Celular">
<span<?php echo $autoridades_escolares->Celular->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $autoridades_escolares->Celular->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="autoridades_escolares" data-field="x_Celular" name="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" id="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" value="<?php echo ew_HtmlEncode($autoridades_escolares->Celular->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="autoridades_escolares" data-field="x_Celular" name="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" id="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Celular" value="<?php echo ew_HtmlEncode($autoridades_escolares->Celular->OldValue) ?>">
...
<span id="el$rowindex$_autoridades_escolares_Maill" class="form-group autoridades_escolares_Maill">
<span<?php echo $autoridades_escolares->Maill->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $autoridades_escolares->Maill->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="autoridades_escolares" data-field="x_Maill" name="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" id="x<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" value="<?php echo ew_HtmlEncode($autoridades_escolares->Maill->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="autoridades_escolares" data-field="x_Maill" name="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" id="o<?php echo $autoridades_escolares_grid->RowIndex ?>_Maill" value="<?php echo ew_HtmlEncode($autoridades_escolares->Maill->OldValue) ?>">
