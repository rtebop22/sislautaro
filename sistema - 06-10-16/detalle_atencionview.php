...
$detalle_atencion_view = NULL; // Initialize page object first

class cdetalle_atencion_view extends cdetalle_atencion {
	...
	// Page object name
	var $PageObjName = 'detalle_atencion_view';
	...
	function __construct() {
		...
		if (@$_GET["Id_Detalle_Atencion"] <> "") {
			$this->RecKey["Id_Detalle_Atencion"] = $_GET["Id_Detalle_Atencion"];
			$KeyUrl .= "&amp;Id_Detalle_Atencion=" . urlencode($this->RecKey["Id_Detalle_Atencion"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["Id_Detalle_Atencion"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= ew_StripSlashes($_GET["Id_Detalle_Atencion"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Id_Atencion"] <> "") {
				...
				$sReturnUrl = "detalle_atencionlist.php"; // Return to list
			}
			if (@$_GET["Id_Detalle_Atencion"] <> "") {
				$this->Id_Detalle_Atencion->setQueryStringValue($_GET["Id_Detalle_Atencion"]);
				$this->RecKey["Id_Detalle_Atencion"] = $this->Id_Detalle_Atencion->QueryStringValue;
			} elseif (@$_POST["Id_Detalle_Atencion"] <> "") {
				$this->Id_Detalle_Atencion->setFormValue($_POST["Id_Detalle_Atencion"]);
				$this->RecKey["Id_Detalle_Atencion"] = $this->Id_Detalle_Atencion->FormValue;
			} else {
				$sReturnUrl = "detalle_atencionlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "detalle_atencionlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "detalle_atencionlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($detalle_atencion_view)) $detalle_atencion_view = new cdetalle_atencion_view();

// Page init
$detalle_atencion_view->Page_Init();

// Page main
$detalle_atencion_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$detalle_atencion_view->Page_Render();
?>
...
var CurrentForm = fdetalle_atencionview = new ew_Form("fdetalle_atencionview", "view");

// Form_CustomValidate event
fdetalle_atencionview.Form_CustomValidate = 
...
fdetalle_atencionview.ValidateRequired = true;
<?php } else { ?>
fdetalle_atencionview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdetalle_atencionview.Lists["x_Id_Tipo_Falla"] = {"LinkField":"x_Id_Tipo_Falla","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_falla"};
fdetalle_atencionview.Lists["x_Id_Problema"] = {"LinkField":"x_Id_Problema","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"problema"};
fdetalle_atencionview.Lists["x_Id_Tipo_Sol_Problem"] = {"LinkField":"x_Id_Tipo_Sol_Problem","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_solucion_problema"};
fdetalle_atencionview.Lists["x_Id_Estado_Atenc"] = {"LinkField":"x_Id_Estado_Atenc","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_actual_solucion_problema"};
...
<?php if ($detalle_atencion->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$detalle_atencion_view->IsModal) { ?>
<?php if ($detalle_atencion->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $detalle_atencion_view->ExportOptions->Render("body") ?>
<?php
	foreach ($detalle_atencion_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$detalle_atencion_view->IsModal) { ?>
<?php if ($detalle_atencion->Export == "") { ?>
...
<?php } ?>
<?php $detalle_atencion_view->ShowPageHeader(); ?>
<?php
$detalle_atencion_view->ShowMessage();
?>
<form name="fdetalle_atencionview" id="fdetalle_atencionview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($detalle_atencion_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $detalle_atencion_view->Token ?>">
<?php } ?>
...
<?php if ($detalle_atencion->Id_Detalle_Atencion->Visible) { // Id_Detalle_Atencion ?>
	<tr id="r_Id_Detalle_Atencion">
		<td><span id="elh_detalle_atencion_Id_Detalle_Atencion"><?php echo $detalle_atencion->Id_Detalle_Atencion->FldCaption() ?></span></td>
		<td data-name="Id_Detalle_Atencion"<?php echo $detalle_atencion->Id_Detalle_Atencion->CellAttributes() ?>>
<span id="el_detalle_atencion_Id_Detalle_Atencion">
<span<?php echo $detalle_atencion->Id_Detalle_Atencion->ViewAttributes() ?>>
<?php echo $detalle_atencion->Id_Detalle_Atencion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detalle_atencion->Id_Tipo_Falla->Visible) { // Id_Tipo_Falla ?>
	<tr id="r_Id_Tipo_Falla">
		<td><span id="elh_detalle_atencion_Id_Tipo_Falla"><?php echo $detalle_atencion->Id_Tipo_Falla->FldCaption() ?></span></td>
...
<?php echo $detalle_atencion->Id_Tipo_Falla->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detalle_atencion->Id_Problema->Visible) { // Id_Problema ?>
	<tr id="r_Id_Problema">
		<td><span id="elh_detalle_atencion_Id_Problema"><?php echo $detalle_atencion->Id_Problema->FldCaption() ?></span></td>
...
<?php echo $detalle_atencion->Id_Problema->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detalle_atencion->Descripcion_Problema->Visible) { // Descripcion_Problema ?>
	<tr id="r_Descripcion_Problema">
		<td><span id="elh_detalle_atencion_Descripcion_Problema"><?php echo $detalle_atencion->Descripcion_Problema->FldCaption() ?></span></td>
...
<?php echo $detalle_atencion->Descripcion_Problema->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detalle_atencion->Id_Tipo_Sol_Problem->Visible) { // Id_Tipo_Sol_Problem ?>
	<tr id="r_Id_Tipo_Sol_Problem">
		<td><span id="elh_detalle_atencion_Id_Tipo_Sol_Problem"><?php echo $detalle_atencion->Id_Tipo_Sol_Problem->FldCaption() ?></span></td>
...
<?php echo $detalle_atencion->Id_Tipo_Sol_Problem->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detalle_atencion->Id_Estado_Atenc->Visible) { // Id_Estado_Atenc ?>
	<tr id="r_Id_Estado_Atenc">
		<td><span id="elh_detalle_atencion_Id_Estado_Atenc"><?php echo $detalle_atencion->Id_Estado_Atenc->FldCaption() ?></span></td>
...
<?php echo $detalle_atencion->Id_Estado_Atenc->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detalle_atencion->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<tr id="r_Fecha_Actualizacion">
		<td><span id="elh_detalle_atencion_Fecha_Actualizacion"><?php echo $detalle_atencion->Fecha_Actualizacion->FldCaption() ?></span></td>
...
<?php echo $detalle_atencion->Fecha_Actualizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($detalle_atencion->Export == "") { ?>
<script type="text/javascript">
fdetalle_atencionview.Init();
</script>
<?php } ?>
<?php
$detalle_atencion_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($detalle_atencion->Export == "") { ?>
...
<?php
$detalle_atencion_view->Page_Terminate();
?>
