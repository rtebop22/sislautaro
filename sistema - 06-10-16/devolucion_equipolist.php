...
class cdevolucion_equipo_list extends cdevolucion_equipo {
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_NroSerie") && $objForm->HasValue("o_NroSerie") && $this->NroSerie->CurrentValue <> $this->NroSerie->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Admin_Que_Recibe") && $objForm->HasValue("o_Admin_Que_Recibe") && $this->Admin_Que_Recibe->CurrentValue <> $this->Admin_Que_Recibe->OldValue)
			return FALSE;
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->Admin_Que_Recibe); // Admin_Que_Recibe
	...
	function LoadDefaultValues() {
		...
		$this->Admin_Que_Recibe->OldValue = $this->Admin_Que_Recibe->CurrentValue;
	...
	function LoadFormValues() {
		...
		$this->Admin_Que_Recibe->setOldValue($objForm->GetValue("o_Admin_Que_Recibe"));
	...
	function AddRow($rsold = NULL) {
		...
		// Admin_Que_Recibe
		$this->Admin_Que_Recibe->SetDbValueDef($rsnew, $this->Admin_Que_Recibe->CurrentValue, NULL, FALSE);
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.fdevolucion_equipolist,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.fdevolucion_equipolist,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.fdevolucion_equipolist,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = TRUE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.fdevolucion_equipolist,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = FALSE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.fdevolucion_equipolist,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = TRUE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.fdevolucion_equipolist,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = TRUE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.fdevolucion_equipolist,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;

		// Export to Email
		$item = &$this->ExportOptions->Add("email");
		$url = "";
		$item->Body = "<button id=\"emf_devolucion_equipo\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_devolucion_equipo',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fdevolucion_equipolist,sel:true" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
fdevolucion_equipolist.EmptyRow = function(infix) {
	...
	if (ew_ValueChanged(fobj, infix, "Admin_Que_Recibe", false)) return false;
...
fdevolucion_equipolist.Lists["x_Admin_Que_Recibe"] = {"LinkField":"x_DniRte","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apelldio_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"referente_tecnico"};
fdevolucion_equipolist.Lists["x_Id_Motivo"] = {"LinkField":"x_Id_Motivo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"motivo_devolucion"};
fdevolucion_equipolist.Lists["x_Id_Estado_Devol"] = {"LinkField":"x_Id_Estado_Devol","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipo_devuleto"};
...
<?php if ($devolucion_equipo_list->TotalRecs > 0) { ?>
...
<?php if ($devolucion_equipo->NroSerie->Visible) { // NroSerie ?>
	...
	<?php } else { ?>
		<th data-name="NroSerie"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $devolucion_equipo->SortUrl($devolucion_equipo->NroSerie) ?>',1);"><div id="elh_devolucion_equipo_NroSerie" class="devolucion_equipo_NroSerie">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $devolucion_equipo->NroSerie->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($devolucion_equipo->NroSerie->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($devolucion_equipo->NroSerie->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($devolucion_equipo->Admin_Que_Recibe->Visible) { // Admin_Que_Recibe ?>
	<?php if ($devolucion_equipo->SortUrl($devolucion_equipo->Admin_Que_Recibe) == "") { ?>
		<th data-name="Admin_Que_Recibe"><div id="elh_devolucion_equipo_Admin_Que_Recibe" class="devolucion_equipo_Admin_Que_Recibe"><div class="ewTableHeaderCaption"><?php echo $devolucion_equipo->Admin_Que_Recibe->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Admin_Que_Recibe"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $devolucion_equipo->SortUrl($devolucion_equipo->Admin_Que_Recibe) ?>',1);"><div id="elh_devolucion_equipo_Admin_Que_Recibe" class="devolucion_equipo_Admin_Que_Recibe">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $devolucion_equipo->Admin_Que_Recibe->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($devolucion_equipo->Admin_Que_Recibe->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($devolucion_equipo->Admin_Que_Recibe->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($devolucion_equipo->Id_Motivo->Visible) { // Id_Motivo ?>
	<?php if ($devolucion_equipo->SortUrl($devolucion_equipo->Id_Motivo) == "") { ?>
		<th data-name="Id_Motivo"><div id="elh_devolucion_equipo_Id_Motivo" class="devolucion_equipo_Id_Motivo"><div class="ewTableHeaderCaption"><?php echo $devolucion_equipo->Id_Motivo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Id_Motivo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $devolucion_equipo->SortUrl($devolucion_equipo->Id_Motivo) ?>',1);"><div id="elh_devolucion_equipo_Id_Motivo" class="devolucion_equipo_Id_Motivo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $devolucion_equipo->Id_Motivo->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($devolucion_equipo->Id_Motivo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($devolucion_equipo->Id_Motivo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($devolucion_equipo->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $devolucion_equipo_list->RowCnt ?>_devolucion_equipo_Admin_Que_Recibe" class="form-group devolucion_equipo_Admin_Que_Recibe">
<select data-table="devolucion_equipo" data-field="x_Admin_Que_Recibe" data-value-separator="<?php echo $devolucion_equipo->Admin_Que_Recibe->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe" name="x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe"<?php echo $devolucion_equipo->Admin_Que_Recibe->EditAttributes() ?>>
<?php echo $devolucion_equipo->Admin_Que_Recibe->SelectOptionListHtml("x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe") ?>
</select>
<input type="hidden" name="s_x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe" id="s_x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe" value="<?php echo $devolucion_equipo->Admin_Que_Recibe->LookupFilterQuery() ?>">
</span>
<input type="hidden" data-table="devolucion_equipo" data-field="x_Admin_Que_Recibe" name="o<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe" id="o<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe" value="<?php echo ew_HtmlEncode($devolucion_equipo->Admin_Que_Recibe->OldValue) ?>">
<?php } ?>
<?php if ($devolucion_equipo->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $devolucion_equipo_list->RowCnt ?>_devolucion_equipo_Admin_Que_Recibe" class="form-group devolucion_equipo_Admin_Que_Recibe">
<select data-table="devolucion_equipo" data-field="x_Admin_Que_Recibe" data-value-separator="<?php echo $devolucion_equipo->Admin_Que_Recibe->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe" name="x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe"<?php echo $devolucion_equipo->Admin_Que_Recibe->EditAttributes() ?>>
...
<?php } ?>
<?php if ($devolucion_equipo->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $devolucion_equipo_list->RowCnt ?>_devolucion_equipo_Admin_Que_Recibe" class="devolucion_equipo_Admin_Que_Recibe">
<span<?php echo $devolucion_equipo->Admin_Que_Recibe->ViewAttributes() ?>>
<?php echo $devolucion_equipo->Admin_Que_Recibe->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($devolucion_equipo->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $devolucion_equipo_list->RowCnt ?>_devolucion_equipo_Fecha_Devolucion" class="form-group devolucion_equipo_Fecha_Devolucion">
<input type="text" data-table="devolucion_equipo" data-field="x_Fecha_Devolucion" name="x<?php echo $devolucion_equipo_list->RowIndex ?>_Fecha_Devolucion" id="x<?php echo $devolucion_equipo_list->RowIndex ?>_Fecha_Devolucion" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($devolucion_equipo->Fecha_Devolucion->getPlaceHolder()) ?>" value="<?php echo $devolucion_equipo->Fecha_Devolucion->EditValue ?>"<?php echo $devolucion_equipo->Fecha_Devolucion->EditAttributes() ?>>
...
<script type="text/javascript">
ew_CreateCalendar("fdevolucion_equipolist", "x<?php echo $devolucion_equipo_list->RowIndex ?>_Fecha_Devolucion", 7);
</script>
<?php } ?>
</span>
...
<?php if ($devolucion_equipo->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $devolucion_equipo_list->RowCnt ?>_devolucion_equipo_Id_Motivo" class="form-group devolucion_equipo_Id_Motivo">
<select data-table="devolucion_equipo" data-field="x_Id_Motivo" data-value-separator="<?php echo $devolucion_equipo->Id_Motivo->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo" name="x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo"<?php echo $devolucion_equipo->Id_Motivo->EditAttributes() ?>>
<?php echo $devolucion_equipo->Id_Motivo->SelectOptionListHtml("x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo") ?>
</select>
<input type="hidden" name="s_x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo" id="s_x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo" value="<?php echo $devolucion_equipo->Id_Motivo->LookupFilterQuery() ?>">
</span>
<input type="hidden" data-table="devolucion_equipo" data-field="x_Id_Motivo" name="o<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo" id="o<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo" value="<?php echo ew_HtmlEncode($devolucion_equipo->Id_Motivo->OldValue) ?>">
<?php } ?>
<?php if ($devolucion_equipo->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $devolucion_equipo_list->RowCnt ?>_devolucion_equipo_Id_Motivo" class="form-group devolucion_equipo_Id_Motivo">
<select data-table="devolucion_equipo" data-field="x_Id_Motivo" data-value-separator="<?php echo $devolucion_equipo->Id_Motivo->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo" name="x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo"<?php echo $devolucion_equipo->Id_Motivo->EditAttributes() ?>>
...
<?php } ?>
<?php if ($devolucion_equipo->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $devolucion_equipo_list->RowCnt ?>_devolucion_equipo_Id_Motivo" class="devolucion_equipo_Id_Motivo">
<span<?php echo $devolucion_equipo->Id_Motivo->ViewAttributes() ?>>
<?php echo $devolucion_equipo->Id_Motivo->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-table="devolucion_equipo" data-field="x_NroSerie" name="o<?php echo $devolucion_equipo_list->RowIndex ?>_NroSerie" id="o<?php echo $devolucion_equipo_list->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($devolucion_equipo->NroSerie->OldValue) ?>">
	...
	<?php } ?>
	<?php if ($devolucion_equipo->Admin_Que_Recibe->Visible) { // Admin_Que_Recibe ?>
		<td data-name="Admin_Que_Recibe">
<span id="el$rowindex$_devolucion_equipo_Admin_Que_Recibe" class="form-group devolucion_equipo_Admin_Que_Recibe">
<select data-table="devolucion_equipo" data-field="x_Admin_Que_Recibe" data-value-separator="<?php echo $devolucion_equipo->Admin_Que_Recibe->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe" name="x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe"<?php echo $devolucion_equipo->Admin_Que_Recibe->EditAttributes() ?>>
<?php echo $devolucion_equipo->Admin_Que_Recibe->SelectOptionListHtml("x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe") ?>
</select>
<input type="hidden" name="s_x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe" id="s_x<?php echo $devolucion_equipo_list->RowIndex ?>_Admin_Que_Recibe" value="<?php echo $devolucion_equipo->Admin_Que_Recibe->LookupFilterQuery() ?>">
...
<span id="el$rowindex$_devolucion_equipo_Fecha_Devolucion" class="form-group devolucion_equipo_Fecha_Devolucion">
<input type="text" data-table="devolucion_equipo" data-field="x_Fecha_Devolucion" name="x<?php echo $devolucion_equipo_list->RowIndex ?>_Fecha_Devolucion" id="x<?php echo $devolucion_equipo_list->RowIndex ?>_Fecha_Devolucion" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($devolucion_equipo->Fecha_Devolucion->getPlaceHolder()) ?>" value="<?php echo $devolucion_equipo->Fecha_Devolucion->EditValue ?>"<?php echo $devolucion_equipo->Fecha_Devolucion->EditAttributes() ?>>
<?php if (!$devolucion_equipo->Fecha_Devolucion->ReadOnly && !$devolucion_equipo->Fecha_Devolucion->Disabled && !isset($devolucion_equipo->Fecha_Devolucion->EditAttrs["readonly"]) && !isset($devolucion_equipo->Fecha_Devolucion->EditAttrs["disabled"])) { ?>
<script type="text/javascript">
ew_CreateCalendar("fdevolucion_equipolist", "x<?php echo $devolucion_equipo_list->RowIndex ?>_Fecha_Devolucion", 7);
...
<span id="el$rowindex$_devolucion_equipo_Id_Motivo" class="form-group devolucion_equipo_Id_Motivo">
<select data-table="devolucion_equipo" data-field="x_Id_Motivo" data-value-separator="<?php echo $devolucion_equipo->Id_Motivo->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo" name="x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo"<?php echo $devolucion_equipo->Id_Motivo->EditAttributes() ?>>
<?php echo $devolucion_equipo->Id_Motivo->SelectOptionListHtml("x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo") ?>
</select>
<input type="hidden" name="s_x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo" id="s_x<?php echo $devolucion_equipo_list->RowIndex ?>_Id_Motivo" value="<?php echo $devolucion_equipo->Id_Motivo->LookupFilterQuery() ?>">
