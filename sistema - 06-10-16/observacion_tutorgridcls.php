...
$observacion_tutor_grid = NULL; // Initialize page object first

class cobservacion_tutor_grid extends cobservacion_tutor {
	...
	// Page object name
	var $PageObjName = 'observacion_tutor_grid';

	// Grid form hidden field names
	var $FormName = 'fobservacion_tutorgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["observacion_tutor"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "tutores") {
			$this->Dni_Tutor->Visible = FALSE;
			if ($GLOBALS["tutores"]->EventCancelled) $this->EventCancelled = TRUE;
		}
