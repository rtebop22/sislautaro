	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["Id_Piso"] != "") {
				...
				$this->setKey("Id_Piso", $this->Id_Piso->CurrentValue); // Set up key
			} else {
				$this->setKey("Id_Piso", ""); // Clear key
...
fpiso_tecnologicoadd.Lists["x_Estado_Ap"] = {"LinkField":"x_Id_Estado_Equipo_piso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipos_piso"};
