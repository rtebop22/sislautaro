...
$equipos_grid = NULL; // Initialize page object first

class cequipos_grid extends cequipos {
	...
	// Page object name
	var $PageObjName = 'equipos_grid';

	// Grid form hidden field names
	var $FormName = 'fequiposgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["equipos"];

		}
		$this->AddUrl = "equiposadd.php";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->NroSerie->CurrentValue = strval($arKeys[0]); // NroSerie
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
