...
fprestamo_equipodelete.Lists["x_Dni"] = {"LinkField":"x_Dni","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","x_Dni","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
...
<?php if ($prestamo_equipo->Fecha_Prestamo->Visible) { // Fecha_Prestamo ?>
		<th><span id="elh_prestamo_equipo_Fecha_Prestamo" class="prestamo_equipo_Fecha_Prestamo"><?php echo $prestamo_equipo->Fecha_Prestamo->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($prestamo_equipo->Fecha_Prestamo->Visible) { // Fecha_Prestamo ?>
		<td<?php echo $prestamo_equipo->Fecha_Prestamo->CellAttributes() ?>>
<span id="el<?php echo $prestamo_equipo_delete->RowCnt ?>_prestamo_equipo_Fecha_Prestamo" class="prestamo_equipo_Fecha_Prestamo">
