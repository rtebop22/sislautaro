	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("departamentolist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fdepartamentodelete = new ew_Form("fdepartamentodelete", "delete");
...
fdepartamentodelete.Lists["x_Id_Provincia"] = {"LinkField":"x_Id_Provincia","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincias"};
...
<?php if ($departamento->Id_Provincia->Visible) { // Id_Provincia ?>
		<th><span id="elh_departamento_Id_Provincia" class="departamento_Id_Provincia"><?php echo $departamento->Id_Provincia->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_Nombre" class="departamento_Nombre">
...
<?php } ?>
<?php if ($departamento->Id_Provincia->Visible) { // Id_Provincia ?>
		<td<?php echo $departamento->Id_Provincia->CellAttributes() ?>>
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_Id_Provincia" class="departamento_Id_Provincia">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $departamento_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
