...
<?php if ($denuncia_robo_equipo->IdDenuncia->Visible) { // IdDenuncia ?>
	<tr id="r_IdDenuncia">
		<td><span id="elh_denuncia_robo_equipo_IdDenuncia"><?php echo $denuncia_robo_equipo->IdDenuncia->FldCaption() ?></span></td>
...
<?php echo $denuncia_robo_equipo->IdDenuncia->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
