...
class cservidor_escolar_edit extends cservidor_escolar {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->Nro_Serie->CurrentValue == "") {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Cue
			$this->Cue->SetDbValueDef($rsnew, $this->Cue->CurrentValue, "", $this->Cue->ReadOnly);
...
<input type="hidden" data-table="servidor_escolar" data-field="x_Nro_Serie" data-page="1" name="x_Nro_Serie" id="x_Nro_Serie" value="<?php echo ew_HtmlEncode($servidor_escolar->Nro_Serie->CurrentValue) ?>">
