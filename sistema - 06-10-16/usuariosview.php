...
class cusuarios_view extends cusuarios {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["User"] <> "") {
			$this->RecKey["User"] = $_GET["User"];
			$KeyUrl .= "&amp;User=" . urlencode($this->RecKey["User"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["User"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["User"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["User"] <> "") {
				...
				$this->RecKey["User"] = $this->User->QueryStringValue;
			} elseif (@$_POST["User"] <> "") {
				$this->User->setFormValue($_POST["User"]);
				$this->RecKey["User"] = $this->User->FormValue;
			} else {
...
fusuariosview.Lists["x_Id_Grupo"] = {"LinkField":"x_Id_Grupo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"grupo_user"};
...
<?php if ($usuarios->User->Visible) { // User ?>
	<tr id="r_User">
		<td><span id="elh_usuarios_User"><?php echo $usuarios->User->FldCaption() ?></span></td>
...
<?php echo $usuarios->User->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->Pass->Visible) { // Pass ?>
	<tr id="r_Pass">
		<td><span id="elh_usuarios_Pass"><?php echo $usuarios->Pass->FldCaption() ?></span></td>
...
<?php echo $usuarios->Pass->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->Id_Grupo->Visible) { // Id_Grupo ?>
	<tr id="r_Id_Grupo">
		<td><span id="elh_usuarios_Id_Grupo"><?php echo $usuarios->Id_Grupo->FldCaption() ?></span></td>
...
<?php echo $usuarios->Id_Grupo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
