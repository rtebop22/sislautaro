...
$liberacion_equipo_delete = NULL; // Initialize page object first

class cliberacion_equipo_delete extends cliberacion_equipo {
	...
	// Page object name
	var $PageObjName = 'liberacion_equipo_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("liberacion_equipolist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in liberacion_equipo class, liberacion_equipoinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("liberacion_equipolist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($liberacion_equipo_delete)) $liberacion_equipo_delete = new cliberacion_equipo_delete();

// Page init
$liberacion_equipo_delete->Page_Init();

// Page main
$liberacion_equipo_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$liberacion_equipo_delete->Page_Render();
?>
...
var CurrentForm = fliberacion_equipodelete = new ew_Form("fliberacion_equipodelete", "delete");

// Form_CustomValidate event
fliberacion_equipodelete.Form_CustomValidate = 
...
fliberacion_equipodelete.ValidateRequired = true;
<?php } else { ?>
fliberacion_equipodelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fliberacion_equipodelete.Lists["x_Dni"] = {"LinkField":"x_Dni","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","x_Dni","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
fliberacion_equipodelete.Lists["x_NroSerie"] = {"LinkField":"x_NroSerie","Ajax":true,"AutoFill":false,"DisplayFields":["x_NroSerie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};
fliberacion_equipodelete.Lists["x_Dni_Tutor"] = {"LinkField":"x_Dni_Tutor","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","x_Dni_Tutor","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tutores"};
fliberacion_equipodelete.Lists["x_Id_Modalidad"] = {"LinkField":"x_Id_Modalidad","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"modalidad_establecimiento"};
fliberacion_equipodelete.Lists["x_Id_Nivel"] = {"LinkField":"x_Id_Nivel","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"nivel_educativo"};
fliberacion_equipodelete.Lists["x_Id_Autoridad"] = {"LinkField":"x_Id_Autoridad","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellido_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"autoridades_escolares"};
...
<?php $liberacion_equipo_delete->ShowPageHeader(); ?>
<?php
$liberacion_equipo_delete->ShowMessage();
?>
<form name="fliberacion_equipodelete" id="fliberacion_equipodelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($liberacion_equipo_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $liberacion_equipo_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="liberacion_equipo">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($liberacion_equipo_delete->RecKeys as $key) { ?>
...
<?php if ($liberacion_equipo->Dni->Visible) { // Dni ?>
		<th><span id="elh_liberacion_equipo_Dni" class="liberacion_equipo_Dni"><?php echo $liberacion_equipo->Dni->FldCaption() ?></span></th>
<?php } ?>
<?php if ($liberacion_equipo->NroSerie->Visible) { // NroSerie ?>
		<th><span id="elh_liberacion_equipo_NroSerie" class="liberacion_equipo_NroSerie"><?php echo $liberacion_equipo->NroSerie->FldCaption() ?></span></th>
<?php } ?>
<?php if ($liberacion_equipo->Dni_Tutor->Visible) { // Dni_Tutor ?>
		<th><span id="elh_liberacion_equipo_Dni_Tutor" class="liberacion_equipo_Dni_Tutor"><?php echo $liberacion_equipo->Dni_Tutor->FldCaption() ?></span></th>
<?php } ?>
<?php if ($liberacion_equipo->Fecha_Finalizacion->Visible) { // Fecha_Finalizacion ?>
		<th><span id="elh_liberacion_equipo_Fecha_Finalizacion" class="liberacion_equipo_Fecha_Finalizacion"><?php echo $liberacion_equipo->Fecha_Finalizacion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($liberacion_equipo->Id_Modalidad->Visible) { // Id_Modalidad ?>
		<th><span id="elh_liberacion_equipo_Id_Modalidad" class="liberacion_equipo_Id_Modalidad"><?php echo $liberacion_equipo->Id_Modalidad->FldCaption() ?></span></th>
<?php } ?>
<?php if ($liberacion_equipo->Id_Nivel->Visible) { // Id_Nivel ?>
		<th><span id="elh_liberacion_equipo_Id_Nivel" class="liberacion_equipo_Id_Nivel"><?php echo $liberacion_equipo->Id_Nivel->FldCaption() ?></span></th>
<?php } ?>
<?php if ($liberacion_equipo->Id_Autoridad->Visible) { // Id_Autoridad ?>
		<th><span id="elh_liberacion_equipo_Id_Autoridad" class="liberacion_equipo_Id_Autoridad"><?php echo $liberacion_equipo->Id_Autoridad->FldCaption() ?></span></th>
<?php } ?>
<?php if ($liberacion_equipo->Fecha_Liberacion->Visible) { // Fecha_Liberacion ?>
		<th><span id="elh_liberacion_equipo_Fecha_Liberacion" class="liberacion_equipo_Fecha_Liberacion"><?php echo $liberacion_equipo->Fecha_Liberacion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($liberacion_equipo->Ruta_Archivo_Copia_Titulo->Visible) { // Ruta_Archivo_Copia_Titulo ?>
		<th><span id="elh_liberacion_equipo_Ruta_Archivo_Copia_Titulo" class="liberacion_equipo_Ruta_Archivo_Copia_Titulo"><?php echo $liberacion_equipo->Ruta_Archivo_Copia_Titulo->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$liberacion_equipo_delete->RecCnt = 0;
$i = 0;
while (!$liberacion_equipo_delete->Recordset->EOF) {
	$liberacion_equipo_delete->RecCnt++;
	$liberacion_equipo_delete->RowCnt++;

	// Set row properties
	$liberacion_equipo->ResetAttrs();
	$liberacion_equipo->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$liberacion_equipo_delete->LoadRowValues($liberacion_equipo_delete->Recordset);

	// Render row
	$liberacion_equipo_delete->RenderRow();
?>
	<tr<?php echo $liberacion_equipo->RowAttributes() ?>>
<?php if ($liberacion_equipo->Dni->Visible) { // Dni ?>
		<td<?php echo $liberacion_equipo->Dni->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_Dni" class="liberacion_equipo_Dni">
...
<?php } ?>
<?php if ($liberacion_equipo->NroSerie->Visible) { // NroSerie ?>
		<td<?php echo $liberacion_equipo->NroSerie->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_NroSerie" class="liberacion_equipo_NroSerie">
...
<?php } ?>
<?php if ($liberacion_equipo->Dni_Tutor->Visible) { // Dni_Tutor ?>
		<td<?php echo $liberacion_equipo->Dni_Tutor->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_Dni_Tutor" class="liberacion_equipo_Dni_Tutor">
...
<?php } ?>
<?php if ($liberacion_equipo->Fecha_Finalizacion->Visible) { // Fecha_Finalizacion ?>
		<td<?php echo $liberacion_equipo->Fecha_Finalizacion->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_Fecha_Finalizacion" class="liberacion_equipo_Fecha_Finalizacion">
...
<?php } ?>
<?php if ($liberacion_equipo->Id_Modalidad->Visible) { // Id_Modalidad ?>
		<td<?php echo $liberacion_equipo->Id_Modalidad->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_Id_Modalidad" class="liberacion_equipo_Id_Modalidad">
...
<?php } ?>
<?php if ($liberacion_equipo->Id_Nivel->Visible) { // Id_Nivel ?>
		<td<?php echo $liberacion_equipo->Id_Nivel->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_Id_Nivel" class="liberacion_equipo_Id_Nivel">
...
<?php } ?>
<?php if ($liberacion_equipo->Id_Autoridad->Visible) { // Id_Autoridad ?>
		<td<?php echo $liberacion_equipo->Id_Autoridad->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_Id_Autoridad" class="liberacion_equipo_Id_Autoridad">
...
<?php } ?>
<?php if ($liberacion_equipo->Fecha_Liberacion->Visible) { // Fecha_Liberacion ?>
		<td<?php echo $liberacion_equipo->Fecha_Liberacion->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_Fecha_Liberacion" class="liberacion_equipo_Fecha_Liberacion">
...
<?php } ?>
<?php if ($liberacion_equipo->Ruta_Archivo_Copia_Titulo->Visible) { // Ruta_Archivo_Copia_Titulo ?>
		<td<?php echo $liberacion_equipo->Ruta_Archivo_Copia_Titulo->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_Ruta_Archivo_Copia_Titulo" class="liberacion_equipo_Ruta_Archivo_Copia_Titulo">
...
<?php
	$liberacion_equipo_delete->Recordset->MoveNext();
}
$liberacion_equipo_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $liberacion_equipo_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fliberacion_equipodelete.Init();
</script>
<?php
$liberacion_equipo_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$liberacion_equipo_delete->Page_Terminate();
?>
