...
class creasignacion_equipo extends cTable {
	...
	function __construct() {
		...
		// Id_Reasignacion
		$this->Id_Reasignacion = new cField('reasignacion_equipo', 'reasignacion_equipo', 'x_Id_Reasignacion', 'Id_Reasignacion', '`Id_Reasignacion`', '`Id_Reasignacion`', 200, -1, FALSE, '`Id_Reasignacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Fecha_Reasignacion
		$this->Fecha_Reasignacion = new cField('reasignacion_equipo', 'reasignacion_equipo', 'x_Fecha_Reasignacion', 'Fecha_Reasignacion', '`Fecha_Reasignacion`', '`Fecha_Reasignacion`', 200, -1, FALSE, '`Fecha_Reasignacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fecha_Reasignacion->Sortable = TRUE; // Allow sort
		$this->fields['Fecha_Reasignacion'] = &$this->Fecha_Reasignacion;

		// Id_Motivo_Reasig
		$this->Id_Motivo_Reasig = new cField('reasignacion_equipo', 'reasignacion_equipo', 'x_Id_Motivo_Reasig', 'Id_Motivo_Reasig', '`Id_Motivo_Reasig`', '`Id_Motivo_Reasig`', 3, -1, FALSE, '`Id_Motivo_Reasig`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function KeyToJson() {
		$json = "";
		$json .= "Id_Reasignacion:" . ew_VarToJson($this->Id_Reasignacion->CurrentValue, "string", "'");
		return "{" . $json . "}";
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Fecha_Reasignacion->EditValue = $this->Fecha_Reasignacion->CurrentValue;
