...
class creferente_tecnico_search extends creferente_tecnico {
	...
	function BuildAdvancedSearch() {
		...
		$this->BuildSearchUrl($sSrchUrl, $this->Apelldio_Nombre); // Apelldio_Nombre
	...
	function LoadSearchValues() {
		...
		// Apelldio_Nombre
		$this->Apelldio_Nombre->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_Apelldio_Nombre"));
		$this->Apelldio_Nombre->AdvancedSearch->SearchOperator = $objForm->GetValue("z_Apelldio_Nombre");
	...
	function RenderRow() {
		...
		$this->Cue->ViewCustomAttributes = "";
			...
			$this->Apelldio_Nombre->EditValue = ew_HtmlEncode($this->Apelldio_Nombre->AdvancedSearch->SearchValue);
...
<?php if ($referente_tecnico->Apelldio_Nombre->Visible) { // Apelldio_Nombre ?>
	<div id="r_Apelldio_Nombre" class="form-group">
		<label for="x_Apelldio_Nombre" class="<?php echo $referente_tecnico_search->SearchLabelClass ?>"><span id="elh_referente_tecnico_Apelldio_Nombre"><?php echo $referente_tecnico->Apelldio_Nombre->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Apelldio_Nombre" id="z_Apelldio_Nombre" value="LIKE"></p>
		</label>
		<div class="<?php echo $referente_tecnico_search->SearchRightColumnClass ?>"><div<?php echo $referente_tecnico->Apelldio_Nombre->CellAttributes() ?>>
...
<?php if ($referente_tecnico->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<div id="r_Fecha_Actualizacion" class="form-group">
		<label class="<?php echo $referente_tecnico_search->SearchLabelClass ?>"><span id="elh_referente_tecnico_Fecha_Actualizacion"><?php echo $referente_tecnico->Fecha_Actualizacion->FldCaption() ?></span>	
