...
class cprovincias_delete extends cprovincias {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("provinciaslist.php"); // Prevent SQL injection, return to list
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("provinciaslist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fprovinciasdelete = new ew_Form("fprovinciasdelete", "delete");
...
fprovinciasdelete.Lists["x_Id_Pais"] = {"LinkField":"x_Id_Pais","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"paises"};
...
<?php if ($provincias->Nombre->Visible) { // Nombre ?>
		<th><span id="elh_provincias_Nombre" class="provincias_Nombre"><?php echo $provincias->Nombre->FldCaption() ?></span></th>
<?php } ?>
<?php if ($provincias->Id_Pais->Visible) { // Id_Pais ?>
		<th><span id="elh_provincias_Id_Pais" class="provincias_Id_Pais"><?php echo $provincias->Id_Pais->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $provincias_delete->RowCnt ?>_provincias_Nombre" class="provincias_Nombre">
...
<?php } ?>
<?php if ($provincias->Id_Pais->Visible) { // Id_Pais ?>
		<td<?php echo $provincias->Id_Pais->CellAttributes() ?>>
<span id="el<?php echo $provincias_delete->RowCnt ?>_provincias_Id_Pais" class="provincias_Id_Pais">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $provincias_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
