...
class creasignacion_equipo_list extends creasignacion_equipo {
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_Id_Reasignacion") && $objForm->HasValue("o_Id_Reasignacion") && $this->Id_Reasignacion->CurrentValue <> $this->Id_Reasignacion->OldValue)
			return FALSE;
		...
		if ($objForm->HasValue("x_NroSerie") && $objForm->HasValue("o_NroSerie") && $this->NroSerie->CurrentValue <> $this->NroSerie->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Fecha_Reasignacion") && $objForm->HasValue("o_Fecha_Reasignacion") && $this->Fecha_Reasignacion->CurrentValue <> $this->Fecha_Reasignacion->OldValue)
			return FALSE;
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->Fecha_Reasignacion); // Fecha_Reasignacion
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->Fecha_Reasignacion->setSort("");
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.freasignacion_equipolist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
	...
	function LoadFormValues() {
		...
		$this->Id_Reasignacion->setOldValue($objForm->GetValue("o_Id_Reasignacion"));
		...
		$this->Fecha_Reasignacion->setOldValue($objForm->GetValue("o_Fecha_Reasignacion"));
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.freasignacion_equipolist,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.freasignacion_equipolist,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.freasignacion_equipolist,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = TRUE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.freasignacion_equipolist,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = FALSE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.freasignacion_equipolist,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = TRUE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.freasignacion_equipolist,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = TRUE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.freasignacion_equipolist,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;
...
freasignacion_equipolist.EmptyRow = function(infix) {
	var fobj = this.Form;
	if (ew_ValueChanged(fobj, infix, "Id_Reasignacion", false)) return false;
	if (ew_ValueChanged(fobj, infix, "Dni", false)) return false;
	if (ew_ValueChanged(fobj, infix, "NroSerie", false)) return false;
	if (ew_ValueChanged(fobj, infix, "Fecha_Reasignacion", false)) return false;
...
<?php if ($reasignacion_equipo_list->TotalRecs > 0) { ?>
...
<?php if ($reasignacion_equipo->Fecha_Reasignacion->Visible) { // Fecha_Reasignacion ?>
	<?php if ($reasignacion_equipo->SortUrl($reasignacion_equipo->Fecha_Reasignacion) == "") { ?>
		<th data-name="Fecha_Reasignacion"><div id="elh_reasignacion_equipo_Fecha_Reasignacion" class="reasignacion_equipo_Fecha_Reasignacion"><div class="ewTableHeaderCaption"><?php echo $reasignacion_equipo->Fecha_Reasignacion->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Fecha_Reasignacion"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $reasignacion_equipo->SortUrl($reasignacion_equipo->Fecha_Reasignacion) ?>',1);"><div id="elh_reasignacion_equipo_Fecha_Reasignacion" class="reasignacion_equipo_Fecha_Reasignacion">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $reasignacion_equipo->Fecha_Reasignacion->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($reasignacion_equipo->Fecha_Reasignacion->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($reasignacion_equipo->Fecha_Reasignacion->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<input type="text" data-table="reasignacion_equipo" data-field="x_NroSerie" name="x<?php echo $reasignacion_equipo_list->RowIndex ?>_NroSerie" id="x<?php echo $reasignacion_equipo_list->RowIndex ?>_NroSerie" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($reasignacion_equipo->NroSerie->getPlaceHolder()) ?>" value="<?php echo $reasignacion_equipo->NroSerie->EditValue ?>"<?php echo $reasignacion_equipo->NroSerie->EditAttributes() ?>>
</span>
...
<?php if ($reasignacion_equipo->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $reasignacion_equipo_list->RowCnt ?>_reasignacion_equipo_Fecha_Reasignacion" class="form-group reasignacion_equipo_Fecha_Reasignacion">
<input type="text" data-table="reasignacion_equipo" data-field="x_Fecha_Reasignacion" name="x<?php echo $reasignacion_equipo_list->RowIndex ?>_Fecha_Reasignacion" id="x<?php echo $reasignacion_equipo_list->RowIndex ?>_Fecha_Reasignacion" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($reasignacion_equipo->Fecha_Reasignacion->getPlaceHolder()) ?>" value="<?php echo $reasignacion_equipo->Fecha_Reasignacion->EditValue ?>"<?php echo $reasignacion_equipo->Fecha_Reasignacion->EditAttributes() ?>>
</span>
<input type="hidden" data-table="reasignacion_equipo" data-field="x_Fecha_Reasignacion" name="o<?php echo $reasignacion_equipo_list->RowIndex ?>_Fecha_Reasignacion" id="o<?php echo $reasignacion_equipo_list->RowIndex ?>_Fecha_Reasignacion" value="<?php echo ew_HtmlEncode($reasignacion_equipo->Fecha_Reasignacion->OldValue) ?>">
<?php } ?>
<?php if ($reasignacion_equipo->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $reasignacion_equipo_list->RowCnt ?>_reasignacion_equipo_Fecha_Reasignacion" class="form-group reasignacion_equipo_Fecha_Reasignacion">
<input type="text" data-table="reasignacion_equipo" data-field="x_Fecha_Reasignacion" name="x<?php echo $reasignacion_equipo_list->RowIndex ?>_Fecha_Reasignacion" id="x<?php echo $reasignacion_equipo_list->RowIndex ?>_Fecha_Reasignacion" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($reasignacion_equipo->Fecha_Reasignacion->getPlaceHolder()) ?>" value="<?php echo $reasignacion_equipo->Fecha_Reasignacion->EditValue ?>"<?php echo $reasignacion_equipo->Fecha_Reasignacion->EditAttributes() ?>>
...
<?php } ?>
<?php if ($reasignacion_equipo->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $reasignacion_equipo_list->RowCnt ?>_reasignacion_equipo_Fecha_Reasignacion" class="reasignacion_equipo_Fecha_Reasignacion">
...
<span id="el$rowindex$_reasignacion_equipo_Id_Reasignacion" class="form-group reasignacion_equipo_Id_Reasignacion">
<input type="text" data-table="reasignacion_equipo" data-field="x_Id_Reasignacion" name="x<?php echo $reasignacion_equipo_list->RowIndex ?>_Id_Reasignacion" id="x<?php echo $reasignacion_equipo_list->RowIndex ?>_Id_Reasignacion" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($reasignacion_equipo->Id_Reasignacion->getPlaceHolder()) ?>" value="<?php echo $reasignacion_equipo->Id_Reasignacion->EditValue ?>"<?php echo $reasignacion_equipo->Id_Reasignacion->EditAttributes() ?>>
</span>
<input type="hidden" data-table="reasignacion_equipo" data-field="x_Id_Reasignacion" name="o<?php echo $reasignacion_equipo_list->RowIndex ?>_Id_Reasignacion" id="o<?php echo $reasignacion_equipo_list->RowIndex ?>_Id_Reasignacion" value="<?php echo ew_HtmlEncode($reasignacion_equipo->Id_Reasignacion->OldValue) ?>">
</td>
...
<input type="hidden" data-table="reasignacion_equipo" data-field="x_NroSerie" name="o<?php echo $reasignacion_equipo_list->RowIndex ?>_NroSerie" id="o<?php echo $reasignacion_equipo_list->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($reasignacion_equipo->NroSerie->OldValue) ?>">
	...
	<?php } ?>
	<?php if ($reasignacion_equipo->Fecha_Reasignacion->Visible) { // Fecha_Reasignacion ?>
		<td data-name="Fecha_Reasignacion">
<span id="el$rowindex$_reasignacion_equipo_Fecha_Reasignacion" class="form-group reasignacion_equipo_Fecha_Reasignacion">
<input type="text" data-table="reasignacion_equipo" data-field="x_Fecha_Reasignacion" name="x<?php echo $reasignacion_equipo_list->RowIndex ?>_Fecha_Reasignacion" id="x<?php echo $reasignacion_equipo_list->RowIndex ?>_Fecha_Reasignacion" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($reasignacion_equipo->Fecha_Reasignacion->getPlaceHolder()) ?>" value="<?php echo $reasignacion_equipo->Fecha_Reasignacion->EditValue ?>"<?php echo $reasignacion_equipo->Fecha_Reasignacion->EditAttributes() ?>>
</span>
<input type="hidden" data-table="reasignacion_equipo" data-field="x_Fecha_Reasignacion" name="o<?php echo $reasignacion_equipo_list->RowIndex ?>_Fecha_Reasignacion" id="o<?php echo $reasignacion_equipo_list->RowIndex ?>_Fecha_Reasignacion" value="<?php echo ew_HtmlEncode($reasignacion_equipo->Fecha_Reasignacion->OldValue) ?>">
</td>
