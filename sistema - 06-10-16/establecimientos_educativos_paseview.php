...
<?php if ($establecimientos_educativos_pase->Nombre_Director->Visible) { // Nombre_Director ?>
	<tr id="r_Nombre_Director">
		<td><span id="elh_establecimientos_educativos_pase_Nombre_Director"><?php echo $establecimientos_educativos_pase->Nombre_Director->FldCaption() ?></span></td>
...
<?php echo $establecimientos_educativos_pase->Nombre_Director->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Cuil_Director->Visible) { // Cuil_Director ?>
	<tr id="r_Cuil_Director">
		<td><span id="elh_establecimientos_educativos_pase_Cuil_Director"><?php echo $establecimientos_educativos_pase->Cuil_Director->FldCaption() ?></span></td>
...
<?php echo $establecimientos_educativos_pase->Cuil_Director->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($establecimientos_educativos_pase->Contacto_Rte->Visible) { // Contacto_Rte ?>
	<tr id="r_Contacto_Rte">
		<td><span id="elh_establecimientos_educativos_pase_Contacto_Rte"><?php echo $establecimientos_educativos_pase->Contacto_Rte->FldCaption() ?></span></td>
...
<?php echo $establecimientos_educativos_pase->Contacto_Rte->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
