...
class cservidor_escolar extends cTable {
	...
	function __construct() {
		...
		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('servidor_escolar', 'servidor_escolar', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, -1, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
