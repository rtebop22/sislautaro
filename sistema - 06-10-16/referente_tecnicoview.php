...
<?php if ($referente_tecnico->Apelldio_Nombre->Visible) { // Apelldio_Nombre ?>
	<tr id="r_Apelldio_Nombre">
		<td><span id="elh_referente_tecnico_Apelldio_Nombre"><?php echo $referente_tecnico->Apelldio_Nombre->FldCaption() ?></span></td>
		<td data-name="Apelldio_Nombre"<?php echo $referente_tecnico->Apelldio_Nombre->CellAttributes() ?>>
<span id="el_referente_tecnico_Apelldio_Nombre" data-page="1">
<span<?php echo $referente_tecnico->Apelldio_Nombre->ViewAttributes() ?>>
<?php echo $referente_tecnico->Apelldio_Nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
