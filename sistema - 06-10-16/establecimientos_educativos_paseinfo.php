...
class cestablecimientos_educativos_pase extends cTable {
	...
	function __construct() {
		...
		// Cue_Establecimiento
		$this->Cue_Establecimiento = new cField('establecimientos_educativos_pase', 'establecimientos_educativos_pase', 'x_Cue_Establecimiento', 'Cue_Establecimiento', '`Cue_Establecimiento`', '`Cue_Establecimiento`', 200, -1, FALSE, '`Cue_Establecimiento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Nombre_Director
		$this->Nombre_Director = new cField('establecimientos_educativos_pase', 'establecimientos_educativos_pase', 'x_Nombre_Director', 'Nombre_Director', '`Nombre_Director`', '`Nombre_Director`', 200, -1, FALSE, '`Nombre_Director`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombre_Director->Sortable = TRUE; // Allow sort
		$this->fields['Nombre_Director'] = &$this->Nombre_Director;

		// Cuil_Director
		$this->Cuil_Director = new cField('establecimientos_educativos_pase', 'establecimientos_educativos_pase', 'x_Cuil_Director', 'Cuil_Director', '`Cuil_Director`', '`Cuil_Director`', 200, -1, FALSE, '`Cuil_Director`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Contacto_Rte
		$this->Contacto_Rte = new cField('establecimientos_educativos_pase', 'establecimientos_educativos_pase', 'x_Contacto_Rte', 'Contacto_Rte', '`Contacto_Rte`', '`Contacto_Rte`', 200, -1, FALSE, '`Contacto_Rte`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
