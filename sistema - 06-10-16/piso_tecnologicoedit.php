...
$piso_tecnologico_edit = NULL; // Initialize page object first

class cpiso_tecnologico_edit extends cpiso_tecnologico {
	...
	// Page object name
	var $PageObjName = 'piso_tecnologico_edit';
	...
	function Page_Main() {
		...
		if (@$_GET["Id_Piso"] <> "") {
			$this->Id_Piso->setQueryStringValue($_GET["Id_Piso"]);
		}
		...
		// Check if valid key
		if ($this->Id_Piso->CurrentValue == "") {
			$this->Page_Terminate("piso_tecnologicolist.php"); // Invalid key, return to list
		}
	...
	function LoadFormValues() {
		...
		if (!$this->Id_Piso->FldIsDetailKey)
	...
	function RenderRow() {
		...
		$this->Usuario->ViewCustomAttributes = "";
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->Plano_Escuela);
...
// Create page object
if (!isset($piso_tecnologico_edit)) $piso_tecnologico_edit = new cpiso_tecnologico_edit();

// Page init
$piso_tecnologico_edit->Page_Init();

// Page main
$piso_tecnologico_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$piso_tecnologico_edit->Page_Render();
?>
...
var CurrentForm = fpiso_tecnologicoedit = new ew_Form("fpiso_tecnologicoedit", "edit");

// Validate form
fpiso_tecnologicoedit.Validate = function() {
...
fpiso_tecnologicoedit.Form_CustomValidate = 
...
fpiso_tecnologicoedit.ValidateRequired = true;
<?php } else { ?>
fpiso_tecnologicoedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fpiso_tecnologicoedit.Lists["x_Switch"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpiso_tecnologicoedit.Lists["x_Switch"].Options = <?php echo json_encode($piso_tecnologico->Switch->Options()) ?>;
fpiso_tecnologicoedit.Lists["x_Estado_Switch"] = {"LinkField":"x_Id_Estado_Equipo_piso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipos_piso"};
fpiso_tecnologicoedit.Lists["x_Estado_Ap"] = {"LinkField":"x_Id_Estado_Equipo_piso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipos_piso"};
fpiso_tecnologicoedit.Lists["x_Ups"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpiso_tecnologicoedit.Lists["x_Ups"].Options = <?php echo json_encode($piso_tecnologico->Ups->Options()) ?>;
fpiso_tecnologicoedit.Lists["x_Estado_Ups"] = {"LinkField":"x_Id_Estado_Equipo_piso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipos_piso"};
fpiso_tecnologicoedit.Lists["x_Cableado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpiso_tecnologicoedit.Lists["x_Cableado"].Options = <?php echo json_encode($piso_tecnologico->Cableado->Options()) ?>;
fpiso_tecnologicoedit.Lists["x_Estado_Cableado"] = {"LinkField":"x_Id_Estado_Equipo_piso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipos_piso"};
...
<?php if (!$piso_tecnologico_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $piso_tecnologico_edit->ShowPageHeader(); ?>
<?php
$piso_tecnologico_edit->ShowMessage();
?>
<form name="fpiso_tecnologicoedit" id="fpiso_tecnologicoedit" class="<?php echo $piso_tecnologico_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($piso_tecnologico_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $piso_tecnologico_edit->Token ?>">
<?php } ?>
...
<?php if ($piso_tecnologico->Switch->Visible) { // Switch ?>
	<div id="r_Switch" class="form-group">
		<label id="elh_piso_tecnologico_Switch" class="col-sm-2 control-label ewLabel"><?php echo $piso_tecnologico->Switch->FldCaption() ?></label>
...
<?php if ($piso_tecnologico->Estado_Switch->Visible) { // Estado_Switch ?>
	<div id="r_Estado_Switch" class="form-group">
		<label id="elh_piso_tecnologico_Estado_Switch" for="x_Estado_Switch" class="col-sm-2 control-label ewLabel"><?php echo $piso_tecnologico->Estado_Switch->FldCaption() ?></label>
...
<?php if ($piso_tecnologico->Cantidad_Ap->Visible) { // Cantidad_Ap ?>
	<div id="r_Cantidad_Ap" class="form-group">
		<label id="elh_piso_tecnologico_Cantidad_Ap" for="x_Cantidad_Ap" class="col-sm-2 control-label ewLabel"><?php echo $piso_tecnologico->Cantidad_Ap->FldCaption() ?></label>
...
<?php if ($piso_tecnologico->Estado_Ap->Visible) { // Estado_Ap ?>
	<div id="r_Estado_Ap" class="form-group">
		<label id="elh_piso_tecnologico_Estado_Ap" for="x_Estado_Ap" class="col-sm-2 control-label ewLabel"><?php echo $piso_tecnologico->Estado_Ap->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $piso_tecnologico->Estado_Ap->CellAttributes() ?>>
<span id="el_piso_tecnologico_Estado_Ap">
<select data-table="piso_tecnologico" data-field="x_Estado_Ap" data-page="1" data-value-separator="<?php echo $piso_tecnologico->Estado_Ap->DisplayValueSeparatorAttribute() ?>" id="x_Estado_Ap" name="x_Estado_Ap"<?php echo $piso_tecnologico->Estado_Ap->EditAttributes() ?>>
...
<?php echo $piso_tecnologico->Estado_Ap->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($piso_tecnologico->Porcent_Estado_Ap->Visible) { // Porcent_Estado_Ap ?>
	<div id="r_Porcent_Estado_Ap" class="form-group">
		<label id="elh_piso_tecnologico_Porcent_Estado_Ap" for="x_Porcent_Estado_Ap" class="col-sm-2 control-label ewLabel"><?php echo $piso_tecnologico->Porcent_Estado_Ap->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $piso_tecnologico->Porcent_Estado_Ap->CellAttributes() ?>>
<span id="el_piso_tecnologico_Porcent_Estado_Ap">
<input type="text" data-table="piso_tecnologico" data-field="x_Porcent_Estado_Ap" data-page="1" name="x_Porcent_Estado_Ap" id="x_Porcent_Estado_Ap" size="30" maxlength="3" placeholder="<?php echo ew_HtmlEncode($piso_tecnologico->Porcent_Estado_Ap->getPlaceHolder()) ?>" value="<?php echo $piso_tecnologico->Porcent_Estado_Ap->EditValue ?>"<?php echo $piso_tecnologico->Porcent_Estado_Ap->EditAttributes() ?>>
</span>
<?php echo $piso_tecnologico->Porcent_Estado_Ap->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($piso_tecnologico->Ups->Visible) { // Ups ?>
	<div id="r_Ups" class="form-group">
		<label id="elh_piso_tecnologico_Ups" class="col-sm-2 control-label ewLabel"><?php echo $piso_tecnologico->Ups->FldCaption() ?></label>
...
<?php if ($piso_tecnologico->Estado_Ups->Visible) { // Estado_Ups ?>
	<div id="r_Estado_Ups" class="form-group">
		<label id="elh_piso_tecnologico_Estado_Ups" for="x_Estado_Ups" class="col-sm-2 control-label ewLabel"><?php echo $piso_tecnologico->Estado_Ups->FldCaption() ?></label>
...
<?php if ($piso_tecnologico->Cableado->Visible) { // Cableado ?>
	<div id="r_Cableado" class="form-group">
		<label id="elh_piso_tecnologico_Cableado" class="col-sm-2 control-label ewLabel"><?php echo $piso_tecnologico->Cableado->FldCaption() ?></label>
...
<?php if ($piso_tecnologico->Estado_Cableado->Visible) { // Estado_Cableado ?>
	<div id="r_Estado_Cableado" class="form-group">
		<label id="elh_piso_tecnologico_Estado_Cableado" for="x_Estado_Cableado" class="col-sm-2 control-label ewLabel"><?php echo $piso_tecnologico->Estado_Cableado->FldCaption() ?></label>
...
<?php } ?>
<input type="hidden" name="fs_x_Plano_Escuela" id= "fs_x_Plano_Escuela" value="200">
...
<input type="hidden" data-table="piso_tecnologico" data-field="x_Id_Piso" name="x_Id_Piso" id="x_Id_Piso" value="<?php echo ew_HtmlEncode($piso_tecnologico->Id_Piso->CurrentValue) ?>">
<?php if (!$piso_tecnologico_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $piso_tecnologico_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fpiso_tecnologicoedit.Init();
</script>
<?php
$piso_tecnologico_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$piso_tecnologico_edit->Page_Terminate();
?>
