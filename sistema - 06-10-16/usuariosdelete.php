...
fusuariosdelete.Lists["x_Id_Grupo"] = {"LinkField":"x_Id_Grupo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"grupo_user"};
...
<?php if ($usuarios->User->Visible) { // User ?>
		<th><span id="elh_usuarios_User" class="usuarios_User"><?php echo $usuarios->User->FldCaption() ?></span></th>
<?php } ?>
<?php if ($usuarios->Pass->Visible) { // Pass ?>
		<th><span id="elh_usuarios_Pass" class="usuarios_Pass"><?php echo $usuarios->Pass->FldCaption() ?></span></th>
<?php } ?>
<?php if ($usuarios->Id_Grupo->Visible) { // Id_Grupo ?>
		<th><span id="elh_usuarios_Id_Grupo" class="usuarios_Id_Grupo"><?php echo $usuarios->Id_Grupo->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($usuarios->User->Visible) { // User ?>
		<td<?php echo $usuarios->User->CellAttributes() ?>>
<span id="el<?php echo $usuarios_delete->RowCnt ?>_usuarios_User" class="usuarios_User">
...
<?php } ?>
<?php if ($usuarios->Pass->Visible) { // Pass ?>
		<td<?php echo $usuarios->Pass->CellAttributes() ?>>
<span id="el<?php echo $usuarios_delete->RowCnt ?>_usuarios_Pass" class="usuarios_Pass">
...
<?php } ?>
<?php if ($usuarios->Id_Grupo->Visible) { // Id_Grupo ?>
		<td<?php echo $usuarios->Id_Grupo->CellAttributes() ?>>
<span id="el<?php echo $usuarios_delete->RowCnt ?>_usuarios_Id_Grupo" class="usuarios_Id_Grupo">
