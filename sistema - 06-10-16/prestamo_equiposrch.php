...
class cprestamo_equipo_search extends cprestamo_equipo {
	...
	function RenderRow() {
		...
		$this->Id_Estado_Devol->ViewCustomAttributes = "";
			...
			$this->Fecha_Prestamo->EditValue = ew_HtmlEncode($this->Fecha_Prestamo->AdvancedSearch->SearchValue);
			...
			$this->Fecha_Actualizacion->EditValue = ew_HtmlEncode(ew_FormatDateTime(ew_UnFormatDateTime($this->Fecha_Actualizacion->AdvancedSearch->SearchValue, 5), 5));
...
fprestamo_equiposearch.Lists["x_Dni"] = {"LinkField":"x_Dni","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","x_Dni","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
...
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_Dni"><?php echo (strval($prestamo_equipo->Dni->AdvancedSearch->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $prestamo_equipo->Dni->AdvancedSearch->ViewValue); ?></span>
</span>
...
<input type="hidden" data-table="prestamo_equipo" data-field="x_Dni" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $prestamo_equipo->Dni->DisplayValueSeparatorAttribute() ?>" name="x_Dni" id="x_Dni" value="<?php echo $prestamo_equipo->Dni->AdvancedSearch->SearchValue ?>"<?php echo $prestamo_equipo->Dni->EditAttributes() ?>>
...
<input type="text" data-table="prestamo_equipo" data-field="x_Fecha_Actualizacion" data-format="5" name="x_Fecha_Actualizacion" id="x_Fecha_Actualizacion" placeholder="<?php echo ew_HtmlEncode($prestamo_equipo->Fecha_Actualizacion->getPlaceHolder()) ?>" value="<?php echo $prestamo_equipo->Fecha_Actualizacion->EditValue ?>"<?php echo $prestamo_equipo->Fecha_Actualizacion->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
