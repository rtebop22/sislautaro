...
$autoridades_escolares_view = NULL; // Initialize page object first

class cautoridades_escolares_view extends cautoridades_escolares {
	...
	// Page object name
	var $PageObjName = 'autoridades_escolares_view';
	...
	function __construct() {
		...
		if (@$_GET["Id_Autoridad"] <> "") {
			$this->RecKey["Id_Autoridad"] = $_GET["Id_Autoridad"];
			$KeyUrl .= "&amp;Id_Autoridad=" . urlencode($this->RecKey["Id_Autoridad"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["Id_Autoridad"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["Id_Autoridad"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Id_Autoridad"] <> "") {
				...
				$this->RecKey["Id_Autoridad"] = $this->Id_Autoridad->QueryStringValue;
			} elseif (@$_POST["Id_Autoridad"] <> "") {
				$this->Id_Autoridad->setFormValue($_POST["Id_Autoridad"]);
				$this->RecKey["Id_Autoridad"] = $this->Id_Autoridad->FormValue;
			} else {
				$sReturnUrl = "autoridades_escolareslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "autoridades_escolareslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "autoridades_escolareslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($autoridades_escolares_view)) $autoridades_escolares_view = new cautoridades_escolares_view();

// Page init
$autoridades_escolares_view->Page_Init();

// Page main
$autoridades_escolares_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$autoridades_escolares_view->Page_Render();
?>
...
var CurrentForm = fautoridades_escolaresview = new ew_Form("fautoridades_escolaresview", "view");

// Form_CustomValidate event
fautoridades_escolaresview.Form_CustomValidate = 
...
fautoridades_escolaresview.ValidateRequired = true;
<?php } else { ?>
fautoridades_escolaresview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fautoridades_escolaresview.Lists["x_Id_Cargo"] = {"LinkField":"x_Id_Cargo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cargo_autoridad"};
fautoridades_escolaresview.Lists["x_Id_Turno"] = {"LinkField":"x_Id_Turno","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"turno"};
...
<?php if ($autoridades_escolares->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$autoridades_escolares_view->IsModal) { ?>
<?php if ($autoridades_escolares->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $autoridades_escolares_view->ExportOptions->Render("body") ?>
<?php
	foreach ($autoridades_escolares_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$autoridades_escolares_view->IsModal) { ?>
<?php if ($autoridades_escolares->Export == "") { ?>
...
<?php } ?>
<?php $autoridades_escolares_view->ShowPageHeader(); ?>
<?php
$autoridades_escolares_view->ShowMessage();
?>
<form name="fautoridades_escolaresview" id="fautoridades_escolaresview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($autoridades_escolares_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $autoridades_escolares_view->Token ?>">
<?php } ?>
...
<?php if ($autoridades_escolares->Apellido_Nombre->Visible) { // Apellido_Nombre ?>
	<tr id="r_Apellido_Nombre">
		<td><span id="elh_autoridades_escolares_Apellido_Nombre"><?php echo $autoridades_escolares->Apellido_Nombre->FldCaption() ?></span></td>
		<td data-name="Apellido_Nombre"<?php echo $autoridades_escolares->Apellido_Nombre->CellAttributes() ?>>
<span id="el_autoridades_escolares_Apellido_Nombre" data-page="1">
<span<?php echo $autoridades_escolares->Apellido_Nombre->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Apellido_Nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($autoridades_escolares->Cuil->Visible) { // Cuil ?>
	<tr id="r_Cuil">
		<td><span id="elh_autoridades_escolares_Cuil"><?php echo $autoridades_escolares->Cuil->FldCaption() ?></span></td>
		<td data-name="Cuil"<?php echo $autoridades_escolares->Cuil->CellAttributes() ?>>
<span id="el_autoridades_escolares_Cuil" data-page="1">
<span<?php echo $autoridades_escolares->Cuil->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Cuil->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($autoridades_escolares->Id_Cargo->Visible) { // Id_Cargo ?>
	<tr id="r_Id_Cargo">
		<td><span id="elh_autoridades_escolares_Id_Cargo"><?php echo $autoridades_escolares->Id_Cargo->FldCaption() ?></span></td>
		<td data-name="Id_Cargo"<?php echo $autoridades_escolares->Id_Cargo->CellAttributes() ?>>
<span id="el_autoridades_escolares_Id_Cargo" data-page="1">
<span<?php echo $autoridades_escolares->Id_Cargo->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Id_Cargo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($autoridades_escolares->Id_Turno->Visible) { // Id_Turno ?>
	<tr id="r_Id_Turno">
		<td><span id="elh_autoridades_escolares_Id_Turno"><?php echo $autoridades_escolares->Id_Turno->FldCaption() ?></span></td>
		<td data-name="Id_Turno"<?php echo $autoridades_escolares->Id_Turno->CellAttributes() ?>>
<span id="el_autoridades_escolares_Id_Turno" data-page="1">
<span<?php echo $autoridades_escolares->Id_Turno->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Id_Turno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($autoridades_escolares->Telefono->Visible) { // Telefono ?>
	<tr id="r_Telefono">
		<td><span id="elh_autoridades_escolares_Telefono"><?php echo $autoridades_escolares->Telefono->FldCaption() ?></span></td>
		<td data-name="Telefono"<?php echo $autoridades_escolares->Telefono->CellAttributes() ?>>
<span id="el_autoridades_escolares_Telefono" data-page="1">
<span<?php echo $autoridades_escolares->Telefono->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Telefono->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($autoridades_escolares->Celular->Visible) { // Celular ?>
	<tr id="r_Celular">
		<td><span id="elh_autoridades_escolares_Celular"><?php echo $autoridades_escolares->Celular->FldCaption() ?></span></td>
		<td data-name="Celular"<?php echo $autoridades_escolares->Celular->CellAttributes() ?>>
<span id="el_autoridades_escolares_Celular" data-page="1">
<span<?php echo $autoridades_escolares->Celular->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Celular->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($autoridades_escolares->Maill->Visible) { // Maill ?>
	<tr id="r_Maill">
		<td><span id="elh_autoridades_escolares_Maill"><?php echo $autoridades_escolares->Maill->FldCaption() ?></span></td>
		<td data-name="Maill"<?php echo $autoridades_escolares->Maill->CellAttributes() ?>>
<span id="el_autoridades_escolares_Maill" data-page="1">
<span<?php echo $autoridades_escolares->Maill->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Maill->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($autoridades_escolares->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<tr id="r_Fecha_Actualizacion">
		<td><span id="elh_autoridades_escolares_Fecha_Actualizacion"><?php echo $autoridades_escolares->Fecha_Actualizacion->FldCaption() ?></span></td>
		<td data-name="Fecha_Actualizacion"<?php echo $autoridades_escolares->Fecha_Actualizacion->CellAttributes() ?>>
<span id="el_autoridades_escolares_Fecha_Actualizacion" data-page="1">
<span<?php echo $autoridades_escolares->Fecha_Actualizacion->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Fecha_Actualizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($autoridades_escolares->Usuario->Visible) { // Usuario ?>
	<tr id="r_Usuario">
		<td><span id="elh_autoridades_escolares_Usuario"><?php echo $autoridades_escolares->Usuario->FldCaption() ?></span></td>
		<td data-name="Usuario"<?php echo $autoridades_escolares->Usuario->CellAttributes() ?>>
<span id="el_autoridades_escolares_Usuario" data-page="1">
<span<?php echo $autoridades_escolares->Usuario->ViewAttributes() ?>>
<?php echo $autoridades_escolares->Usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($autoridades_escolares->Export == "") { ?>
<script type="text/javascript">
fautoridades_escolaresview.Init();
</script>
<?php } ?>
<?php
$autoridades_escolares_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($autoridades_escolares->Export == "") { ?>
...
<?php
$autoridades_escolares_view->Page_Terminate();
?>
