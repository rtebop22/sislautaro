...
class cequipos_list extends cequipos {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->Ultima_Actualiz->AdvancedSearch->ToJSON(), ","); // Field Ultima_Actualiz
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field Ultima_Actualiz
		$this->Ultima_Actualiz->AdvancedSearch->SearchValue = @$filter["x_Ultima_Actualiz"];
		$this->Ultima_Actualiz->AdvancedSearch->SearchOperator = @$filter["z_Ultima_Actualiz"];
		$this->Ultima_Actualiz->AdvancedSearch->SearchCondition = @$filter["v_Ultima_Actualiz"];
		$this->Ultima_Actualiz->AdvancedSearch->SearchValue2 = @$filter["y_Ultima_Actualiz"];
		$this->Ultima_Actualiz->AdvancedSearch->SearchOperator2 = @$filter["w_Ultima_Actualiz"];
		$this->Ultima_Actualiz->AdvancedSearch->Save();
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->Ultima_Actualiz, $Default, FALSE); // Ultima_Actualiz
		...
		if (!$Default && $this->Command == "search") {
			...
			$this->Ultima_Actualiz->AdvancedSearch->Save(); // Ultima_Actualiz
		}
		return $sWhere;
	}
	...
	function CheckSearchParms() {
		...
		if ($this->User_Actualiz->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Ultima_Actualiz->AdvancedSearch->IssetSession())
			return TRUE;
		return FALSE;
	}
	...
	function ResetAdvancedSearchParms() {
		...
		$this->Ultima_Actualiz->AdvancedSearch->UnsetSession();
	}
	...
	function RenderListOptions() {
		...
		if ($Security->IsLoggedIn()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewCopy\" title=\"" . $copycaption . "\" data-table=\"equipos\" data-caption=\"" . $copycaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->CopyUrl) . "',caption:'" . $copycaption . "'});\">" . $Language->Phrase("CopyLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
		...
		if ($Security->IsLoggedIn()) {
			...
			$links = "";
			if ($GLOBALS["observacion_equipo_grid"]->DetailView && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["observacion_equipo_grid"]->DetailEdit && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["observacion_equipo_grid"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
	...
	function SetupOtherOptions() {
		...
		if (ew_IsMobile())
			...
			$item->Body = "<a class=\"ewAddEdit ewAdd\" title=\"" . $addcaption . "\" data-table=\"equipos\" data-caption=\"" . $addcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->AddUrl) . "',caption:'" . $addcaption . "'});\">" . $Language->Phrase("AddLink") . "</a>";
		...
		$item->Visible = ($GLOBALS["observacion_equipo"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn());
		if ($item->Visible) {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.fequiposlist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
	...
	function LoadSearchValues() {
		...
		// Ultima_Actualiz
		$this->Ultima_Actualiz->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_Ultima_Actualiz"]);
		if ($this->Ultima_Actualiz->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->Ultima_Actualiz->AdvancedSearch->SearchOperator = @$_GET["z_Ultima_Actualiz"];
	}
	...
	function AddRow($rsold = NULL) {
		...
		// Id_Ubicacion
		$this->Id_Ubicacion->SetDbValueDef($rsnew, $this->Id_Ubicacion->CurrentValue, 0, FALSE);

		// Id_Estado
		$this->Id_Estado->SetDbValueDef($rsnew, $this->Id_Estado->CurrentValue, 0, FALSE);

		// Id_Sit_Estado
		$this->Id_Sit_Estado->SetDbValueDef($rsnew, $this->Id_Sit_Estado->CurrentValue, 0, FALSE);
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.fequiposlist,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.fequiposlist,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.fequiposlist,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = TRUE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.fequiposlist,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = FALSE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.fequiposlist,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = TRUE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.fequiposlist,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = TRUE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.fequiposlist,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;

		// Export to Email
		$item = &$this->ExportOptions->Add("email");
		$url = "";
		$item->Body = "<button id=\"emf_equipos\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_equipos',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fequiposlist,sel:true" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
<?php if ($equipos_list->TotalRecs > 0) { ?>
