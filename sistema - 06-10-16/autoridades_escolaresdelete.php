...
<?php if ($autoridades_escolares->Celular->Visible) { // Celular ?>
		<th><span id="elh_autoridades_escolares_Celular" class="autoridades_escolares_Celular"><?php echo $autoridades_escolares->Celular->FldCaption() ?></span></th>
<?php } ?>
<?php if ($autoridades_escolares->Maill->Visible) { // Maill ?>
		<th><span id="elh_autoridades_escolares_Maill" class="autoridades_escolares_Maill"><?php echo $autoridades_escolares->Maill->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($autoridades_escolares->Celular->Visible) { // Celular ?>
		<td<?php echo $autoridades_escolares->Celular->CellAttributes() ?>>
<span id="el<?php echo $autoridades_escolares_delete->RowCnt ?>_autoridades_escolares_Celular" class="autoridades_escolares_Celular">
...
<?php } ?>
<?php if ($autoridades_escolares->Maill->Visible) { // Maill ?>
		<td<?php echo $autoridades_escolares->Maill->CellAttributes() ?>>
<span id="el<?php echo $autoridades_escolares_delete->RowCnt ?>_autoridades_escolares_Maill" class="autoridades_escolares_Maill">
