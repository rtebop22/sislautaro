...
class cprestamo_equipo_add extends cprestamo_equipo {
	...
	function LoadDefaultValues() {
		...
		$this->Prestamo_Cargador->OldValue = $this->Prestamo_Cargador->CurrentValue;
...
fprestamo_equipoadd.Lists["x_Dni"] = {"LinkField":"x_Dni","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","x_Dni","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
...
<input type="hidden" data-table="prestamo_equipo" data-field="x_Dni" data-page="1" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $prestamo_equipo->Dni->DisplayValueSeparatorAttribute() ?>" name="x_Dni" id="x_Dni" value="<?php echo $prestamo_equipo->Dni->CurrentValue ?>"<?php echo $prestamo_equipo->Dni->EditAttributes() ?>>
