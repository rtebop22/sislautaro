...
class cestado_actual_legajo_persona_list extends cestado_actual_legajo_persona {
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.festado_actual_legajo_personalist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.festado_actual_legajo_personalist,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.festado_actual_legajo_personalist,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.festado_actual_legajo_personalist,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = TRUE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.festado_actual_legajo_personalist,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = FALSE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.festado_actual_legajo_personalist,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = TRUE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.festado_actual_legajo_personalist,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = TRUE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.festado_actual_legajo_personalist,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;

		// Export to Email
		$item = &$this->ExportOptions->Add("email");
		$url = "";
		$item->Body = "<button id=\"emf_estado_actual_legajo_persona\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_estado_actual_legajo_persona',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.festado_actual_legajo_personalist,sel:true" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
<?php if ($estado_actual_legajo_persona_list->TotalRecs > 0) { ?>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Matricula" data-value-separator="<?php echo $estado_actual_legajo_persona->Matricula->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Matricula" name="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Matricula"<?php echo $estado_actual_legajo_persona->Matricula->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Matricula->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Matricula") ?>
</select>
</span>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Certificado_Pase" data-value-separator="<?php echo $estado_actual_legajo_persona->Certificado_Pase->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Certificado_Pase" name="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Certificado_Pase"<?php echo $estado_actual_legajo_persona->Certificado_Pase->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Certificado_Pase->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Certificado_Pase") ?>
</select>
</span>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Tiene_DNI" data-value-separator="<?php echo $estado_actual_legajo_persona->Tiene_DNI->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Tiene_DNI" name="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Tiene_DNI"<?php echo $estado_actual_legajo_persona->Tiene_DNI->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Tiene_DNI->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Tiene_DNI") ?>
</select>
</span>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Certificado_Medico" data-value-separator="<?php echo $estado_actual_legajo_persona->Certificado_Medico->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Certificado_Medico" name="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Certificado_Medico"<?php echo $estado_actual_legajo_persona->Certificado_Medico->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Certificado_Medico->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Certificado_Medico") ?>
</select>
</span>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Posee_Autorizacion" data-value-separator="<?php echo $estado_actual_legajo_persona->Posee_Autorizacion->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Posee_Autorizacion" name="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Posee_Autorizacion"<?php echo $estado_actual_legajo_persona->Posee_Autorizacion->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Posee_Autorizacion->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Posee_Autorizacion") ?>
</select>
</span>
...
<select data-table="estado_actual_legajo_persona" data-field="x_Cooperadora" data-value-separator="<?php echo $estado_actual_legajo_persona->Cooperadora->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Cooperadora" name="x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Cooperadora"<?php echo $estado_actual_legajo_persona->Cooperadora->EditAttributes() ?>>
<?php echo $estado_actual_legajo_persona->Cooperadora->SelectOptionListHtml("x<?php echo $estado_actual_legajo_persona_list->RowIndex ?>_Cooperadora") ?>
</select>
</span>
