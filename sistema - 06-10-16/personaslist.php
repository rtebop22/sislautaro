...
class cpersonas_list extends cpersonas {
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->User_Actualiz, $Default, FALSE); // User_Actualiz
		...
		if (!$Default && $this->Command == "search") {
			...
			$this->User_Actualiz->AdvancedSearch->Save(); // User_Actualiz
	...
	function CheckSearchParms() {
		...
		if ($this->NroSerie->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->User_Actualiz->AdvancedSearch->IssetSession())
			return TRUE;
	...
	function ResetAdvancedSearchParms() {
		...
		$this->User_Actualiz->AdvancedSearch->UnsetSession();
	...
	function RenderListOptions() {
		...
		if ($Security->IsLoggedIn()) {
			...
			$links = "";
			if ($GLOBALS["estado_actual_legajo_persona_grid"]->DetailView && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["estado_actual_legajo_persona_grid"]->DetailEdit && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["estado_actual_legajo_persona_grid"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
		...
		if ($Security->IsLoggedIn()) {
			...
			$links = "";
			if ($GLOBALS["materias_adeudadas_grid"]->DetailView && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["materias_adeudadas_grid"]->DetailEdit && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["materias_adeudadas_grid"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
		...
		if ($Security->IsLoggedIn()) {
			...
			$links = "";
			if ($GLOBALS["observacion_persona_grid"]->DetailView && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["observacion_persona_grid"]->DetailEdit && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["observacion_persona_grid"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
		...
		if ($Security->IsLoggedIn()) {
			...
			$links = "";
			if ($GLOBALS["equipos_grid"]->DetailView && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["equipos_grid"]->DetailEdit && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["equipos_grid"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
		...
		if ($Security->IsLoggedIn()) {
			...
			$links = "";
			if ($GLOBALS["tutores_grid"]->DetailView && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["tutores_grid"]->DetailEdit && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
			...
			if ($GLOBALS["tutores_grid"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn()) {
	...
	function SetupOtherOptions() {
		...
		$item->Visible = ($GLOBALS["estado_actual_legajo_persona"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn());
		if ($item->Visible) {
		...
		$item->Body = "<a class=\"ewDetailAddGroup ewDetailAdd\" title=\"" . ew_HtmlTitle($caption) . "\" data-caption=\"" . ew_HtmlTitle($caption) . "\" href=\"" . ew_HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["materias_adeudadas"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn());
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
		...
		$item->Body = "<a class=\"ewDetailAddGroup ewDetailAdd\" title=\"" . ew_HtmlTitle($caption) . "\" data-caption=\"" . ew_HtmlTitle($caption) . "\" href=\"" . ew_HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["observacion_persona"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn());
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
		...
		$item->Body = "<a class=\"ewDetailAddGroup ewDetailAdd\" title=\"" . ew_HtmlTitle($caption) . "\" data-caption=\"" . ew_HtmlTitle($caption) . "\" href=\"" . ew_HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["equipos"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn());
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
		...
		$item->Body = "<a class=\"ewDetailAddGroup ewDetailAdd\" title=\"" . ew_HtmlTitle($caption) . "\" data-caption=\"" . ew_HtmlTitle($caption) . "\" href=\"" . ew_HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["tutores"]->DetailAdd && $Security->IsLoggedIn() && $Security->IsLoggedIn());
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
	...
	function LoadSearchValues() {
		...
		// User_Actualiz
		$this->User_Actualiz->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_User_Actualiz"]);
		if ($this->User_Actualiz->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->User_Actualiz->AdvancedSearch->SearchOperator = @$_GET["z_User_Actualiz"];
	...
	function AddRow($rsold = NULL) {
		...
		// NroSerie
		$this->NroSerie->SetDbValueDef($rsnew, $this->NroSerie->CurrentValue, "", strval($this->NroSerie->CurrentValue) == "");
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.fpersonaslist,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.fpersonaslist,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.fpersonaslist,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = TRUE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.fpersonaslist,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = FALSE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.fpersonaslist,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = TRUE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.fpersonaslist,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = TRUE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.fpersonaslist,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;
...
fpersonaslist.Lists["x_Id_Departamento"] = {"LinkField":"x_Id_Departamento","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":["x_Id_Localidad"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
...
<?php if ($personas_list->TotalRecs > 0) { ?>
...
<?php if ($personas->Cuil->Visible) { // Cuil ?>
	...
	<?php } else { ?>
		<th data-name="Cuil"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $personas->SortUrl($personas->Cuil) ?>',1);"><div id="elh_personas_Cuil" class="personas_Cuil">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $personas->Cuil->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($personas->Cuil->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($personas->Cuil->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($personas->Id_Departamento->Visible) { // Id_Departamento ?>
	<?php if ($personas->SortUrl($personas->Id_Departamento) == "") { ?>
		<th data-name="Id_Departamento"><div id="elh_personas_Id_Departamento" class="personas_Id_Departamento"><div class="ewTableHeaderCaption"><?php echo $personas->Id_Departamento->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Id_Departamento"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $personas->SortUrl($personas->Id_Departamento) ?>',1);"><div id="elh_personas_Id_Departamento" class="personas_Id_Departamento">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $personas->Id_Departamento->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($personas->Id_Departamento->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($personas->Id_Departamento->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($personas->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_Cuil" class="form-group personas_Cuil">
<input type="text" data-table="personas" data-field="x_Cuil" name="x<?php echo $personas_list->RowIndex ?>_Cuil" id="x<?php echo $personas_list->RowIndex ?>_Cuil" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($personas->Cuil->getPlaceHolder()) ?>" value="<?php echo $personas->Cuil->EditValue ?>"<?php echo $personas->Cuil->EditAttributes() ?>>
</span>
<input type="hidden" data-table="personas" data-field="x_Cuil" name="o<?php echo $personas_list->RowIndex ?>_Cuil" id="o<?php echo $personas_list->RowIndex ?>_Cuil" value="<?php echo ew_HtmlEncode($personas->Cuil->OldValue) ?>">
<?php } ?>
<?php if ($personas->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_Cuil" class="form-group personas_Cuil">
<input type="text" data-table="personas" data-field="x_Cuil" name="x<?php echo $personas_list->RowIndex ?>_Cuil" id="x<?php echo $personas_list->RowIndex ?>_Cuil" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($personas->Cuil->getPlaceHolder()) ?>" value="<?php echo $personas->Cuil->EditValue ?>"<?php echo $personas->Cuil->EditAttributes() ?>>
...
<?php } ?>
<?php if ($personas->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_Cuil" class="personas_Cuil">
...
<?php if ($personas->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_Id_Departamento" class="form-group personas_Id_Departamento">
<select data-table="personas" data-field="x_Id_Departamento" data-value-separator="<?php echo $personas->Id_Departamento->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $personas_list->RowIndex ?>_Id_Departamento" name="x<?php echo $personas_list->RowIndex ?>_Id_Departamento"<?php echo $personas->Id_Departamento->EditAttributes() ?>>
<?php echo $personas->Id_Departamento->SelectOptionListHtml("x<?php echo $personas_list->RowIndex ?>_Id_Departamento") ?>
</select>
<input type="hidden" name="s_x<?php echo $personas_list->RowIndex ?>_Id_Departamento" id="s_x<?php echo $personas_list->RowIndex ?>_Id_Departamento" value="<?php echo $personas->Id_Departamento->LookupFilterQuery() ?>">
</span>
<input type="hidden" data-table="personas" data-field="x_Id_Departamento" name="o<?php echo $personas_list->RowIndex ?>_Id_Departamento" id="o<?php echo $personas_list->RowIndex ?>_Id_Departamento" value="<?php echo ew_HtmlEncode($personas->Id_Departamento->OldValue) ?>">
<?php } ?>
<?php if ($personas->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_Id_Departamento" class="form-group personas_Id_Departamento">
<select data-table="personas" data-field="x_Id_Departamento" data-value-separator="<?php echo $personas->Id_Departamento->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $personas_list->RowIndex ?>_Id_Departamento" name="x<?php echo $personas_list->RowIndex ?>_Id_Departamento"<?php echo $personas->Id_Departamento->EditAttributes() ?>>
...
<?php } ?>
<?php if ($personas->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $personas_list->RowCnt ?>_personas_Id_Departamento" class="personas_Id_Departamento">
...
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x<?php echo $personas_list->RowIndex ?>_NroSerie"><?php echo (strval($personas->NroSerie->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $personas->NroSerie->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($personas->NroSerie->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x<?php echo $personas_list->RowIndex ?>_NroSerie',m:0,n:10});" class="ewLookupBtn btn btn-default btn-sm"><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="personas" data-field="x_NroSerie" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $personas->NroSerie->DisplayValueSeparatorAttribute() ?>" name="x<?php echo $personas_list->RowIndex ?>_NroSerie" id="x<?php echo $personas_list->RowIndex ?>_NroSerie" value="<?php echo $personas->NroSerie->CurrentValue ?>"<?php echo $personas->NroSerie->EditAttributes() ?>>
...
<span id="el$rowindex$_personas_Id_Departamento" class="form-group personas_Id_Departamento">
<select data-table="personas" data-field="x_Id_Departamento" data-value-separator="<?php echo $personas->Id_Departamento->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $personas_list->RowIndex ?>_Id_Departamento" name="x<?php echo $personas_list->RowIndex ?>_Id_Departamento"<?php echo $personas->Id_Departamento->EditAttributes() ?>>
<?php echo $personas->Id_Departamento->SelectOptionListHtml("x<?php echo $personas_list->RowIndex ?>_Id_Departamento") ?>
</select>
<input type="hidden" name="s_x<?php echo $personas_list->RowIndex ?>_Id_Departamento" id="s_x<?php echo $personas_list->RowIndex ?>_Id_Departamento" value="<?php echo $personas->Id_Departamento->LookupFilterQuery() ?>">
