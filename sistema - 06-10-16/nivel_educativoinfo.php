...
//
// Table class for nivel_educativo
//
class cnivel_educativo extends cTable {
	var $Id_Nivel;
	var $Detalle;
	...
	function __construct() {
		...
		$this->TableVar = 'nivel_educativo';
		$this->TableName = 'nivel_educativo';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`nivel_educativo`";
		$this->DBID = 'DB';
		...
		// Id_Nivel
		$this->Id_Nivel = new cField('nivel_educativo', 'nivel_educativo', 'x_Id_Nivel', 'Id_Nivel', '`Id_Nivel`', '`Id_Nivel`', 3, -1, FALSE, '`Id_Nivel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Detalle
		$this->Detalle = new cField('nivel_educativo', 'nivel_educativo', 'x_Detalle', 'Detalle', '`Detalle`', '`Detalle`', 200, -1, FALSE, '`Detalle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`nivel_educativo`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "nivel_educativolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("nivel_educativoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("nivel_educativoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "nivel_educativoadd.php?" . $this->UrlParm($parm);
		else
			$url = "nivel_educativoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("nivel_educativoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("nivel_educativoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("nivel_educativodelete.php", $this->UrlParm());
	}
