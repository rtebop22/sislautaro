...
class cview1_list extends cview1 {
	...
	function Page_Init() {
		...
		$this->Apellidos_Nombres1->SetVisibility();
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = $UserProfile->GetSearchFilters(CurrentUserName(), "fview1listsrch");
		} else {
			$sSavedFilterList = "";
		}
		...
		$sFilterList = ew_Concat($sFilterList, $this->Apellidos_Nombres1->AdvancedSearch->ToJSON(), ","); // Field Apellidos_Nombres1
	...
	function RestoreFilterList() {
		...
		// Field Apellidos_Nombres1
		$this->Apellidos_Nombres1->AdvancedSearch->SearchValue = @$filter["x_Apellidos_Nombres1"];
		$this->Apellidos_Nombres1->AdvancedSearch->SearchOperator = @$filter["z_Apellidos_Nombres1"];
		$this->Apellidos_Nombres1->AdvancedSearch->SearchCondition = @$filter["v_Apellidos_Nombres1"];
		$this->Apellidos_Nombres1->AdvancedSearch->SearchValue2 = @$filter["y_Apellidos_Nombres1"];
		$this->Apellidos_Nombres1->AdvancedSearch->SearchOperator2 = @$filter["w_Apellidos_Nombres1"];
		$this->Apellidos_Nombres1->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->Apellidos_Nombres1, $arKeywords, $type);
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->Apellidos_Nombres1); // Apellidos_Nombres1
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->Apellidos_Nombres1->setSort("");
	...
	function LoadDbValues(&$rs) {
		...
		$this->Apellidos_Nombres1->DbValue = $row['Apellidos_Nombres1'];
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.fview1list,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.fview1list,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.fview1list,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = TRUE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.fview1list,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = FALSE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.fview1list,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = TRUE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.fview1list,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = TRUE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.fview1list,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;

		// Export to Email
		$item = &$this->ExportOptions->Add("email");
		$url = "";
		$item->Body = "<button id=\"emf_view1\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_view1',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fview1list,sel:true" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
fview1list.Lists["x_Dni"] = {"LinkField":"x_Dni","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","x_Dni","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
...
<div class="panel panel-default ewGrid view1">
...
?>
<?php if ($view1->Dni->Visible) { // Dni ?>
	<?php if ($view1->SortUrl($view1->Dni) == "") { ?>
		<th data-name="Dni"><div id="elh_view1_Dni" class="view1_Dni"><div class="ewTableHeaderCaption"><?php echo $view1->Dni->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Dni"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->Dni) ?>',1);"><div id="elh_view1_Dni" class="view1_Dni">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->Dni->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($view1->Dni->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->Dni->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->NroSerie->Visible) { // NroSerie ?>
	<?php if ($view1->SortUrl($view1->NroSerie) == "") { ?>
		<th data-name="NroSerie"><div id="elh_view1_NroSerie" class="view1_NroSerie"><div class="ewTableHeaderCaption"><?php echo $view1->NroSerie->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="NroSerie"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->NroSerie) ?>',1);"><div id="elh_view1_NroSerie" class="view1_NroSerie">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->NroSerie->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->NroSerie->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->NroSerie->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
	<?php if ($view1->SortUrl($view1->Apellidos_Nombres) == "") { ?>
		<th data-name="Apellidos_Nombres"><div id="elh_view1_Apellidos_Nombres" class="view1_Apellidos_Nombres"><div class="ewTableHeaderCaption"><?php echo $view1->Apellidos_Nombres->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Apellidos_Nombres"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->Apellidos_Nombres) ?>',1);"><div id="elh_view1_Apellidos_Nombres" class="view1_Apellidos_Nombres">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->Apellidos_Nombres->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->Apellidos_Nombres->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->Apellidos_Nombres->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->Apellidos_Nombres1->Visible) { // Apellidos_Nombres1 ?>
	<?php if ($view1->SortUrl($view1->Apellidos_Nombres1) == "") { ?>
		<th data-name="Apellidos_Nombres1"><div id="elh_view1_Apellidos_Nombres1" class="view1_Apellidos_Nombres1"><div class="ewTableHeaderCaption"><?php echo $view1->Apellidos_Nombres1->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Apellidos_Nombres1"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->Apellidos_Nombres1) ?>',1);"><div id="elh_view1_Apellidos_Nombres1" class="view1_Apellidos_Nombres1">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->Apellidos_Nombres1->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->Apellidos_Nombres1->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->Apellidos_Nombres1->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->Dni_Tutor->Visible) { // Dni_Tutor ?>
	<?php if ($view1->SortUrl($view1->Dni_Tutor) == "") { ?>
		<th data-name="Dni_Tutor"><div id="elh_view1_Dni_Tutor" class="view1_Dni_Tutor"><div class="ewTableHeaderCaption"><?php echo $view1->Dni_Tutor->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Dni_Tutor"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->Dni_Tutor) ?>',1);"><div id="elh_view1_Dni_Tutor" class="view1_Dni_Tutor">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->Dni_Tutor->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($view1->Dni_Tutor->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->Dni_Tutor->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->Fecha_Finalizacion->Visible) { // Fecha_Finalizacion ?>
	<?php if ($view1->SortUrl($view1->Fecha_Finalizacion) == "") { ?>
		<th data-name="Fecha_Finalizacion"><div id="elh_view1_Fecha_Finalizacion" class="view1_Fecha_Finalizacion"><div class="ewTableHeaderCaption"><?php echo $view1->Fecha_Finalizacion->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Fecha_Finalizacion"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->Fecha_Finalizacion) ?>',1);"><div id="elh_view1_Fecha_Finalizacion" class="view1_Fecha_Finalizacion">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->Fecha_Finalizacion->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->Fecha_Finalizacion->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->Fecha_Finalizacion->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->Fecha_Liberacion->Visible) { // Fecha_Liberacion ?>
	<?php if ($view1->SortUrl($view1->Fecha_Liberacion) == "") { ?>
		<th data-name="Fecha_Liberacion"><div id="elh_view1_Fecha_Liberacion" class="view1_Fecha_Liberacion"><div class="ewTableHeaderCaption"><?php echo $view1->Fecha_Liberacion->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Fecha_Liberacion"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->Fecha_Liberacion) ?>',1);"><div id="elh_view1_Fecha_Liberacion" class="view1_Fecha_Liberacion">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->Fecha_Liberacion->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->Fecha_Liberacion->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->Fecha_Liberacion->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($view1->Dni->Visible) { // Dni ?>
		<td data-name="Dni"<?php echo $view1->Dni->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_Dni" class="view1_Dni">
<span<?php echo $view1->Dni->ViewAttributes() ?>>
<?php echo $view1->Dni->ListViewValue() ?></span>
</span>
<a id="<?php echo $view1_list->PageObjName . "_row_" . $view1_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($view1->NroSerie->Visible) { // NroSerie ?>
		<td data-name="NroSerie"<?php echo $view1->NroSerie->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_NroSerie" class="view1_NroSerie">
<span<?php echo $view1->NroSerie->ViewAttributes() ?>>
<?php echo $view1->NroSerie->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
		<td data-name="Apellidos_Nombres"<?php echo $view1->Apellidos_Nombres->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_Apellidos_Nombres" class="view1_Apellidos_Nombres">
<span<?php echo $view1->Apellidos_Nombres->ViewAttributes() ?>>
<?php echo $view1->Apellidos_Nombres->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->Apellidos_Nombres1->Visible) { // Apellidos_Nombres1 ?>
		<td data-name="Apellidos_Nombres1"<?php echo $view1->Apellidos_Nombres1->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_Apellidos_Nombres1" class="view1_Apellidos_Nombres1">
<span<?php echo $view1->Apellidos_Nombres1->ViewAttributes() ?>>
<?php echo $view1->Apellidos_Nombres1->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->Dni_Tutor->Visible) { // Dni_Tutor ?>
		<td data-name="Dni_Tutor"<?php echo $view1->Dni_Tutor->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_Dni_Tutor" class="view1_Dni_Tutor">
<span<?php echo $view1->Dni_Tutor->ViewAttributes() ?>>
<?php echo $view1->Dni_Tutor->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->Fecha_Finalizacion->Visible) { // Fecha_Finalizacion ?>
		<td data-name="Fecha_Finalizacion"<?php echo $view1->Fecha_Finalizacion->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_Fecha_Finalizacion" class="view1_Fecha_Finalizacion">
<span<?php echo $view1->Fecha_Finalizacion->ViewAttributes() ?>>
<?php echo $view1->Fecha_Finalizacion->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->Fecha_Liberacion->Visible) { // Fecha_Liberacion ?>
		<td data-name="Fecha_Liberacion"<?php echo $view1->Fecha_Liberacion->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_Fecha_Liberacion" class="view1_Fecha_Liberacion">
<span<?php echo $view1->Fecha_Liberacion->ViewAttributes() ?>>
<?php echo $view1->Fecha_Liberacion->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
