...
<?php echo $liberacion_equipo->Dni->ViewValue ?></span></span></td>
	</tr>
<?php } ?>
...
<?php echo $liberacion_equipo->NroSerie->ViewValue ?></span></span></td>
	</tr>
<?php } ?>
...
<?php echo $liberacion_equipo->Dni_Tutor->ViewValue ?></span></span></td>
	</tr>
<?php } ?>
...
<?php echo $liberacion_equipo->Id_Autoridad->ViewValue ?></span></span></td>
	</tr>
<?php } ?>
...
<?php echo $liberacion_equipo->Fecha_Liberacion->ViewValue ?></span></span></td>
	</tr>
<?php } ?>
</table>
...
function GenerarActaLiberacion(){
		...
		var params={};
        params.action='generar';
        params.serie=$('.el_liberacion_equipo_NroSerie').val();
		$nombre=params.serie;
		//alert("HOLA");
		$.post('Actas/Liberacion.php',params,function(){
		$('#popupbox').load('actas/Liberacion.php',{action:"buscar",nombre:($nombre)});
		alert($nombre);
			$('#block').show();
            $('#popupbox').show();
			//window.location.href='actas/Liberacion.php?nombre='+nombre; /
			//window.location = "actas/Liberacion.php";
	      })
        return false;
		}
</script>
