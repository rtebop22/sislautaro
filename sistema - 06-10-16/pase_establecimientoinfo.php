...
class cpase_establecimiento extends cTable {
	...
	function __construct() {
		...
		// Id_Pase
		$this->Id_Pase = new cField('pase_establecimiento', 'pase_establecimiento', 'x_Id_Pase', 'Id_Pase', '`Id_Pase`', '`Id_Pase`', 3, -1, FALSE, '`Id_Pase`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// NroSerie
		$this->NroSerie = new cField('pase_establecimiento', 'pase_establecimiento', 'x_NroSerie', 'NroSerie', '`NroSerie`', '`NroSerie`', 200, -1, FALSE, '`NroSerie`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NroSerie->Sortable = TRUE; // Allow sort
		$this->fields['NroSerie'] = &$this->NroSerie;

		// Cue_Establecimiento_Alta
		$this->Cue_Establecimiento_Alta = new cField('pase_establecimiento', 'pase_establecimiento', 'x_Cue_Establecimiento_Alta', 'Cue_Establecimiento_Alta', '`Cue_Establecimiento_Alta`', '`Cue_Establecimiento_Alta`', 200, -1, FALSE, '`Cue_Establecimiento_Alta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->Cue_Establecimiento_Alta->Sortable = TRUE; // Allow sort
		$this->Cue_Establecimiento_Alta->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->Cue_Establecimiento_Alta->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['Cue_Establecimiento_Alta'] = &$this->Cue_Establecimiento_Alta;

		// Cue_Establecimiento_Baja
		$this->Cue_Establecimiento_Baja = new cField('pase_establecimiento', 'pase_establecimiento', 'x_Cue_Establecimiento_Baja', 'Cue_Establecimiento_Baja', '`Cue_Establecimiento_Baja`', '`Cue_Establecimiento_Baja`', 200, -1, FALSE, '`Cue_Establecimiento_Baja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->Cue_Establecimiento_Baja->Sortable = TRUE; // Allow sort
		$this->Cue_Establecimiento_Baja->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->Cue_Establecimiento_Baja->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['Cue_Establecimiento_Baja'] = &$this->Cue_Establecimiento_Baja;

		// Fecha_Pase
		$this->Fecha_Pase = new cField('pase_establecimiento', 'pase_establecimiento', 'x_Fecha_Pase', 'Fecha_Pase', '`Fecha_Pase`', 'DATE_FORMAT(`Fecha_Pase`, \'\')', 133, -1, FALSE, '`Fecha_Pase`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fecha_Pase->Sortable = TRUE; // Allow sort
		$this->Fecha_Pase->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Fecha_Pase->EditValue = $this->Fecha_Pase->CurrentValue;
