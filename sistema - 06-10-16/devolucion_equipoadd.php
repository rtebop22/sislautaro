...
class cdevolucion_equipo_add extends cdevolucion_equipo {
	...
	function LoadDefaultValues() {
		...
		$this->Devuelve_Cargador->OldValue = $this->Devuelve_Cargador->CurrentValue;
	}
...
fdevolucion_equipoadd.Lists["x_Admin_Que_Recibe"] = {"LinkField":"x_DniRte","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apelldio_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"referente_tecnico"};
...
fdevolucion_equipoadd.Lists["x_Id_Estado_Devol"] = {"LinkField":"x_Id_Estado_Devol","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipo_devuleto"};
...
<script type="text/javascript">
ew_CreateCalendar("fdevolucion_equipoadd", "x_Fecha_Devolucion", 7);
</script>
<?php } ?>
</span>
