...
class cpiso_tecnologico_view extends cpiso_tecnologico {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["Id_Piso"] <> "") {
			$this->RecKey["Id_Piso"] = $_GET["Id_Piso"];
			$KeyUrl .= "&amp;Id_Piso=" . urlencode($this->RecKey["Id_Piso"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["Id_Piso"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["Id_Piso"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Id_Piso"] <> "") {
				...
				$this->RecKey["Id_Piso"] = $this->Id_Piso->QueryStringValue;
			} elseif (@$_POST["Id_Piso"] <> "") {
				$this->Id_Piso->setFormValue($_POST["Id_Piso"]);
				$this->RecKey["Id_Piso"] = $this->Id_Piso->FormValue;
			} else {
...
fpiso_tecnologicoview.Lists["x_Estado_Ap"] = {"LinkField":"x_Id_Estado_Equipo_piso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipos_piso"};
...
<?php if ($piso_tecnologico->Estado_Ap->Visible) { // Estado_Ap ?>
	<tr id="r_Estado_Ap">
		<td><span id="elh_piso_tecnologico_Estado_Ap"><?php echo $piso_tecnologico->Estado_Ap->FldCaption() ?></span></td>
		<td data-name="Estado_Ap"<?php echo $piso_tecnologico->Estado_Ap->CellAttributes() ?>>
<span id="el_piso_tecnologico_Estado_Ap" data-page="1">
<span<?php echo $piso_tecnologico->Estado_Ap->ViewAttributes() ?>>
<?php echo $piso_tecnologico->Estado_Ap->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($piso_tecnologico->Porcent_Estado_Ap->Visible) { // Porcent_Estado_Ap ?>
	<tr id="r_Porcent_Estado_Ap">
		<td><span id="elh_piso_tecnologico_Porcent_Estado_Ap"><?php echo $piso_tecnologico->Porcent_Estado_Ap->FldCaption() ?></span></td>
		<td data-name="Porcent_Estado_Ap"<?php echo $piso_tecnologico->Porcent_Estado_Ap->CellAttributes() ?>>
<span id="el_piso_tecnologico_Porcent_Estado_Ap" data-page="1">
<span<?php echo $piso_tecnologico->Porcent_Estado_Ap->ViewAttributes() ?>>
<?php echo $piso_tecnologico->Porcent_Estado_Ap->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($piso_tecnologico->Ultima_Actualizacion->Visible) { // Ultima_Actualizacion ?>
	<tr id="r_Ultima_Actualizacion">
		<td><span id="elh_piso_tecnologico_Ultima_Actualizacion"><?php echo $piso_tecnologico->Ultima_Actualizacion->FldCaption() ?></span></td>
		<td data-name="Ultima_Actualizacion"<?php echo $piso_tecnologico->Ultima_Actualizacion->CellAttributes() ?>>
<span id="el_piso_tecnologico_Ultima_Actualizacion" data-page="1">
<span<?php echo $piso_tecnologico->Ultima_Actualizacion->ViewAttributes() ?>>
<?php echo $piso_tecnologico->Ultima_Actualizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
