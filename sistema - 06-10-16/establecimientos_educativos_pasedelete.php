...
$establecimientos_educativos_pase_delete = NULL; // Initialize page object first

class cestablecimientos_educativos_pase_delete extends cestablecimientos_educativos_pase {
	...
	// Page object name
	var $PageObjName = 'establecimientos_educativos_pase_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("establecimientos_educativos_paselist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in establecimientos_educativos_pase class, establecimientos_educativos_paseinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("establecimientos_educativos_paselist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($establecimientos_educativos_pase_delete)) $establecimientos_educativos_pase_delete = new cestablecimientos_educativos_pase_delete();

// Page init
$establecimientos_educativos_pase_delete->Page_Init();

// Page main
$establecimientos_educativos_pase_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$establecimientos_educativos_pase_delete->Page_Render();
?>
...
var CurrentForm = festablecimientos_educativos_pasedelete = new ew_Form("festablecimientos_educativos_pasedelete", "delete");

// Form_CustomValidate event
festablecimientos_educativos_pasedelete.Form_CustomValidate = 
...
festablecimientos_educativos_pasedelete.ValidateRequired = true;
<?php } else { ?>
festablecimientos_educativos_pasedelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
festablecimientos_educativos_pasedelete.Lists["x_Id_Provincia"] = {"LinkField":"x_Id_Provincia","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":["x_Id_Departamento"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincias"};
festablecimientos_educativos_pasedelete.Lists["x_Id_Departamento"] = {"LinkField":"x_Id_Departamento","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":["x_Id_Localidad"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
festablecimientos_educativos_pasedelete.Lists["x_Id_Localidad"] = {"LinkField":"x_Id_Localidad","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"localidades"};
...
<?php $establecimientos_educativos_pase_delete->ShowPageHeader(); ?>
<?php
$establecimientos_educativos_pase_delete->ShowMessage();
?>
<form name="festablecimientos_educativos_pasedelete" id="festablecimientos_educativos_pasedelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($establecimientos_educativos_pase_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $establecimientos_educativos_pase_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="establecimientos_educativos_pase">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($establecimientos_educativos_pase_delete->RecKeys as $key) { ?>
...
<?php if ($establecimientos_educativos_pase->Cue_Establecimiento->Visible) { // Cue_Establecimiento ?>
		<th><span id="elh_establecimientos_educativos_pase_Cue_Establecimiento" class="establecimientos_educativos_pase_Cue_Establecimiento"><?php echo $establecimientos_educativos_pase->Cue_Establecimiento->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nombre_Establecimiento->Visible) { // Nombre_Establecimiento ?>
		<th><span id="elh_establecimientos_educativos_pase_Nombre_Establecimiento" class="establecimientos_educativos_pase_Nombre_Establecimiento"><?php echo $establecimientos_educativos_pase->Nombre_Establecimiento->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nombre_Director->Visible) { // Nombre_Director ?>
		<th><span id="elh_establecimientos_educativos_pase_Nombre_Director" class="establecimientos_educativos_pase_Nombre_Director"><?php echo $establecimientos_educativos_pase->Nombre_Director->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Cuil_Director->Visible) { // Cuil_Director ?>
		<th><span id="elh_establecimientos_educativos_pase_Cuil_Director" class="establecimientos_educativos_pase_Cuil_Director"><?php echo $establecimientos_educativos_pase->Cuil_Director->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nombre_Rte->Visible) { // Nombre_Rte ?>
		<th><span id="elh_establecimientos_educativos_pase_Nombre_Rte" class="establecimientos_educativos_pase_Nombre_Rte"><?php echo $establecimientos_educativos_pase->Nombre_Rte->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Contacto_Rte->Visible) { // Contacto_Rte ?>
		<th><span id="elh_establecimientos_educativos_pase_Contacto_Rte" class="establecimientos_educativos_pase_Contacto_Rte"><?php echo $establecimientos_educativos_pase->Contacto_Rte->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nro_Serie_Server_Escolar->Visible) { // Nro_Serie_Server_Escolar ?>
		<th><span id="elh_establecimientos_educativos_pase_Nro_Serie_Server_Escolar" class="establecimientos_educativos_pase_Nro_Serie_Server_Escolar"><?php echo $establecimientos_educativos_pase->Nro_Serie_Server_Escolar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Contacto_Establecimiento->Visible) { // Contacto_Establecimiento ?>
		<th><span id="elh_establecimientos_educativos_pase_Contacto_Establecimiento" class="establecimientos_educativos_pase_Contacto_Establecimiento"><?php echo $establecimientos_educativos_pase->Contacto_Establecimiento->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Id_Provincia->Visible) { // Id_Provincia ?>
		<th><span id="elh_establecimientos_educativos_pase_Id_Provincia" class="establecimientos_educativos_pase_Id_Provincia"><?php echo $establecimientos_educativos_pase->Id_Provincia->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Id_Departamento->Visible) { // Id_Departamento ?>
		<th><span id="elh_establecimientos_educativos_pase_Id_Departamento" class="establecimientos_educativos_pase_Id_Departamento"><?php echo $establecimientos_educativos_pase->Id_Departamento->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Id_Localidad->Visible) { // Id_Localidad ?>
		<th><span id="elh_establecimientos_educativos_pase_Id_Localidad" class="establecimientos_educativos_pase_Id_Localidad"><?php echo $establecimientos_educativos_pase->Id_Localidad->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<th><span id="elh_establecimientos_educativos_pase_Fecha_Actualizacion" class="establecimientos_educativos_pase_Fecha_Actualizacion"><?php echo $establecimientos_educativos_pase->Fecha_Actualizacion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Usuario->Visible) { // Usuario ?>
		<th><span id="elh_establecimientos_educativos_pase_Usuario" class="establecimientos_educativos_pase_Usuario"><?php echo $establecimientos_educativos_pase->Usuario->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$establecimientos_educativos_pase_delete->RecCnt = 0;
$i = 0;
while (!$establecimientos_educativos_pase_delete->Recordset->EOF) {
	$establecimientos_educativos_pase_delete->RecCnt++;
	$establecimientos_educativos_pase_delete->RowCnt++;

	// Set row properties
	$establecimientos_educativos_pase->ResetAttrs();
	$establecimientos_educativos_pase->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$establecimientos_educativos_pase_delete->LoadRowValues($establecimientos_educativos_pase_delete->Recordset);

	// Render row
	$establecimientos_educativos_pase_delete->RenderRow();
?>
	<tr<?php echo $establecimientos_educativos_pase->RowAttributes() ?>>
<?php if ($establecimientos_educativos_pase->Cue_Establecimiento->Visible) { // Cue_Establecimiento ?>
		<td<?php echo $establecimientos_educativos_pase->Cue_Establecimiento->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Cue_Establecimiento" class="establecimientos_educativos_pase_Cue_Establecimiento">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nombre_Establecimiento->Visible) { // Nombre_Establecimiento ?>
		<td<?php echo $establecimientos_educativos_pase->Nombre_Establecimiento->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Nombre_Establecimiento" class="establecimientos_educativos_pase_Nombre_Establecimiento">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nombre_Director->Visible) { // Nombre_Director ?>
		<td<?php echo $establecimientos_educativos_pase->Nombre_Director->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Nombre_Director" class="establecimientos_educativos_pase_Nombre_Director">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Cuil_Director->Visible) { // Cuil_Director ?>
		<td<?php echo $establecimientos_educativos_pase->Cuil_Director->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Cuil_Director" class="establecimientos_educativos_pase_Cuil_Director">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nombre_Rte->Visible) { // Nombre_Rte ?>
		<td<?php echo $establecimientos_educativos_pase->Nombre_Rte->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Nombre_Rte" class="establecimientos_educativos_pase_Nombre_Rte">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Contacto_Rte->Visible) { // Contacto_Rte ?>
		<td<?php echo $establecimientos_educativos_pase->Contacto_Rte->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Contacto_Rte" class="establecimientos_educativos_pase_Contacto_Rte">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nro_Serie_Server_Escolar->Visible) { // Nro_Serie_Server_Escolar ?>
		<td<?php echo $establecimientos_educativos_pase->Nro_Serie_Server_Escolar->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Nro_Serie_Server_Escolar" class="establecimientos_educativos_pase_Nro_Serie_Server_Escolar">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Contacto_Establecimiento->Visible) { // Contacto_Establecimiento ?>
		<td<?php echo $establecimientos_educativos_pase->Contacto_Establecimiento->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Contacto_Establecimiento" class="establecimientos_educativos_pase_Contacto_Establecimiento">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Id_Provincia->Visible) { // Id_Provincia ?>
		<td<?php echo $establecimientos_educativos_pase->Id_Provincia->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Id_Provincia" class="establecimientos_educativos_pase_Id_Provincia">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Id_Departamento->Visible) { // Id_Departamento ?>
		<td<?php echo $establecimientos_educativos_pase->Id_Departamento->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Id_Departamento" class="establecimientos_educativos_pase_Id_Departamento">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Id_Localidad->Visible) { // Id_Localidad ?>
		<td<?php echo $establecimientos_educativos_pase->Id_Localidad->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Id_Localidad" class="establecimientos_educativos_pase_Id_Localidad">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<td<?php echo $establecimientos_educativos_pase->Fecha_Actualizacion->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Fecha_Actualizacion" class="establecimientos_educativos_pase_Fecha_Actualizacion">
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Usuario->Visible) { // Usuario ?>
		<td<?php echo $establecimientos_educativos_pase->Usuario->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Usuario" class="establecimientos_educativos_pase_Usuario">
...
<?php
	$establecimientos_educativos_pase_delete->Recordset->MoveNext();
}
$establecimientos_educativos_pase_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $establecimientos_educativos_pase_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
festablecimientos_educativos_pasedelete.Init();
</script>
<?php
$establecimientos_educativos_pase_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$establecimientos_educativos_pase_delete->Page_Terminate();
?>
