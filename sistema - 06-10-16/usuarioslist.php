...
class cusuarios_list extends cusuarios {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->User->setFormValue($arrKeyFlds[0]);
		}
		return TRUE;
	}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->User->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'>";
	...
	function LoadOldRecord() {
		...
		$bValidKey = TRUE;
		if (strval($this->getKey("User")) <> "")
			$this->User->CurrentValue = $this->getKey("User"); // User
		else
			$bValidKey = FALSE;
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.fusuarioslist,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.fusuarioslist,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.fusuarioslist,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = TRUE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.fusuarioslist,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = FALSE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.fusuarioslist,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = TRUE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.fusuarioslist,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = TRUE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.fusuarioslist,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;
...
fusuarioslist.Lists["x_Id_Grupo"] = {"LinkField":"x_Id_Grupo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"grupo_user"};
...
<?php if ($usuarios->User->Visible) { // User ?>
	<?php if ($usuarios->SortUrl($usuarios->User) == "") { ?>
		<th data-name="User"><div id="elh_usuarios_User" class="usuarios_User"><div class="ewTableHeaderCaption"><?php echo $usuarios->User->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="User"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->User) ?>',1);"><div id="elh_usuarios_User" class="usuarios_User">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->User->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->User->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->User->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->Pass->Visible) { // Pass ?>
	<?php if ($usuarios->SortUrl($usuarios->Pass) == "") { ?>
		<th data-name="Pass"><div id="elh_usuarios_Pass" class="usuarios_Pass"><div class="ewTableHeaderCaption"><?php echo $usuarios->Pass->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Pass"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->Pass) ?>',1);"><div id="elh_usuarios_Pass" class="usuarios_Pass">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->Pass->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->Pass->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->Pass->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->Id_Grupo->Visible) { // Id_Grupo ?>
	<?php if ($usuarios->SortUrl($usuarios->Id_Grupo) == "") { ?>
		<th data-name="Id_Grupo"><div id="elh_usuarios_Id_Grupo" class="usuarios_Id_Grupo"><div class="ewTableHeaderCaption"><?php echo $usuarios->Id_Grupo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Id_Grupo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->Id_Grupo) ?>',1);"><div id="elh_usuarios_Id_Grupo" class="usuarios_Id_Grupo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->Id_Grupo->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->Id_Grupo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->Id_Grupo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($usuarios->User->Visible) { // User ?>
		<td data-name="User"<?php echo $usuarios->User->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_User" class="usuarios_User">
<span<?php echo $usuarios->User->ViewAttributes() ?>>
<?php echo $usuarios->User->ListViewValue() ?></span>
</span>
<a id="<?php echo $usuarios_list->PageObjName . "_row_" . $usuarios_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($usuarios->Pass->Visible) { // Pass ?>
		<td data-name="Pass"<?php echo $usuarios->Pass->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_Pass" class="usuarios_Pass">
<span<?php echo $usuarios->Pass->ViewAttributes() ?>>
<?php echo $usuarios->Pass->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($usuarios->Id_Grupo->Visible) { // Id_Grupo ?>
		<td data-name="Id_Grupo"<?php echo $usuarios->Id_Grupo->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_Id_Grupo" class="usuarios_Id_Grupo">
<span<?php echo $usuarios->Id_Grupo->ViewAttributes() ?>>
<?php echo $usuarios->Id_Grupo->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
