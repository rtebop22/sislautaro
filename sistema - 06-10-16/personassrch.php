...
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_NroSerie"><?php echo (strval($personas->NroSerie->AdvancedSearch->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $personas->NroSerie->AdvancedSearch->ViewValue); ?></span>
</span>
...
<input type="hidden" data-table="personas" data-field="x_NroSerie" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $personas->NroSerie->DisplayValueSeparatorAttribute() ?>" name="x_NroSerie" id="x_NroSerie" value="<?php echo $personas->NroSerie->AdvancedSearch->SearchValue ?>"<?php echo $personas->NroSerie->EditAttributes() ?>>
