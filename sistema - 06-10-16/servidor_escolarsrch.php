...
<input type="text" data-table="servidor_escolar" data-field="x_Fecha_Actualizacion" name="x_Fecha_Actualizacion" id="x_Fecha_Actualizacion" size="30" placeholder="<?php echo ew_HtmlEncode($servidor_escolar->Fecha_Actualizacion->getPlaceHolder()) ?>" value="<?php echo $servidor_escolar->Fecha_Actualizacion->EditValue ?>"<?php echo $servidor_escolar->Fecha_Actualizacion->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
