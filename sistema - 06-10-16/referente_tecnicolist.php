...
class creferente_tecnico_list extends creferente_tecnico {
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_DniRte") && $objForm->HasValue("o_DniRte") && $this->DniRte->CurrentValue <> $this->DniRte->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Apelldio_Nombre") && $objForm->HasValue("o_Apelldio_Nombre") && $this->Apelldio_Nombre->CurrentValue <> $this->Apelldio_Nombre->OldValue)
			return FALSE;
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->Apelldio_Nombre->AdvancedSearch->ToJSON(), ","); // Field Apelldio_Nombre
	...
	function RestoreFilterList() {
		...
		// Field Apelldio_Nombre
		$this->Apelldio_Nombre->AdvancedSearch->SearchValue = @$filter["x_Apelldio_Nombre"];
		$this->Apelldio_Nombre->AdvancedSearch->SearchOperator = @$filter["z_Apelldio_Nombre"];
		$this->Apelldio_Nombre->AdvancedSearch->SearchCondition = @$filter["v_Apelldio_Nombre"];
		$this->Apelldio_Nombre->AdvancedSearch->SearchValue2 = @$filter["y_Apelldio_Nombre"];
		$this->Apelldio_Nombre->AdvancedSearch->SearchOperator2 = @$filter["w_Apelldio_Nombre"];
		$this->Apelldio_Nombre->AdvancedSearch->Save();
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->Apelldio_Nombre, $Default, FALSE); // Apelldio_Nombre
		...
		if (!$Default && $this->Command == "search") {
			...
			$this->Apelldio_Nombre->AdvancedSearch->Save(); // Apelldio_Nombre
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->Apelldio_Nombre, $arKeywords, $type);
	...
	function CheckSearchParms() {
		...
		if ($this->DniRte->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Apelldio_Nombre->AdvancedSearch->IssetSession())
			return TRUE;
	...
	function ResetAdvancedSearchParms() {
		...
		$this->Apelldio_Nombre->AdvancedSearch->UnsetSession();
	...
	function RestoreSearchParms() {
		...
		$this->Apelldio_Nombre->AdvancedSearch->Load();
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->Apelldio_Nombre); // Apelldio_Nombre
	...
	function RenderListOptions() {
		...
		if ($Security->IsLoggedIn()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewCopy\" title=\"" . $copycaption . "\" data-table=\"referente_tecnico\" data-caption=\"" . $copycaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->CopyUrl) . "',caption:'" . $copycaption . "'});\">" . $Language->Phrase("CopyLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
	...
	function SetupOtherOptions() {
		...
		if (ew_IsMobile())
			...
			$item->Body = "<a class=\"ewAddEdit ewAdd\" title=\"" . $addcaption . "\" data-table=\"referente_tecnico\" data-caption=\"" . $addcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->AddUrl) . "',caption:'" . $addcaption . "'});\">" . $Language->Phrase("AddLink") . "</a>";
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.freferente_tecnicolist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
	...
	function LoadSearchValues() {
		...
		// Apelldio_Nombre
		$this->Apelldio_Nombre->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_Apelldio_Nombre"]);
		if ($this->Apelldio_Nombre->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->Apelldio_Nombre->AdvancedSearch->SearchOperator = @$_GET["z_Apelldio_Nombre"];
	...
	function LoadFormValues() {
		...
		$this->Apelldio_Nombre->setOldValue($objForm->GetValue("o_Apelldio_Nombre"));
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->Apelldio_Nombre->SetDbValueDef($rsnew, $this->Apelldio_Nombre->CurrentValue, NULL, $this->Apelldio_Nombre->ReadOnly);
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.freferente_tecnicolist,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.freferente_tecnicolist,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.freferente_tecnicolist,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = TRUE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.freferente_tecnicolist,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = FALSE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.freferente_tecnicolist,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = TRUE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.freferente_tecnicolist,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = TRUE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.freferente_tecnicolist,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;
...
<?php if ($referente_tecnico_list->TotalRecs > 0) { ?>
...
<?php if ($referente_tecnico->Apelldio_Nombre->Visible) { // Apelldio_Nombre ?>
	...
	<?php } else { ?>
		<th data-name="Apelldio_Nombre"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $referente_tecnico->SortUrl($referente_tecnico->Apelldio_Nombre) ?>',1);"><div id="elh_referente_tecnico_Apelldio_Nombre" class="referente_tecnico_Apelldio_Nombre">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $referente_tecnico->Apelldio_Nombre->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($referente_tecnico->Apelldio_Nombre->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($referente_tecnico->Apelldio_Nombre->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($referente_tecnico->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $referente_tecnico_list->RowCnt ?>_referente_tecnico_Apelldio_Nombre" class="form-group referente_tecnico_Apelldio_Nombre">
<input type="text" data-table="referente_tecnico" data-field="x_Apelldio_Nombre" name="x<?php echo $referente_tecnico_list->RowIndex ?>_Apelldio_Nombre" id="x<?php echo $referente_tecnico_list->RowIndex ?>_Apelldio_Nombre" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($referente_tecnico->Apelldio_Nombre->getPlaceHolder()) ?>" value="<?php echo $referente_tecnico->Apelldio_Nombre->EditValue ?>"<?php echo $referente_tecnico->Apelldio_Nombre->EditAttributes() ?>>
</span>
<input type="hidden" data-table="referente_tecnico" data-field="x_Apelldio_Nombre" name="o<?php echo $referente_tecnico_list->RowIndex ?>_Apelldio_Nombre" id="o<?php echo $referente_tecnico_list->RowIndex ?>_Apelldio_Nombre" value="<?php echo ew_HtmlEncode($referente_tecnico->Apelldio_Nombre->OldValue) ?>">
<?php } ?>
<?php if ($referente_tecnico->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $referente_tecnico_list->RowCnt ?>_referente_tecnico_Apelldio_Nombre" class="form-group referente_tecnico_Apelldio_Nombre">
<input type="text" data-table="referente_tecnico" data-field="x_Apelldio_Nombre" name="x<?php echo $referente_tecnico_list->RowIndex ?>_Apelldio_Nombre" id="x<?php echo $referente_tecnico_list->RowIndex ?>_Apelldio_Nombre" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($referente_tecnico->Apelldio_Nombre->getPlaceHolder()) ?>" value="<?php echo $referente_tecnico->Apelldio_Nombre->EditValue ?>"<?php echo $referente_tecnico->Apelldio_Nombre->EditAttributes() ?>>
...
<?php } ?>
<?php if ($referente_tecnico->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $referente_tecnico_list->RowCnt ?>_referente_tecnico_Apelldio_Nombre" class="referente_tecnico_Apelldio_Nombre">
