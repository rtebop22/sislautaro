...
//
// Table class for modelo
//
class cmodelo extends cTable {
	var $Id_Modelo;
	var $Descripcion;
	var $Id_Marca;
	...
	function __construct() {
		...
		$this->TableVar = 'modelo';
		$this->TableName = 'modelo';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`modelo`";
		$this->DBID = 'DB';
		...
		// Id_Modelo
		$this->Id_Modelo = new cField('modelo', 'modelo', 'x_Id_Modelo', 'Id_Modelo', '`Id_Modelo`', '`Id_Modelo`', 3, -1, FALSE, '`Id_Modelo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Descripcion
		$this->Descripcion = new cField('modelo', 'modelo', 'x_Descripcion', 'Descripcion', '`Descripcion`', '`Descripcion`', 200, -1, FALSE, '`Descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Descripcion->Sortable = TRUE; // Allow sort
		$this->fields['Descripcion'] = &$this->Descripcion;

		// Id_Marca
		$this->Id_Marca = new cField('modelo', 'modelo', 'x_Id_Marca', 'Id_Marca', '`Id_Marca`', '`Id_Marca`', 3, -1, FALSE, '`Id_Marca`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`modelo`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("modeloview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("modeloview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "modeloadd.php?" . $this->UrlParm($parm);
		else
			$url = "modeloadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("modeloedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("modeloadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("modelodelete.php", $this->UrlParm());
	}
