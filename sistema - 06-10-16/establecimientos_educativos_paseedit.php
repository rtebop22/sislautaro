...
<input type="hidden" data-table="establecimientos_educativos_pase" data-field="x_Cue_Establecimiento" name="x_Cue_Establecimiento" id="x_Cue_Establecimiento" value="<?php echo ew_HtmlEncode($establecimientos_educativos_pase->Cue_Establecimiento->CurrentValue) ?>">
