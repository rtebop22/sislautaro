...
<?php if ($atencion_para_st->NroSerie->Visible) { // NroSerie ?>
	<div id="r_NroSerie" class="form-group">
		<label id="elh_atencion_para_st_NroSerie" for="x_NroSerie" class="col-sm-2 control-label ewLabel"><?php echo $atencion_para_st->NroSerie->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $atencion_para_st->NroSerie->CellAttributes() ?>>
...
<input type="hidden" id="x_NroSerie" name="x_NroSerie" value="<?php echo ew_HtmlEncode($atencion_para_st->NroSerie->CurrentValue) ?>">
<?php } else { ?>
<span id="el_atencion_para_st_NroSerie">
<input type="text" data-table="atencion_para_st" data-field="x_NroSerie" data-page="1" name="x_NroSerie" id="x_NroSerie" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($atencion_para_st->NroSerie->getPlaceHolder()) ?>" value="<?php echo $atencion_para_st->NroSerie->EditValue ?>"<?php echo $atencion_para_st->NroSerie->EditAttributes() ?>>
</span>
<?php } ?>
<?php echo $atencion_para_st->NroSerie->CustomMsg ?></div></div>
	</div>
<?php } ?>
