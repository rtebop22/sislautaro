...
$servidor_escolar_grid = NULL; // Initialize page object first

class cservidor_escolar_grid extends cservidor_escolar {
	...
	// Page object name
	var $PageObjName = 'servidor_escolar_grid';

	// Grid form hidden field names
	var $FormName = 'fservidor_escolargrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["servidor_escolar"];
