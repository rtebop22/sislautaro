...
<?php if ($detalle_atencion->NroSerie->Visible) { // NroSerie ?>
		<th><span id="elh_detalle_atencion_NroSerie" class="detalle_atencion_NroSerie"><?php echo $detalle_atencion->NroSerie->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($detalle_atencion->NroSerie->Visible) { // NroSerie ?>
		<td<?php echo $detalle_atencion->NroSerie->CellAttributes() ?>>
<span id="el<?php echo $detalle_atencion_delete->RowCnt ?>_detalle_atencion_NroSerie" class="detalle_atencion_NroSerie">
