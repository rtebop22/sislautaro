...
$autoridad_firma_actas = NULL;

//
// Table class for autoridad_firma_actas
//
class cautoridad_firma_actas extends cTable {
	var $Id_Autoridad;
	var $Nombre;
	...
	function __construct() {
		...
		$this->TableVar = 'autoridad_firma_actas';
		$this->TableName = 'autoridad_firma_actas';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`autoridad_firma_actas`";
		$this->DBID = 'DB';
		...
		// Id_Autoridad
		$this->Id_Autoridad = new cField('autoridad_firma_actas', 'autoridad_firma_actas', 'x_Id_Autoridad', 'Id_Autoridad', '`Id_Autoridad`', '`Id_Autoridad`', 3, -1, FALSE, '`Id_Autoridad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Nombre
		$this->Nombre = new cField('autoridad_firma_actas', 'autoridad_firma_actas', 'x_Nombre', 'Nombre', '`Nombre`', '`Nombre`', 200, -1, FALSE, '`Nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`autoridad_firma_actas`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "autoridad_firma_actaslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("autoridad_firma_actasview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("autoridad_firma_actasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "autoridad_firma_actasadd.php?" . $this->UrlParm($parm);
		else
			$url = "autoridad_firma_actasadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("autoridad_firma_actasedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("autoridad_firma_actasadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("autoridad_firma_actasdelete.php", $this->UrlParm());
	}
