...
if ($referente_tecnico->CurrentAction == "gridadd") {
	...
	if ($referente_tecnico->CurrentAction == "" && $referente_tecnico_grid->TotalRecs == 0) {
		if (!$Security->CanList())
			$referente_tecnico_grid->setWarningMessage(ew_DeniedMsg());
...
<?php if ($referente_tecnico->Apellido_Nombre->Visible) { // Apellido_Nombre ?>
	...
	<?php } else { ?>
		<th data-name="Apellido_Nombre"><div><div id="elh_referente_tecnico_Apellido_Nombre" class="referente_tecnico_Apellido_Nombre">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $referente_tecnico->Apellido_Nombre->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($referente_tecnico->Apellido_Nombre->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($referente_tecnico->Apellido_Nombre->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($referente_tecnico->Fecha_Ingreso->Visible) { // Fecha_Ingreso ?>
	...
	<?php } else { ?>
		<th data-name="Fecha_Ingreso"><div><div id="elh_referente_tecnico_Fecha_Ingreso" class="referente_tecnico_Fecha_Ingreso">
...
<?php if ($referente_tecnico->Titulo->Visible) { // Titulo ?>
	...
	<?php } else { ?>
		<th data-name="Titulo"><div><div id="elh_referente_tecnico_Titulo" class="referente_tecnico_Titulo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $referente_tecnico->Titulo->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($referente_tecnico->Titulo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($referente_tecnico->Titulo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<span id="el<?php echo $referente_tecnico_grid->RowCnt ?>_referente_tecnico_Apellido_Nombre" class="form-group referente_tecnico_Apellido_Nombre">
<input type="text" data-table="referente_tecnico" data-field="x_Apellido_Nombre" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($referente_tecnico->Apellido_Nombre->getPlaceHolder()) ?>" value="<?php echo $referente_tecnico->Apellido_Nombre->EditValue ?>"<?php echo $referente_tecnico->Apellido_Nombre->EditAttributes() ?>>
</span>
<input type="hidden" data-table="referente_tecnico" data-field="x_Apellido_Nombre" name="o<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" id="o<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" value="<?php echo ew_HtmlEncode($referente_tecnico->Apellido_Nombre->OldValue) ?>">
<?php } ?>
...
<span id="el<?php echo $referente_tecnico_grid->RowCnt ?>_referente_tecnico_Apellido_Nombre" class="referente_tecnico_Apellido_Nombre">
...
<input type="hidden" data-table="referente_tecnico" data-field="x_Apellido_Nombre" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" value="<?php echo ew_HtmlEncode($referente_tecnico->Apellido_Nombre->FormValue) ?>">
<input type="hidden" data-table="referente_tecnico" data-field="x_Apellido_Nombre" name="o<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" id="o<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" value="<?php echo ew_HtmlEncode($referente_tecnico->Apellido_Nombre->OldValue) ?>">
<?php } ?>
...
<?php if ($referente_tecnico->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $referente_tecnico_grid->RowCnt ?>_referente_tecnico_Fecha_Ingreso" class="form-group referente_tecnico_Fecha_Ingreso">
<input type="text" data-table="referente_tecnico" data-field="x_Fecha_Ingreso" data-format="2" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" placeholder="<?php echo ew_HtmlEncode($referente_tecnico->Fecha_Ingreso->getPlaceHolder()) ?>" value="<?php echo $referente_tecnico->Fecha_Ingreso->EditValue ?>"<?php echo $referente_tecnico->Fecha_Ingreso->EditAttributes() ?>>
...
<script type="text/javascript">
ew_CreateCalendar("freferente_tecnicogrid", "x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso", 2);
</script>
<?php } ?>
</span>
<input type="hidden" data-table="referente_tecnico" data-field="x_Fecha_Ingreso" name="o<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" id="o<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" value="<?php echo ew_HtmlEncode($referente_tecnico->Fecha_Ingreso->OldValue) ?>">
<?php } ?>
<?php if ($referente_tecnico->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $referente_tecnico_grid->RowCnt ?>_referente_tecnico_Fecha_Ingreso" class="form-group referente_tecnico_Fecha_Ingreso">
<input type="text" data-table="referente_tecnico" data-field="x_Fecha_Ingreso" data-format="2" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" placeholder="<?php echo ew_HtmlEncode($referente_tecnico->Fecha_Ingreso->getPlaceHolder()) ?>" value="<?php echo $referente_tecnico->Fecha_Ingreso->EditValue ?>"<?php echo $referente_tecnico->Fecha_Ingreso->EditAttributes() ?>>
...
<?php } ?>
<?php if ($referente_tecnico->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $referente_tecnico_grid->RowCnt ?>_referente_tecnico_Fecha_Ingreso" class="referente_tecnico_Fecha_Ingreso">
<span<?php echo $referente_tecnico->Fecha_Ingreso->ViewAttributes() ?>>
<?php echo $referente_tecnico->Fecha_Ingreso->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="referente_tecnico" data-field="x_Fecha_Ingreso" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" value="<?php echo ew_HtmlEncode($referente_tecnico->Fecha_Ingreso->FormValue) ?>">
<input type="hidden" data-table="referente_tecnico" data-field="x_Fecha_Ingreso" name="o<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" id="o<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" value="<?php echo ew_HtmlEncode($referente_tecnico->Fecha_Ingreso->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($referente_tecnico->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $referente_tecnico_grid->RowCnt ?>_referente_tecnico_Titulo" class="form-group referente_tecnico_Titulo">
<input type="text" data-table="referente_tecnico" data-field="x_Titulo" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($referente_tecnico->Titulo->getPlaceHolder()) ?>" value="<?php echo $referente_tecnico->Titulo->EditValue ?>"<?php echo $referente_tecnico->Titulo->EditAttributes() ?>>
</span>
<input type="hidden" data-table="referente_tecnico" data-field="x_Titulo" name="o<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" id="o<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" value="<?php echo ew_HtmlEncode($referente_tecnico->Titulo->OldValue) ?>">
<?php } ?>
<?php if ($referente_tecnico->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $referente_tecnico_grid->RowCnt ?>_referente_tecnico_Titulo" class="form-group referente_tecnico_Titulo">
<input type="text" data-table="referente_tecnico" data-field="x_Titulo" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($referente_tecnico->Titulo->getPlaceHolder()) ?>" value="<?php echo $referente_tecnico->Titulo->EditValue ?>"<?php echo $referente_tecnico->Titulo->EditAttributes() ?>>
...
<?php } ?>
<?php if ($referente_tecnico->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $referente_tecnico_grid->RowCnt ?>_referente_tecnico_Titulo" class="referente_tecnico_Titulo">
<span<?php echo $referente_tecnico->Titulo->ViewAttributes() ?>>
<?php echo $referente_tecnico->Titulo->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="referente_tecnico" data-field="x_Titulo" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" value="<?php echo ew_HtmlEncode($referente_tecnico->Titulo->FormValue) ?>">
<input type="hidden" data-table="referente_tecnico" data-field="x_Titulo" name="o<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" id="o<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" value="<?php echo ew_HtmlEncode($referente_tecnico->Titulo->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<span id="el$rowindex$_referente_tecnico_Apellido_Nombre" class="form-group referente_tecnico_Apellido_Nombre">
<span<?php echo $referente_tecnico->Apellido_Nombre->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $referente_tecnico->Apellido_Nombre->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="referente_tecnico" data-field="x_Apellido_Nombre" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" value="<?php echo ew_HtmlEncode($referente_tecnico->Apellido_Nombre->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="referente_tecnico" data-field="x_Apellido_Nombre" name="o<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" id="o<?php echo $referente_tecnico_grid->RowIndex ?>_Apellido_Nombre" value="<?php echo ew_HtmlEncode($referente_tecnico->Apellido_Nombre->OldValue) ?>">
...
<span id="el$rowindex$_referente_tecnico_Fecha_Ingreso" class="form-group referente_tecnico_Fecha_Ingreso">
<span<?php echo $referente_tecnico->Fecha_Ingreso->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $referente_tecnico->Fecha_Ingreso->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="referente_tecnico" data-field="x_Fecha_Ingreso" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" value="<?php echo ew_HtmlEncode($referente_tecnico->Fecha_Ingreso->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="referente_tecnico" data-field="x_Fecha_Ingreso" name="o<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" id="o<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Ingreso" value="<?php echo ew_HtmlEncode($referente_tecnico->Fecha_Ingreso->OldValue) ?>">
...
<span id="el$rowindex$_referente_tecnico_Titulo" class="form-group referente_tecnico_Titulo">
<span<?php echo $referente_tecnico->Titulo->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $referente_tecnico->Titulo->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="referente_tecnico" data-field="x_Titulo" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" value="<?php echo ew_HtmlEncode($referente_tecnico->Titulo->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="referente_tecnico" data-field="x_Titulo" name="o<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" id="o<?php echo $referente_tecnico_grid->RowIndex ?>_Titulo" value="<?php echo ew_HtmlEncode($referente_tecnico->Titulo->OldValue) ?>">
...
<?php if ($referente_tecnico->CurrentAction <> "F") { ?>
<?php } else { ?>
<span id="el$rowindex$_referente_tecnico_Fecha_Actualizacion" class="form-group referente_tecnico_Fecha_Actualizacion">
<span<?php echo $referente_tecnico->Fecha_Actualizacion->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $referente_tecnico->Fecha_Actualizacion->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="referente_tecnico" data-field="x_Fecha_Actualizacion" name="x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Actualizacion" id="x<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Actualizacion" value="<?php echo ew_HtmlEncode($referente_tecnico->Fecha_Actualizacion->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="referente_tecnico" data-field="x_Fecha_Actualizacion" name="o<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Actualizacion" id="o<?php echo $referente_tecnico_grid->RowIndex ?>_Fecha_Actualizacion" value="<?php echo ew_HtmlEncode($referente_tecnico->Fecha_Actualizacion->OldValue) ?>">
