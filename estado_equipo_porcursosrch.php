...
$estado_equipo_porcurso_search = NULL; // Initialize page object first

class cestado_equipo_porcurso_search extends cestado_equipo_porcurso {
	...
	// Page object name
	var $PageObjName = 'estado_equipo_porcurso_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "estado_equipo_porcursolist.php" . "?" . $sSrchStr;
...
// Create page object
if (!isset($estado_equipo_porcurso_search)) $estado_equipo_porcurso_search = new cestado_equipo_porcurso_search();

// Page init
$estado_equipo_porcurso_search->Page_Init();

// Page main
$estado_equipo_porcurso_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$estado_equipo_porcurso_search->Page_Render();
?>
...
<?php if ($estado_equipo_porcurso_search->IsModal) { ?>
var CurrentAdvancedSearchForm = festado_equipo_porcursosearch = new ew_Form("festado_equipo_porcursosearch", "search");
<?php } else { ?>
var CurrentForm = festado_equipo_porcursosearch = new ew_Form("festado_equipo_porcursosearch", "search");
<?php } ?>

// Form_CustomValidate event
festado_equipo_porcursosearch.Form_CustomValidate = 
...
festado_equipo_porcursosearch.ValidateRequired = true;
<?php } else { ?>
festado_equipo_porcursosearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
festado_equipo_porcursosearch.Lists["x_Id_Curso"] = {"LinkField":"x_Id_Curso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cursos"};
festado_equipo_porcursosearch.Lists["x_Id_Division"] = {"LinkField":"x_Id_Division","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"division"};
festado_equipo_porcursosearch.Lists["x_Id_Turno"] = {"LinkField":"x_Id_Turno","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"turno"};
festado_equipo_porcursosearch.Lists["x_Id_Cargo"] = {"LinkField":"x_Id_Cargo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cargo_persona"};
festado_equipo_porcursosearch.Lists["x_Id_Estado"] = {"LinkField":"x_Id_Estado","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_persona"};
festado_equipo_porcursosearch.Lists["x_Id_Sit_Estado"] = {"LinkField":"x_Id_Sit_Estado","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"situacion_estado"};

// Form object for search
// Validate function for search

festado_equipo_porcursosearch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($estado_equipo_porcurso->Dni->FldErrMsg()) ?>");
...
<?php } ?>
<?php $estado_equipo_porcurso_search->ShowPageHeader(); ?>
<?php
$estado_equipo_porcurso_search->ShowMessage();
?>
<form name="festado_equipo_porcursosearch" id="festado_equipo_porcursosearch" class="<?php echo $estado_equipo_porcurso_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($estado_equipo_porcurso_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $estado_equipo_porcurso_search->Token ?>">
<?php } ?>
...
<?php if ($estado_equipo_porcurso->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
	<div id="r_Apellidos_Nombres" class="form-group">
		<label for="x_Apellidos_Nombres" class="<?php echo $estado_equipo_porcurso_search->SearchLabelClass ?>"><span id="elh_estado_equipo_porcurso_Apellidos_Nombres"><?php echo $estado_equipo_porcurso->Apellidos_Nombres->FldCaption() ?></span>	
		...
		<div class="<?php echo $estado_equipo_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $estado_equipo_porcurso->Apellidos_Nombres->CellAttributes() ?>>
			<span id="el_estado_equipo_porcurso_Apellidos_Nombres">
<input type="text" data-table="estado_equipo_porcurso" data-field="x_Apellidos_Nombres" name="x_Apellidos_Nombres" id="x_Apellidos_Nombres" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($estado_equipo_porcurso->Apellidos_Nombres->getPlaceHolder()) ?>" value="<?php echo $estado_equipo_porcurso->Apellidos_Nombres->EditValue ?>"<?php echo $estado_equipo_porcurso->Apellidos_Nombres->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($estado_equipo_porcurso->Dni->Visible) { // Dni ?>
	<div id="r_Dni" class="form-group">
		<label for="x_Dni" class="<?php echo $estado_equipo_porcurso_search->SearchLabelClass ?>"><span id="elh_estado_equipo_porcurso_Dni"><?php echo $estado_equipo_porcurso->Dni->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_Dni" id="z_Dni" value="="></p>
		</label>
		<div class="<?php echo $estado_equipo_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $estado_equipo_porcurso->Dni->CellAttributes() ?>>
			<span id="el_estado_equipo_porcurso_Dni">
<input type="text" data-table="estado_equipo_porcurso" data-field="x_Dni" name="x_Dni" id="x_Dni" size="30" placeholder="<?php echo ew_HtmlEncode($estado_equipo_porcurso->Dni->getPlaceHolder()) ?>" value="<?php echo $estado_equipo_porcurso->Dni->EditValue ?>"<?php echo $estado_equipo_porcurso->Dni->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($estado_equipo_porcurso->Id_Curso->Visible) { // Id_Curso ?>
	<div id="r_Id_Curso" class="form-group">
		<label for="x_Id_Curso" class="<?php echo $estado_equipo_porcurso_search->SearchLabelClass ?>"><span id="elh_estado_equipo_porcurso_Id_Curso"><?php echo $estado_equipo_porcurso->Id_Curso->FldCaption() ?></span>	
		...
		<div class="<?php echo $estado_equipo_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $estado_equipo_porcurso->Id_Curso->CellAttributes() ?>>
			<span id="el_estado_equipo_porcurso_Id_Curso">
<select data-table="estado_equipo_porcurso" data-field="x_Id_Curso" data-value-separator="<?php echo $estado_equipo_porcurso->Id_Curso->DisplayValueSeparatorAttribute() ?>" id="x_Id_Curso" name="x_Id_Curso"<?php echo $estado_equipo_porcurso->Id_Curso->EditAttributes() ?>>
<?php echo $estado_equipo_porcurso->Id_Curso->SelectOptionListHtml("x_Id_Curso") ?>
</select>
<input type="hidden" name="s_x_Id_Curso" id="s_x_Id_Curso" value="<?php echo $estado_equipo_porcurso->Id_Curso->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($estado_equipo_porcurso->Id_Division->Visible) { // Id_Division ?>
	<div id="r_Id_Division" class="form-group">
		<label for="x_Id_Division" class="<?php echo $estado_equipo_porcurso_search->SearchLabelClass ?>"><span id="elh_estado_equipo_porcurso_Id_Division"><?php echo $estado_equipo_porcurso->Id_Division->FldCaption() ?></span>	
		...
		<div class="<?php echo $estado_equipo_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $estado_equipo_porcurso->Id_Division->CellAttributes() ?>>
			<span id="el_estado_equipo_porcurso_Id_Division">
<select data-table="estado_equipo_porcurso" data-field="x_Id_Division" data-value-separator="<?php echo $estado_equipo_porcurso->Id_Division->DisplayValueSeparatorAttribute() ?>" id="x_Id_Division" name="x_Id_Division"<?php echo $estado_equipo_porcurso->Id_Division->EditAttributes() ?>>
<?php echo $estado_equipo_porcurso->Id_Division->SelectOptionListHtml("x_Id_Division") ?>
</select>
<input type="hidden" name="s_x_Id_Division" id="s_x_Id_Division" value="<?php echo $estado_equipo_porcurso->Id_Division->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($estado_equipo_porcurso->Id_Turno->Visible) { // Id_Turno ?>
	<div id="r_Id_Turno" class="form-group">
		<label for="x_Id_Turno" class="<?php echo $estado_equipo_porcurso_search->SearchLabelClass ?>"><span id="elh_estado_equipo_porcurso_Id_Turno"><?php echo $estado_equipo_porcurso->Id_Turno->FldCaption() ?></span>	
		...
		<div class="<?php echo $estado_equipo_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $estado_equipo_porcurso->Id_Turno->CellAttributes() ?>>
			<span id="el_estado_equipo_porcurso_Id_Turno">
<select data-table="estado_equipo_porcurso" data-field="x_Id_Turno" data-value-separator="<?php echo $estado_equipo_porcurso->Id_Turno->DisplayValueSeparatorAttribute() ?>" id="x_Id_Turno" name="x_Id_Turno"<?php echo $estado_equipo_porcurso->Id_Turno->EditAttributes() ?>>
<?php echo $estado_equipo_porcurso->Id_Turno->SelectOptionListHtml("x_Id_Turno") ?>
</select>
<input type="hidden" name="s_x_Id_Turno" id="s_x_Id_Turno" value="<?php echo $estado_equipo_porcurso->Id_Turno->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($estado_equipo_porcurso->Id_Cargo->Visible) { // Id_Cargo ?>
	<div id="r_Id_Cargo" class="form-group">
		<label for="x_Id_Cargo" class="<?php echo $estado_equipo_porcurso_search->SearchLabelClass ?>"><span id="elh_estado_equipo_porcurso_Id_Cargo"><?php echo $estado_equipo_porcurso->Id_Cargo->FldCaption() ?></span>	
		...
		<div class="<?php echo $estado_equipo_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $estado_equipo_porcurso->Id_Cargo->CellAttributes() ?>>
			<span id="el_estado_equipo_porcurso_Id_Cargo">
<select data-table="estado_equipo_porcurso" data-field="x_Id_Cargo" data-value-separator="<?php echo $estado_equipo_porcurso->Id_Cargo->DisplayValueSeparatorAttribute() ?>" id="x_Id_Cargo" name="x_Id_Cargo"<?php echo $estado_equipo_porcurso->Id_Cargo->EditAttributes() ?>>
<?php echo $estado_equipo_porcurso->Id_Cargo->SelectOptionListHtml("x_Id_Cargo") ?>
</select>
<input type="hidden" name="s_x_Id_Cargo" id="s_x_Id_Cargo" value="<?php echo $estado_equipo_porcurso->Id_Cargo->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($estado_equipo_porcurso->Id_Estado->Visible) { // Id_Estado ?>
	<div id="r_Id_Estado" class="form-group">
		<label for="x_Id_Estado" class="<?php echo $estado_equipo_porcurso_search->SearchLabelClass ?>"><span id="elh_estado_equipo_porcurso_Id_Estado"><?php echo $estado_equipo_porcurso->Id_Estado->FldCaption() ?></span>	
		...
		<div class="<?php echo $estado_equipo_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $estado_equipo_porcurso->Id_Estado->CellAttributes() ?>>
			<span id="el_estado_equipo_porcurso_Id_Estado">
<select data-table="estado_equipo_porcurso" data-field="x_Id_Estado" data-value-separator="<?php echo $estado_equipo_porcurso->Id_Estado->DisplayValueSeparatorAttribute() ?>" id="x_Id_Estado" name="x_Id_Estado"<?php echo $estado_equipo_porcurso->Id_Estado->EditAttributes() ?>>
<?php echo $estado_equipo_porcurso->Id_Estado->SelectOptionListHtml("x_Id_Estado") ?>
</select>
<input type="hidden" name="s_x_Id_Estado" id="s_x_Id_Estado" value="<?php echo $estado_equipo_porcurso->Id_Estado->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($estado_equipo_porcurso->NroSerie->Visible) { // NroSerie ?>
	<div id="r_NroSerie" class="form-group">
		<label for="x_NroSerie" class="<?php echo $estado_equipo_porcurso_search->SearchLabelClass ?>"><span id="elh_estado_equipo_porcurso_NroSerie"><?php echo $estado_equipo_porcurso->NroSerie->FldCaption() ?></span>	
		...
		<div class="<?php echo $estado_equipo_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $estado_equipo_porcurso->NroSerie->CellAttributes() ?>>
			<span id="el_estado_equipo_porcurso_NroSerie">
<input type="text" data-table="estado_equipo_porcurso" data-field="x_NroSerie" name="x_NroSerie" id="x_NroSerie" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($estado_equipo_porcurso->NroSerie->getPlaceHolder()) ?>" value="<?php echo $estado_equipo_porcurso->NroSerie->EditValue ?>"<?php echo $estado_equipo_porcurso->NroSerie->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($estado_equipo_porcurso->Id_Sit_Estado->Visible) { // Id_Sit_Estado ?>
	<div id="r_Id_Sit_Estado" class="form-group">
		<label for="x_Id_Sit_Estado" class="<?php echo $estado_equipo_porcurso_search->SearchLabelClass ?>"><span id="elh_estado_equipo_porcurso_Id_Sit_Estado"><?php echo $estado_equipo_porcurso->Id_Sit_Estado->FldCaption() ?></span>	
		...
		<div class="<?php echo $estado_equipo_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $estado_equipo_porcurso->Id_Sit_Estado->CellAttributes() ?>>
			<span id="el_estado_equipo_porcurso_Id_Sit_Estado">
<select data-table="estado_equipo_porcurso" data-field="x_Id_Sit_Estado" data-value-separator="<?php echo $estado_equipo_porcurso->Id_Sit_Estado->DisplayValueSeparatorAttribute() ?>" id="x_Id_Sit_Estado" name="x_Id_Sit_Estado"<?php echo $estado_equipo_porcurso->Id_Sit_Estado->EditAttributes() ?>>
<?php echo $estado_equipo_porcurso->Id_Sit_Estado->SelectOptionListHtml("x_Id_Sit_Estado") ?>
</select>
<input type="hidden" name="s_x_Id_Sit_Estado" id="s_x_Id_Sit_Estado" value="<?php echo $estado_equipo_porcurso->Id_Sit_Estado->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($estado_equipo_porcurso->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<div id="r_Fecha_Actualizacion" class="form-group">
		<label class="<?php echo $estado_equipo_porcurso_search->SearchLabelClass ?>"><span id="elh_estado_equipo_porcurso_Fecha_Actualizacion"><?php echo $estado_equipo_porcurso->Fecha_Actualizacion->FldCaption() ?></span>	
		...
		<div class="<?php echo $estado_equipo_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $estado_equipo_porcurso->Fecha_Actualizacion->CellAttributes() ?>>
			<span id="el_estado_equipo_porcurso_Fecha_Actualizacion">
<input type="text" data-table="estado_equipo_porcurso" data-field="x_Fecha_Actualizacion" data-format="7" name="x_Fecha_Actualizacion" id="x_Fecha_Actualizacion" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($estado_equipo_porcurso->Fecha_Actualizacion->getPlaceHolder()) ?>" value="<?php echo $estado_equipo_porcurso->Fecha_Actualizacion->EditValue ?>"<?php echo $estado_equipo_porcurso->Fecha_Actualizacion->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
...
<script type="text/javascript">
festado_equipo_porcursosearch.Init();
</script>
<?php
$estado_equipo_porcurso_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$estado_equipo_porcurso_search->Page_Terminate();
?>
