...
// Multi-Page
festablecimientos_educativos_paseadd.MultiPage = new ew_MultiPage("festablecimientos_educativos_paseadd");
...
<div class="panel-group" id="establecimientos_educativos_pase_add">
	<div class="panel panel-default<?php echo $establecimientos_educativos_pase_add->MultiPages->PageStyle("1") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#establecimientos_educativos_pase_add" href="#tab_establecimientos_educativos_pase1"><?php echo $establecimientos_educativos_pase->PageCaption(1) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $establecimientos_educativos_pase_add->MultiPages->PageStyle("1") ?>" id="tab_establecimientos_educativos_pase1">
...
<input type="text" data-table="establecimientos_educativos_pase" data-field="x_Cue_Establecimiento" data-page="1" name="x_Cue_Establecimiento" id="x_Cue_Establecimiento" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($establecimientos_educativos_pase->Cue_Establecimiento->getPlaceHolder()) ?>" value="<?php echo $establecimientos_educativos_pase->Cue_Establecimiento->EditValue ?>"<?php echo $establecimientos_educativos_pase->Cue_Establecimiento->EditAttributes() ?>>
</span>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $establecimientos_educativos_pase_add->MultiPages->PageStyle("2") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#establecimientos_educativos_pase_add" href="#tab_establecimientos_educativos_pase2"><?php echo $establecimientos_educativos_pase->PageCaption(2) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $establecimientos_educativos_pase_add->MultiPages->PageStyle("2") ?>" id="tab_establecimientos_educativos_pase2">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $establecimientos_educativos_pase_add->MultiPages->PageStyle("3") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#establecimientos_educativos_pase_add" href="#tab_establecimientos_educativos_pase3"><?php echo $establecimientos_educativos_pase->PageCaption(3) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $establecimientos_educativos_pase_add->MultiPages->PageStyle("3") ?>" id="tab_establecimientos_educativos_pase3">
			<div class="panel-body">
<div>
