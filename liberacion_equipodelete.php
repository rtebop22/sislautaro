...
<?php if ($liberacion_equipo->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<th><span id="elh_liberacion_equipo_Fecha_Actualizacion" class="liberacion_equipo_Fecha_Actualizacion"><?php echo $liberacion_equipo->Fecha_Actualizacion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($liberacion_equipo->Usuario->Visible) { // Usuario ?>
		<th><span id="elh_liberacion_equipo_Usuario" class="liberacion_equipo_Usuario"><?php echo $liberacion_equipo->Usuario->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($liberacion_equipo->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<td<?php echo $liberacion_equipo->Fecha_Actualizacion->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_Fecha_Actualizacion" class="liberacion_equipo_Fecha_Actualizacion">
...
<?php } ?>
<?php if ($liberacion_equipo->Usuario->Visible) { // Usuario ?>
		<td<?php echo $liberacion_equipo->Usuario->CellAttributes() ?>>
<span id="el<?php echo $liberacion_equipo_delete->RowCnt ?>_liberacion_equipo_Usuario" class="liberacion_equipo_Usuario">
