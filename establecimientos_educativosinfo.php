...
$establecimientos_educativos = NULL;

//
// Table class for establecimientos_educativos
//
class cestablecimientos_educativos extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'establecimientos_educativos';
		$this->TableName = 'establecimientos_educativos';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`establecimientos_educativos`";
		$this->DBID = 'DB';
		...
		// Cue_Establecimiento
		$this->Cue_Establecimiento = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Cue_Establecimiento', 'Cue_Establecimiento', '`Cue_Establecimiento`', '`Cue_Establecimiento`', 200, -1, FALSE, '`Cue_Establecimiento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cue_Establecimiento->Sortable = TRUE; // Allow sort
		$this->fields['Cue_Establecimiento'] = &$this->Cue_Establecimiento;

		// Nombre_Establecimiento
		$this->Nombre_Establecimiento = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Nombre_Establecimiento', 'Nombre_Establecimiento', '`Nombre_Establecimiento`', '`Nombre_Establecimiento`', 200, -1, FALSE, '`Nombre_Establecimiento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombre_Establecimiento->Sortable = TRUE; // Allow sort
		$this->fields['Nombre_Establecimiento'] = &$this->Nombre_Establecimiento;

		// Nombre_Director
		$this->Nombre_Director = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Nombre_Director', 'Nombre_Director', '`Nombre_Director`', '`Nombre_Director`', 200, -1, FALSE, '`Nombre_Director`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombre_Director->Sortable = TRUE; // Allow sort
		$this->fields['Nombre_Director'] = &$this->Nombre_Director;

		// Cuil_Director
		$this->Cuil_Director = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Cuil_Director', 'Cuil_Director', '`Cuil_Director`', '`Cuil_Director`', 200, -1, FALSE, '`Cuil_Director`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cuil_Director->Sortable = TRUE; // Allow sort
		$this->fields['Cuil_Director'] = &$this->Cuil_Director;

		// Nombre_Rte
		$this->Nombre_Rte = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Nombre_Rte', 'Nombre_Rte', '`Nombre_Rte`', '`Nombre_Rte`', 200, -1, FALSE, '`Nombre_Rte`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombre_Rte->Sortable = TRUE; // Allow sort
		$this->fields['Nombre_Rte'] = &$this->Nombre_Rte;

		// Contacto_Rte
		$this->Contacto_Rte = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Contacto_Rte', 'Contacto_Rte', '`Contacto_Rte`', '`Contacto_Rte`', 200, -1, FALSE, '`Contacto_Rte`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Contacto_Rte->Sortable = TRUE; // Allow sort
		$this->fields['Contacto_Rte'] = &$this->Contacto_Rte;

		// Nro_Serie_Server_Escolar
		$this->Nro_Serie_Server_Escolar = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Nro_Serie_Server_Escolar', 'Nro_Serie_Server_Escolar', '`Nro_Serie_Server_Escolar`', '`Nro_Serie_Server_Escolar`', 200, -1, FALSE, '`Nro_Serie_Server_Escolar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->Contacto_Establecimiento = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Contacto_Establecimiento', 'Contacto_Establecimiento', '`Contacto_Establecimiento`', '`Contacto_Establecimiento`', 200, -1, FALSE, '`Contacto_Establecimiento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Contacto_Establecimiento->Sortable = TRUE; // Allow sort
		$this->fields['Contacto_Establecimiento'] = &$this->Contacto_Establecimiento;

		// Id_Provincia
		$this->Id_Provincia = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Id_Provincia', 'Id_Provincia', '`Id_Provincia`', '`Id_Provincia`', 3, -1, FALSE, '`Id_Provincia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Localidad
		$this->Id_Localidad = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Id_Localidad', 'Id_Localidad', '`Id_Localidad`', '`Id_Localidad`', 3, -1, FALSE, '`Id_Localidad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 0, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
		...
		// Usuario
		$this->Usuario = new cField('establecimientos_educativos', 'establecimientos_educativos', 'x_Usuario', 'Usuario', '`Usuario`', '`Usuario`', 200, -1, FALSE, '`Usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`establecimientos_educativos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "establecimientos_educativoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("establecimientos_educativosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("establecimientos_educativosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "establecimientos_educativosadd.php?" . $this->UrlParm($parm);
		else
			$url = "establecimientos_educativosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("establecimientos_educativosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("establecimientos_educativosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("establecimientos_educativosdelete.php", $this->UrlParm());
	}
	...
	function KeyToJson() {
		$json = "";
		$json .= "Cue_Establecimiento:" . ew_VarToJson($this->Cue_Establecimiento->CurrentValue, "string", "'");
		return "{" . $json . "}";
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Nombre_Director->EditValue = $this->Nombre_Director->CurrentValue;
		...
		$this->Cuil_Director->EditValue = $this->Cuil_Director->CurrentValue;
		...
		$this->Contacto_Rte->EditValue = $this->Contacto_Rte->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->Nombre_Director->Exportable) $Doc->ExportCaption($this->Nombre_Director);
					if ($this->Cuil_Director->Exportable) $Doc->ExportCaption($this->Cuil_Director);
					if ($this->Nombre_Rte->Exportable) $Doc->ExportCaption($this->Nombre_Rte);
					if ($this->Contacto_Rte->Exportable) $Doc->ExportCaption($this->Contacto_Rte);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->Nombre_Director->Exportable) $Doc->ExportField($this->Nombre_Director);
						if ($this->Cuil_Director->Exportable) $Doc->ExportField($this->Cuil_Director);
						if ($this->Nombre_Rte->Exportable) $Doc->ExportField($this->Nombre_Rte);
						if ($this->Contacto_Rte->Exportable) $Doc->ExportField($this->Contacto_Rte);
