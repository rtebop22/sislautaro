...
$novedades_view = NULL; // Initialize page object first

class cnovedades_view extends cnovedades {
	...
	// Page object name
	var $PageObjName = 'novedades_view';
	...
	function Page_Init() {
		...
		if (@$_GET["Id_Novedad"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["Id_Novedad"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["Id_Novedad"] <> "") {
				$this->Id_Novedad->setFormValue($_POST["Id_Novedad"]);
				$this->RecKey["Id_Novedad"] = $this->Id_Novedad->FormValue;
			} else {
				$sReturnUrl = "novedadeslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "novedadeslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "novedadeslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($novedades_view)) $novedades_view = new cnovedades_view();

// Page init
$novedades_view->Page_Init();

// Page main
$novedades_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$novedades_view->Page_Render();
?>
...
var CurrentForm = fnovedadesview = new ew_Form("fnovedadesview", "view");

// Form_CustomValidate event
fnovedadesview.Form_CustomValidate = 
...
fnovedadesview.ValidateRequired = true;
<?php } else { ?>
fnovedadesview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($novedades->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$novedades_view->IsModal) { ?>
<?php if ($novedades->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $novedades_view->ExportOptions->Render("body") ?>
<?php
	foreach ($novedades_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$novedades_view->IsModal) { ?>
<?php if ($novedades->Export == "") { ?>
...
<?php } ?>
<?php $novedades_view->ShowPageHeader(); ?>
<?php
$novedades_view->ShowMessage();
?>
<form name="fnovedadesview" id="fnovedadesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($novedades_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $novedades_view->Token ?>">
<?php } ?>
...
<?php if ($novedades->Id_Novedad->Visible) { // Id_Novedad ?>
	<tr id="r_Id_Novedad">
		<td><span id="elh_novedades_Id_Novedad"><?php echo $novedades->Id_Novedad->FldCaption() ?></span></td>
...
<?php echo $novedades->Id_Novedad->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($novedades->Detalle->Visible) { // Detalle ?>
	<tr id="r_Detalle">
		<td><span id="elh_novedades_Detalle"><?php echo $novedades->Detalle->FldCaption() ?></span></td>
...
<?php echo $novedades->Detalle->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($novedades->Archivos->Visible) { // Archivos ?>
	<tr id="r_Archivos">
		<td><span id="elh_novedades_Archivos"><?php echo $novedades->Archivos->FldCaption() ?></span></td>
		<td data-name="Archivos"<?php echo $novedades->Archivos->CellAttributes() ?>>
<span id="el_novedades_Archivos">
<span>
<?php echo ew_GetFileViewTag($novedades->Archivos, $novedades->Archivos->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($novedades->Links->Visible) { // Links ?>
	<tr id="r_Links">
		<td><span id="elh_novedades_Links"><?php echo $novedades->Links->FldCaption() ?></span></td>
...
<?php if ((!ew_EmptyStr($novedades->Links->ViewValue)) && $novedades->Links->LinkAttributes() <> "") { ?>
<a<?php echo $novedades->Links->LinkAttributes() ?>><?php echo $novedades->Links->ViewValue ?></a>
<?php } else { ?>
<?php echo $novedades->Links->ViewValue ?>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($novedades->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<tr id="r_Fecha_Actualizacion">
		<td><span id="elh_novedades_Fecha_Actualizacion"><?php echo $novedades->Fecha_Actualizacion->FldCaption() ?></span></td>
...
<?php echo $novedades->Fecha_Actualizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($novedades->Usuario->Visible) { // Usuario ?>
	<tr id="r_Usuario">
		<td><span id="elh_novedades_Usuario"><?php echo $novedades->Usuario->FldCaption() ?></span></td>
...
<?php echo $novedades->Usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
