...
$observacion_persona_grid = NULL; // Initialize page object first

class cobservacion_persona_grid extends cobservacion_persona {
	...
	// Page object name
	var $PageObjName = 'observacion_persona_grid';

	// Grid form hidden field names
	var $FormName = 'fobservacion_personagrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["observacion_persona"];
