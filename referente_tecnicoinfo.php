...
class creferente_tecnico extends cTable {
	...
	function __construct() {
		...
		// Apellido_Nombre
		$this->Apellido_Nombre = new cField('referente_tecnico', 'referente_tecnico', 'x_Apellido_Nombre', 'Apellido_Nombre', '`Apellido_Nombre`', '`Apellido_Nombre`', 200, -1, FALSE, '`Apellido_Nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Fecha_Ingreso
		$this->Fecha_Ingreso = new cField('referente_tecnico', 'referente_tecnico', 'x_Fecha_Ingreso', 'Fecha_Ingreso', '`Fecha_Ingreso`', 'DATE_FORMAT(`Fecha_Ingreso`, \'\')', 133, 2, FALSE, '`Fecha_Ingreso`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Titulo
		$this->Titulo = new cField('referente_tecnico', 'referente_tecnico', 'x_Titulo', 'Titulo', '`Titulo`', '`Titulo`', 200, -1, FALSE, '`Titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('referente_tecnico', 'referente_tecnico', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 7, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Fecha_Ingreso->EditValue = ew_FormatDateTime($this->Fecha_Ingreso->CurrentValue, 2);
