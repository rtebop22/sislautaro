...
class cdenuncia_robo_equipo extends cTable {
	...
	function __construct() {
		...
		// Fecha_Denuncia
		$this->Fecha_Denuncia = new cField('denuncia_robo_equipo', 'denuncia_robo_equipo', 'x_Fecha_Denuncia', 'Fecha_Denuncia', '`Fecha_Denuncia`', 'DATE_FORMAT(`Fecha_Denuncia`, \'\')', 133, 7, FALSE, '`Fecha_Denuncia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fecha_Denuncia->Sortable = TRUE; // Allow sort
		$this->Fecha_Denuncia->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Fecha_Denuncia'] = &$this->Fecha_Denuncia;

		// Id_Estado_Den
		$this->Id_Estado_Den = new cField('denuncia_robo_equipo', 'denuncia_robo_equipo', 'x_Id_Estado_Den', 'Id_Estado_Den', '`Id_Estado_Den`', '`Id_Estado_Den`', 3, -1, FALSE, '`Id_Estado_Den`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->Id_Estado_Den->Sortable = TRUE; // Allow sort
		$this->Id_Estado_Den->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->Id_Estado_Den->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['Id_Estado_Den'] = &$this->Id_Estado_Den;

		// Ruta_Archivo
		$this->Ruta_Archivo = new cField('denuncia_robo_equipo', 'denuncia_robo_equipo', 'x_Ruta_Archivo', 'Ruta_Archivo', '`Ruta_Archivo`', '`Ruta_Archivo`', 201, -1, TRUE, '`Ruta_Archivo`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		...
		// Usuario
		$this->Usuario = new cField('denuncia_robo_equipo', 'denuncia_robo_equipo', 'x_Usuario', 'Usuario', '`Usuario`', '`Usuario`', 200, -1, FALSE, '`Usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Usuario->Sortable = TRUE; // Allow sort
		$this->fields['Usuario'] = &$this->Usuario;

		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('denuncia_robo_equipo', 'denuncia_robo_equipo', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 0, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Fecha_Denuncia->EditValue = ew_FormatDateTime($this->Fecha_Denuncia->CurrentValue, 7);
