...
$establecimientos_educativos_pase_view = NULL; // Initialize page object first

class cestablecimientos_educativos_pase_view extends cestablecimientos_educativos_pase {
	...
	// Page object name
	var $PageObjName = 'establecimientos_educativos_pase_view';
	...
	function __construct() {
		...
		if (@$_GET["Cue_Establecimiento"] <> "") {
			$this->RecKey["Cue_Establecimiento"] = $_GET["Cue_Establecimiento"];
			$KeyUrl .= "&amp;Cue_Establecimiento=" . urlencode($this->RecKey["Cue_Establecimiento"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["Cue_Establecimiento"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["Cue_Establecimiento"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Cue_Establecimiento"] <> "") {
				...
				$this->RecKey["Cue_Establecimiento"] = $this->Cue_Establecimiento->QueryStringValue;
			} elseif (@$_POST["Cue_Establecimiento"] <> "") {
				$this->Cue_Establecimiento->setFormValue($_POST["Cue_Establecimiento"]);
				$this->RecKey["Cue_Establecimiento"] = $this->Cue_Establecimiento->FormValue;
			} else {
				$sReturnUrl = "establecimientos_educativos_paselist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "establecimientos_educativos_paselist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "establecimientos_educativos_paselist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($establecimientos_educativos_pase_view)) $establecimientos_educativos_pase_view = new cestablecimientos_educativos_pase_view();

// Page init
$establecimientos_educativos_pase_view->Page_Init();

// Page main
$establecimientos_educativos_pase_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$establecimientos_educativos_pase_view->Page_Render();
?>
...
var CurrentForm = festablecimientos_educativos_paseview = new ew_Form("festablecimientos_educativos_paseview", "view");

// Form_CustomValidate event
festablecimientos_educativos_paseview.Form_CustomValidate = 
...
festablecimientos_educativos_paseview.ValidateRequired = true;
<?php } else { ?>
festablecimientos_educativos_paseview.ValidateRequired = false; 
<?php } ?>

// Multi-Page
festablecimientos_educativos_paseview.MultiPage = new ew_MultiPage("festablecimientos_educativos_paseview");

// Dynamic selection lists
festablecimientos_educativos_paseview.Lists["x_Id_Provincia"] = {"LinkField":"x_Id_Provincia","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":["x_Id_Departamento"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincias"};
festablecimientos_educativos_paseview.Lists["x_Id_Departamento"] = {"LinkField":"x_Id_Departamento","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":["x_Id_Localidad"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
festablecimientos_educativos_paseview.Lists["x_Id_Localidad"] = {"LinkField":"x_Id_Localidad","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"localidades"};
...
<?php if ($establecimientos_educativos_pase->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$establecimientos_educativos_pase_view->IsModal) { ?>
<?php if ($establecimientos_educativos_pase->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $establecimientos_educativos_pase_view->ExportOptions->Render("body") ?>
<?php
	foreach ($establecimientos_educativos_pase_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$establecimientos_educativos_pase_view->IsModal) { ?>
<?php if ($establecimientos_educativos_pase->Export == "") { ?>
...
<?php } ?>
<?php $establecimientos_educativos_pase_view->ShowPageHeader(); ?>
<?php
$establecimientos_educativos_pase_view->ShowMessage();
?>
<form name="festablecimientos_educativos_paseview" id="festablecimientos_educativos_paseview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($establecimientos_educativos_pase_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $establecimientos_educativos_pase_view->Token ?>">
<?php } ?>
...
<div class="panel-group" id="establecimientos_educativos_pase_view">
<?php } ?>
<?php if ($establecimientos_educativos_pase->Export == "") { ?>
	<div class="panel panel-default<?php echo $establecimientos_educativos_pase_view->MultiPages->PageStyle("1") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#establecimientos_educativos_pase_view" href="#tab_establecimientos_educativos_pase1"><?php echo $establecimientos_educativos_pase->PageCaption(1) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $establecimientos_educativos_pase_view->MultiPages->PageStyle("1") ?>" id="tab_establecimientos_educativos_pase1">
			<div class="panel-body">
<?php } ?>
<table class="table table-bordered table-striped ewViewTable">
<?php if ($establecimientos_educativos_pase->Cue_Establecimiento->Visible) { // Cue_Establecimiento ?>
	<tr id="r_Cue_Establecimiento">
		<td><span id="elh_establecimientos_educativos_pase_Cue_Establecimiento"><?php echo $establecimientos_educativos_pase->Cue_Establecimiento->FldCaption() ?></span></td>
		<td data-name="Cue_Establecimiento"<?php echo $establecimientos_educativos_pase->Cue_Establecimiento->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Cue_Establecimiento" data-page="1">
<span<?php echo $establecimientos_educativos_pase->Cue_Establecimiento->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Cue_Establecimiento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nombre_Establecimiento->Visible) { // Nombre_Establecimiento ?>
	<tr id="r_Nombre_Establecimiento">
		<td><span id="elh_establecimientos_educativos_pase_Nombre_Establecimiento"><?php echo $establecimientos_educativos_pase->Nombre_Establecimiento->FldCaption() ?></span></td>
		<td data-name="Nombre_Establecimiento"<?php echo $establecimientos_educativos_pase->Nombre_Establecimiento->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Nombre_Establecimiento" data-page="1">
<span<?php echo $establecimientos_educativos_pase->Nombre_Establecimiento->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Nombre_Establecimiento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nro_Serie_Server_Escolar->Visible) { // Nro_Serie_Server_Escolar ?>
	<tr id="r_Nro_Serie_Server_Escolar">
		<td><span id="elh_establecimientos_educativos_pase_Nro_Serie_Server_Escolar"><?php echo $establecimientos_educativos_pase->Nro_Serie_Server_Escolar->FldCaption() ?></span></td>
		<td data-name="Nro_Serie_Server_Escolar"<?php echo $establecimientos_educativos_pase->Nro_Serie_Server_Escolar->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Nro_Serie_Server_Escolar" data-page="1">
<span<?php echo $establecimientos_educativos_pase->Nro_Serie_Server_Escolar->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Nro_Serie_Server_Escolar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Contacto_Establecimiento->Visible) { // Contacto_Establecimiento ?>
	<tr id="r_Contacto_Establecimiento">
		<td><span id="elh_establecimientos_educativos_pase_Contacto_Establecimiento"><?php echo $establecimientos_educativos_pase->Contacto_Establecimiento->FldCaption() ?></span></td>
		<td data-name="Contacto_Establecimiento"<?php echo $establecimientos_educativos_pase->Contacto_Establecimiento->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Contacto_Establecimiento" data-page="1">
<span<?php echo $establecimientos_educativos_pase->Contacto_Establecimiento->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Contacto_Establecimiento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Domicilio_Escuela->Visible) { // Domicilio_Escuela ?>
	<tr id="r_Domicilio_Escuela">
		<td><span id="elh_establecimientos_educativos_pase_Domicilio_Escuela"><?php echo $establecimientos_educativos_pase->Domicilio_Escuela->FldCaption() ?></span></td>
		<td data-name="Domicilio_Escuela"<?php echo $establecimientos_educativos_pase->Domicilio_Escuela->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Domicilio_Escuela" data-page="1">
<span<?php echo $establecimientos_educativos_pase->Domicilio_Escuela->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Domicilio_Escuela->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Id_Provincia->Visible) { // Id_Provincia ?>
	<tr id="r_Id_Provincia">
		<td><span id="elh_establecimientos_educativos_pase_Id_Provincia"><?php echo $establecimientos_educativos_pase->Id_Provincia->FldCaption() ?></span></td>
		<td data-name="Id_Provincia"<?php echo $establecimientos_educativos_pase->Id_Provincia->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Id_Provincia" data-page="1">
<span<?php echo $establecimientos_educativos_pase->Id_Provincia->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Id_Provincia->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Id_Departamento->Visible) { // Id_Departamento ?>
	<tr id="r_Id_Departamento">
		<td><span id="elh_establecimientos_educativos_pase_Id_Departamento"><?php echo $establecimientos_educativos_pase->Id_Departamento->FldCaption() ?></span></td>
		<td data-name="Id_Departamento"<?php echo $establecimientos_educativos_pase->Id_Departamento->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Id_Departamento" data-page="1">
<span<?php echo $establecimientos_educativos_pase->Id_Departamento->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Id_Departamento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Id_Localidad->Visible) { // Id_Localidad ?>
	<tr id="r_Id_Localidad">
		<td><span id="elh_establecimientos_educativos_pase_Id_Localidad"><?php echo $establecimientos_educativos_pase->Id_Localidad->FldCaption() ?></span></td>
		<td data-name="Id_Localidad"<?php echo $establecimientos_educativos_pase->Id_Localidad->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Id_Localidad" data-page="1">
<span<?php echo $establecimientos_educativos_pase->Id_Localidad->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Id_Localidad->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<tr id="r_Fecha_Actualizacion">
		<td><span id="elh_establecimientos_educativos_pase_Fecha_Actualizacion"><?php echo $establecimientos_educativos_pase->Fecha_Actualizacion->FldCaption() ?></span></td>
		<td data-name="Fecha_Actualizacion"<?php echo $establecimientos_educativos_pase->Fecha_Actualizacion->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Fecha_Actualizacion" data-page="1">
<span<?php echo $establecimientos_educativos_pase->Fecha_Actualizacion->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Fecha_Actualizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Usuario->Visible) { // Usuario ?>
	<tr id="r_Usuario">
		<td><span id="elh_establecimientos_educativos_pase_Usuario"><?php echo $establecimientos_educativos_pase->Usuario->FldCaption() ?></span></td>
		<td data-name="Usuario"<?php echo $establecimientos_educativos_pase->Usuario->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Usuario" data-page="1">
<span<?php echo $establecimientos_educativos_pase->Usuario->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Export == "") { ?>
	<div class="panel panel-default<?php echo $establecimientos_educativos_pase_view->MultiPages->PageStyle("2") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#establecimientos_educativos_pase_view" href="#tab_establecimientos_educativos_pase2"><?php echo $establecimientos_educativos_pase->PageCaption(2) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $establecimientos_educativos_pase_view->MultiPages->PageStyle("2") ?>" id="tab_establecimientos_educativos_pase2">
			<div class="panel-body">
<?php } ?>
<table class="table table-bordered table-striped ewViewTable">
<?php if ($establecimientos_educativos_pase->Nombre_Directivo->Visible) { // Nombre_Directivo ?>
	<tr id="r_Nombre_Directivo">
		<td><span id="elh_establecimientos_educativos_pase_Nombre_Directivo"><?php echo $establecimientos_educativos_pase->Nombre_Directivo->FldCaption() ?></span></td>
		<td data-name="Nombre_Directivo"<?php echo $establecimientos_educativos_pase->Nombre_Directivo->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Nombre_Directivo" data-page="2">
<span<?php echo $establecimientos_educativos_pase->Nombre_Directivo->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Nombre_Directivo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Cuil_Directivo->Visible) { // Cuil_Directivo ?>
	<tr id="r_Cuil_Directivo">
		<td><span id="elh_establecimientos_educativos_pase_Cuil_Directivo"><?php echo $establecimientos_educativos_pase->Cuil_Directivo->FldCaption() ?></span></td>
		<td data-name="Cuil_Directivo"<?php echo $establecimientos_educativos_pase->Cuil_Directivo->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Cuil_Directivo" data-page="2">
<span<?php echo $establecimientos_educativos_pase->Cuil_Directivo->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Cuil_Directivo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Export == "") { ?>
	<div class="panel panel-default<?php echo $establecimientos_educativos_pase_view->MultiPages->PageStyle("3") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#establecimientos_educativos_pase_view" href="#tab_establecimientos_educativos_pase3"><?php echo $establecimientos_educativos_pase->PageCaption(3) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $establecimientos_educativos_pase_view->MultiPages->PageStyle("3") ?>" id="tab_establecimientos_educativos_pase3">
			<div class="panel-body">
<?php } ?>
<table class="table table-bordered table-striped ewViewTable">
<?php if ($establecimientos_educativos_pase->Nombre_Rte->Visible) { // Nombre_Rte ?>
	<tr id="r_Nombre_Rte">
		<td><span id="elh_establecimientos_educativos_pase_Nombre_Rte"><?php echo $establecimientos_educativos_pase->Nombre_Rte->FldCaption() ?></span></td>
		<td data-name="Nombre_Rte"<?php echo $establecimientos_educativos_pase->Nombre_Rte->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Nombre_Rte" data-page="3">
<span<?php echo $establecimientos_educativos_pase->Nombre_Rte->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Nombre_Rte->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Tel_Rte->Visible) { // Tel_Rte ?>
	<tr id="r_Tel_Rte">
		<td><span id="elh_establecimientos_educativos_pase_Tel_Rte"><?php echo $establecimientos_educativos_pase->Tel_Rte->FldCaption() ?></span></td>
		<td data-name="Tel_Rte"<?php echo $establecimientos_educativos_pase->Tel_Rte->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Tel_Rte" data-page="3">
<span<?php echo $establecimientos_educativos_pase->Tel_Rte->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Tel_Rte->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($establecimientos_educativos_pase->Email_Rte->Visible) { // Email_Rte ?>
	<tr id="r_Email_Rte">
		<td><span id="elh_establecimientos_educativos_pase_Email_Rte"><?php echo $establecimientos_educativos_pase->Email_Rte->FldCaption() ?></span></td>
		<td data-name="Email_Rte"<?php echo $establecimientos_educativos_pase->Email_Rte->CellAttributes() ?>>
<span id="el_establecimientos_educativos_pase_Email_Rte" data-page="3">
<span<?php echo $establecimientos_educativos_pase->Email_Rte->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Email_Rte->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($establecimientos_educativos_pase->Export == "") { ?>
<script type="text/javascript">
festablecimientos_educativos_paseview.Init();
</script>
<?php } ?>
<?php
$establecimientos_educativos_pase_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($establecimientos_educativos_pase->Export == "") { ?>
...
<?php
$establecimientos_educativos_pase_view->Page_Terminate();
?>
