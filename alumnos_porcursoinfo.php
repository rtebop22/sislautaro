...
$alumnos_porcurso = NULL;

//
// Table class for alumnos_porcurso
//
class calumnos_porcurso extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'alumnos_porcurso';
		$this->TableName = 'alumnos_porcurso';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`alumnos_porcurso`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Apellidos_Nombres
		$this->Apellidos_Nombres = new cField('alumnos_porcurso', 'alumnos_porcurso', 'x_Apellidos_Nombres', 'Apellidos_Nombres', '`Apellidos_Nombres`', '`Apellidos_Nombres`', 201, -1, FALSE, '`Apellidos_Nombres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellidos_Nombres->Sortable = TRUE; // Allow sort
		$this->fields['Apellidos_Nombres'] = &$this->Apellidos_Nombres;

		// Dni
		$this->Dni = new cField('alumnos_porcurso', 'alumnos_porcurso', 'x_Dni', 'Dni', '`Dni`', '`Dni`', 3, -1, FALSE, '`Dni`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Dni->Sortable = TRUE; // Allow sort
		$this->Dni->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Dni'] = &$this->Dni;

		// Id_Curso
		$this->Id_Curso = new cField('alumnos_porcurso', 'alumnos_porcurso', 'x_Id_Curso', 'Id_Curso', '`Id_Curso`', '`Id_Curso`', 3, -1, FALSE, '`Id_Curso`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Division
		$this->Id_Division = new cField('alumnos_porcurso', 'alumnos_porcurso', 'x_Id_Division', 'Id_Division', '`Id_Division`', '`Id_Division`', 3, -1, FALSE, '`Id_Division`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Turno
		$this->Id_Turno = new cField('alumnos_porcurso', 'alumnos_porcurso', 'x_Id_Turno', 'Id_Turno', '`Id_Turno`', '`Id_Turno`', 3, -1, FALSE, '`Id_Turno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Estado
		$this->Id_Estado = new cField('alumnos_porcurso', 'alumnos_porcurso', 'x_Id_Estado', 'Id_Estado', '`Id_Estado`', '`Id_Estado`', 3, -1, FALSE, '`Id_Estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Cargo
		$this->Id_Cargo = new cField('alumnos_porcurso', 'alumnos_porcurso', 'x_Id_Cargo', 'Id_Cargo', '`Id_Cargo`', '`Id_Cargo`', 3, -1, FALSE, '`Id_Cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('alumnos_porcurso', 'alumnos_porcurso', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 7, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`alumnos_porcurso`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "alumnos_porcursolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("alumnos_porcursoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("alumnos_porcursoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "alumnos_porcursoadd.php?" . $this->UrlParm($parm);
		else
			$url = "alumnos_porcursoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("alumnos_porcursoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("alumnos_porcursoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("alumnos_porcursodelete.php", $this->UrlParm());
	}
