...
class cpersonas extends cTable {
	...
	function __construct() {
		...
		// Foto
		$this->Foto = new cField('personas', 'personas', 'x_Foto', 'Foto', '`Foto`', '`Foto`', 201, -1, TRUE, '`Foto`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		...
		// Usuario
		$this->Usuario = new cField('personas', 'personas', 'x_Usuario', 'Usuario', '`Usuario`', '`Usuario`', 200, -1, FALSE, '`Usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Usuario->Sortable = TRUE; // Allow sort
		$this->fields['Usuario'] = &$this->Usuario;

		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('personas', 'personas', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 7, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
