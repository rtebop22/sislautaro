...
$observacion_tutor_view = NULL; // Initialize page object first

class cobservacion_tutor_view extends cobservacion_tutor {
	...
	// Page object name
	var $PageObjName = 'observacion_tutor_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Id_Observacion"] <> "") {
				...
				$sReturnUrl = "observacion_tutorlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "observacion_tutorlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "observacion_tutorlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($observacion_tutor_view)) $observacion_tutor_view = new cobservacion_tutor_view();

// Page init
$observacion_tutor_view->Page_Init();

// Page main
$observacion_tutor_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$observacion_tutor_view->Page_Render();
?>
...
var CurrentForm = fobservacion_tutorview = new ew_Form("fobservacion_tutorview", "view");

// Form_CustomValidate event
fobservacion_tutorview.Form_CustomValidate = 
...
fobservacion_tutorview.ValidateRequired = true;
<?php } else { ?>
fobservacion_tutorview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($observacion_tutor->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$observacion_tutor_view->IsModal) { ?>
<?php if ($observacion_tutor->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $observacion_tutor_view->ExportOptions->Render("body") ?>
<?php
	foreach ($observacion_tutor_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$observacion_tutor_view->IsModal) { ?>
<?php if ($observacion_tutor->Export == "") { ?>
...
<?php } ?>
<?php $observacion_tutor_view->ShowPageHeader(); ?>
<?php
$observacion_tutor_view->ShowMessage();
?>
<form name="fobservacion_tutorview" id="fobservacion_tutorview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($observacion_tutor_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $observacion_tutor_view->Token ?>">
<?php } ?>
...
<?php if ($observacion_tutor->Detalle->Visible) { // Detalle ?>
	<tr id="r_Detalle">
		<td><span id="elh_observacion_tutor_Detalle"><?php echo $observacion_tutor->Detalle->FldCaption() ?></span></td>
		<td data-name="Detalle"<?php echo $observacion_tutor->Detalle->CellAttributes() ?>>
<span id="el_observacion_tutor_Detalle" data-page="1">
<span<?php echo $observacion_tutor->Detalle->ViewAttributes() ?>>
<?php echo $observacion_tutor->Detalle->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($observacion_tutor->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<tr id="r_Fecha_Actualizacion">
		<td><span id="elh_observacion_tutor_Fecha_Actualizacion"><?php echo $observacion_tutor->Fecha_Actualizacion->FldCaption() ?></span></td>
		<td data-name="Fecha_Actualizacion"<?php echo $observacion_tutor->Fecha_Actualizacion->CellAttributes() ?>>
<span id="el_observacion_tutor_Fecha_Actualizacion" data-page="1">
<span<?php echo $observacion_tutor->Fecha_Actualizacion->ViewAttributes() ?>>
<?php echo $observacion_tutor->Fecha_Actualizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($observacion_tutor->Dni_Tutor->Visible) { // Dni_Tutor ?>
	<tr id="r_Dni_Tutor">
		<td><span id="elh_observacion_tutor_Dni_Tutor"><?php echo $observacion_tutor->Dni_Tutor->FldCaption() ?></span></td>
		<td data-name="Dni_Tutor"<?php echo $observacion_tutor->Dni_Tutor->CellAttributes() ?>>
<span id="el_observacion_tutor_Dni_Tutor" data-page="1">
<span<?php echo $observacion_tutor->Dni_Tutor->ViewAttributes() ?>>
<?php echo $observacion_tutor->Dni_Tutor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($observacion_tutor->Export == "") { ?>
<script type="text/javascript">
fobservacion_tutorview.Init();
</script>
<?php } ?>
<?php
$observacion_tutor_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($observacion_tutor->Export == "") { ?>
...
<?php
$observacion_tutor_view->Page_Terminate();
?>
