...
class cequipos_update extends cequipos {
	...
	function LoadMultiUpdateValues() {
		...
		if ($this->Recordset = $this->LoadRecordset()) {
			...
			while (!$this->Recordset->EOF) {
				if ($i == 1) {
					$this->SpecialNumber->setDbValue($this->Recordset->fields('SpecialNumber'));
					...
					$this->Tiene_Cargador->setDbValue($this->Recordset->fields('Tiene_Cargador'));
					$this->Id_Tipo_Equipo->setDbValue($this->Recordset->fields('Id_Tipo_Equipo'));
					...
					if (!ew_CompareValue($this->SpecialNumber->DbValue, $this->Recordset->fields('SpecialNumber')))
					...
					if (!ew_CompareValue($this->Tiene_Cargador->DbValue, $this->Recordset->fields('Tiene_Cargador')))
						$this->Tiene_Cargador->CurrentValue = NULL;
					if (!ew_CompareValue($this->Id_Tipo_Equipo->DbValue, $this->Recordset->fields('Id_Tipo_Equipo')))
	...
	function LoadFormValues() {
		...
		$this->SpecialNumber->MultiUpdate = $objForm->GetValue("u_SpecialNumber");
		...
		$this->Tiene_Cargador->MultiUpdate = $objForm->GetValue("u_Tiene_Cargador");
		if (!$this->Id_Tipo_Equipo->FldIsDetailKey) {
			$this->Id_Tipo_Equipo->setFormValue($objForm->GetValue("x_Id_Tipo_Equipo"));
		}
		$this->Id_Tipo_Equipo->MultiUpdate = $objForm->GetValue("u_Id_Tipo_Equipo");
	...
	function ValidateForm() {
		...
		$gsFormError = "";
		$lUpdateCnt = 0;
		if ($this->SpecialNumber->MultiUpdate == "1") $lUpdateCnt++;
		...
		if ($this->Tiene_Cargador->MultiUpdate == "1") $lUpdateCnt++;
		if ($this->Id_Tipo_Equipo->MultiUpdate == "1") $lUpdateCnt++;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// SpecialNumber
			$this->SpecialNumber->SetDbValueDef($rsnew, $this->SpecialNumber->CurrentValue, NULL, $this->SpecialNumber->ReadOnly || $this->SpecialNumber->MultiUpdate <> "1");
			...
			// Tiene_Cargador
			$this->Tiene_Cargador->SetDbValueDef($rsnew, $this->Tiene_Cargador->CurrentValue, NULL, $this->Tiene_Cargador->ReadOnly || $this->Tiene_Cargador->MultiUpdate <> "1");

			// Id_Tipo_Equipo
			$this->Id_Tipo_Equipo->SetDbValueDef($rsnew, $this->Id_Tipo_Equipo->CurrentValue, NULL, $this->Id_Tipo_Equipo->ReadOnly || $this->Id_Tipo_Equipo->MultiUpdate <> "1");
...
fequiposupdate.Lists["x_Tiene_Cargador"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fequiposupdate.Lists["x_Tiene_Cargador"].Options = <?php echo json_encode($equipos->Tiene_Cargador->Options()) ?>;
fequiposupdate.Lists["x_Id_Tipo_Equipo"] = {"LinkField":"x_Id_Tipo_Equipo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_equipo"};
...
<?php if ($equipos->SpecialNumber->Visible) { // SpecialNumber ?>
	<div id="r_SpecialNumber" class="form-group">
		<label for="x_SpecialNumber" class="col-sm-2 control-label">
<input type="checkbox" name="u_SpecialNumber" id="u_SpecialNumber" value="1"<?php echo ($equipos->SpecialNumber->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $equipos->SpecialNumber->FldCaption() ?></label>
...
<input type="checkbox" name="u_Tiene_Cargador" id="u_Tiene_Cargador" value="1"<?php echo ($equipos->Tiene_Cargador->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $equipos->Tiene_Cargador->FldCaption() ?></label>
...
<?php if ($equipos->Id_Tipo_Equipo->Visible) { // Id_Tipo_Equipo ?>
	<div id="r_Id_Tipo_Equipo" class="form-group">
		<label for="x_Id_Tipo_Equipo" class="col-sm-2 control-label">
<input type="checkbox" name="u_Id_Tipo_Equipo" id="u_Id_Tipo_Equipo" value="1"<?php echo ($equipos->Id_Tipo_Equipo->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $equipos->Id_Tipo_Equipo->FldCaption() ?></label>
...
<input type="checkbox" name="u_Usuario" id="u_Usuario" value="1"<?php echo ($equipos->Usuario->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $equipos->Usuario->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $equipos->Usuario->CellAttributes() ?>>
<?php echo $equipos->Usuario->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<input type="checkbox" name="u_Fecha_Actualizacion" id="u_Fecha_Actualizacion" value="1"<?php echo ($equipos->Fecha_Actualizacion->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $equipos->Fecha_Actualizacion->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $equipos->Fecha_Actualizacion->CellAttributes() ?>>
<?php echo $equipos->Fecha_Actualizacion->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if (!$equipos_update->IsModal) { ?>
