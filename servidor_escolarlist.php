...
class cservidor_escolar_list extends cservidor_escolar {
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_Id_Estado") && $objForm->HasValue("o_Id_Estado") && $this->Id_Estado->CurrentValue <> $this->Id_Estado->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_User_Server") && $objForm->HasValue("o_User_Server") && $this->User_Server->CurrentValue <> $this->User_Server->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_User_TdServer") && $objForm->HasValue("o_User_TdServer") && $this->User_TdServer->CurrentValue <> $this->User_TdServer->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->User_Server, $Default, FALSE); // User_Server
		$this->BuildSearchSql($sWhere, $this->Pass_Server, $Default, FALSE); // Pass_Server
		$this->BuildSearchSql($sWhere, $this->User_TdServer, $Default, FALSE); // User_TdServer
		...
		if (!$Default && $this->Command == "search") {
			...
			$this->User_Server->AdvancedSearch->Save(); // User_Server
			$this->Pass_Server->AdvancedSearch->Save(); // Pass_Server
			$this->User_TdServer->AdvancedSearch->Save(); // User_TdServer
	...
	function CheckSearchParms() {
		...
		if ($this->Id_Estado->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->User_Server->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Pass_Server->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->User_TdServer->AdvancedSearch->IssetSession())
			return TRUE;
	...
	function ResetAdvancedSearchParms() {
		...
		$this->User_Server->AdvancedSearch->UnsetSession();
		$this->Pass_Server->AdvancedSearch->UnsetSession();
		$this->User_TdServer->AdvancedSearch->UnsetSession();
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiUpdate\" title=\"" . ew_HtmlTitle($Language->Phrase("UpdateSelectedLink")) . "\" data-table=\"servidor_escolar\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("UpdateSelectedLink")) . "\" href=\"\" onclick=\"ew_ModalDialogShow({lnk:this,f:document.fservidor_escolarlist,url:'" . $this->MultiUpdateUrl . "',caption:'" . $Language->Phrase("UpdateBtn") . "'});return false;\">" . $Language->Phrase("UpdateSelectedLink") . "</a>";
		$item->Visible = ($Security->CanEdit());
	...
	function LoadSearchValues() {
		...
		// User_Server
		$this->User_Server->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_User_Server"]);
		if ($this->User_Server->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->User_Server->AdvancedSearch->SearchOperator = @$_GET["z_User_Server"];
		...
		// User_TdServer
		$this->User_TdServer->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_User_TdServer"]);
		if ($this->User_TdServer->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->User_TdServer->AdvancedSearch->SearchOperator = @$_GET["z_User_TdServer"];
	...
	function LoadFormValues() {
		...
		$this->User_Server->setOldValue($objForm->GetValue("o_User_Server"));
		if (!$this->User_TdServer->FldIsDetailKey) {
			$this->User_TdServer->setFormValue($objForm->GetValue("x_User_TdServer"));
		}
		$this->User_TdServer->setOldValue($objForm->GetValue("o_User_TdServer"));
...
if ($servidor_escolar->CurrentAction == "gridadd") {
	...
	if ($servidor_escolar->CurrentAction == "" && $servidor_escolar_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$servidor_escolar_list->setWarningMessage(ew_DeniedMsg());
...
<?php if ($servidor_escolar_list->TotalRecs > 0 || $servidor_escolar->CurrentAction == "add" || $servidor_escolar->CurrentAction == "copy") { ?>
...
<?php if ($servidor_escolar->User_Server->Visible) { // User_Server ?>
	...
	<?php } else { ?>
		<th data-name="User_Server"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $servidor_escolar->SortUrl($servidor_escolar->User_Server) ?>',1);"><div id="elh_servidor_escolar_User_Server" class="servidor_escolar_User_Server">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $servidor_escolar->User_Server->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($servidor_escolar->User_Server->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($servidor_escolar->User_Server->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($servidor_escolar->User_TdServer->Visible) { // User_TdServer ?>
	...
	<?php } else { ?>
		<th data-name="User_TdServer"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $servidor_escolar->SortUrl($servidor_escolar->User_TdServer) ?>',1);"><div id="elh_servidor_escolar_User_TdServer" class="servidor_escolar_User_TdServer">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $servidor_escolar->User_TdServer->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($servidor_escolar->User_TdServer->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($servidor_escolar->User_TdServer->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<tbody>
<?php
	if ($servidor_escolar->CurrentAction == "add" || $servidor_escolar->CurrentAction == "copy") {
		$servidor_escolar_list->RowIndex = 0;
		$servidor_escolar_list->KeyCount = $servidor_escolar_list->RowIndex;
		if ($servidor_escolar->CurrentAction == "add")
			$servidor_escolar_list->LoadDefaultValues();
		if ($servidor_escolar->EventCancelled) // Insert failed
			$servidor_escolar_list->RestoreFormValues(); // Restore form values

		// Set row properties
		$servidor_escolar->ResetAttrs();
		$servidor_escolar->RowAttrs = array_merge($servidor_escolar->RowAttrs, array('data-rowindex'=>0, 'id'=>'r0_servidor_escolar', 'data-rowtype'=>EW_ROWTYPE_ADD));
...
<span id="el<?php echo $servidor_escolar_list->RowCnt ?>_servidor_escolar_User_Server" class="form-group servidor_escolar_User_Server">
<input type="text" data-table="servidor_escolar" data-field="x_User_Server" name="x<?php echo $servidor_escolar_list->RowIndex ?>_User_Server" id="x<?php echo $servidor_escolar_list->RowIndex ?>_User_Server" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($servidor_escolar->User_Server->getPlaceHolder()) ?>" value="<?php echo $servidor_escolar->User_Server->EditValue ?>"<?php echo $servidor_escolar->User_Server->EditAttributes() ?>>
</span>
<input type="hidden" data-table="servidor_escolar" data-field="x_User_Server" name="o<?php echo $servidor_escolar_list->RowIndex ?>_User_Server" id="o<?php echo $servidor_escolar_list->RowIndex ?>_User_Server" value="<?php echo ew_HtmlEncode($servidor_escolar->User_Server->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($servidor_escolar->User_TdServer->Visible) { // User_TdServer ?>
		<td data-name="User_TdServer">
<span id="el<?php echo $servidor_escolar_list->RowCnt ?>_servidor_escolar_User_TdServer" class="form-group servidor_escolar_User_TdServer">
<input type="text" data-table="servidor_escolar" data-field="x_User_TdServer" name="x<?php echo $servidor_escolar_list->RowIndex ?>_User_TdServer" id="x<?php echo $servidor_escolar_list->RowIndex ?>_User_TdServer" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($servidor_escolar->User_TdServer->getPlaceHolder()) ?>" value="<?php echo $servidor_escolar->User_TdServer->EditValue ?>"<?php echo $servidor_escolar->User_TdServer->EditAttributes() ?>>
</span>
<input type="hidden" data-table="servidor_escolar" data-field="x_User_TdServer" name="o<?php echo $servidor_escolar_list->RowIndex ?>_User_TdServer" id="o<?php echo $servidor_escolar_list->RowIndex ?>_User_TdServer" value="<?php echo ew_HtmlEncode($servidor_escolar->User_TdServer->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($servidor_escolar->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
...
$servidor_escolar->ResetAttrs();
$servidor_escolar_list->RenderRow();
$servidor_escolar_list->EditRowCnt = 0;
if ($servidor_escolar->CurrentAction == "edit")
	$servidor_escolar_list->RowIndex = 1;
if ($servidor_escolar->CurrentAction == "gridadd")
	$servidor_escolar_list->RowIndex = 0;
...
while ($servidor_escolar_list->RecCnt < $servidor_escolar_list->StopRec) {
	...
	if (intval($servidor_escolar_list->RecCnt) >= intval($servidor_escolar_list->StartRec)) {
		...
		if ($servidor_escolar->CurrentAction == "edit") {
			if ($servidor_escolar_list->CheckInlineEditKey() && $servidor_escolar_list->EditRowCnt == 0) { // Inline edit
		...
		if ($servidor_escolar->CurrentAction == "edit" && $servidor_escolar->RowType == EW_ROWTYPE_EDIT && $servidor_escolar->EventCancelled) { // Update failed
			$objForm->Index = 1;
			$servidor_escolar_list->RestoreFormValues(); // Restore form values
		}
...
<a id="<?php echo $servidor_escolar_list->PageObjName . "_row_" . $servidor_escolar_list->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($servidor_escolar->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="servidor_escolar" data-field="x_Cue" name="x<?php echo $servidor_escolar_list->RowIndex ?>_Cue" id="x<?php echo $servidor_escolar_list->RowIndex ?>_Cue" value="<?php echo ew_HtmlEncode($servidor_escolar->Cue->CurrentValue) ?>">
<input type="hidden" data-table="servidor_escolar" data-field="x_Cue" name="o<?php echo $servidor_escolar_list->RowIndex ?>_Cue" id="o<?php echo $servidor_escolar_list->RowIndex ?>_Cue" value="<?php echo ew_HtmlEncode($servidor_escolar->Cue->OldValue) ?>">
<?php } ?>
...
<?php } ?>
<?php if ($servidor_escolar->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $servidor_escolar_list->RowCnt ?>_servidor_escolar_User_Server" class="servidor_escolar_User_Server">
...
<?php } ?>
<?php if ($servidor_escolar->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $servidor_escolar_list->RowCnt ?>_servidor_escolar_User_TdServer" class="servidor_escolar_User_TdServer">
...
<?php } ?>
<?php if ($servidor_escolar->CurrentAction == "add" || $servidor_escolar->CurrentAction == "copy") { ?>
...
<?php } ?>
<?php if ($servidor_escolar->CurrentAction == "edit") { ?>
<input type="hidden" name="<?php echo $servidor_escolar_list->FormKeyCountName ?>" id="<?php echo $servidor_escolar_list->FormKeyCountName ?>" value="<?php echo $servidor_escolar_list->KeyCount ?>">
<?php } ?>
