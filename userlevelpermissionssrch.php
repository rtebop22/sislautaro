...
$userlevelpermissions_search = NULL; // Initialize page object first

class cuserlevelpermissions_search extends cuserlevelpermissions {
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "userlevelpermissionslist.php" . "?" . $sSrchStr;
	...
	function BuildAdvancedSearch() {
		...
		$this->BuildSearchUrl($sSrchUrl, $this->_tablename); // tablename
		$this->BuildSearchUrl($sSrchUrl, $this->permission); // permission
	...
	function LoadSearchValues() {
		...
		// tablename
		$this->_tablename->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x__tablename"));
		$this->_tablename->AdvancedSearch->SearchOperator = $objForm->GetValue("z__tablename");

		// permission
		$this->permission->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_permission"));
		$this->permission->AdvancedSearch->SearchOperator = $objForm->GetValue("z_permission");
	}
	...
	function RenderRow() {
		...
		$this->permission->ViewCustomAttributes = "";
			...
			$this->_tablename->EditValue = ew_HtmlEncode($this->_tablename->AdvancedSearch->SearchValue);
			...
			$this->permission->EditValue = ew_HtmlEncode($this->permission->AdvancedSearch->SearchValue);
	...
	function ValidateSearch() {
		...
		if (!ew_CheckInteger($this->permission->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->permission->FldErrMsg());
		}
...
// Create page object
if (!isset($userlevelpermissions_search)) $userlevelpermissions_search = new cuserlevelpermissions_search();
...
var CurrentAdvancedSearchForm = fuserlevelpermissionssearch = new ew_Form("fuserlevelpermissionssearch", "search");
<?php } else { ?>
var CurrentForm = fuserlevelpermissionssearch = new ew_Form("fuserlevelpermissionssearch", "search");
<?php } ?>

// Form_CustomValidate event
fuserlevelpermissionssearch.Form_CustomValidate = 
...
fuserlevelpermissionssearch.ValidateRequired = true;
<?php } else { ?>
fuserlevelpermissionssearch.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="fuserlevelpermissionssearch" id="fuserlevelpermissionssearch" class="<?php echo $userlevelpermissions_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($userlevelpermissions_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $userlevelpermissions_search->Token ?>">
<?php } ?>
...
<?php if ($userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	<div id="r_userlevelid" class="form-group">
		<label for="x_userlevelid" class="<?php echo $userlevelpermissions_search->SearchLabelClass ?>"><span id="elh_userlevelpermissions_userlevelid"><?php echo $userlevelpermissions->userlevelid->FldCaption() ?></span>	
		...
		<div class="<?php echo $userlevelpermissions_search->SearchRightColumnClass ?>"><div<?php echo $userlevelpermissions->userlevelid->CellAttributes() ?>>
...
<?php if ($userlevelpermissions->_tablename->Visible) { // tablename ?>
	<div id="r__tablename" class="form-group">
		<label for="x__tablename" class="<?php echo $userlevelpermissions_search->SearchLabelClass ?>"><span id="elh_userlevelpermissions__tablename"><?php echo $userlevelpermissions->_tablename->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z__tablename" id="z__tablename" value="LIKE"></p>
		</label>
		<div class="<?php echo $userlevelpermissions_search->SearchRightColumnClass ?>"><div<?php echo $userlevelpermissions->_tablename->CellAttributes() ?>>
...
<?php if ($userlevelpermissions->permission->Visible) { // permission ?>
	<div id="r_permission" class="form-group">
		<label for="x_permission" class="<?php echo $userlevelpermissions_search->SearchLabelClass ?>"><span id="elh_userlevelpermissions_permission"><?php echo $userlevelpermissions->permission->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_permission" id="z_permission" value="="></p>
		</label>
		<div class="<?php echo $userlevelpermissions_search->SearchRightColumnClass ?>"><div<?php echo $userlevelpermissions->permission->CellAttributes() ?>>
...
<script type="text/javascript">
fuserlevelpermissionssearch.Init();
</script>
<?php
