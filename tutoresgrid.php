...
if ($tutores->CurrentAction == "gridadd") {
	...
	if ($tutores->CurrentAction == "" && $tutores_grid->TotalRecs == 0) {
		if (!$Security->CanList())
			$tutores_grid->setWarningMessage(ew_DeniedMsg());
...
<?php if ($tutores->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	...
	<?php } else { ?>
		<th data-name="Fecha_Actualizacion"><div><div id="elh_tutores_Fecha_Actualizacion" class="tutores_Fecha_Actualizacion">
...
<?php if ($tutores->Usuario->Visible) { // Usuario ?>
	...
	<?php } else { ?>
		<th data-name="Usuario"><div><div id="elh_tutores_Usuario" class="tutores_Usuario">
...
<?php if ($tutores->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="tutores" data-field="x_Fecha_Actualizacion" name="o<?php echo $tutores_grid->RowIndex ?>_Fecha_Actualizacion" id="o<?php echo $tutores_grid->RowIndex ?>_Fecha_Actualizacion" value="<?php echo ew_HtmlEncode($tutores->Fecha_Actualizacion->OldValue) ?>">
<?php } ?>
<?php if ($tutores->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<?php } ?>
<?php if ($tutores->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $tutores_grid->RowCnt ?>_tutores_Fecha_Actualizacion" class="tutores_Fecha_Actualizacion">
<span<?php echo $tutores->Fecha_Actualizacion->ViewAttributes() ?>>
<?php echo $tutores->Fecha_Actualizacion->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="tutores" data-field="x_Fecha_Actualizacion" name="x<?php echo $tutores_grid->RowIndex ?>_Fecha_Actualizacion" id="x<?php echo $tutores_grid->RowIndex ?>_Fecha_Actualizacion" value="<?php echo ew_HtmlEncode($tutores->Fecha_Actualizacion->FormValue) ?>">
<input type="hidden" data-table="tutores" data-field="x_Fecha_Actualizacion" name="o<?php echo $tutores_grid->RowIndex ?>_Fecha_Actualizacion" id="o<?php echo $tutores_grid->RowIndex ?>_Fecha_Actualizacion" value="<?php echo ew_HtmlEncode($tutores->Fecha_Actualizacion->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($tutores->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="tutores" data-field="x_Usuario" name="o<?php echo $tutores_grid->RowIndex ?>_Usuario" id="o<?php echo $tutores_grid->RowIndex ?>_Usuario" value="<?php echo ew_HtmlEncode($tutores->Usuario->OldValue) ?>">
<?php } ?>
<?php if ($tutores->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<?php } ?>
<?php if ($tutores->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $tutores_grid->RowCnt ?>_tutores_Usuario" class="tutores_Usuario">
<span<?php echo $tutores->Usuario->ViewAttributes() ?>>
<?php echo $tutores->Usuario->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="tutores" data-field="x_Usuario" name="x<?php echo $tutores_grid->RowIndex ?>_Usuario" id="x<?php echo $tutores_grid->RowIndex ?>_Usuario" value="<?php echo ew_HtmlEncode($tutores->Usuario->FormValue) ?>">
<input type="hidden" data-table="tutores" data-field="x_Usuario" name="o<?php echo $tutores_grid->RowIndex ?>_Usuario" id="o<?php echo $tutores_grid->RowIndex ?>_Usuario" value="<?php echo ew_HtmlEncode($tutores->Usuario->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($tutores->CurrentAction <> "F") { ?>
<?php } else { ?>
<span id="el$rowindex$_tutores_Fecha_Actualizacion" class="form-group tutores_Fecha_Actualizacion">
<span<?php echo $tutores->Fecha_Actualizacion->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $tutores->Fecha_Actualizacion->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="tutores" data-field="x_Fecha_Actualizacion" name="x<?php echo $tutores_grid->RowIndex ?>_Fecha_Actualizacion" id="x<?php echo $tutores_grid->RowIndex ?>_Fecha_Actualizacion" value="<?php echo ew_HtmlEncode($tutores->Fecha_Actualizacion->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="tutores" data-field="x_Fecha_Actualizacion" name="o<?php echo $tutores_grid->RowIndex ?>_Fecha_Actualizacion" id="o<?php echo $tutores_grid->RowIndex ?>_Fecha_Actualizacion" value="<?php echo ew_HtmlEncode($tutores->Fecha_Actualizacion->OldValue) ?>">
...
<?php if ($tutores->CurrentAction <> "F") { ?>
<?php } else { ?>
<span id="el$rowindex$_tutores_Usuario" class="form-group tutores_Usuario">
<span<?php echo $tutores->Usuario->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $tutores->Usuario->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="tutores" data-field="x_Usuario" name="x<?php echo $tutores_grid->RowIndex ?>_Usuario" id="x<?php echo $tutores_grid->RowIndex ?>_Usuario" value="<?php echo ew_HtmlEncode($tutores->Usuario->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="tutores" data-field="x_Usuario" name="o<?php echo $tutores_grid->RowIndex ?>_Usuario" id="o<?php echo $tutores_grid->RowIndex ?>_Usuario" value="<?php echo ew_HtmlEncode($tutores->Usuario->OldValue) ?>">
