...
class catencion_para_st extends cTable {
   ...
   // Common render codes
	...
	if ($ExisteFecha>0){
		...
		echo '<script language="javascript">alert("No Existe fecha devol en bd");</script>';
		if ($FechaDevol!=NULL){
		...
		return TRUE;
			...
			if ($Tiket=='PENDIENTE'){
				...
				echo '<script language="javascript">alert("TIKET PENDIENTE");</script>';
				if ($Retiro==1){
				...
				echo '<script language="javascript">alert("Retirado");</script>';
					$sql = ew_ExecuteRow("SELECT Id_Atencion, Fecha_Devolucion, Id_Tipo_Retiro FROM atencion_para_st WHERE NroSerie='$Serie' and Id_Atencion!=$Id_Atencion ");
					$ExisteAtencion=$sql["Id_Atencion"];
					$Fecha_Devolucion=$sql["Fecha_Devolucion"];
					$TipoRetiro=$sql["Id_Tipo_Retiro"];
					if ($ExisteAtencion>0){

					echo '<script language="javascript">alert("EXISTE OTRa Atencion");</script>';
						if ($Fecha_Devolucion!=NULL){
							...
							echo '<script language="javascript">alert("EXISTE UN PEDIDIO QUE TODAVIA NO REGRESO DE ST");</script>';
							return true;
							}
						}
					}
			...
			elseif($Tiket!='PENDIENTE'){

				echo '<script language="javascript">alert("Dist de pend TIKET");</script>';
				$sql = ew_ExecuteRow("SELECT Id_Atencion FROM atencion_para_st WHERE Nro_Tiket='$Tiket' and Id_Atencion!=$Id_Atencion ");
				$ExisteTiket=$sql["Id_Atencion"];
				if ($ExisteTiket>0){
					echo '<script language="javascript">alert("EXISTE OTRO TIKET CON EL MISMO NUMERO");</script>';
					return FALSE;
				}
				else{

					echo '<script language="javascript">alert("NO EXISTE OTRO TIKET");</script>';
					if ($Retiro==1){
					...
					echo '<script language="javascript">alert("Retiro Correo");</script>';
					$sql = ew_ExecuteRow("SELECT Id_Atencion, Fecha_Devolucion, Id_Tipo_Retiro FROM atencion_para_st WHERE NroSerie='$Serie' and 		Id_Atencion!=$Id_Atencion ");
					$ExisteAtencion=$sql["Id_Atencion"];
					$Fecha_Devolucion=$sql["Fecha_Devolucion"];
					$TipoRetiro=$sql["Id_Tipo_Retiro"];
					if ($ExisteAtencion>0){
						...
						if ($Fecha_Devolucion!=NULL){
							...
							echo '<script language="javascript">alert("EXISTE UN PEDIDO QUE TODAVIA NO REGRESO DE ST");</script>';
							return TRUE;
							}	
