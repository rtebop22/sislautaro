...
$datos_extras_escuela_delete = NULL; // Initialize page object first

class cdatos_extras_escuela_delete extends cdatos_extras_escuela {
	...
	// Page object name
	var $PageObjName = 'datos_extras_escuela_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("datos_extras_escuelalist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in datos_extras_escuela class, datos_extras_escuelainfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("datos_extras_escuelalist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($datos_extras_escuela_delete)) $datos_extras_escuela_delete = new cdatos_extras_escuela_delete();

// Page init
$datos_extras_escuela_delete->Page_Init();

// Page main
$datos_extras_escuela_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$datos_extras_escuela_delete->Page_Render();
?>
...
var CurrentForm = fdatos_extras_escueladelete = new ew_Form("fdatos_extras_escueladelete", "delete");

// Form_CustomValidate event
fdatos_extras_escueladelete.Form_CustomValidate = 
...
fdatos_extras_escueladelete.ValidateRequired = true;
<?php } else { ?>
fdatos_extras_escueladelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdatos_extras_escueladelete.Lists["x_Tiene_Internet"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdatos_extras_escueladelete.Lists["x_Tiene_Internet"].Options = <?php echo json_encode($datos_extras_escuela->Tiene_Internet->Options()) ?>;
fdatos_extras_escueladelete.Lists["x_Estado_Internet"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdatos_extras_escueladelete.Lists["x_Estado_Internet"].Options = <?php echo json_encode($datos_extras_escuela->Estado_Internet->Options()) ?>;
...
<?php $datos_extras_escuela_delete->ShowPageHeader(); ?>
<?php
$datos_extras_escuela_delete->ShowMessage();
?>
<form name="fdatos_extras_escueladelete" id="fdatos_extras_escueladelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($datos_extras_escuela_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $datos_extras_escuela_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="datos_extras_escuela">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($datos_extras_escuela_delete->RecKeys as $key) { ?>
...
<?php if ($datos_extras_escuela->Cue->Visible) { // Cue ?>
		<th><span id="elh_datos_extras_escuela_Cue" class="datos_extras_escuela_Cue"><?php echo $datos_extras_escuela->Cue->FldCaption() ?></span></th>
<?php } ?>
<?php if ($datos_extras_escuela->Usuario_Conig->Visible) { // Usuario_Conig ?>
		<th><span id="elh_datos_extras_escuela_Usuario_Conig" class="datos_extras_escuela_Usuario_Conig"><?php echo $datos_extras_escuela->Usuario_Conig->FldCaption() ?></span></th>
<?php } ?>
<?php if ($datos_extras_escuela->Password_Conig->Visible) { // Password_Conig ?>
		<th><span id="elh_datos_extras_escuela_Password_Conig" class="datos_extras_escuela_Password_Conig"><?php echo $datos_extras_escuela->Password_Conig->FldCaption() ?></span></th>
<?php } ?>
<?php if ($datos_extras_escuela->Tiene_Internet->Visible) { // Tiene_Internet ?>
		<th><span id="elh_datos_extras_escuela_Tiene_Internet" class="datos_extras_escuela_Tiene_Internet"><?php echo $datos_extras_escuela->Tiene_Internet->FldCaption() ?></span></th>
<?php } ?>
<?php if ($datos_extras_escuela->Servicio_Internet->Visible) { // Servicio_Internet ?>
		<th><span id="elh_datos_extras_escuela_Servicio_Internet" class="datos_extras_escuela_Servicio_Internet"><?php echo $datos_extras_escuela->Servicio_Internet->FldCaption() ?></span></th>
<?php } ?>
<?php if ($datos_extras_escuela->Estado_Internet->Visible) { // Estado_Internet ?>
		<th><span id="elh_datos_extras_escuela_Estado_Internet" class="datos_extras_escuela_Estado_Internet"><?php echo $datos_extras_escuela->Estado_Internet->FldCaption() ?></span></th>
<?php } ?>
<?php if ($datos_extras_escuela->Quien_Paga->Visible) { // Quien_Paga ?>
		<th><span id="elh_datos_extras_escuela_Quien_Paga" class="datos_extras_escuela_Quien_Paga"><?php echo $datos_extras_escuela->Quien_Paga->FldCaption() ?></span></th>
<?php } ?>
<?php if ($datos_extras_escuela->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<th><span id="elh_datos_extras_escuela_Fecha_Actualizacion" class="datos_extras_escuela_Fecha_Actualizacion"><?php echo $datos_extras_escuela->Fecha_Actualizacion->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$datos_extras_escuela_delete->RecCnt = 0;
$i = 0;
while (!$datos_extras_escuela_delete->Recordset->EOF) {
	$datos_extras_escuela_delete->RecCnt++;
	$datos_extras_escuela_delete->RowCnt++;

	// Set row properties
	$datos_extras_escuela->ResetAttrs();
	$datos_extras_escuela->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$datos_extras_escuela_delete->LoadRowValues($datos_extras_escuela_delete->Recordset);

	// Render row
	$datos_extras_escuela_delete->RenderRow();
?>
	<tr<?php echo $datos_extras_escuela->RowAttributes() ?>>
<?php if ($datos_extras_escuela->Cue->Visible) { // Cue ?>
		<td<?php echo $datos_extras_escuela->Cue->CellAttributes() ?>>
<span id="el<?php echo $datos_extras_escuela_delete->RowCnt ?>_datos_extras_escuela_Cue" class="datos_extras_escuela_Cue">
...
<?php } ?>
<?php if ($datos_extras_escuela->Usuario_Conig->Visible) { // Usuario_Conig ?>
		<td<?php echo $datos_extras_escuela->Usuario_Conig->CellAttributes() ?>>
<span id="el<?php echo $datos_extras_escuela_delete->RowCnt ?>_datos_extras_escuela_Usuario_Conig" class="datos_extras_escuela_Usuario_Conig">
...
<?php } ?>
<?php if ($datos_extras_escuela->Password_Conig->Visible) { // Password_Conig ?>
		<td<?php echo $datos_extras_escuela->Password_Conig->CellAttributes() ?>>
<span id="el<?php echo $datos_extras_escuela_delete->RowCnt ?>_datos_extras_escuela_Password_Conig" class="datos_extras_escuela_Password_Conig">
...
<?php } ?>
<?php if ($datos_extras_escuela->Tiene_Internet->Visible) { // Tiene_Internet ?>
		<td<?php echo $datos_extras_escuela->Tiene_Internet->CellAttributes() ?>>
<span id="el<?php echo $datos_extras_escuela_delete->RowCnt ?>_datos_extras_escuela_Tiene_Internet" class="datos_extras_escuela_Tiene_Internet">
...
<?php } ?>
<?php if ($datos_extras_escuela->Servicio_Internet->Visible) { // Servicio_Internet ?>
		<td<?php echo $datos_extras_escuela->Servicio_Internet->CellAttributes() ?>>
<span id="el<?php echo $datos_extras_escuela_delete->RowCnt ?>_datos_extras_escuela_Servicio_Internet" class="datos_extras_escuela_Servicio_Internet">
...
<?php } ?>
<?php if ($datos_extras_escuela->Estado_Internet->Visible) { // Estado_Internet ?>
		<td<?php echo $datos_extras_escuela->Estado_Internet->CellAttributes() ?>>
<span id="el<?php echo $datos_extras_escuela_delete->RowCnt ?>_datos_extras_escuela_Estado_Internet" class="datos_extras_escuela_Estado_Internet">
...
<?php } ?>
<?php if ($datos_extras_escuela->Quien_Paga->Visible) { // Quien_Paga ?>
		<td<?php echo $datos_extras_escuela->Quien_Paga->CellAttributes() ?>>
<span id="el<?php echo $datos_extras_escuela_delete->RowCnt ?>_datos_extras_escuela_Quien_Paga" class="datos_extras_escuela_Quien_Paga">
...
<?php } ?>
<?php if ($datos_extras_escuela->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<td<?php echo $datos_extras_escuela->Fecha_Actualizacion->CellAttributes() ?>>
<span id="el<?php echo $datos_extras_escuela_delete->RowCnt ?>_datos_extras_escuela_Fecha_Actualizacion" class="datos_extras_escuela_Fecha_Actualizacion">
...
<?php
	$datos_extras_escuela_delete->Recordset->MoveNext();
}
$datos_extras_escuela_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $datos_extras_escuela_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fdatos_extras_escueladelete.Init();
</script>
<?php
$datos_extras_escuela_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$datos_extras_escuela_delete->Page_Terminate();
?>
