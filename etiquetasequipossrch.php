...
$etiquetasequipos_search = NULL; // Initialize page object first

class cetiquetasequipos_search extends cetiquetasequipos {
	...
	// Page object name
	var $PageObjName = 'etiquetasequipos_search';
	...
	function Page_Init() {
		...
		if (!$Security->CanSearch()) {
			...
			if ($Security->CanList())
				$this->Page_Terminate(ew_GetUrl("etiquetasequiposlist.php"));
			else
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "etiquetasequiposlist.php" . "?" . $sSrchStr;
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, $this->AddMasterUrl("etiquetasequiposlist.php"), "", $this->TableVar, TRUE);
		$PageId = "search";
...
// Create page object
if (!isset($etiquetasequipos_search)) $etiquetasequipos_search = new cetiquetasequipos_search();

// Page init
$etiquetasequipos_search->Page_Init();

// Page main
$etiquetasequipos_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$etiquetasequipos_search->Page_Render();
?>
...
<?php if ($etiquetasequipos_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fetiquetasequipossearch = new ew_Form("fetiquetasequipossearch", "search");
<?php } else { ?>
var CurrentForm = fetiquetasequipossearch = new ew_Form("fetiquetasequipossearch", "search");
<?php } ?>

// Form_CustomValidate event
fetiquetasequipossearch.Form_CustomValidate = 
...
fetiquetasequipossearch.ValidateRequired = true;
<?php } else { ?>
fetiquetasequipossearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fetiquetasequipossearch.Lists["x_Id_Curso"] = {"LinkField":"x_Id_Curso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cursos"};
fetiquetasequipossearch.Lists["x_Id_Division"] = {"LinkField":"x_Id_Division","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"division"};
fetiquetasequipossearch.Lists["x_Id_Turno"] = {"LinkField":"x_Id_Turno","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"turno"};
fetiquetasequipossearch.Lists["x_Id_Cargo"] = {"LinkField":"x_Id_Cargo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cargo_persona"};
fetiquetasequipossearch.Lists["x_Id_Estado"] = {"LinkField":"x_Id_Estado","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_persona"};
fetiquetasequipossearch.Lists["x_NroSerie"] = {"LinkField":"x_NroSerie","Ajax":true,"AutoFill":false,"DisplayFields":["x_NroSerie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};

// Form object for search
// Validate function for search

fetiquetasequipossearch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($etiquetasequipos->Dni->FldErrMsg()) ?>");
...
<?php } ?>
<?php $etiquetasequipos_search->ShowPageHeader(); ?>
<?php
$etiquetasequipos_search->ShowMessage();
?>
<form name="fetiquetasequipossearch" id="fetiquetasequipossearch" class="<?php echo $etiquetasequipos_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($etiquetasequipos_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $etiquetasequipos_search->Token ?>">
<?php } ?>
...
<?php if ($etiquetasequipos->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
	<div id="r_Apellidos_Nombres" class="form-group">
		<label for="x_Apellidos_Nombres" class="<?php echo $etiquetasequipos_search->SearchLabelClass ?>"><span id="elh_etiquetasequipos_Apellidos_Nombres"><?php echo $etiquetasequipos->Apellidos_Nombres->FldCaption() ?></span>	
		...
		<div class="<?php echo $etiquetasequipos_search->SearchRightColumnClass ?>"><div<?php echo $etiquetasequipos->Apellidos_Nombres->CellAttributes() ?>>
			<span id="el_etiquetasequipos_Apellidos_Nombres">
<input type="text" data-table="etiquetasequipos" data-field="x_Apellidos_Nombres" name="x_Apellidos_Nombres" id="x_Apellidos_Nombres" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($etiquetasequipos->Apellidos_Nombres->getPlaceHolder()) ?>" value="<?php echo $etiquetasequipos->Apellidos_Nombres->EditValue ?>"<?php echo $etiquetasequipos->Apellidos_Nombres->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($etiquetasequipos->Id_Curso->Visible) { // Id_Curso ?>
	<div id="r_Id_Curso" class="form-group">
		<label for="x_Id_Curso" class="<?php echo $etiquetasequipos_search->SearchLabelClass ?>"><span id="elh_etiquetasequipos_Id_Curso"><?php echo $etiquetasequipos->Id_Curso->FldCaption() ?></span>	
		...
		<div class="<?php echo $etiquetasequipos_search->SearchRightColumnClass ?>"><div<?php echo $etiquetasequipos->Id_Curso->CellAttributes() ?>>
			<span id="el_etiquetasequipos_Id_Curso">
<select data-table="etiquetasequipos" data-field="x_Id_Curso" data-value-separator="<?php echo $etiquetasequipos->Id_Curso->DisplayValueSeparatorAttribute() ?>" id="x_Id_Curso" name="x_Id_Curso"<?php echo $etiquetasequipos->Id_Curso->EditAttributes() ?>>
<?php echo $etiquetasequipos->Id_Curso->SelectOptionListHtml("x_Id_Curso") ?>
</select>
<input type="hidden" name="s_x_Id_Curso" id="s_x_Id_Curso" value="<?php echo $etiquetasequipos->Id_Curso->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($etiquetasequipos->Id_Division->Visible) { // Id_Division ?>
	<div id="r_Id_Division" class="form-group">
		<label for="x_Id_Division" class="<?php echo $etiquetasequipos_search->SearchLabelClass ?>"><span id="elh_etiquetasequipos_Id_Division"><?php echo $etiquetasequipos->Id_Division->FldCaption() ?></span>	
		...
		<div class="<?php echo $etiquetasequipos_search->SearchRightColumnClass ?>"><div<?php echo $etiquetasequipos->Id_Division->CellAttributes() ?>>
			<span id="el_etiquetasequipos_Id_Division">
<select data-table="etiquetasequipos" data-field="x_Id_Division" data-value-separator="<?php echo $etiquetasequipos->Id_Division->DisplayValueSeparatorAttribute() ?>" id="x_Id_Division" name="x_Id_Division"<?php echo $etiquetasequipos->Id_Division->EditAttributes() ?>>
<?php echo $etiquetasequipos->Id_Division->SelectOptionListHtml("x_Id_Division") ?>
</select>
<input type="hidden" name="s_x_Id_Division" id="s_x_Id_Division" value="<?php echo $etiquetasequipos->Id_Division->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($etiquetasequipos->Id_Turno->Visible) { // Id_Turno ?>
	<div id="r_Id_Turno" class="form-group">
		<label for="x_Id_Turno" class="<?php echo $etiquetasequipos_search->SearchLabelClass ?>"><span id="elh_etiquetasequipos_Id_Turno"><?php echo $etiquetasequipos->Id_Turno->FldCaption() ?></span>	
		...
		<div class="<?php echo $etiquetasequipos_search->SearchRightColumnClass ?>"><div<?php echo $etiquetasequipos->Id_Turno->CellAttributes() ?>>
			<span id="el_etiquetasequipos_Id_Turno">
<select data-table="etiquetasequipos" data-field="x_Id_Turno" data-value-separator="<?php echo $etiquetasequipos->Id_Turno->DisplayValueSeparatorAttribute() ?>" id="x_Id_Turno" name="x_Id_Turno"<?php echo $etiquetasequipos->Id_Turno->EditAttributes() ?>>
<?php echo $etiquetasequipos->Id_Turno->SelectOptionListHtml("x_Id_Turno") ?>
</select>
<input type="hidden" name="s_x_Id_Turno" id="s_x_Id_Turno" value="<?php echo $etiquetasequipos->Id_Turno->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($etiquetasequipos->Id_Cargo->Visible) { // Id_Cargo ?>
	<div id="r_Id_Cargo" class="form-group">
		<label for="x_Id_Cargo" class="<?php echo $etiquetasequipos_search->SearchLabelClass ?>"><span id="elh_etiquetasequipos_Id_Cargo"><?php echo $etiquetasequipos->Id_Cargo->FldCaption() ?></span>	
		...
		<div class="<?php echo $etiquetasequipos_search->SearchRightColumnClass ?>"><div<?php echo $etiquetasequipos->Id_Cargo->CellAttributes() ?>>
			<span id="el_etiquetasequipos_Id_Cargo">
<select data-table="etiquetasequipos" data-field="x_Id_Cargo" data-value-separator="<?php echo $etiquetasequipos->Id_Cargo->DisplayValueSeparatorAttribute() ?>" id="x_Id_Cargo" name="x_Id_Cargo"<?php echo $etiquetasequipos->Id_Cargo->EditAttributes() ?>>
<?php echo $etiquetasequipos->Id_Cargo->SelectOptionListHtml("x_Id_Cargo") ?>
</select>
<input type="hidden" name="s_x_Id_Cargo" id="s_x_Id_Cargo" value="<?php echo $etiquetasequipos->Id_Cargo->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($etiquetasequipos->Id_Estado->Visible) { // Id_Estado ?>
	<div id="r_Id_Estado" class="form-group">
		<label for="x_Id_Estado" class="<?php echo $etiquetasequipos_search->SearchLabelClass ?>"><span id="elh_etiquetasequipos_Id_Estado"><?php echo $etiquetasequipos->Id_Estado->FldCaption() ?></span>	
		...
		<div class="<?php echo $etiquetasequipos_search->SearchRightColumnClass ?>"><div<?php echo $etiquetasequipos->Id_Estado->CellAttributes() ?>>
			<span id="el_etiquetasequipos_Id_Estado">
<select data-table="etiquetasequipos" data-field="x_Id_Estado" data-value-separator="<?php echo $etiquetasequipos->Id_Estado->DisplayValueSeparatorAttribute() ?>" id="x_Id_Estado" name="x_Id_Estado"<?php echo $etiquetasequipos->Id_Estado->EditAttributes() ?>>
<?php echo $etiquetasequipos->Id_Estado->SelectOptionListHtml("x_Id_Estado") ?>
</select>
<input type="hidden" name="s_x_Id_Estado" id="s_x_Id_Estado" value="<?php echo $etiquetasequipos->Id_Estado->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($etiquetasequipos->Dni->Visible) { // Dni ?>
	<div id="r_Dni" class="form-group">
		<label for="x_Dni" class="<?php echo $etiquetasequipos_search->SearchLabelClass ?>"><span id="elh_etiquetasequipos_Dni"><?php echo $etiquetasequipos->Dni->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_Dni" id="z_Dni" value="="></p>
		</label>
		<div class="<?php echo $etiquetasequipos_search->SearchRightColumnClass ?>"><div<?php echo $etiquetasequipos->Dni->CellAttributes() ?>>
			<span id="el_etiquetasequipos_Dni">
<input type="text" data-table="etiquetasequipos" data-field="x_Dni" name="x_Dni" id="x_Dni" size="30" placeholder="<?php echo ew_HtmlEncode($etiquetasequipos->Dni->getPlaceHolder()) ?>" value="<?php echo $etiquetasequipos->Dni->EditValue ?>"<?php echo $etiquetasequipos->Dni->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($etiquetasequipos->NroSerie->Visible) { // NroSerie ?>
	<div id="r_NroSerie" class="form-group">
		<label class="<?php echo $etiquetasequipos_search->SearchLabelClass ?>"><span id="elh_etiquetasequipos_NroSerie"><?php echo $etiquetasequipos->NroSerie->FldCaption() ?></span>	
		...
		<div class="<?php echo $etiquetasequipos_search->SearchRightColumnClass ?>"><div<?php echo $etiquetasequipos->NroSerie->CellAttributes() ?>>
			<span id="el_etiquetasequipos_NroSerie">
<?php
$wrkonchange = trim(" " . @$etiquetasequipos->NroSerie->EditAttrs["onchange"]);
if ($wrkonchange <> "") $wrkonchange = " onchange=\"" . ew_JsEncode2($wrkonchange) . "\"";
$etiquetasequipos->NroSerie->EditAttrs["onchange"] = "";
?>
<span id="as_x_NroSerie" style="white-space: nowrap; z-index: NaN">
	<input type="text" name="sv_x_NroSerie" id="sv_x_NroSerie" value="<?php echo $etiquetasequipos->NroSerie->EditValue ?>" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($etiquetasequipos->NroSerie->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($etiquetasequipos->NroSerie->getPlaceHolder()) ?>"<?php echo $etiquetasequipos->NroSerie->EditAttributes() ?>>
</span>
<input type="hidden" data-table="etiquetasequipos" data-field="x_NroSerie" data-value-separator="<?php echo $etiquetasequipos->NroSerie->DisplayValueSeparatorAttribute() ?>" name="x_NroSerie" id="x_NroSerie" value="<?php echo ew_HtmlEncode($etiquetasequipos->NroSerie->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<input type="hidden" name="q_x_NroSerie" id="q_x_NroSerie" value="<?php echo $etiquetasequipos->NroSerie->LookupFilterQuery(true) ?>">
<script type="text/javascript">
fetiquetasequipossearch.CreateAutoSuggest({"id":"x_NroSerie","forceSelect":true});
</script>
</span>
		</div></div>
	</div>
...
<script type="text/javascript">
fetiquetasequipossearch.Init();
</script>
<?php
$etiquetasequipos_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$etiquetasequipos_search->Page_Terminate();
?>
