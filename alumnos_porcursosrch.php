...
$alumnos_porcurso_search = NULL; // Initialize page object first

class calumnos_porcurso_search extends calumnos_porcurso {
	...
	// Page object name
	var $PageObjName = 'alumnos_porcurso_search';
	...
	function Page_Init() {
		...
		if (!$Security->CanSearch()) {
			...
			if ($Security->CanList())
				$this->Page_Terminate(ew_GetUrl("alumnos_porcursolist.php"));
			else
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "alumnos_porcursolist.php" . "?" . $sSrchStr;
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, $this->AddMasterUrl("alumnos_porcursolist.php"), "", $this->TableVar, TRUE);
		$PageId = "search";
...
// Create page object
if (!isset($alumnos_porcurso_search)) $alumnos_porcurso_search = new calumnos_porcurso_search();

// Page init
$alumnos_porcurso_search->Page_Init();

// Page main
$alumnos_porcurso_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$alumnos_porcurso_search->Page_Render();
?>
...
<?php if ($alumnos_porcurso_search->IsModal) { ?>
var CurrentAdvancedSearchForm = falumnos_porcursosearch = new ew_Form("falumnos_porcursosearch", "search");
<?php } else { ?>
var CurrentForm = falumnos_porcursosearch = new ew_Form("falumnos_porcursosearch", "search");
<?php } ?>

// Form_CustomValidate event
falumnos_porcursosearch.Form_CustomValidate = 
...
falumnos_porcursosearch.ValidateRequired = true;
<?php } else { ?>
falumnos_porcursosearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
falumnos_porcursosearch.Lists["x_Id_Curso"] = {"LinkField":"x_Id_Curso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cursos"};
falumnos_porcursosearch.Lists["x_Id_Division"] = {"LinkField":"x_Id_Division","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"division"};
falumnos_porcursosearch.Lists["x_Id_Turno"] = {"LinkField":"x_Id_Turno","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"turno"};
falumnos_porcursosearch.Lists["x_Id_Estado"] = {"LinkField":"x_Id_Estado","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_persona"};
falumnos_porcursosearch.Lists["x_Id_Cargo"] = {"LinkField":"x_Id_Cargo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cargo_persona"};

// Form object for search
// Validate function for search

falumnos_porcursosearch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($alumnos_porcurso->Dni->FldErrMsg()) ?>");
	elm = this.GetElements("x" + infix + "_Fecha_Actualizacion");
	if (elm && !ew_CheckEuroDate(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($alumnos_porcurso->Fecha_Actualizacion->FldErrMsg()) ?>");
...
<?php } ?>
<?php $alumnos_porcurso_search->ShowPageHeader(); ?>
<?php
$alumnos_porcurso_search->ShowMessage();
?>
<form name="falumnos_porcursosearch" id="falumnos_porcursosearch" class="<?php echo $alumnos_porcurso_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($alumnos_porcurso_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $alumnos_porcurso_search->Token ?>">
<?php } ?>
...
<?php if ($alumnos_porcurso->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
	<div id="r_Apellidos_Nombres" class="form-group">
		<label for="x_Apellidos_Nombres" class="<?php echo $alumnos_porcurso_search->SearchLabelClass ?>"><span id="elh_alumnos_porcurso_Apellidos_Nombres"><?php echo $alumnos_porcurso->Apellidos_Nombres->FldCaption() ?></span>	
		...
		<div class="<?php echo $alumnos_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $alumnos_porcurso->Apellidos_Nombres->CellAttributes() ?>>
			<span id="el_alumnos_porcurso_Apellidos_Nombres">
<input type="text" data-table="alumnos_porcurso" data-field="x_Apellidos_Nombres" name="x_Apellidos_Nombres" id="x_Apellidos_Nombres" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($alumnos_porcurso->Apellidos_Nombres->getPlaceHolder()) ?>" value="<?php echo $alumnos_porcurso->Apellidos_Nombres->EditValue ?>"<?php echo $alumnos_porcurso->Apellidos_Nombres->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($alumnos_porcurso->Dni->Visible) { // Dni ?>
	<div id="r_Dni" class="form-group">
		<label for="x_Dni" class="<?php echo $alumnos_porcurso_search->SearchLabelClass ?>"><span id="elh_alumnos_porcurso_Dni"><?php echo $alumnos_porcurso->Dni->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_Dni" id="z_Dni" value="="></p>
		</label>
		<div class="<?php echo $alumnos_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $alumnos_porcurso->Dni->CellAttributes() ?>>
			<span id="el_alumnos_porcurso_Dni">
<input type="text" data-table="alumnos_porcurso" data-field="x_Dni" name="x_Dni" id="x_Dni" size="30" placeholder="<?php echo ew_HtmlEncode($alumnos_porcurso->Dni->getPlaceHolder()) ?>" value="<?php echo $alumnos_porcurso->Dni->EditValue ?>"<?php echo $alumnos_porcurso->Dni->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($alumnos_porcurso->Id_Curso->Visible) { // Id_Curso ?>
	<div id="r_Id_Curso" class="form-group">
		<label for="x_Id_Curso" class="<?php echo $alumnos_porcurso_search->SearchLabelClass ?>"><span id="elh_alumnos_porcurso_Id_Curso"><?php echo $alumnos_porcurso->Id_Curso->FldCaption() ?></span>	
		...
		<div class="<?php echo $alumnos_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $alumnos_porcurso->Id_Curso->CellAttributes() ?>>
			<span id="el_alumnos_porcurso_Id_Curso">
<select data-table="alumnos_porcurso" data-field="x_Id_Curso" data-value-separator="<?php echo $alumnos_porcurso->Id_Curso->DisplayValueSeparatorAttribute() ?>" id="x_Id_Curso" name="x_Id_Curso"<?php echo $alumnos_porcurso->Id_Curso->EditAttributes() ?>>
<?php echo $alumnos_porcurso->Id_Curso->SelectOptionListHtml("x_Id_Curso") ?>
</select>
<input type="hidden" name="s_x_Id_Curso" id="s_x_Id_Curso" value="<?php echo $alumnos_porcurso->Id_Curso->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($alumnos_porcurso->Id_Division->Visible) { // Id_Division ?>
	<div id="r_Id_Division" class="form-group">
		<label for="x_Id_Division" class="<?php echo $alumnos_porcurso_search->SearchLabelClass ?>"><span id="elh_alumnos_porcurso_Id_Division"><?php echo $alumnos_porcurso->Id_Division->FldCaption() ?></span>	
		...
		<div class="<?php echo $alumnos_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $alumnos_porcurso->Id_Division->CellAttributes() ?>>
			<span id="el_alumnos_porcurso_Id_Division">
<select data-table="alumnos_porcurso" data-field="x_Id_Division" data-value-separator="<?php echo $alumnos_porcurso->Id_Division->DisplayValueSeparatorAttribute() ?>" id="x_Id_Division" name="x_Id_Division"<?php echo $alumnos_porcurso->Id_Division->EditAttributes() ?>>
<?php echo $alumnos_porcurso->Id_Division->SelectOptionListHtml("x_Id_Division") ?>
</select>
<input type="hidden" name="s_x_Id_Division" id="s_x_Id_Division" value="<?php echo $alumnos_porcurso->Id_Division->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($alumnos_porcurso->Id_Turno->Visible) { // Id_Turno ?>
	<div id="r_Id_Turno" class="form-group">
		<label for="x_Id_Turno" class="<?php echo $alumnos_porcurso_search->SearchLabelClass ?>"><span id="elh_alumnos_porcurso_Id_Turno"><?php echo $alumnos_porcurso->Id_Turno->FldCaption() ?></span>	
		...
		<div class="<?php echo $alumnos_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $alumnos_porcurso->Id_Turno->CellAttributes() ?>>
			<span id="el_alumnos_porcurso_Id_Turno">
<select data-table="alumnos_porcurso" data-field="x_Id_Turno" data-value-separator="<?php echo $alumnos_porcurso->Id_Turno->DisplayValueSeparatorAttribute() ?>" id="x_Id_Turno" name="x_Id_Turno"<?php echo $alumnos_porcurso->Id_Turno->EditAttributes() ?>>
<?php echo $alumnos_porcurso->Id_Turno->SelectOptionListHtml("x_Id_Turno") ?>
</select>
<input type="hidden" name="s_x_Id_Turno" id="s_x_Id_Turno" value="<?php echo $alumnos_porcurso->Id_Turno->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($alumnos_porcurso->Id_Estado->Visible) { // Id_Estado ?>
	<div id="r_Id_Estado" class="form-group">
		<label for="x_Id_Estado" class="<?php echo $alumnos_porcurso_search->SearchLabelClass ?>"><span id="elh_alumnos_porcurso_Id_Estado"><?php echo $alumnos_porcurso->Id_Estado->FldCaption() ?></span>	
		...
		<div class="<?php echo $alumnos_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $alumnos_porcurso->Id_Estado->CellAttributes() ?>>
			<span id="el_alumnos_porcurso_Id_Estado">
<select data-table="alumnos_porcurso" data-field="x_Id_Estado" data-value-separator="<?php echo $alumnos_porcurso->Id_Estado->DisplayValueSeparatorAttribute() ?>" id="x_Id_Estado" name="x_Id_Estado"<?php echo $alumnos_porcurso->Id_Estado->EditAttributes() ?>>
<?php echo $alumnos_porcurso->Id_Estado->SelectOptionListHtml("x_Id_Estado") ?>
</select>
<input type="hidden" name="s_x_Id_Estado" id="s_x_Id_Estado" value="<?php echo $alumnos_porcurso->Id_Estado->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($alumnos_porcurso->Id_Cargo->Visible) { // Id_Cargo ?>
	<div id="r_Id_Cargo" class="form-group">
		<label for="x_Id_Cargo" class="<?php echo $alumnos_porcurso_search->SearchLabelClass ?>"><span id="elh_alumnos_porcurso_Id_Cargo"><?php echo $alumnos_porcurso->Id_Cargo->FldCaption() ?></span>	
		...
		<div class="<?php echo $alumnos_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $alumnos_porcurso->Id_Cargo->CellAttributes() ?>>
			<span id="el_alumnos_porcurso_Id_Cargo">
<select data-table="alumnos_porcurso" data-field="x_Id_Cargo" data-value-separator="<?php echo $alumnos_porcurso->Id_Cargo->DisplayValueSeparatorAttribute() ?>" id="x_Id_Cargo" name="x_Id_Cargo"<?php echo $alumnos_porcurso->Id_Cargo->EditAttributes() ?>>
<?php echo $alumnos_porcurso->Id_Cargo->SelectOptionListHtml("x_Id_Cargo") ?>
</select>
<input type="hidden" name="s_x_Id_Cargo" id="s_x_Id_Cargo" value="<?php echo $alumnos_porcurso->Id_Cargo->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($alumnos_porcurso->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<div id="r_Fecha_Actualizacion" class="form-group">
		<label for="x_Fecha_Actualizacion" class="<?php echo $alumnos_porcurso_search->SearchLabelClass ?>"><span id="elh_alumnos_porcurso_Fecha_Actualizacion"><?php echo $alumnos_porcurso->Fecha_Actualizacion->FldCaption() ?></span>	
		...
		<div class="<?php echo $alumnos_porcurso_search->SearchRightColumnClass ?>"><div<?php echo $alumnos_porcurso->Fecha_Actualizacion->CellAttributes() ?>>
			<span id="el_alumnos_porcurso_Fecha_Actualizacion">
<input type="text" data-table="alumnos_porcurso" data-field="x_Fecha_Actualizacion" data-format="7" name="x_Fecha_Actualizacion" id="x_Fecha_Actualizacion" placeholder="<?php echo ew_HtmlEncode($alumnos_porcurso->Fecha_Actualizacion->getPlaceHolder()) ?>" value="<?php echo $alumnos_porcurso->Fecha_Actualizacion->EditValue ?>"<?php echo $alumnos_porcurso->Fecha_Actualizacion->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
...
<script type="text/javascript">
falumnos_porcursosearch.Init();
</script>
<?php
$alumnos_porcurso_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$alumnos_porcurso_search->Page_Terminate();
?>
