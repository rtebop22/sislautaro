...
$atencion_para_st_view = NULL; // Initialize page object first

class catencion_para_st_view extends catencion_para_st {
	...
	// Page object name
	var $PageObjName = 'atencion_para_st_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Id_Atencion"] <> "") {
				...
				$sReturnUrl = "atencion_para_stlist.php"; // Return to list
			}
			if (@$_GET["NroSerie"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "atencion_para_stlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "atencion_para_stlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($atencion_para_st_view)) $atencion_para_st_view = new catencion_para_st_view();

// Page init
$atencion_para_st_view->Page_Init();

// Page main
$atencion_para_st_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$atencion_para_st_view->Page_Render();
?>
...
var CurrentForm = fatencion_para_stview = new ew_Form("fatencion_para_stview", "view");

// Form_CustomValidate event
fatencion_para_stview.Form_CustomValidate = 
...
fatencion_para_stview.ValidateRequired = true;
<?php } else { ?>
fatencion_para_stview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fatencion_para_stview.Lists["x_Id_Tipo_Retiro"] = {"LinkField":"x_Id_Tipo_Retiro","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_retiro_atencion_st"};
...
<?php if ($atencion_para_st->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$atencion_para_st_view->IsModal) { ?>
<?php if ($atencion_para_st->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $atencion_para_st_view->ExportOptions->Render("body") ?>
<?php
	foreach ($atencion_para_st_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$atencion_para_st_view->IsModal) { ?>
<?php if ($atencion_para_st->Export == "") { ?>
...
<?php } ?>
<?php $atencion_para_st_view->ShowPageHeader(); ?>
<?php
$atencion_para_st_view->ShowMessage();
?>
<form name="fatencion_para_stview" id="fatencion_para_stview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($atencion_para_st_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $atencion_para_st_view->Token ?>">
<?php } ?>
...
<?php if ($atencion_para_st->Id_Atencion->Visible) { // Id_Atencion ?>
	<tr id="r_Id_Atencion">
		<td><span id="elh_atencion_para_st_Id_Atencion"><?php echo $atencion_para_st->Id_Atencion->FldCaption() ?></span></td>
		<td data-name="Id_Atencion"<?php echo $atencion_para_st->Id_Atencion->CellAttributes() ?>>
<span id="el_atencion_para_st_Id_Atencion" data-page="1">
<span<?php echo $atencion_para_st->Id_Atencion->ViewAttributes() ?>>
<?php echo $atencion_para_st->Id_Atencion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($atencion_para_st->NroSerie->Visible) { // NroSerie ?>
	<tr id="r_NroSerie">
		<td><span id="elh_atencion_para_st_NroSerie"><?php echo $atencion_para_st->NroSerie->FldCaption() ?></span></td>
		<td data-name="NroSerie"<?php echo $atencion_para_st->NroSerie->CellAttributes() ?>>
<span id="el_atencion_para_st_NroSerie" data-page="1">
<span<?php echo $atencion_para_st->NroSerie->ViewAttributes() ?>>
<?php echo $atencion_para_st->NroSerie->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($atencion_para_st->Nro_Tiket->Visible) { // Nro_Tiket ?>
	<tr id="r_Nro_Tiket">
		<td><span id="elh_atencion_para_st_Nro_Tiket"><?php echo $atencion_para_st->Nro_Tiket->FldCaption() ?></span></td>
		<td data-name="Nro_Tiket"<?php echo $atencion_para_st->Nro_Tiket->CellAttributes() ?>>
<span id="el_atencion_para_st_Nro_Tiket" data-page="1">
<span<?php echo $atencion_para_st->Nro_Tiket->ViewAttributes() ?>>
<?php echo $atencion_para_st->Nro_Tiket->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($atencion_para_st->Id_Tipo_Retiro->Visible) { // Id_Tipo_Retiro ?>
	<tr id="r_Id_Tipo_Retiro">
		<td><span id="elh_atencion_para_st_Id_Tipo_Retiro"><?php echo $atencion_para_st->Id_Tipo_Retiro->FldCaption() ?></span></td>
		<td data-name="Id_Tipo_Retiro"<?php echo $atencion_para_st->Id_Tipo_Retiro->CellAttributes() ?>>
<span id="el_atencion_para_st_Id_Tipo_Retiro" data-page="1">
<span<?php echo $atencion_para_st->Id_Tipo_Retiro->ViewAttributes() ?>>
<?php echo $atencion_para_st->Id_Tipo_Retiro->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($atencion_para_st->Referencia_Tipo_Retiro->Visible) { // Referencia_Tipo_Retiro ?>
	<tr id="r_Referencia_Tipo_Retiro">
		<td><span id="elh_atencion_para_st_Referencia_Tipo_Retiro"><?php echo $atencion_para_st->Referencia_Tipo_Retiro->FldCaption() ?></span></td>
		<td data-name="Referencia_Tipo_Retiro"<?php echo $atencion_para_st->Referencia_Tipo_Retiro->CellAttributes() ?>>
<span id="el_atencion_para_st_Referencia_Tipo_Retiro" data-page="1">
<span<?php echo $atencion_para_st->Referencia_Tipo_Retiro->ViewAttributes() ?>>
<?php echo $atencion_para_st->Referencia_Tipo_Retiro->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($atencion_para_st->Fecha_Retiro->Visible) { // Fecha_Retiro ?>
	<tr id="r_Fecha_Retiro">
		<td><span id="elh_atencion_para_st_Fecha_Retiro"><?php echo $atencion_para_st->Fecha_Retiro->FldCaption() ?></span></td>
		<td data-name="Fecha_Retiro"<?php echo $atencion_para_st->Fecha_Retiro->CellAttributes() ?>>
<span id="el_atencion_para_st_Fecha_Retiro" data-page="1">
<span<?php echo $atencion_para_st->Fecha_Retiro->ViewAttributes() ?>>
<?php echo $atencion_para_st->Fecha_Retiro->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($atencion_para_st->Observacion->Visible) { // Observacion ?>
	<tr id="r_Observacion">
		<td><span id="elh_atencion_para_st_Observacion"><?php echo $atencion_para_st->Observacion->FldCaption() ?></span></td>
		<td data-name="Observacion"<?php echo $atencion_para_st->Observacion->CellAttributes() ?>>
<span id="el_atencion_para_st_Observacion" data-page="1">
<span<?php echo $atencion_para_st->Observacion->ViewAttributes() ?>>
<?php echo $atencion_para_st->Observacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($atencion_para_st->Fecha_Devolucion->Visible) { // Fecha_Devolucion ?>
	<tr id="r_Fecha_Devolucion">
		<td><span id="elh_atencion_para_st_Fecha_Devolucion"><?php echo $atencion_para_st->Fecha_Devolucion->FldCaption() ?></span></td>
		<td data-name="Fecha_Devolucion"<?php echo $atencion_para_st->Fecha_Devolucion->CellAttributes() ?>>
<span id="el_atencion_para_st_Fecha_Devolucion" data-page="1">
<span<?php echo $atencion_para_st->Fecha_Devolucion->ViewAttributes() ?>>
<?php echo $atencion_para_st->Fecha_Devolucion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($atencion_para_st->Export == "") { ?>
<script type="text/javascript">
fatencion_para_stview.Init();
</script>
<?php } ?>
<?php
$atencion_para_st_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($atencion_para_st->Export == "") { ?>
...
<?php
$atencion_para_st_view->Page_Terminate();
?>
