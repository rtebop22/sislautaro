...
$zonas_search = NULL; // Initialize page object first

class czonas_search extends czonas {
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "zonaslist.php" . "?" . $sSrchStr;
	...
	function RenderRow() {
		...
		$this->Usuario->ViewCustomAttributes = "";
			...
			$this->Id_Zona->EditValue = ew_HtmlEncode($this->Id_Zona->AdvancedSearch->SearchValue);
	...
	function ValidateSearch() {
		...
		if (!EW_SERVER_VALIDATE)
			return TRUE;
		if (!ew_CheckInteger($this->Id_Zona->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->Id_Zona->FldErrMsg());
		}
...
// Create page object
if (!isset($zonas_search)) $zonas_search = new czonas_search();

// Page init
$zonas_search->Page_Init();

// Page main
$zonas_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$zonas_search->Page_Render();
?>
...
<?php if ($zonas_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fzonassearch = new ew_Form("fzonassearch", "search");
<?php } else { ?>
var CurrentForm = fzonassearch = new ew_Form("fzonassearch", "search");
<?php } ?>

// Form_CustomValidate event
fzonassearch.Form_CustomValidate = 
...
fzonassearch.ValidateRequired = true;
<?php } else { ?>
fzonassearch.ValidateRequired = false; 
<?php } ?>
...
fzonassearch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($zonas->Id_Zona->FldErrMsg()) ?>");
...
<?php } ?>
<?php $zonas_search->ShowPageHeader(); ?>
<?php
$zonas_search->ShowMessage();
?>
<form name="fzonassearch" id="fzonassearch" class="<?php echo $zonas_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($zonas_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $zonas_search->Token ?>">
<?php } ?>
...
<?php if ($zonas->Id_Zona->Visible) { // Id_Zona ?>
	<div id="r_Id_Zona" class="form-group">
		<label for="x_Id_Zona" class="<?php echo $zonas_search->SearchLabelClass ?>"><span id="elh_zonas_Id_Zona"><?php echo $zonas->Id_Zona->FldCaption() ?></span>	
		...
		<div class="<?php echo $zonas_search->SearchRightColumnClass ?>"><div<?php echo $zonas->Id_Zona->CellAttributes() ?>>
			<span id="el_zonas_Id_Zona">
<input type="text" data-table="zonas" data-field="x_Id_Zona" name="x_Id_Zona" id="x_Id_Zona" placeholder="<?php echo ew_HtmlEncode($zonas->Id_Zona->getPlaceHolder()) ?>" value="<?php echo $zonas->Id_Zona->EditValue ?>"<?php echo $zonas->Id_Zona->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($zonas->Descripcion->Visible) { // Descripcion ?>
	<div id="r_Descripcion" class="form-group">
		<label for="x_Descripcion" class="<?php echo $zonas_search->SearchLabelClass ?>"><span id="elh_zonas_Descripcion"><?php echo $zonas->Descripcion->FldCaption() ?></span>	
		...
		<div class="<?php echo $zonas_search->SearchRightColumnClass ?>"><div<?php echo $zonas->Descripcion->CellAttributes() ?>>
...
<?php if ($zonas->Id_Departamento->Visible) { // Id_Departamento ?>
	<div id="r_Id_Departamento" class="form-group">
		<label for="x_Id_Departamento" class="<?php echo $zonas_search->SearchLabelClass ?>"><span id="elh_zonas_Id_Departamento"><?php echo $zonas->Id_Departamento->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Id_Departamento" id="z_Id_Departamento" value="LIKE"></p>
		</label>
		<div class="<?php echo $zonas_search->SearchRightColumnClass ?>"><div<?php echo $zonas->Id_Departamento->CellAttributes() ?>>
...
<?php if ($zonas->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<div id="r_Fecha_Actualizacion" class="form-group">
		<label for="x_Fecha_Actualizacion" class="<?php echo $zonas_search->SearchLabelClass ?>"><span id="elh_zonas_Fecha_Actualizacion"><?php echo $zonas->Fecha_Actualizacion->FldCaption() ?></span>	
		...
		<div class="<?php echo $zonas_search->SearchRightColumnClass ?>"><div<?php echo $zonas->Fecha_Actualizacion->CellAttributes() ?>>
...
<?php if ($zonas->Usuario->Visible) { // Usuario ?>
	<div id="r_Usuario" class="form-group">
		<label for="x_Usuario" class="<?php echo $zonas_search->SearchLabelClass ?>"><span id="elh_zonas_Usuario"><?php echo $zonas->Usuario->FldCaption() ?></span>	
		...
		<div class="<?php echo $zonas_search->SearchRightColumnClass ?>"><div<?php echo $zonas->Usuario->CellAttributes() ?>>
			<span id="el_zonas_Usuario">
<input type="text" data-table="zonas" data-field="x_Usuario" name="x_Usuario" id="x_Usuario" size="35" placeholder="<?php echo ew_HtmlEncode($zonas->Usuario->getPlaceHolder()) ?>" value="<?php echo $zonas->Usuario->EditValue ?>"<?php echo $zonas->Usuario->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
