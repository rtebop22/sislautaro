...
class catencion_equipos_list extends catencion_equipos {
	...
	function SetupListOptions() {
		...
		$item->CssStyle = "white-space: nowrap;";
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'detalle_atencion') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
		...
		$item->CssStyle = "white-space: nowrap;";
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'atencion_para_st') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
		$item->ShowInButtonGroup = FALSE;
		if (!isset($GLOBALS["atencion_para_st_grid"])) $GLOBALS["atencion_para_st_grid"] = new catencion_para_st_grid;

		// "detail_historial_atencion"
		$item = &$this->ListOptions->Add("detail_historial_atencion");
		$item->CssStyle = "white-space: nowrap;";
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'historial_atencion') && !$this->ShowMultipleDetails;
		$item->OnLeft = TRUE;
		$item->ShowInButtonGroup = FALSE;
		if (!isset($GLOBALS["historial_atencion_grid"])) $GLOBALS["historial_atencion_grid"] = new chistorial_atencion_grid;
	...
	function RenderListOptions() {
		...
		if ($Security->CanView()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewView\" title=\"" . $viewcaption . "\" data-table=\"atencion_equipos\" data-caption=\"" . $viewcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->ViewUrl) . "'});\">" . $Language->Phrase("ViewLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
		...
		if ($Security->AllowList(CurrentProjectID() . 'detalle_atencion')) {
			...
			$body = "<a class=\"btn btn-default btn-sm ewRowLink ewDetail\" data-action=\"list\" href=\"" . ew_HtmlEncode("detalle_atencionlist.php?" . EW_TABLE_SHOW_MASTER . "=atencion_equipos&fk_Id_Atencion=" . urlencode(strval($this->Id_Atencion->CurrentValue)) . "&fk_NroSerie=" . urlencode(strval($this->NroSerie->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["detalle_atencion_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'detalle_atencion')) {
			...
			if ($GLOBALS["detalle_atencion_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'detalle_atencion')) {
			...
			if ($GLOBALS["detalle_atencion_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'detalle_atencion')) {
		...
		if ($Security->AllowList(CurrentProjectID() . 'atencion_para_st')) {
			...
			$body = "<a class=\"btn btn-default btn-sm ewRowLink ewDetail\" data-action=\"list\" href=\"" . ew_HtmlEncode("atencion_para_stlist.php?" . EW_TABLE_SHOW_MASTER . "=atencion_equipos&fk_Id_Atencion=" . urlencode(strval($this->Id_Atencion->CurrentValue)) . "&fk_NroSerie=" . urlencode(strval($this->NroSerie->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["atencion_para_st_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'atencion_para_st')) {
			...
			if ($GLOBALS["atencion_para_st_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'atencion_para_st')) {
			...
			if ($GLOBALS["atencion_para_st_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'atencion_para_st')) {
		...
		// "detail_historial_atencion"
		$oListOpt = &$this->ListOptions->Items["detail_historial_atencion"];
		if ($Security->AllowList(CurrentProjectID() . 'historial_atencion')) {
			$body = $Language->Phrase("DetailLink") . $Language->TablePhrase("historial_atencion", "TblCaption");
			$body .= str_replace("%c", $this->historial_atencion_Count, $Language->Phrase("DetailCount"));
			$body = "<a class=\"btn btn-default btn-sm ewRowLink ewDetail\" data-action=\"list\" href=\"" . ew_HtmlEncode("historial_atencionlist.php?" . EW_TABLE_SHOW_MASTER . "=atencion_equipos&fk_Id_Atencion=" . urlencode(strval($this->Id_Atencion->CurrentValue)) . "&fk_NroSerie=" . urlencode(strval($this->NroSerie->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["historial_atencion_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'historial_atencion')) {
				$links .= "<li><a class=\"ewRowLink ewDetailView\" data-action=\"view\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailViewLink")) . "\" href=\"" . ew_HtmlEncode($this->GetViewUrl(EW_TABLE_SHOW_DETAIL . "=historial_atencion")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailViewLink")) . "</a></li>";
				if ($DetailViewTblVar <> "") $DetailViewTblVar .= ",";
				$DetailViewTblVar .= "historial_atencion";
			}
			if ($GLOBALS["historial_atencion_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'historial_atencion')) {
				$links .= "<li><a class=\"ewRowLink ewDetailEdit\" data-action=\"edit\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailEditLink")) . "\" href=\"" . ew_HtmlEncode($this->GetEditUrl(EW_TABLE_SHOW_DETAIL . "=historial_atencion")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailEditLink")) . "</a></li>";
				if ($DetailEditTblVar <> "") $DetailEditTblVar .= ",";
				$DetailEditTblVar .= "historial_atencion";
			}
			if ($GLOBALS["historial_atencion_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'historial_atencion')) {
				$links .= "<li><a class=\"ewRowLink ewDetailCopy\" data-action=\"add\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailCopyLink")) . "\" href=\"" . ew_HtmlEncode($this->GetCopyUrl(EW_TABLE_SHOW_DETAIL . "=historial_atencion")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailCopyLink")) . "</a></li>";
				if ($DetailCopyTblVar <> "") $DetailCopyTblVar .= ",";
				$DetailCopyTblVar .= "historial_atencion";
			}
			if ($links <> "") {
				$body .= "<button class=\"dropdown-toggle btn btn-default btn-sm ewDetail\" data-toggle=\"dropdown\"><b class=\"caret\"></b></button>";
				$body .= "<ul class=\"dropdown-menu\">". $links . "</ul>";
	...
	function SetupOtherOptions() {
		...
		$item->Visible = ($GLOBALS["detalle_atencion"]->DetailAdd && $Security->AllowAdd(CurrentProjectID() . 'detalle_atencion') && $Security->CanAdd());
		if ($item->Visible) {
		...
		$item->Body = "<a class=\"ewDetailAddGroup ewDetailAdd\" title=\"" . ew_HtmlTitle($caption) . "\" data-caption=\"" . ew_HtmlTitle($caption) . "\" href=\"" . ew_HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["atencion_para_st"]->DetailAdd && $Security->AllowAdd(CurrentProjectID() . 'atencion_para_st') && $Security->CanAdd());
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
			$DetailTableLink .= "atencion_para_st";
		}
		$item = &$option->Add("detailadd_historial_atencion");
		$url = $this->GetAddUrl(EW_TABLE_SHOW_DETAIL . "=historial_atencion");
		$caption = $Language->Phrase("Add") . "&nbsp;" . $this->TableCaption() . "/" . $GLOBALS["historial_atencion"]->TableCaption();
		$item->Body = "<a class=\"ewDetailAddGroup ewDetailAdd\" title=\"" . ew_HtmlTitle($caption) . "\" data-caption=\"" . ew_HtmlTitle($caption) . "\" href=\"" . ew_HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["historial_atencion"]->DetailAdd && $Security->AllowAdd(CurrentProjectID() . 'historial_atencion') && $Security->CanAdd());
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
			$DetailTableLink .= "historial_atencion";
		}
	...
	function LoadDefaultValues() {
		...
		$this->Fecha_Entrada->CurrentValue = ew_CurrentDate();
		$this->Fecha_Entrada->OldValue = $this->Fecha_Entrada->CurrentValue;
		$this->Id_Prioridad->CurrentValue = 1;
	...
	function LoadRowValues(&$rs) {
		...
		if (!isset($GLOBALS["historial_atencion_grid"])) $GLOBALS["historial_atencion_grid"] = new chistorial_atencion_grid;
		$sDetailFilter = $GLOBALS["historial_atencion"]->SqlDetailFilter_atencion_equipos();
		$sDetailFilter = str_replace("@Id_Atencion@", ew_AdjustSql($this->Id_Atencion->DbValue, "DB"), $sDetailFilter);
		$sDetailFilter = str_replace("@NroSerie@", ew_AdjustSql($this->NroSerie->DbValue, "DB"), $sDetailFilter);
		$GLOBALS["historial_atencion"]->setCurrentMasterTable("atencion_equipos");
		$sDetailFilter = $GLOBALS["historial_atencion"]->ApplyUserIDFilters($sDetailFilter);
		$this->historial_atencion_Count = $GLOBALS["historial_atencion"]->LoadRecordCount($sDetailFilter);
	}
...
if ($atencion_equipos->CurrentAction == "gridadd") {
	...
	if ($atencion_equipos->CurrentAction == "" && $atencion_equipos_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$atencion_equipos_list->setWarningMessage(ew_DeniedMsg());
...
<?php if ($atencion_equipos_list->TotalRecs > 0 || $atencion_equipos->CurrentAction == "add" || $atencion_equipos->CurrentAction == "copy") { ?>
...
<?php if ($atencion_equipos->NroSerie->Visible) { // NroSerie ?>
	...
	<?php } else { ?>
		<th data-name="NroSerie"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $atencion_equipos->SortUrl($atencion_equipos->NroSerie) ?>',1);"><div id="elh_atencion_equipos_NroSerie" class="atencion_equipos_NroSerie">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $atencion_equipos->NroSerie->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($atencion_equipos->NroSerie->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($atencion_equipos->NroSerie->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<tbody>
<?php
	if ($atencion_equipos->CurrentAction == "add" || $atencion_equipos->CurrentAction == "copy") {
		$atencion_equipos_list->RowIndex = 0;
		$atencion_equipos_list->KeyCount = $atencion_equipos_list->RowIndex;
		if ($atencion_equipos->CurrentAction == "add")
			$atencion_equipos_list->LoadDefaultValues();
		if ($atencion_equipos->EventCancelled) // Insert failed
			$atencion_equipos_list->RestoreFormValues(); // Restore form values

		// Set row properties
		$atencion_equipos->ResetAttrs();
		$atencion_equipos->RowAttrs = array_merge($atencion_equipos->RowAttrs, array('data-rowindex'=>0, 'id'=>'r0_atencion_equipos', 'data-rowtype'=>EW_ROWTYPE_ADD));
...
<button type="button" title="<?php echo ew_HtmlTitle($Language->Phrase("AddLink")) . "&nbsp;" . $atencion_equipos->Dni->FldCaption() ?>" onclick="ew_AddOptDialogShow({lnk:this,el:'x<?php echo $atencion_equipos_list->RowIndex ?>_Dni',url:'personasaddopt.php'});" class="ewAddOptBtn btn btn-default btn-sm" id="aol_x<?php echo $atencion_equipos_list->RowIndex ?>_Dni"><span class="glyphicon glyphicon-plus ewIcon"></span><span class="hide"><?php echo $Language->Phrase("AddLink") ?>&nbsp;<?php echo $atencion_equipos->Dni->FldCaption() ?></span></button>
<?php } ?>
...
<button type="button" title="<?php echo ew_HtmlTitle($Language->Phrase("AddLink")) . "&nbsp;" . $atencion_equipos->NroSerie->FldCaption() ?>" onclick="ew_AddOptDialogShow({lnk:this,el:'x<?php echo $atencion_equipos_list->RowIndex ?>_NroSerie',url:'equiposaddopt.php'});" class="ewAddOptBtn btn btn-default btn-sm" id="aol_x<?php echo $atencion_equipos_list->RowIndex ?>_NroSerie"><span class="glyphicon glyphicon-plus ewIcon"></span><span class="hide"><?php echo $Language->Phrase("AddLink") ?>&nbsp;<?php echo $atencion_equipos->NroSerie->FldCaption() ?></span></button>
<?php } ?>
...
$atencion_equipos->ResetAttrs();
$atencion_equipos_list->RenderRow();
$atencion_equipos_list->EditRowCnt = 0;
if ($atencion_equipos->CurrentAction == "edit")
	$atencion_equipos_list->RowIndex = 1;
if ($atencion_equipos->CurrentAction == "gridadd")
	$atencion_equipos_list->RowIndex = 0;
...
while ($atencion_equipos_list->RecCnt < $atencion_equipos_list->StopRec) {
	...
	if (intval($atencion_equipos_list->RecCnt) >= intval($atencion_equipos_list->StartRec)) {
		...
		if ($atencion_equipos->CurrentAction == "edit") {
			if ($atencion_equipos_list->CheckInlineEditKey() && $atencion_equipos_list->EditRowCnt == 0) { // Inline edit
		...
		if ($atencion_equipos->CurrentAction == "edit" && $atencion_equipos->RowType == EW_ROWTYPE_EDIT && $atencion_equipos->EventCancelled) { // Update failed
			$objForm->Index = 1;
			$atencion_equipos_list->RestoreFormValues(); // Restore form values
		}
...
<input type="hidden" data-table="atencion_equipos" data-field="x_NroSerie" name="x<?php echo $atencion_equipos_list->RowIndex ?>_NroSerie" id="x<?php echo $atencion_equipos_list->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($atencion_equipos->NroSerie->CurrentValue) ?>">
<?php } ?>
<?php if ($atencion_equipos->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<?php } ?>
<?php if ($atencion_equipos->CurrentAction == "add" || $atencion_equipos->CurrentAction == "copy") { ?>
...
<?php } ?>
<?php if ($atencion_equipos->CurrentAction == "edit") { ?>
<input type="hidden" name="<?php echo $atencion_equipos_list->FormKeyCountName ?>" id="<?php echo $atencion_equipos_list->FormKeyCountName ?>" value="<?php echo $atencion_equipos_list->KeyCount ?>">
<?php } ?>
