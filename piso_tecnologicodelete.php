...
<?php if ($piso_tecnologico->Bocas_Switch->Visible) { // Bocas_Switch ?>
		<th><span id="elh_piso_tecnologico_Bocas_Switch" class="piso_tecnologico_Bocas_Switch"><?php echo $piso_tecnologico->Bocas_Switch->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($piso_tecnologico->Cantidad_Ap_Func->Visible) { // Cantidad_Ap_Func ?>
		<th><span id="elh_piso_tecnologico_Cantidad_Ap_Func" class="piso_tecnologico_Cantidad_Ap_Func"><?php echo $piso_tecnologico->Cantidad_Ap_Func->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($piso_tecnologico->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<th><span id="elh_piso_tecnologico_Fecha_Actualizacion" class="piso_tecnologico_Fecha_Actualizacion"><?php echo $piso_tecnologico->Fecha_Actualizacion->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($piso_tecnologico->Bocas_Switch->Visible) { // Bocas_Switch ?>
		<td<?php echo $piso_tecnologico->Bocas_Switch->CellAttributes() ?>>
<span id="el<?php echo $piso_tecnologico_delete->RowCnt ?>_piso_tecnologico_Bocas_Switch" class="piso_tecnologico_Bocas_Switch">
...
<?php } ?>
<?php if ($piso_tecnologico->Cantidad_Ap_Func->Visible) { // Cantidad_Ap_Func ?>
		<td<?php echo $piso_tecnologico->Cantidad_Ap_Func->CellAttributes() ?>>
<span id="el<?php echo $piso_tecnologico_delete->RowCnt ?>_piso_tecnologico_Cantidad_Ap_Func" class="piso_tecnologico_Cantidad_Ap_Func">
...
<?php } ?>
<?php if ($piso_tecnologico->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<td<?php echo $piso_tecnologico->Fecha_Actualizacion->CellAttributes() ?>>
<span id="el<?php echo $piso_tecnologico_delete->RowCnt ?>_piso_tecnologico_Fecha_Actualizacion" class="piso_tecnologico_Fecha_Actualizacion">
