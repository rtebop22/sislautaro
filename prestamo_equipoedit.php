...
class cprestamo_equipo_edit extends cprestamo_equipo {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Fecha_Prestamo
			$this->Fecha_Prestamo->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->Fecha_Prestamo->CurrentValue, 7), NULL, $this->Fecha_Prestamo->ReadOnly);
...
fprestamo_equipoedit.Lists["x_Devuelve_Cargador"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fprestamo_equipoedit.Lists["x_Devuelve_Cargador"].Options = <?php echo json_encode($prestamo_equipo->Devuelve_Cargador->Options()) ?>;
...
<?php if ($prestamo_equipo->Id_Estado_Devol->Visible) { // Id_Estado_Devol ?>
	<div id="r_Id_Estado_Devol" class="form-group">
		<label id="elh_prestamo_equipo_Id_Estado_Devol" for="x_Id_Estado_Devol" class="col-sm-2 control-label ewLabel"><?php echo $prestamo_equipo->Id_Estado_Devol->FldCaption() ?></label>
...
<?php if ($prestamo_equipo->Devuelve_Cargador->Visible) { // Devuelve_Cargador ?>
	<div id="r_Devuelve_Cargador" class="form-group">
		<label id="elh_prestamo_equipo_Devuelve_Cargador" class="col-sm-2 control-label ewLabel"><?php echo $prestamo_equipo->Devuelve_Cargador->FldCaption() ?></label>
