...
$materias_adeudadas_view = NULL; // Initialize page object first

class cmaterias_adeudadas_view extends cmaterias_adeudadas {
	...
	// Page object name
	var $PageObjName = 'materias_adeudadas_view';
	...
	function __construct() {
		...
		if (@$_GET["Id_Mat_Adeuda"] <> "") {
			$this->RecKey["Id_Mat_Adeuda"] = $_GET["Id_Mat_Adeuda"];
			$KeyUrl .= "&amp;Id_Mat_Adeuda=" . urlencode($this->RecKey["Id_Mat_Adeuda"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["Id_Mat_Adeuda"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["Id_Mat_Adeuda"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Id_Mat_Adeuda"] <> "") {
				...
				$this->RecKey["Id_Mat_Adeuda"] = $this->Id_Mat_Adeuda->QueryStringValue;
			} elseif (@$_POST["Id_Mat_Adeuda"] <> "") {
				$this->Id_Mat_Adeuda->setFormValue($_POST["Id_Mat_Adeuda"]);
				$this->RecKey["Id_Mat_Adeuda"] = $this->Id_Mat_Adeuda->FormValue;
			} else {
				$sReturnUrl = "materias_adeudadaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "materias_adeudadaslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "materias_adeudadaslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($materias_adeudadas_view)) $materias_adeudadas_view = new cmaterias_adeudadas_view();

// Page init
$materias_adeudadas_view->Page_Init();

// Page main
$materias_adeudadas_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$materias_adeudadas_view->Page_Render();
?>
...
var CurrentForm = fmaterias_adeudadasview = new ew_Form("fmaterias_adeudadasview", "view");

// Form_CustomValidate event
fmaterias_adeudadasview.Form_CustomValidate = 
...
fmaterias_adeudadasview.ValidateRequired = true;
<?php } else { ?>
fmaterias_adeudadasview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaterias_adeudadasview.Lists["x_Id_Materia"] = {"LinkField":"x_Id_Materia","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"materias_anuales"};
...
<?php if ($materias_adeudadas->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$materias_adeudadas_view->IsModal) { ?>
<?php if ($materias_adeudadas->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $materias_adeudadas_view->ExportOptions->Render("body") ?>
<?php
	foreach ($materias_adeudadas_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$materias_adeudadas_view->IsModal) { ?>
<?php if ($materias_adeudadas->Export == "") { ?>
...
<?php } ?>
<?php $materias_adeudadas_view->ShowPageHeader(); ?>
<?php
$materias_adeudadas_view->ShowMessage();
?>
<form name="fmaterias_adeudadasview" id="fmaterias_adeudadasview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($materias_adeudadas_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $materias_adeudadas_view->Token ?>">
<?php } ?>
...
<?php if ($materias_adeudadas->Id_Materia->Visible) { // Id_Materia ?>
	<tr id="r_Id_Materia">
		<td><span id="elh_materias_adeudadas_Id_Materia"><?php echo $materias_adeudadas->Id_Materia->FldCaption() ?></span></td>
...
<?php echo $materias_adeudadas->Id_Materia->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($materias_adeudadas->Observacion->Visible) { // Observacion ?>
	<tr id="r_Observacion">
		<td><span id="elh_materias_adeudadas_Observacion"><?php echo $materias_adeudadas->Observacion->FldCaption() ?></span></td>
...
<?php echo $materias_adeudadas->Observacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($materias_adeudadas->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<tr id="r_Fecha_Actualizacion">
		<td><span id="elh_materias_adeudadas_Fecha_Actualizacion"><?php echo $materias_adeudadas->Fecha_Actualizacion->FldCaption() ?></span></td>
...
<?php echo $materias_adeudadas->Fecha_Actualizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($materias_adeudadas->Usuario->Visible) { // Usuario ?>
	<tr id="r_Usuario">
		<td><span id="elh_materias_adeudadas_Usuario"><?php echo $materias_adeudadas->Usuario->FldCaption() ?></span></td>
		<td data-name="Usuario"<?php echo $materias_adeudadas->Usuario->CellAttributes() ?>>
<span id="el_materias_adeudadas_Usuario">
<span<?php echo $materias_adeudadas->Usuario->ViewAttributes() ?>>
<?php echo $materias_adeudadas->Usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($materias_adeudadas->Export == "") { ?>
<script type="text/javascript">
fmaterias_adeudadasview.Init();
</script>
<?php } ?>
<?php
$materias_adeudadas_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($materias_adeudadas->Export == "") { ?>
...
<?php
$materias_adeudadas_view->Page_Terminate();
?>
