...
class cuserlevels_list extends cuserlevels {
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->userlevelname, $Default, FALSE); // userlevelname
	...
	function RenderListOptions() {
		...
		if ($Security->CanView()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewView\" title=\"" . $viewcaption . "\" data-table=\"userlevels\" data-caption=\"" . $viewcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->ViewUrl) . "'});\">" . $Language->Phrase("ViewLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
		...
		if ($Security->CanEdit()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewEdit\" title=\"" . $editcaption . "\" data-table=\"userlevels\" data-caption=\"" . $editcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->EditUrl) . "',caption:'" . $editcaption . "'});\">" . $Language->Phrase("EditLink") . "</a>";
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiUpdate\" title=\"" . ew_HtmlTitle($Language->Phrase("UpdateSelectedLink")) . "\" data-table=\"userlevels\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("UpdateSelectedLink")) . "\" href=\"\" onclick=\"ew_ModalDialogShow({lnk:this,f:document.fuserlevelslist,url:'" . $this->MultiUpdateUrl . "',caption:'" . $Language->Phrase("UpdateBtn") . "'});return false;\">" . $Language->Phrase("UpdateSelectedLink") . "</a>";
		$item->Visible = ($Security->CanEdit());
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<a class=\"btn btn-default ewAdvancedSearch\" title=\"" . $Language->Phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->Phrase("AdvancedSearch") . "\" href=\"userlevelssrch.php\">" . $Language->Phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;
	...
	function LoadSearchValues() {
		...
		// userlevelname
		$this->userlevelname->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_userlevelname"]);
		if ($this->userlevelname->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->userlevelname->AdvancedSearch->SearchOperator = @$_GET["z_userlevelname"];
	}
...
// Validate form
fuserlevelslist.Validate = function() {
...
// Check empty row
fuserlevelslist.EmptyRow = function(infix) {
	var fobj = this.Form;
...
if ($userlevels->CurrentAction == "gridadd") {
	$userlevels->CurrentFilter = "0=1";
	$userlevels_list->StartRec = 1;
	$userlevels_list->DisplayRecs = $userlevels->GridAddRowCount;
	$userlevels_list->TotalRecs = $userlevels_list->DisplayRecs;
	$userlevels_list->StopRec = $userlevels_list->DisplayRecs;
} else {
...
<span id="el<?php echo $userlevels_list->RowCnt ?>_userlevels_userlevelid" class="form-group userlevels_userlevelid">
<input type="text" data-table="userlevels" data-field="x_userlevelid" name="x<?php echo $userlevels_list->RowIndex ?>_userlevelid" id="x<?php echo $userlevels_list->RowIndex ?>_userlevelid" size="30" placeholder="<?php echo ew_HtmlEncode($userlevels->userlevelid->getPlaceHolder()) ?>" value="<?php echo $userlevels->userlevelid->EditValue ?>"<?php echo $userlevels->userlevelid->EditAttributes() ?>>
</span>
<input type="hidden" data-table="userlevels" data-field="x_userlevelid" name="o<?php echo $userlevels_list->RowIndex ?>_userlevelid" id="o<?php echo $userlevels_list->RowIndex ?>_userlevelid" value="<?php echo ew_HtmlEncode($userlevels->userlevelid->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
		<td data-name="userlevelname">
<span id="el<?php echo $userlevels_list->RowCnt ?>_userlevels_userlevelname" class="form-group userlevels_userlevelname">
<input type="text" data-table="userlevels" data-field="x_userlevelname" name="x<?php echo $userlevels_list->RowIndex ?>_userlevelname" id="x<?php echo $userlevels_list->RowIndex ?>_userlevelname" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($userlevels->userlevelname->getPlaceHolder()) ?>" value="<?php echo $userlevels->userlevelname->EditValue ?>"<?php echo $userlevels->userlevelname->EditAttributes() ?>>
</span>
<input type="hidden" data-table="userlevels" data-field="x_userlevelname" name="o<?php echo $userlevels_list->RowIndex ?>_userlevelname" id="o<?php echo $userlevels_list->RowIndex ?>_userlevelname" value="<?php echo ew_HtmlEncode($userlevels->userlevelname->OldValue) ?>">
</td>
	<?php } ?>
<?php
...
if ($objForm) {
	$objForm->Index = -1;
	if ($objForm->HasValue($userlevels_list->FormKeyCountName) && ($userlevels->CurrentAction == "gridadd" || $userlevels->CurrentAction == "gridedit" || $userlevels->CurrentAction == "F")) {
		$userlevels_list->KeyCount = $objForm->GetValue($userlevels_list->FormKeyCountName);
		$userlevels_list->StopRec = $userlevels_list->StartRec + $userlevels_list->KeyCount - 1;
	}
}
...
$userlevels->ResetAttrs();
$userlevels_list->RenderRow();
$userlevels_list->EditRowCnt = 0;
if ($userlevels->CurrentAction == "edit")
	$userlevels_list->RowIndex = 1;
if ($userlevels->CurrentAction == "gridadd")
	$userlevels_list->RowIndex = 0;
if ($userlevels->CurrentAction == "gridedit")
	$userlevels_list->RowIndex = 0;
while ($userlevels_list->RecCnt < $userlevels_list->StopRec) {
	...
	if (intval($userlevels_list->RecCnt) >= intval($userlevels_list->StartRec)) {
		...
		if ($userlevels->CurrentAction == "gridadd" || $userlevels->CurrentAction == "gridedit" || $userlevels->CurrentAction == "F") {
			$userlevels_list->RowIndex++;
			$objForm->Index = $userlevels_list->RowIndex;
			if ($objForm->HasValue($userlevels_list->FormActionName))
				$userlevels_list->RowAction = strval($objForm->GetValue($userlevels_list->FormActionName));
			elseif ($userlevels->CurrentAction == "gridadd")
				$userlevels_list->RowAction = "insert";
			else
				$userlevels_list->RowAction = "";
		}
		...
		if ($userlevels->CurrentAction == "gridadd") // Grid add
			$userlevels->RowType = EW_ROWTYPE_ADD; // Render add
		if ($userlevels->CurrentAction == "gridadd" && $userlevels->EventCancelled && !$objForm->HasValue("k_blankrow")) // Insert failed
			$userlevels_list->RestoreCurrentRowFormValues($userlevels_list->RowIndex); // Restore form values
		if ($userlevels->CurrentAction == "edit") {
			if ($userlevels_list->CheckInlineEditKey() && $userlevels_list->EditRowCnt == 0) { // Inline edit
				$userlevels->RowType = EW_ROWTYPE_EDIT; // Render edit
			}
		}
		if ($userlevels->CurrentAction == "gridedit") { // Grid edit
			if ($userlevels->EventCancelled) {
				$userlevels_list->RestoreCurrentRowFormValues($userlevels_list->RowIndex); // Restore form values
			}
			if ($userlevels_list->RowAction == "insert")
				$userlevels->RowType = EW_ROWTYPE_ADD; // Render add
			else
				$userlevels->RowType = EW_ROWTYPE_EDIT; // Render edit
		}
		if ($userlevels->CurrentAction == "edit" && $userlevels->RowType == EW_ROWTYPE_EDIT && $userlevels->EventCancelled) { // Update failed
			$objForm->Index = 1;
			$userlevels_list->RestoreFormValues(); // Restore form values
		}
		if ($userlevels->CurrentAction == "gridedit" && ($userlevels->RowType == EW_ROWTYPE_EDIT || $userlevels->RowType == EW_ROWTYPE_ADD) && $userlevels->EventCancelled) // Update failed
			$userlevels_list->RestoreCurrentRowFormValues($userlevels_list->RowIndex); // Restore form values
		if ($userlevels->RowType == EW_ROWTYPE_EDIT) // Edit row
			$userlevels_list->EditRowCnt++;
		...
		if ($userlevels_list->RowAction <> "delete" && $userlevels_list->RowAction <> "insertdelete" && !($userlevels_list->RowAction == "insert" && $userlevels->CurrentAction == "F" && $userlevels_list->EmptyRow())) {
?>
	<tr<?php echo $userlevels->RowAttributes() ?>>
<?php
...
<?php if ($userlevels->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $userlevels_list->RowCnt ?>_userlevels_userlevelid" class="form-group userlevels_userlevelid">
<input type="text" data-table="userlevels" data-field="x_userlevelid" name="x<?php echo $userlevels_list->RowIndex ?>_userlevelid" id="x<?php echo $userlevels_list->RowIndex ?>_userlevelid" size="30" placeholder="<?php echo ew_HtmlEncode($userlevels->userlevelid->getPlaceHolder()) ?>" value="<?php echo $userlevels->userlevelid->EditValue ?>"<?php echo $userlevels->userlevelid->EditAttributes() ?>>
</span>
<input type="hidden" data-table="userlevels" data-field="x_userlevelid" name="o<?php echo $userlevels_list->RowIndex ?>_userlevelid" id="o<?php echo $userlevels_list->RowIndex ?>_userlevelid" value="<?php echo ew_HtmlEncode($userlevels->userlevelid->OldValue) ?>">
<?php } ?>
<?php if ($userlevels->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $userlevels_list->RowCnt ?>_userlevels_userlevelid" class="form-group userlevels_userlevelid">
...
<input type="hidden" data-table="userlevels" data-field="x_userlevelid" name="x<?php echo $userlevels_list->RowIndex ?>_userlevelid" id="x<?php echo $userlevels_list->RowIndex ?>_userlevelid" value="<?php echo ew_HtmlEncode($userlevels->userlevelid->CurrentValue) ?>">
<?php } ?>
<?php if ($userlevels->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<?php if ($userlevels->RowType == EW_ROWTYPE_ADD || $userlevels->RowType == EW_ROWTYPE_EDIT) { ?>
<script type="text/javascript">
fuserlevelslist.UpdateOpts(<?php echo $userlevels_list->RowIndex ?>);
</script>
<?php } ?>
<?php
	...
	if ($userlevels->CurrentAction <> "gridadd")
		if (!$userlevels_list->Recordset->EOF) $userlevels_list->Recordset->MoveNext();
}
?>
<?php
	if ($userlevels->CurrentAction == "gridadd" || $userlevels->CurrentAction == "gridedit") {
		$userlevels_list->RowIndex = '$rowindex$';
		$userlevels_list->LoadDefaultValues();

		// Set row properties
		$userlevels->ResetAttrs();
		$userlevels->RowAttrs = array_merge($userlevels->RowAttrs, array('data-rowindex'=>$userlevels_list->RowIndex, 'id'=>'r0_userlevels', 'data-rowtype'=>EW_ROWTYPE_ADD));
		ew_AppendClass($userlevels->RowAttrs["class"], "ewTemplate");
		$userlevels->RowType = EW_ROWTYPE_ADD;
...
// Render list options (body, left)
$userlevels_list->ListOptions->Render("body", "left", $userlevels_list->RowIndex);
?>
	<?php if ($userlevels->userlevelid->Visible) { // userlevelid ?>
		<td data-name="userlevelid">
<span id="el$rowindex$_userlevels_userlevelid" class="form-group userlevels_userlevelid">
<input type="text" data-table="userlevels" data-field="x_userlevelid" name="x<?php echo $userlevels_list->RowIndex ?>_userlevelid" id="x<?php echo $userlevels_list->RowIndex ?>_userlevelid" size="30" placeholder="<?php echo ew_HtmlEncode($userlevels->userlevelid->getPlaceHolder()) ?>" value="<?php echo $userlevels->userlevelid->EditValue ?>"<?php echo $userlevels->userlevelid->EditAttributes() ?>>
</span>
<input type="hidden" data-table="userlevels" data-field="x_userlevelid" name="o<?php echo $userlevels_list->RowIndex ?>_userlevelid" id="o<?php echo $userlevels_list->RowIndex ?>_userlevelid" value="<?php echo ew_HtmlEncode($userlevels->userlevelid->OldValue) ?>">
</td>
	...
	<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
		<td data-name="userlevelname">
<span id="el$rowindex$_userlevels_userlevelname" class="form-group userlevels_userlevelname">
<input type="text" data-table="userlevels" data-field="x_userlevelname" name="x<?php echo $userlevels_list->RowIndex ?>_userlevelname" id="x<?php echo $userlevels_list->RowIndex ?>_userlevelname" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($userlevels->userlevelname->getPlaceHolder()) ?>" value="<?php echo $userlevels->userlevelname->EditValue ?>"<?php echo $userlevels->userlevelname->EditAttributes() ?>>
</span>
<input type="hidden" data-table="userlevels" data-field="x_userlevelname" name="o<?php echo $userlevels_list->RowIndex ?>_userlevelname" id="o<?php echo $userlevels_list->RowIndex ?>_userlevelname" value="<?php echo ew_HtmlEncode($userlevels->userlevelname->OldValue) ?>">
</td>
...
<input type="hidden" name="<?php echo $userlevels_list->FormKeyCountName ?>" id="<?php echo $userlevels_list->FormKeyCountName ?>" value="<?php echo $userlevels_list->KeyCount ?>">
<?php } ?>
<?php if ($userlevels->CurrentAction == "gridadd") { ?>
<input type="hidden" name="a_list" id="a_list" value="gridinsert">
<input type="hidden" name="<?php echo $userlevels_list->FormKeyCountName ?>" id="<?php echo $userlevels_list->FormKeyCountName ?>" value="<?php echo $userlevels_list->KeyCount ?>">
<?php echo $userlevels_list->MultiSelectKey ?>
<?php } ?>
<?php if ($userlevels->CurrentAction == "edit") { ?>
<input type="hidden" name="<?php echo $userlevels_list->FormKeyCountName ?>" id="<?php echo $userlevels_list->FormKeyCountName ?>" value="<?php echo $userlevels_list->KeyCount ?>">
<?php } ?>
<?php if ($userlevels->CurrentAction == "gridedit") { ?>
