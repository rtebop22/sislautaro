...
$datos_extras_escuela_grid = NULL; // Initialize page object first

class cdatos_extras_escuela_grid extends cdatos_extras_escuela {
	...
	// Page object name
	var $PageObjName = 'datos_extras_escuela_grid';

	// Grid form hidden field names
	var $FormName = 'fdatos_extras_escuelagrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["datos_extras_escuela"];
