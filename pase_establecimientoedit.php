...
// Multi-Page
fpase_establecimientoedit.MultiPage = new ew_MultiPage("fpase_establecimientoedit");

// Dynamic selection lists
fpase_establecimientoedit.Lists["x_Serie_Equipo"] = {"LinkField":"x_NroSerie","Ajax":true,"AutoFill":true,"DisplayFields":["x_NroSerie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};
fpase_establecimientoedit.Lists["x_Modelo_Net"] = {"LinkField":"x_Descripcion","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"modelo"};
fpase_establecimientoedit.Lists["x_Nombre_Titular"] = {"LinkField":"x_Apellidos_Nombres","Ajax":true,"AutoFill":true,"DisplayFields":["x_Apellidos_Nombres","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
fpase_establecimientoedit.Lists["x_Nombre_Tutor"] = {"LinkField":"x_Apellidos_Nombres","Ajax":true,"AutoFill":true,"DisplayFields":["x_Apellidos_Nombres","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tutores"};
fpase_establecimientoedit.Lists["x_Cue_Establecimiento_Alta"] = {"LinkField":"x_Cue_Establecimiento","Ajax":true,"AutoFill":true,"DisplayFields":["x_Cue_Establecimiento","x_Nombre_Establecimiento","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"establecimientos_educativos_pase"};
fpase_establecimientoedit.Lists["x_Dpto_Esc_alta"] = {"LinkField":"x_Nombre","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
fpase_establecimientoedit.Lists["x_Localidad_Esc_Alta"] = {"LinkField":"x_Nombre","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"localidades"};
fpase_establecimientoedit.Lists["x_Cue_Establecimiento_Baja"] = {"LinkField":"x_Cue_Establecimiento","Ajax":true,"AutoFill":true,"DisplayFields":["x_Cue_Establecimiento","x_Nombre_Establecimiento","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"establecimientos_educativos_pase"};
fpase_establecimientoedit.Lists["x_Dpto_Esc_Baja"] = {"LinkField":"x_Nombre","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
fpase_establecimientoedit.Lists["x_Localidad_Esc_Baja"] = {"LinkField":"x_Nombre","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"localidades"};
...
<div class="panel-group" id="pase_establecimiento_edit">
	<div class="panel panel-default<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("1") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#pase_establecimiento_edit" href="#tab_pase_establecimiento1"><?php echo $pase_establecimiento->PageCaption(1) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("1") ?>" id="tab_pase_establecimiento1">
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("2") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#pase_establecimiento_edit" href="#tab_pase_establecimiento2"><?php echo $pase_establecimiento->PageCaption(2) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("2") ?>" id="tab_pase_establecimiento2">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("3") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#pase_establecimiento_edit" href="#tab_pase_establecimiento3"><?php echo $pase_establecimiento->PageCaption(3) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("3") ?>" id="tab_pase_establecimiento3">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("4") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#pase_establecimiento_edit" href="#tab_pase_establecimiento4"><?php echo $pase_establecimiento->PageCaption(4) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("4") ?>" id="tab_pase_establecimiento4">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("5") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#pase_establecimiento_edit" href="#tab_pase_establecimiento5"><?php echo $pase_establecimiento->PageCaption(5) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("5") ?>" id="tab_pase_establecimiento5">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("6") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#pase_establecimiento_edit" href="#tab_pase_establecimiento6"><?php echo $pase_establecimiento->PageCaption(6) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $pase_establecimiento_edit->MultiPages->PageStyle("6") ?>" id="tab_pase_establecimiento6">
			<div class="panel-body">
<div>
...
<script type="text/javascript">
ew_CreateCalendar("fpase_establecimientoedit", "x_Fecha_Pase", 7);
</script>
<?php } ?>
</span>
