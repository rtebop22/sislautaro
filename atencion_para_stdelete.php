...
<?php if ($atencion_para_st->Id_Atencion->Visible) { // Id_Atencion ?>
		<th><span id="elh_atencion_para_st_Id_Atencion" class="atencion_para_st_Id_Atencion"><?php echo $atencion_para_st->Id_Atencion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($atencion_para_st->NroSerie->Visible) { // NroSerie ?>
		<th><span id="elh_atencion_para_st_NroSerie" class="atencion_para_st_NroSerie"><?php echo $atencion_para_st->NroSerie->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($atencion_para_st->Referencia_Tipo_Retiro->Visible) { // Referencia_Tipo_Retiro ?>
		<th><span id="elh_atencion_para_st_Referencia_Tipo_Retiro" class="atencion_para_st_Referencia_Tipo_Retiro"><?php echo $atencion_para_st->Referencia_Tipo_Retiro->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($atencion_para_st->Id_Atencion->Visible) { // Id_Atencion ?>
		<td<?php echo $atencion_para_st->Id_Atencion->CellAttributes() ?>>
<span id="el<?php echo $atencion_para_st_delete->RowCnt ?>_atencion_para_st_Id_Atencion" class="atencion_para_st_Id_Atencion">
...
<?php } ?>
<?php if ($atencion_para_st->NroSerie->Visible) { // NroSerie ?>
		<td<?php echo $atencion_para_st->NroSerie->CellAttributes() ?>>
<span id="el<?php echo $atencion_para_st_delete->RowCnt ?>_atencion_para_st_NroSerie" class="atencion_para_st_NroSerie">
...
<?php } ?>
<?php if ($atencion_para_st->Referencia_Tipo_Retiro->Visible) { // Referencia_Tipo_Retiro ?>
		<td<?php echo $atencion_para_st->Referencia_Tipo_Retiro->CellAttributes() ?>>
<span id="el<?php echo $atencion_para_st_delete->RowCnt ?>_atencion_para_st_Referencia_Tipo_Retiro" class="atencion_para_st_Referencia_Tipo_Retiro">
