...
$establecimientos_educativos_add = NULL; // Initialize page object first

class cestablecimientos_educativos_add extends cestablecimientos_educativos {
	...
	// Page object name
	var $PageObjName = 'establecimientos_educativos_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "establecimientos_educativosview.php")
...
// Create page object
if (!isset($establecimientos_educativos_add)) $establecimientos_educativos_add = new cestablecimientos_educativos_add();

// Page init
$establecimientos_educativos_add->Page_Init();

// Page main
$establecimientos_educativos_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$establecimientos_educativos_add->Page_Render();
?>
...
var CurrentForm = festablecimientos_educativosadd = new ew_Form("festablecimientos_educativosadd", "add");

// Validate form
festablecimientos_educativosadd.Validate = function() {
...
festablecimientos_educativosadd.Form_CustomValidate = 
...
festablecimientos_educativosadd.ValidateRequired = true;
<?php } else { ?>
festablecimientos_educativosadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
festablecimientos_educativosadd.Lists["x_Id_Provincia"] = {"LinkField":"x_Id_Provincia","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":["x_Id_Localidad"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincias"};
festablecimientos_educativosadd.Lists["x_Id_Localidad"] = {"LinkField":"x_Id_Localidad","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":["x_Id_Provincia"],"ChildFields":[],"FilterFields":["x_Id_Provincia"],"Options":[],"Template":"","LinkTable":"localidades"};
...
<?php if (!$establecimientos_educativos_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $establecimientos_educativos_add->ShowPageHeader(); ?>
<?php
$establecimientos_educativos_add->ShowMessage();
?>
<form name="festablecimientos_educativosadd" id="festablecimientos_educativosadd" class="<?php echo $establecimientos_educativos_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($establecimientos_educativos_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $establecimientos_educativos_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $establecimientos_educativos_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
festablecimientos_educativosadd.Init();
</script>
<?php
$establecimientos_educativos_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$establecimientos_educativos_add->Page_Terminate();
?>
