...
<?php include_once "historial_atenciongridcls.php" ?>
...
$atencion_equipos_edit = NULL; // Initialize page object first

class catencion_equipos_edit extends catencion_equipos {
	...
	// Page object name
	var $PageObjName = 'atencion_equipos_edit';
	...
	function Page_Init() {
		...
		if (@$_POST["ajax"] == "autofill") {
			...
			// Process auto fill for detail table 'historial_atencion'
			if (@$_POST["grid"] == "fhistorial_atenciongrid") {
				if (!isset($GLOBALS["historial_atencion_grid"])) $GLOBALS["historial_atencion_grid"] = new chistorial_atencion_grid;
				$GLOBALS["historial_atencion_grid"]->Page_Init();
				$this->Page_Terminate();
				exit();
			}
	...
	function Page_Main() {
		...
		if ($this->Id_Atencion->CurrentValue == "") {
			$this->Page_Terminate("atencion_equiposlist.php"); // Invalid key, return to list
		}
	...
	function ValidateForm() {
		...
		if (in_array("detalle_atencion", $DetailTblVar) && $GLOBALS["detalle_atencion"]->DetailEdit) {
		...
		if (in_array("atencion_para_st", $DetailTblVar) && $GLOBALS["atencion_para_st"]->DetailEdit) {
		...
		if (in_array("historial_atencion", $DetailTblVar) && $GLOBALS["historial_atencion"]->DetailEdit) {
			if (!isset($GLOBALS["historial_atencion_grid"])) $GLOBALS["historial_atencion_grid"] = new chistorial_atencion_grid(); // get detail page object
			$GLOBALS["historial_atencion_grid"]->ValidateGridForm();
		}
		...
		if ($rs->EOF) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("detalle_atencion", $DetailTblVar) && $GLOBALS["detalle_atencion"]->DetailEdit) {
						if (!isset($GLOBALS["detalle_atencion_grid"])) $GLOBALS["detalle_atencion_grid"] = new cdetalle_atencion_grid(); // Get detail page object
						$Security->LoadCurrentUserLevel($this->ProjectID . "detalle_atencion"); // Load user level of detail table
						$EditRow = $GLOBALS["detalle_atencion_grid"]->GridUpdate();
				...
				if ($EditRow) {
					if (in_array("atencion_para_st", $DetailTblVar) && $GLOBALS["atencion_para_st"]->DetailEdit) {
						if (!isset($GLOBALS["atencion_para_st_grid"])) $GLOBALS["atencion_para_st_grid"] = new catencion_para_st_grid(); // Get detail page object
						$Security->LoadCurrentUserLevel($this->ProjectID . "atencion_para_st"); // Load user level of detail table
						$EditRow = $GLOBALS["atencion_para_st_grid"]->GridUpdate();
						$Security->LoadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
					}
				}
				if ($EditRow) {
					if (in_array("historial_atencion", $DetailTblVar) && $GLOBALS["historial_atencion"]->DetailEdit) {
						if (!isset($GLOBALS["historial_atencion_grid"])) $GLOBALS["historial_atencion_grid"] = new chistorial_atencion_grid(); // Get detail page object
						$Security->LoadCurrentUserLevel($this->ProjectID . "historial_atencion"); // Load user level of detail table
						$EditRow = $GLOBALS["historial_atencion_grid"]->GridUpdate();
						$Security->LoadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
					}
				}
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("detalle_atencion", $DetailTblVar)) {
				...
				if ($GLOBALS["detalle_atencion_grid"]->DetailEdit) {
					$GLOBALS["detalle_atencion_grid"]->CurrentMode = "edit";
					$GLOBALS["detalle_atencion_grid"]->CurrentAction = "gridedit";
					...
					$GLOBALS["detalle_atencion_grid"]->NroSerie->FldIsDetailKey = TRUE;
					$GLOBALS["detalle_atencion_grid"]->NroSerie->CurrentValue = $this->NroSerie->CurrentValue;
					$GLOBALS["detalle_atencion_grid"]->NroSerie->setSessionValue($GLOBALS["detalle_atencion_grid"]->NroSerie->CurrentValue);
				}
			}
			if (in_array("atencion_para_st", $DetailTblVar)) {
				...
				if ($GLOBALS["atencion_para_st_grid"]->DetailEdit) {
					$GLOBALS["atencion_para_st_grid"]->CurrentMode = "edit";
					$GLOBALS["atencion_para_st_grid"]->CurrentAction = "gridedit";
					...
					$GLOBALS["atencion_para_st_grid"]->NroSerie->FldIsDetailKey = TRUE;
					$GLOBALS["atencion_para_st_grid"]->NroSerie->CurrentValue = $this->NroSerie->CurrentValue;
					$GLOBALS["atencion_para_st_grid"]->NroSerie->setSessionValue($GLOBALS["atencion_para_st_grid"]->NroSerie->CurrentValue);
				}
			}
			if (in_array("historial_atencion", $DetailTblVar)) {
				if (!isset($GLOBALS["historial_atencion_grid"]))
					$GLOBALS["historial_atencion_grid"] = new chistorial_atencion_grid;
				if ($GLOBALS["historial_atencion_grid"]->DetailEdit) {
					$GLOBALS["historial_atencion_grid"]->CurrentMode = "edit";
					$GLOBALS["historial_atencion_grid"]->CurrentAction = "gridedit";

					// Save current master table to detail table
					$GLOBALS["historial_atencion_grid"]->setCurrentMasterTable($this->TableVar);
					$GLOBALS["historial_atencion_grid"]->setStartRecordNumber(1);
					$GLOBALS["historial_atencion_grid"]->Id_Atencion->FldIsDetailKey = TRUE;
					$GLOBALS["historial_atencion_grid"]->Id_Atencion->CurrentValue = $this->Id_Atencion->CurrentValue;
					$GLOBALS["historial_atencion_grid"]->Id_Atencion->setSessionValue($GLOBALS["historial_atencion_grid"]->Id_Atencion->CurrentValue);
					$GLOBALS["historial_atencion_grid"]->NroSerie->FldIsDetailKey = TRUE;
					$GLOBALS["historial_atencion_grid"]->NroSerie->CurrentValue = $this->NroSerie->CurrentValue;
					$GLOBALS["historial_atencion_grid"]->NroSerie->setSessionValue($GLOBALS["historial_atencion_grid"]->NroSerie->CurrentValue);
				}
			}
		}
	}
...
// Create page object
if (!isset($atencion_equipos_edit)) $atencion_equipos_edit = new catencion_equipos_edit();

// Page init
$atencion_equipos_edit->Page_Init();

// Page main
$atencion_equipos_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$atencion_equipos_edit->Page_Render();
?>
...
var CurrentForm = fatencion_equiposedit = new ew_Form("fatencion_equiposedit", "edit");

// Validate form
fatencion_equiposedit.Validate = function() {
...
fatencion_equiposedit.Form_CustomValidate = 
...
fatencion_equiposedit.ValidateRequired = true;
<?php } else { ?>
fatencion_equiposedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fatencion_equiposedit.Lists["x_Dni"] = {"LinkField":"x_Dni","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","x_Dni","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
fatencion_equiposedit.Lists["x_NroSerie"] = {"LinkField":"x_NroSerie","Ajax":true,"AutoFill":false,"DisplayFields":["x_NroSerie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};
fatencion_equiposedit.Lists["x_Id_Prioridad"] = {"LinkField":"x_Id_Prioridad","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_prioridad_atencion"};
...
<?php if (!$atencion_equipos_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $atencion_equipos_edit->ShowPageHeader(); ?>
<?php
$atencion_equipos_edit->ShowMessage();
?>
<form name="fatencion_equiposedit" id="fatencion_equiposedit" class="<?php echo $atencion_equipos_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($atencion_equipos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $atencion_equipos_edit->Token ?>">
<?php } ?>
...
<button type="button" title="<?php echo ew_HtmlTitle($Language->Phrase("AddLink")) . "&nbsp;" . $atencion_equipos->Dni->FldCaption() ?>" onclick="ew_AddOptDialogShow({lnk:this,el:'x_Dni',url:'personasaddopt.php'});" class="ewAddOptBtn btn btn-default btn-sm" id="aol_x_Dni"><span class="glyphicon glyphicon-plus ewIcon"></span><span class="hide"><?php echo $Language->Phrase("AddLink") ?>&nbsp;<?php echo $atencion_equipos->Dni->FldCaption() ?></span></button>
<?php } ?>
...
<?php if ($atencion_equipos->NroSerie->Visible) { // NroSerie ?>
	<div id="r_NroSerie" class="form-group">
		<label id="elh_atencion_equipos_NroSerie" class="col-sm-2 control-label ewLabel"><?php echo $atencion_equipos->NroSerie->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<p class="form-control-static"><?php echo $atencion_equipos->NroSerie->EditValue ?></p></span>
</span>
<input type="hidden" data-table="atencion_equipos" data-field="x_NroSerie" data-page="1" name="x_NroSerie" id="x_NroSerie" value="<?php echo ew_HtmlEncode($atencion_equipos->NroSerie->CurrentValue) ?>">
...
<script type="text/javascript">
ew_CreateCalendar("fatencion_equiposedit", "x_Fecha_Entrada", 7);
</script>
<?php } ?>
</span>
...
<input type="hidden" data-table="atencion_equipos" data-field="x_Id_Atencion" name="x_Id_Atencion" id="x_Id_Atencion" value="<?php echo ew_HtmlEncode($atencion_equipos->Id_Atencion->CurrentValue) ?>">
<?php if ($atencion_equipos->getCurrentDetailTable() <> "") { ?>
<?php
	$FirstActiveDetailTable = $atencion_equipos_edit->DetailPages->ActivePageIndex();
?>
<div class="ewDetailPages">
<div class="panel-group" id="atencion_equipos_edit_details">
<?php
	if (in_array("detalle_atencion", explode(",", $atencion_equipos->getCurrentDetailTable())) && $detalle_atencion->DetailEdit) {
		if ($FirstActiveDetailTable == "" || $FirstActiveDetailTable == "detalle_atencion") {
			$FirstActiveDetailTable = "detalle_atencion";
		}
?>
	<div class="panel panel-default<?php echo $atencion_equipos_edit->DetailPages->PageStyle("detalle_atencion") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#atencion_equipos_edit_details" href="#tab_detalle_atencion"><?php echo $Language->TablePhrase("detalle_atencion", "TblCaption") ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $atencion_equipos_edit->DetailPages->PageStyle("detalle_atencion") ?>" id="tab_detalle_atencion">
...
<?php } ?>
<?php
	if (in_array("atencion_para_st", explode(",", $atencion_equipos->getCurrentDetailTable())) && $atencion_para_st->DetailEdit) {
		if ($FirstActiveDetailTable == "" || $FirstActiveDetailTable == "atencion_para_st") {
			$FirstActiveDetailTable = "atencion_para_st";
		}
?>
	<div class="panel panel-default<?php echo $atencion_equipos_edit->DetailPages->PageStyle("atencion_para_st") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#atencion_equipos_edit_details" href="#tab_atencion_para_st"><?php echo $Language->TablePhrase("atencion_para_st", "TblCaption") ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $atencion_equipos_edit->DetailPages->PageStyle("atencion_para_st") ?>" id="tab_atencion_para_st">
			<div class="panel-body">
...
<?php } ?>
<?php
	if (in_array("historial_atencion", explode(",", $atencion_equipos->getCurrentDetailTable())) && $historial_atencion->DetailEdit) {
		if ($FirstActiveDetailTable == "" || $FirstActiveDetailTable == "historial_atencion") {
			$FirstActiveDetailTable = "historial_atencion";
		}
?>
	<div class="panel panel-default<?php echo $atencion_equipos_edit->DetailPages->PageStyle("historial_atencion") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#atencion_equipos_edit_details" href="#tab_historial_atencion"><?php echo $Language->TablePhrase("historial_atencion", "TblCaption") ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $atencion_equipos_edit->DetailPages->PageStyle("historial_atencion") ?>" id="tab_historial_atencion">
			<div class="panel-body">
<?php include_once "historial_atenciongrid.php" ?>
			</div>
		</div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $atencion_equipos_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fatencion_equiposedit.Init();
</script>
<?php
$atencion_equipos_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$atencion_equipos_edit->Page_Terminate();
?>
