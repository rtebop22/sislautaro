...
define("EW_PROJECT_NAME", "Sistema_de_Control", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{9FD9BA28-0339-4B41-9A45-0CAE935EFE3A}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'XEc9FFYnscWNXIsG', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Sistema_de_Control.css", TRUE); // Project stylesheet file name
...
define("EW_USER_ID_FILTER", "(`Nombre` = '%u')", TRUE);
...
define("EW_USER_PROFILE_RETRY_LOCKOUT", 10, TRUE);
...
define("EW_SENDER_EMAIL", "lautaro826@gmail.com", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "lautaro826@gmail.com", TRUE); // Recipient email address
...
define("EW_UPLOAD_DEST_PATH", "/Archivos/", TRUE); // Upload destination path (relative to app root)
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,docx,xls,pdf,zip,xlsx,rar", TRUE); // Allowed file extensions
define("EW_IMAGE_ALLOWED_FILE_EXT", "gif,jpg,png,bmp,jpeg", TRUE); // Allowed file extensions for images
define("EW_DOWNLOAD_ALLOWED_FILE_EXT", "pdf,xls,doc,xlsx,docx,zip,rar", TRUE); // Allowed file extensions for download (non-image)
define("EW_ENCRYPT_FILE_PATH", TRUE, TRUE); // Encrypt file path
define("EW_MAX_FILE_SIZE", 90000000, TRUE); // Max file size
...
define("EW_EXPORT_ORIGINAL_VALUE", TRUE, TRUE);
...
define("EW_EXPORT_MASTER_RECORD_FOR_CSV", TRUE, TRUE); // TRUE to export master record for CSV
define("EW_EXPORT_DETAIL_RECORDS", TRUE, TRUE); // TRUE to export detail records
define("EW_EXPORT_DETAIL_RECORDS_FOR_CSV", TRUE, TRUE); // TRUE to export detail records for CSV
$EW_EXPORT = array(
	"email" => "cExportEmail",
	"html" => "cExportHtml",
	"word" => "cExportWord",
