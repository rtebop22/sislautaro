...
fdepartamentoedit.Lists["x_Id_Provincia"] = {"LinkField":"x_Id_Provincia","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincias"};
...
<?php if (!$departamento_edit->IsModal) { ?>
<div class="ewToolbar">
...
<input type="hidden" data-table="departamento" data-field="x_Id_Departamento" name="x_Id_Departamento" id="x_Id_Departamento" value="<?php echo ew_HtmlEncode($departamento->Id_Departamento->CurrentValue) ?>">
<?php if (!$departamento_edit->IsModal) { ?>
