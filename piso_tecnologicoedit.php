...
class cpiso_tecnologico_edit extends cpiso_tecnologico {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Marca_Modelo_Serie_Ups
			$this->Marca_Modelo_Serie_Ups->SetDbValueDef($rsnew, $this->Marca_Modelo_Serie_Ups->CurrentValue, NULL, $this->Marca_Modelo_Serie_Ups->ReadOnly);
...
<input type="hidden" data-table="piso_tecnologico" data-field="x_Cue" name="x_Cue" id="x_Cue" value="<?php echo ew_HtmlEncode($piso_tecnologico->Cue->CurrentValue) ?>">
<?php if (!$piso_tecnologico_edit->IsModal) { ?>
