...
$pedido_paquetes = NULL;

//
// Table class for pedido_paquetes
//
class cpedido_paquetes extends cTable {
	var $Cue;
	var $Sigla;
	var $Id_Zona;
	var $Id_Hardware;
	...
	function __construct() {
		...
		$this->TableVar = 'pedido_paquetes';
		$this->TableName = 'pedido_paquetes';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`pedido_paquetes`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Cue
		$this->Cue = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Cue', 'Cue', '`Cue`', '`Cue`', 200, -1, FALSE, '`Cue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cue->Sortable = TRUE; // Allow sort
		$this->fields['Cue'] = &$this->Cue;

		// Sigla
		$this->Sigla = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Sigla', 'Sigla', '`Sigla`', '`Sigla`', 200, -1, FALSE, '`Sigla`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Sigla->Sortable = TRUE; // Allow sort
		$this->fields['Sigla'] = &$this->Sigla;

		// Id_Zona
		$this->Id_Zona = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Id_Zona', 'Id_Zona', '`Id_Zona`', '`Id_Zona`', 3, -1, FALSE, '`Id_Zona`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Hardware
		$this->Id_Hardware = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Id_Hardware', 'Id_Hardware', '`Id_Hardware`', '`Id_Hardware`', 200, -1, FALSE, '`Id_Hardware`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Id_Hardware->Sortable = TRUE; // Allow sort
		$this->fields['Id_Hardware'] = &$this->Id_Hardware;

		// SN
		$this->SN = new cField('pedido_paquetes', 'pedido_paquetes', 'x_SN', 'SN', '`SN`', '`SN`', 200, -1, FALSE, '`SN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SN->Sortable = TRUE; // Allow sort
		$this->fields['SN'] = &$this->SN;

		// Marca_Arranque
		$this->Marca_Arranque = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Marca_Arranque', 'Marca_Arranque', '`Marca_Arranque`', '`Marca_Arranque`', 200, -1, FALSE, '`Marca_Arranque`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Marca_Arranque->Sortable = TRUE; // Allow sort
		$this->fields['Marca_Arranque'] = &$this->Marca_Arranque;

		// Id_Tipo_Extraccion
		$this->Id_Tipo_Extraccion = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Id_Tipo_Extraccion', 'Id_Tipo_Extraccion', '`Id_Tipo_Extraccion`', '`Id_Tipo_Extraccion`', 3, -1, FALSE, '`Id_Tipo_Extraccion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Estado_Paquete
		$this->Id_Estado_Paquete = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Id_Estado_Paquete', 'Id_Estado_Paquete', '`Id_Estado_Paquete`', '`Id_Estado_Paquete`', 3, -1, FALSE, '`Id_Estado_Paquete`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Motivo
		$this->Id_Motivo = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Id_Motivo', 'Id_Motivo', '`Id_Motivo`', '`Id_Motivo`', 3, -1, FALSE, '`Id_Motivo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Serie_Server
		$this->Serie_Server = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Serie_Server', 'Serie_Server', '`Serie_Server`', '`Serie_Server`', 200, -1, FALSE, '`Serie_Server`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Serie_Server->Sortable = TRUE; // Allow sort
		$this->fields['Serie_Server'] = &$this->Serie_Server;

		// Email_Solicitante
		$this->Email_Solicitante = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Email_Solicitante', 'Email_Solicitante', '`Email_Solicitante`', '`Email_Solicitante`', 200, -1, FALSE, '`Email_Solicitante`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Email_Solicitante->Sortable = TRUE; // Allow sort
		$this->fields['Email_Solicitante'] = &$this->Email_Solicitante;

		// Id_Tipo_Paquete
		$this->Id_Tipo_Paquete = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Id_Tipo_Paquete', 'Id_Tipo_Paquete', '`Id_Tipo_Paquete`', '`Id_Tipo_Paquete`', 3, -1, FALSE, '`Id_Tipo_Paquete`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Serie_Netbook
		$this->Serie_Netbook = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Serie_Netbook', 'Serie_Netbook', '`Serie_Netbook`', '`Serie_Netbook`', 200, -1, FALSE, '`Serie_Netbook`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Serie_Netbook->Sortable = TRUE; // Allow sort
		$this->fields['Serie_Netbook'] = &$this->Serie_Netbook;

		// Apellido_Nombre_Solicitante
		$this->Apellido_Nombre_Solicitante = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Apellido_Nombre_Solicitante', 'Apellido_Nombre_Solicitante', '`Apellido_Nombre_Solicitante`', '`Apellido_Nombre_Solicitante`', 200, -1, FALSE, '`Apellido_Nombre_Solicitante`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Dni
		$this->Dni = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Dni', 'Dni', '`Dni`', '`Dni`', 3, -1, FALSE, '`Dni`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Dni->Sortable = TRUE; // Allow sort
		$this->Dni->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Dni'] = &$this->Dni;

		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 7, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
		...
		// Usuario
		$this->Usuario = new cField('pedido_paquetes', 'pedido_paquetes', 'x_Usuario', 'Usuario', '`Usuario`', '`Usuario`', 200, -1, FALSE, '`Usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`pedido_paquetes`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "pedido_paqueteslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("pedido_paquetesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("pedido_paquetesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "pedido_paquetesadd.php?" . $this->UrlParm($parm);
		else
			$url = "pedido_paquetesadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("pedido_paquetesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("pedido_paquetesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("pedido_paquetesdelete.php", $this->UrlParm());
	}
