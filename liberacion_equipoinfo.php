...
class cliberacion_equipo extends cTable {
	...
	function __construct() {
		...
		// Fecha_Liberacion
		$this->Fecha_Liberacion = new cField('liberacion_equipo', 'liberacion_equipo', 'x_Fecha_Liberacion', 'Fecha_Liberacion', '`Fecha_Liberacion`', 'DATE_FORMAT(`Fecha_Liberacion`, \'\')', 133, 7, FALSE, '`Fecha_Liberacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->Ruta_Archivo_Copia_Titulo = new cField('liberacion_equipo', 'liberacion_equipo', 'x_Ruta_Archivo_Copia_Titulo', 'Ruta_Archivo_Copia_Titulo', '`Ruta_Archivo_Copia_Titulo`', '`Ruta_Archivo_Copia_Titulo`', 201, -1, TRUE, '`Ruta_Archivo_Copia_Titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		...
		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('liberacion_equipo', 'liberacion_equipo', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 7, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Usuario
		$this->Usuario = new cField('liberacion_equipo', 'liberacion_equipo', 'x_Usuario', 'Usuario', '`Usuario`', '`Usuario`', 200, -1, FALSE, '`Usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Fecha_Liberacion->EditValue = ew_FormatDateTime($this->Fecha_Liberacion->CurrentValue, 7);
