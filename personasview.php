...
class cpersonas_view extends cpersonas {
	...
	function SetupOtherOptions() {
		...
		$links = "";
		if ($GLOBALS["estado_actual_legajo_persona_grid"] && $GLOBALS["estado_actual_legajo_persona_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'estado_actual_legajo_persona')) {
		...
		if ($GLOBALS["estado_actual_legajo_persona_grid"] && $GLOBALS["estado_actual_legajo_persona_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'estado_actual_legajo_persona')) {
		...
		if ($GLOBALS["estado_actual_legajo_persona_grid"] && $GLOBALS["estado_actual_legajo_persona_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'estado_actual_legajo_persona')) {
		...
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'estado_actual_legajo_persona');
		if ($item->Visible) {
		...
		$links = "";
		if ($GLOBALS["materias_adeudadas_grid"] && $GLOBALS["materias_adeudadas_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'materias_adeudadas')) {
		...
		if ($GLOBALS["materias_adeudadas_grid"] && $GLOBALS["materias_adeudadas_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'materias_adeudadas')) {
		...
		if ($GLOBALS["materias_adeudadas_grid"] && $GLOBALS["materias_adeudadas_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'materias_adeudadas')) {
		...
		$body = "<div class=\"btn-group\">" . $body . "</div>";
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'materias_adeudadas');
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
		...
		$links = "";
		if ($GLOBALS["observacion_persona_grid"] && $GLOBALS["observacion_persona_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'observacion_persona')) {
		...
		if ($GLOBALS["observacion_persona_grid"] && $GLOBALS["observacion_persona_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'observacion_persona')) {
		...
		if ($GLOBALS["observacion_persona_grid"] && $GLOBALS["observacion_persona_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'observacion_persona')) {
		...
		$body = "<div class=\"btn-group\">" . $body . "</div>";
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'observacion_persona');
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
		...
		$links = "";
		if ($GLOBALS["equipos_grid"] && $GLOBALS["equipos_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'equipos')) {
		...
		if ($GLOBALS["equipos_grid"] && $GLOBALS["equipos_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'equipos')) {
		...
		if ($GLOBALS["equipos_grid"] && $GLOBALS["equipos_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'equipos')) {
		...
		$body = "<div class=\"btn-group\">" . $body . "</div>";
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'equipos');
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
		...
		$links = "";
		if ($GLOBALS["tutores_grid"] && $GLOBALS["tutores_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'tutores')) {
		...
		if ($GLOBALS["tutores_grid"] && $GLOBALS["tutores_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'tutores')) {
		...
		if ($GLOBALS["tutores_grid"] && $GLOBALS["tutores_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'tutores')) {
		...
		$body = "<div class=\"btn-group\">" . $body . "</div>";
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'tutores');
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
...
<?php if ($personas->Foto->Visible) { // Foto ?>
	<tr id="r_Foto">
		<td><span id="elh_personas_Foto"><?php echo $personas->Foto->FldCaption() ?></span></td>
		<td data-name="Foto"<?php echo $personas->Foto->CellAttributes() ?>>
<span id="el_personas_Foto" data-page="1">
<span>
<?php echo ew_GetFileViewTag($personas->Foto, $personas->Foto->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($personas->Usuario->Visible) { // Usuario ?>
	<tr id="r_Usuario">
		<td><span id="elh_personas_Usuario"><?php echo $personas->Usuario->FldCaption() ?></span></td>
		<td data-name="Usuario"<?php echo $personas->Usuario->CellAttributes() ?>>
<span id="el_personas_Usuario" data-page="1">
<span<?php echo $personas->Usuario->ViewAttributes() ?>>
<?php echo $personas->Usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
