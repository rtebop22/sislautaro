...
<?php if ($servidor_escolar->User_Server->Visible) { // User_Server ?>
	<tr id="r_User_Server">
		<td><span id="elh_servidor_escolar_User_Server"><?php echo $servidor_escolar->User_Server->FldCaption() ?></span></td>
		<td data-name="User_Server"<?php echo $servidor_escolar->User_Server->CellAttributes() ?>>
<span id="el_servidor_escolar_User_Server" data-page="1">
<span<?php echo $servidor_escolar->User_Server->ViewAttributes() ?>>
<?php echo $servidor_escolar->User_Server->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($servidor_escolar->User_TdServer->Visible) { // User_TdServer ?>
	<tr id="r_User_TdServer">
		<td><span id="elh_servidor_escolar_User_TdServer"><?php echo $servidor_escolar->User_TdServer->FldCaption() ?></span></td>
		<td data-name="User_TdServer"<?php echo $servidor_escolar->User_TdServer->CellAttributes() ?>>
<span id="el_servidor_escolar_User_TdServer" data-page="1">
<span<?php echo $servidor_escolar->User_TdServer->ViewAttributes() ?>>
<?php echo $servidor_escolar->User_TdServer->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
