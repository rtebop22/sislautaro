...
<?php if ($personas->Foto->Visible) { // Foto ?>
	<div id="r_Foto" class="form-group">
		<label class="<?php echo $personas_search->SearchLabelClass ?>"><span id="elh_personas_Foto"><?php echo $personas->Foto->FldCaption() ?></span>	
		...
		<div class="<?php echo $personas_search->SearchRightColumnClass ?>"><div<?php echo $personas->Foto->CellAttributes() ?>>
			<span id="el_personas_Foto">
<input type="text" data-table="personas" data-field="x_Foto" name="x_Foto" id="x_Foto" placeholder="<?php echo ew_HtmlEncode($personas->Foto->getPlaceHolder()) ?>" value="<?php echo $personas->Foto->EditValue ?>"<?php echo $personas->Foto->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
...
<?php if ($personas->Usuario->Visible) { // Usuario ?>
	<div id="r_Usuario" class="form-group">
		<label for="x_Usuario" class="<?php echo $personas_search->SearchLabelClass ?>"><span id="elh_personas_Usuario"><?php echo $personas->Usuario->FldCaption() ?></span>	
		...
		<div class="<?php echo $personas_search->SearchRightColumnClass ?>"><div<?php echo $personas->Usuario->CellAttributes() ?>>
			<span id="el_personas_Usuario">
<input type="text" data-table="personas" data-field="x_Usuario" name="x_Usuario" id="x_Usuario" size="30" maxlength="18" placeholder="<?php echo ew_HtmlEncode($personas->Usuario->getPlaceHolder()) ?>" value="<?php echo $personas->Usuario->EditValue ?>"<?php echo $personas->Usuario->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($personas->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<div id="r_Fecha_Actualizacion" class="form-group">
		<label for="x_Fecha_Actualizacion" class="<?php echo $personas_search->SearchLabelClass ?>"><span id="elh_personas_Fecha_Actualizacion"><?php echo $personas->Fecha_Actualizacion->FldCaption() ?></span>	
...
<input type="text" data-table="personas" data-field="x_Fecha_Actualizacion" data-format="7" name="x_Fecha_Actualizacion" id="x_Fecha_Actualizacion" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($personas->Fecha_Actualizacion->getPlaceHolder()) ?>" value="<?php echo $personas->Fecha_Actualizacion->EditValue ?>"<?php echo $personas->Fecha_Actualizacion->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
