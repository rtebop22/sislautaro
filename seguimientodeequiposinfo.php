...
$seguimientodeequipos = NULL;

//
// Table class for seguimientodeequipos
//
class cseguimientodeequipos extends cTable {
	var $NroSerie;
	var $Detalle;
	...
	function __construct() {
		...
		$this->TableVar = 'seguimientodeequipos';
		$this->TableName = 'seguimientodeequipos';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`seguimientodeequipos`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// NroSerie
		$this->NroSerie = new cField('seguimientodeequipos', 'seguimientodeequipos', 'x_NroSerie', 'NroSerie', '`NroSerie`', '`NroSerie`', 200, -1, FALSE, '`NroSerie`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NroSerie->Sortable = TRUE; // Allow sort
		$this->fields['NroSerie'] = &$this->NroSerie;

		// Detalle
		$this->Detalle = new cField('seguimientodeequipos', 'seguimientodeequipos', 'x_Detalle', 'Detalle', '`Detalle`', '`Detalle`', 201, -1, FALSE, '`Detalle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Detalle->Sortable = TRUE; // Allow sort
		$this->fields['Detalle'] = &$this->Detalle;

		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('seguimientodeequipos', 'seguimientodeequipos', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 7, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`seguimientodeequipos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "seguimientodeequiposlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("seguimientodeequiposview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("seguimientodeequiposview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "seguimientodeequiposadd.php?" . $this->UrlParm($parm);
		else
			$url = "seguimientodeequiposadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("seguimientodeequiposedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("seguimientodeequiposadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("seguimientodeequiposdelete.php", $this->UrlParm());
	}
