...
class cestablecimientos_educativos_pase_search extends cestablecimientos_educativos_pase {
	...
	function BuildAdvancedSearch() {
		...
		$this->BuildSearchUrl($sSrchUrl, $this->Nombre_Directivo); // Nombre_Directivo
		$this->BuildSearchUrl($sSrchUrl, $this->Cuil_Directivo); // Cuil_Directivo
		$this->BuildSearchUrl($sSrchUrl, $this->Nombre_Rte); // Nombre_Rte
		$this->BuildSearchUrl($sSrchUrl, $this->Tel_Rte); // Tel_Rte
		$this->BuildSearchUrl($sSrchUrl, $this->Email_Rte); // Email_Rte
		...
		$this->BuildSearchUrl($sSrchUrl, $this->Domicilio_Escuela); // Domicilio_Escuela
	...
	function LoadSearchValues() {
		...
		// Nombre_Directivo
		$this->Nombre_Directivo->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_Nombre_Directivo"));
		$this->Nombre_Directivo->AdvancedSearch->SearchOperator = $objForm->GetValue("z_Nombre_Directivo");

		// Cuil_Directivo
		$this->Cuil_Directivo->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_Cuil_Directivo"));
		$this->Cuil_Directivo->AdvancedSearch->SearchOperator = $objForm->GetValue("z_Cuil_Directivo");
		...
		// Tel_Rte
		$this->Tel_Rte->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_Tel_Rte"));
		$this->Tel_Rte->AdvancedSearch->SearchOperator = $objForm->GetValue("z_Tel_Rte");

		// Email_Rte
		$this->Email_Rte->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_Email_Rte"));
		$this->Email_Rte->AdvancedSearch->SearchOperator = $objForm->GetValue("z_Email_Rte");
		...
		// Domicilio_Escuela
		$this->Domicilio_Escuela->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_Domicilio_Escuela"));
		$this->Domicilio_Escuela->AdvancedSearch->SearchOperator = $objForm->GetValue("z_Domicilio_Escuela");
	...
	function RenderRow() {
		...
		$this->Usuario->ViewCustomAttributes = "";
			...
			$this->Nombre_Directivo->EditValue = ew_HtmlEncode($this->Nombre_Directivo->AdvancedSearch->SearchValue);
			...
			$this->Cuil_Directivo->EditValue = ew_HtmlEncode($this->Cuil_Directivo->AdvancedSearch->SearchValue);
			...
			$this->Tel_Rte->EditValue = ew_HtmlEncode($this->Tel_Rte->AdvancedSearch->SearchValue);
			...
			$this->Email_Rte->EditValue = ew_HtmlEncode($this->Email_Rte->AdvancedSearch->SearchValue);
			...
			$this->Domicilio_Escuela->EditValue = ew_HtmlEncode($this->Domicilio_Escuela->AdvancedSearch->SearchValue);
...
<?php if ($establecimientos_educativos_pase->Nombre_Directivo->Visible) { // Nombre_Directivo ?>
	<div id="r_Nombre_Directivo" class="form-group">
		<label for="x_Nombre_Directivo" class="<?php echo $establecimientos_educativos_pase_search->SearchLabelClass ?>"><span id="elh_establecimientos_educativos_pase_Nombre_Directivo"><?php echo $establecimientos_educativos_pase->Nombre_Directivo->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Nombre_Directivo" id="z_Nombre_Directivo" value="LIKE"></p>
		</label>
		<div class="<?php echo $establecimientos_educativos_pase_search->SearchRightColumnClass ?>"><div<?php echo $establecimientos_educativos_pase->Nombre_Directivo->CellAttributes() ?>>
...
<?php if ($establecimientos_educativos_pase->Cuil_Directivo->Visible) { // Cuil_Directivo ?>
	<div id="r_Cuil_Directivo" class="form-group">
		<label for="x_Cuil_Directivo" class="<?php echo $establecimientos_educativos_pase_search->SearchLabelClass ?>"><span id="elh_establecimientos_educativos_pase_Cuil_Directivo"><?php echo $establecimientos_educativos_pase->Cuil_Directivo->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Cuil_Directivo" id="z_Cuil_Directivo" value="LIKE"></p>
		</label>
		<div class="<?php echo $establecimientos_educativos_pase_search->SearchRightColumnClass ?>"><div<?php echo $establecimientos_educativos_pase->Cuil_Directivo->CellAttributes() ?>>
...
<?php if ($establecimientos_educativos_pase->Tel_Rte->Visible) { // Tel_Rte ?>
	<div id="r_Tel_Rte" class="form-group">
		<label for="x_Tel_Rte" class="<?php echo $establecimientos_educativos_pase_search->SearchLabelClass ?>"><span id="elh_establecimientos_educativos_pase_Tel_Rte"><?php echo $establecimientos_educativos_pase->Tel_Rte->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Tel_Rte" id="z_Tel_Rte" value="LIKE"></p>
		</label>
		<div class="<?php echo $establecimientos_educativos_pase_search->SearchRightColumnClass ?>"><div<?php echo $establecimientos_educativos_pase->Tel_Rte->CellAttributes() ?>>
...
<?php if ($establecimientos_educativos_pase->Email_Rte->Visible) { // Email_Rte ?>
	<div id="r_Email_Rte" class="form-group">
		<label for="x_Email_Rte" class="<?php echo $establecimientos_educativos_pase_search->SearchLabelClass ?>"><span id="elh_establecimientos_educativos_pase_Email_Rte"><?php echo $establecimientos_educativos_pase->Email_Rte->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Email_Rte" id="z_Email_Rte" value="LIKE"></p>
		</label>
		<div class="<?php echo $establecimientos_educativos_pase_search->SearchRightColumnClass ?>"><div<?php echo $establecimientos_educativos_pase->Email_Rte->CellAttributes() ?>>
...
<?php if ($establecimientos_educativos_pase->Domicilio_Escuela->Visible) { // Domicilio_Escuela ?>
	<div id="r_Domicilio_Escuela" class="form-group">
		<label for="x_Domicilio_Escuela" class="<?php echo $establecimientos_educativos_pase_search->SearchLabelClass ?>"><span id="elh_establecimientos_educativos_pase_Domicilio_Escuela"><?php echo $establecimientos_educativos_pase->Domicilio_Escuela->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Domicilio_Escuela" id="z_Domicilio_Escuela" value="LIKE"></p>
		</label>
		<div class="<?php echo $establecimientos_educativos_pase_search->SearchRightColumnClass ?>"><div<?php echo $establecimientos_educativos_pase->Domicilio_Escuela->CellAttributes() ?>>
