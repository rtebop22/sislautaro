...
$estado_titulares_cursos = NULL;

//
// Table class for estado_titulares_cursos
//
class cestado_titulares_cursos extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'estado_titulares_cursos';
		$this->TableName = 'estado_titulares_cursos';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`estado_titulares_cursos`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Apellidos_Nombres
		$this->Apellidos_Nombres = new cField('estado_titulares_cursos', 'estado_titulares_cursos', 'x_Apellidos_Nombres', 'Apellidos_Nombres', '`Apellidos_Nombres`', '`Apellidos_Nombres`', 201, -1, FALSE, '`Apellidos_Nombres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellidos_Nombres->Sortable = TRUE; // Allow sort
		$this->fields['Apellidos_Nombres'] = &$this->Apellidos_Nombres;

		// Dni
		$this->Dni = new cField('estado_titulares_cursos', 'estado_titulares_cursos', 'x_Dni', 'Dni', '`Dni`', '`Dni`', 3, -1, FALSE, '`Dni`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Dni->Sortable = TRUE; // Allow sort
		$this->Dni->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Dni'] = &$this->Dni;

		// Cuil
		$this->Cuil = new cField('estado_titulares_cursos', 'estado_titulares_cursos', 'x_Cuil', 'Cuil', '`Cuil`', '`Cuil`', 200, -1, FALSE, '`Cuil`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cuil->Sortable = TRUE; // Allow sort
		$this->fields['Cuil'] = &$this->Cuil;

		// Id_Curso
		$this->Id_Curso = new cField('estado_titulares_cursos', 'estado_titulares_cursos', 'x_Id_Curso', 'Id_Curso', '`Id_Curso`', '`Id_Curso`', 3, -1, FALSE, '`Id_Curso`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Division
		$this->Id_Division = new cField('estado_titulares_cursos', 'estado_titulares_cursos', 'x_Id_Division', 'Id_Division', '`Id_Division`', '`Id_Division`', 3, -1, FALSE, '`Id_Division`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Turno
		$this->Id_Turno = new cField('estado_titulares_cursos', 'estado_titulares_cursos', 'x_Id_Turno', 'Id_Turno', '`Id_Turno`', '`Id_Turno`', 3, -1, FALSE, '`Id_Turno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Cargo
		$this->Id_Cargo = new cField('estado_titulares_cursos', 'estado_titulares_cursos', 'x_Id_Cargo', 'Id_Cargo', '`Id_Cargo`', '`Id_Cargo`', 3, -1, FALSE, '`Id_Cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Estado
		$this->Id_Estado = new cField('estado_titulares_cursos', 'estado_titulares_cursos', 'x_Id_Estado', 'Id_Estado', '`Id_Estado`', '`Id_Estado`', 3, -1, FALSE, '`Id_Estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Repitente
		$this->Repitente = new cField('estado_titulares_cursos', 'estado_titulares_cursos', 'x_Repitente', 'Repitente', '`Repitente`', '`Repitente`', 200, -1, FALSE, '`Repitente`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Repitente->Sortable = TRUE; // Allow sort
		$this->fields['Repitente'] = &$this->Repitente;

		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('estado_titulares_cursos', 'estado_titulares_cursos', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 7, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`estado_titulares_cursos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "estado_titulares_cursoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("estado_titulares_cursosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("estado_titulares_cursosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "estado_titulares_cursosadd.php?" . $this->UrlParm($parm);
		else
			$url = "estado_titulares_cursosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("estado_titulares_cursosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("estado_titulares_cursosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("estado_titulares_cursosdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Repitente->EditValue = $this->Repitente->CurrentValue;
