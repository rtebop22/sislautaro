...
class cequipos_view extends cequipos {
	...
	function SetupOtherOptions() {
		...
		$links = "";
		if ($GLOBALS["observacion_equipo_grid"] && $GLOBALS["observacion_equipo_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'observacion_equipo')) {
		...
		if ($GLOBALS["observacion_equipo_grid"] && $GLOBALS["observacion_equipo_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'observacion_equipo')) {
		...
		if ($GLOBALS["observacion_equipo_grid"] && $GLOBALS["observacion_equipo_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 'observacion_equipo')) {
		...
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'observacion_equipo');
		if ($item->Visible) {
...
fequiposview.Lists["x_Tiene_Cargador"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fequiposview.Lists["x_Tiene_Cargador"].Options = <?php echo json_encode($equipos->Tiene_Cargador->Options()) ?>;
fequiposview.Lists["x_Id_Tipo_Equipo"] = {"LinkField":"x_Id_Tipo_Equipo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_equipo"};
...
<?php if ($equipos->SpecialNumber->Visible) { // SpecialNumber ?>
	<tr id="r_SpecialNumber">
		<td><span id="elh_equipos_SpecialNumber"><?php echo $equipos->SpecialNumber->FldCaption() ?></span></td>
		<td data-name="SpecialNumber"<?php echo $equipos->SpecialNumber->CellAttributes() ?>>
<span id="el_equipos_SpecialNumber">
<span<?php echo $equipos->SpecialNumber->ViewAttributes() ?>>
<?php echo $equipos->SpecialNumber->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($equipos->Tiene_Cargador->Visible) { // Tiene_Cargador ?>
	<tr id="r_Tiene_Cargador">
		<td><span id="elh_equipos_Tiene_Cargador"><?php echo $equipos->Tiene_Cargador->FldCaption() ?></span></td>
		<td data-name="Tiene_Cargador"<?php echo $equipos->Tiene_Cargador->CellAttributes() ?>>
<span id="el_equipos_Tiene_Cargador">
<span<?php echo $equipos->Tiene_Cargador->ViewAttributes() ?>>
<?php echo $equipos->Tiene_Cargador->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equipos->Id_Tipo_Equipo->Visible) { // Id_Tipo_Equipo ?>
	<tr id="r_Id_Tipo_Equipo">
		<td><span id="elh_equipos_Id_Tipo_Equipo"><?php echo $equipos->Id_Tipo_Equipo->FldCaption() ?></span></td>
...
<?php echo $equipos->Id_Tipo_Equipo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equipos->Usuario->Visible) { // Usuario ?>
	<tr id="r_Usuario">
		<td><span id="elh_equipos_Usuario"><?php echo $equipos->Usuario->FldCaption() ?></span></td>
...
<?php echo $equipos->Usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($equipos->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<tr id="r_Fecha_Actualizacion">
		<td><span id="elh_equipos_Fecha_Actualizacion"><?php echo $equipos->Fecha_Actualizacion->FldCaption() ?></span></td>
...
<?php echo $equipos->Fecha_Actualizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
