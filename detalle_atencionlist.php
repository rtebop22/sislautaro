...
$detalle_atencion_list = NULL; // Initialize page object first

class cdetalle_atencion_list extends cdetalle_atencion {
	...
	// Page object name
	var $PageObjName = 'detalle_atencion_list';

	// Grid form hidden field names
	var $FormName = 'fdetalle_atencionlist';
	...
	function __construct() {
		...
		$this->AddUrl = "detalle_atencionadd.php";
		$this->InlineAddUrl = $this->PageUrl() . "a=add";
		$this->GridAddUrl = $this->PageUrl() . "a=gridadd";
		$this->GridEditUrl = $this->PageUrl() . "a=gridedit";
		$this->MultiDeleteUrl = "detalle_atenciondelete.php";
		$this->MultiUpdateUrl = "detalle_atencionupdate.php";
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fdetalle_atencionlistsrch";
	...
	function ClearInlineMode() {
		...
		$this->setKey("Id_Detalle_Atencion", ""); // Clear inline edit key
	...
	function InlineEditMode() {
		...
		if ($bInlineEdit) {
			if ($this->LoadRow()) {
				...
				$this->setKey("Id_Detalle_Atencion", $this->Id_Detalle_Atencion->CurrentValue); // Set up inline edit key
	...
	function CheckInlineEditKey() {
		...
		if (strval($this->getKey("NroSerie")) <> strval($this->NroSerie->CurrentValue))
			return FALSE;
		if (strval($this->getKey("Id_Detalle_Atencion")) <> strval($this->Id_Detalle_Atencion->CurrentValue))
			return FALSE;
		return TRUE;
	}
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 3) {
			...
			$this->Id_Detalle_Atencion->setFormValue($arrKeyFlds[2]);
			if (!is_numeric($this->Id_Detalle_Atencion->FormValue))
				return FALSE;
		}
		return TRUE;
	}
		...
		for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
			...
			if (!$this->EmptyRow()) {
				...
				if ($bGridInsert) {
					...
					if ($sKey <> "") $sKey .= $GLOBALS["EW_COMPOSITE_KEY_SEPARATOR"];
					$sKey .= $this->Id_Detalle_Atencion->CurrentValue;
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_NroSerie") && $objForm->HasValue("o_NroSerie") && $this->NroSerie->CurrentValue <> $this->NroSerie->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Id_Tipo_Falla") && $objForm->HasValue("o_Id_Tipo_Falla") && $this->Id_Tipo_Falla->CurrentValue <> $this->Id_Tipo_Falla->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Id_Problema") && $objForm->HasValue("o_Id_Problema") && $this->Id_Problema->CurrentValue <> $this->Id_Problema->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Descripcion_Problema") && $objForm->HasValue("o_Descripcion_Problema") && $this->Descripcion_Problema->CurrentValue <> $this->Descripcion_Problema->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Id_Tipo_Sol_Problem") && $objForm->HasValue("o_Id_Tipo_Sol_Problem") && $this->Id_Tipo_Sol_Problem->CurrentValue <> $this->Id_Tipo_Sol_Problem->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Id_Estado_Atenc") && $objForm->HasValue("o_Id_Estado_Atenc") && $this->Id_Estado_Atenc->CurrentValue <> $this->Id_Estado_Atenc->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = $UserProfile->GetSearchFilters(CurrentUserName(), "fdetalle_atencionlistsrch");
		} else {
			$sSavedFilterList = "";
		}
		...
		$sFilterList = ew_Concat($sFilterList, $this->Id_Detalle_Atencion->AdvancedSearch->ToJSON(), ","); // Field Id_Detalle_Atencion
		...
		$sFilterList = ew_Concat($sFilterList, $this->Descripcion_Problema->AdvancedSearch->ToJSON(), ","); // Field Descripcion_Problema
	...
	function ProcessFilterList() {
		...
		if (@$_POST["cmd"] == "savefilters") {
			...
			$UserProfile->SetSearchFilters(CurrentUserName(), "fdetalle_atencionlistsrch", $filters);
	...
	function RestoreFilterList() {
		...
		// Field Id_Detalle_Atencion
		$this->Id_Detalle_Atencion->AdvancedSearch->SearchValue = @$filter["x_Id_Detalle_Atencion"];
		$this->Id_Detalle_Atencion->AdvancedSearch->SearchOperator = @$filter["z_Id_Detalle_Atencion"];
		$this->Id_Detalle_Atencion->AdvancedSearch->SearchCondition = @$filter["v_Id_Detalle_Atencion"];
		$this->Id_Detalle_Atencion->AdvancedSearch->SearchValue2 = @$filter["y_Id_Detalle_Atencion"];
		$this->Id_Detalle_Atencion->AdvancedSearch->SearchOperator2 = @$filter["w_Id_Detalle_Atencion"];
		$this->Id_Detalle_Atencion->AdvancedSearch->Save();
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->Id_Detalle_Atencion, $Default, FALSE); // Id_Detalle_Atencion
		...
		$this->BuildSearchSql($sWhere, $this->Descripcion_Problema, $Default, FALSE); // Descripcion_Problema
		...
		if (!$Default && $this->Command == "search") {
			...
			$this->Id_Detalle_Atencion->AdvancedSearch->Save(); // Id_Detalle_Atencion
			$this->Id_Tipo_Falla->AdvancedSearch->Save(); // Id_Tipo_Falla
			$this->Id_Problema->AdvancedSearch->Save(); // Id_Problema
			$this->Descripcion_Problema->AdvancedSearch->Save(); // Descripcion_Problema
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->Id_Detalle_Atencion, $arKeywords, $type);
	...
	function CheckSearchParms() {
		...
		if ($this->NroSerie->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Id_Detalle_Atencion->AdvancedSearch->IssetSession())
			return TRUE;
	...
	function ResetAdvancedSearchParms() {
		...
		$this->Id_Detalle_Atencion->AdvancedSearch->UnsetSession();
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->Descripcion_Problema); // Descripcion_Problema
	...
	function RenderListOptions() {
		...
		if ($this->CurrentAction == "edit" && $this->RowType == EW_ROWTYPE_EDIT) { // Inline-Edit
			...
			$oListOpt->Body .= "<input type=\"hidden\" name=\"k" . $this->RowIndex . "_key\" id=\"k" . $this->RowIndex . "_key\" value=\"" . ew_HtmlEncode($this->Id_Atencion->CurrentValue . $GLOBALS["EW_COMPOSITE_KEY_SEPARATOR"] . $this->NroSerie->CurrentValue . $GLOBALS["EW_COMPOSITE_KEY_SEPARATOR"] . $this->Id_Detalle_Atencion->CurrentValue) . "\">";
			return;
		}
		...
		if ($Security->CanView()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewView\" title=\"" . $viewcaption . "\" data-table=\"detalle_atencion\" data-caption=\"" . $viewcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->ViewUrl) . "'});\">" . $Language->Phrase("ViewLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
		...
		if ($Security->CanEdit()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewEdit\" title=\"" . $editcaption . "\" data-table=\"detalle_atencion\" data-caption=\"" . $editcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->EditUrl) . "',caption:'" . $editcaption . "'});\">" . $Language->Phrase("EditLink") . "</a>";
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->Id_Atencion->CurrentValue . $GLOBALS["EW_COMPOSITE_KEY_SEPARATOR"] . $this->NroSerie->CurrentValue . $GLOBALS["EW_COMPOSITE_KEY_SEPARATOR"] . $this->Id_Detalle_Atencion->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'>";
		if ($this->CurrentAction == "gridedit" && is_numeric($this->RowIndex)) {
			$this->MultiSelectKey .= "<input type=\"hidden\" name=\"" . $KeyName . "\" id=\"" . $KeyName . "\" value=\"" . $this->Id_Atencion->CurrentValue . $GLOBALS["EW_COMPOSITE_KEY_SEPARATOR"] . $this->NroSerie->CurrentValue . $GLOBALS["EW_COMPOSITE_KEY_SEPARATOR"] . $this->Id_Detalle_Atencion->CurrentValue . "\">";
		}
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.fdetalle_atencionlist,url:'" . $this->MultiDeleteUrl . "',msg:ewLanguage.Phrase('DeleteConfirmMsg')});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->CanDelete());

		// Add multi update
		$item = &$option->Add("multiupdate");
		$item->Body = "<a class=\"ewAction ewMultiUpdate\" title=\"" . ew_HtmlTitle($Language->Phrase("UpdateSelectedLink")) . "\" data-table=\"detalle_atencion\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("UpdateSelectedLink")) . "\" href=\"\" onclick=\"ew_ModalDialogShow({lnk:this,f:document.fdetalle_atencionlist,url:'" . $this->MultiUpdateUrl . "',caption:'" . $Language->Phrase("UpdateBtn") . "'});return false;\">" . $Language->Phrase("UpdateSelectedLink") . "</a>";
		$item->Visible = ($Security->CanEdit());
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fdetalle_atencionlistsrch\" href=\"#\">" . $Language->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fdetalle_atencionlistsrch\" href=\"#\">" . $Language->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		if ($this->CurrentAction <> "gridadd" && $this->CurrentAction <> "gridedit") { // Not grid add/edit mode
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == EW_ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ewAction ewListAction\" title=\"" . ew_HtmlEncode($caption) . "\" data-caption=\"" . ew_HtmlEncode($caption) . "\" href=\"\" onclick=\"ew_SubmitAction(event,jQuery.extend({f:document.fdetalle_atencionlist}," . $listaction->ToJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fdetalle_atencionlistsrch\">" . $Language->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"btn btn-default ewAdvancedSearch\" title=\"" . $Language->Phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->Phrase("AdvancedSearch") . "\" href=\"detalle_atencionsrch.php\">" . $Language->Phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;
	...
	function LoadDefaultValues() {
		...
		$this->Id_Tipo_Falla->OldValue = $this->Id_Tipo_Falla->CurrentValue;
		$this->Id_Problema->CurrentValue = 2;
		$this->Id_Problema->OldValue = $this->Id_Problema->CurrentValue;
		...
		$this->Id_Tipo_Sol_Problem->OldValue = $this->Id_Tipo_Sol_Problem->CurrentValue;
		$this->Id_Estado_Atenc->CurrentValue = 4;
		$this->Id_Estado_Atenc->OldValue = $this->Id_Estado_Atenc->CurrentValue;
	...
	function LoadSearchValues() {
		...
		// Id_Detalle_Atencion
		$this->Id_Detalle_Atencion->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_Id_Detalle_Atencion"]);
		if ($this->Id_Detalle_Atencion->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->Id_Detalle_Atencion->AdvancedSearch->SearchOperator = @$_GET["z_Id_Detalle_Atencion"];
	...
	function LoadFormValues() {
		...
		$this->Id_Tipo_Falla->setOldValue($objForm->GetValue("o_Id_Tipo_Falla"));
		if (!$this->Id_Problema->FldIsDetailKey) {
			$this->Id_Problema->setFormValue($objForm->GetValue("x_Id_Problema"));
		}
		$this->Id_Problema->setOldValue($objForm->GetValue("o_Id_Problema"));
		...
		if (!$this->Id_Detalle_Atencion->FldIsDetailKey && $this->CurrentAction <> "gridadd" && $this->CurrentAction <> "add")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_detalle_atencion\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_detalle_atencion',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fdetalle_atencionlist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($detalle_atencion_list)) $detalle_atencion_list = new cdetalle_atencion_list();

// Page init
$detalle_atencion_list->Page_Init();

// Page main
$detalle_atencion_list->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$detalle_atencion_list->Page_Render();
?>
...
var CurrentForm = fdetalle_atencionlist = new ew_Form("fdetalle_atencionlist", "list");
fdetalle_atencionlist.FormKeyCountName = '<?php echo $detalle_atencion_list->FormKeyCountName ?>';

// Validate form
fdetalle_atencionlist.Validate = function() {
...
// Check empty row
fdetalle_atencionlist.EmptyRow = function(infix) {
	var fobj = this.Form;
...
fdetalle_atencionlist.Form_CustomValidate = 
...
fdetalle_atencionlist.ValidateRequired = true;
<?php } else { ?>
fdetalle_atencionlist.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdetalle_atencionlist.Lists["x_Id_Tipo_Falla"] = {"LinkField":"x_Id_Tipo_Falla","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_falla"};
fdetalle_atencionlist.Lists["x_Id_Problema"] = {"LinkField":"x_Id_Problema","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"problema"};
fdetalle_atencionlist.Lists["x_Id_Tipo_Sol_Problem"] = {"LinkField":"x_Id_Tipo_Sol_Problem","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_solucion_problema"};
fdetalle_atencionlist.Lists["x_Id_Estado_Atenc"] = {"LinkField":"x_Id_Estado_Atenc","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_actual_solucion_problema"};

// Form object for search
var CurrentSearchForm = fdetalle_atencionlistsrch = new ew_Form("fdetalle_atencionlistsrch");
</script>
<script type="text/javascript">
...
<?php } ?>
<?php if ($detalle_atencion_list->TotalRecs > 0 && $detalle_atencion_list->ExportOptions->Visible()) { ?>
<?php $detalle_atencion_list->ExportOptions->Render("body") ?>
<?php } ?>
<?php if ($detalle_atencion_list->SearchOptions->Visible()) { ?>
<?php $detalle_atencion_list->SearchOptions->Render("body") ?>
<?php } ?>
<?php if ($detalle_atencion_list->FilterOptions->Visible()) { ?>
<?php $detalle_atencion_list->FilterOptions->Render("body") ?>
<?php } ?>
<?php if ($detalle_atencion->Export == "") { ?>
...
<?php } ?>
<?php if (($detalle_atencion->Export == "") || (EW_EXPORT_MASTER_RECORD && $detalle_atencion->Export == "print")) { ?>
<?php
if ($detalle_atencion_list->DbMasterFilter <> "" && $detalle_atencion->getCurrentMasterTable() == "atencion_equipos") {
	if ($detalle_atencion_list->MasterRecordExists) {
?>
...
if ($detalle_atencion->CurrentAction == "gridadd") {
	...
	$detalle_atencion_list->StartRec = 1;
	$detalle_atencion_list->DisplayRecs = $detalle_atencion->GridAddRowCount;
	$detalle_atencion_list->TotalRecs = $detalle_atencion_list->DisplayRecs;
	$detalle_atencion_list->StopRec = $detalle_atencion_list->DisplayRecs;
} else {
	$bSelectLimit = $detalle_atencion_list->UseSelectLimit;
	if ($bSelectLimit) {
		if ($detalle_atencion_list->TotalRecs <= 0)
			$detalle_atencion_list->TotalRecs = $detalle_atencion->SelectRecordCount();
	} else {
		if (!$detalle_atencion_list->Recordset && ($detalle_atencion_list->Recordset = $detalle_atencion_list->LoadRecordset()))
			$detalle_atencion_list->TotalRecs = $detalle_atencion_list->Recordset->RecordCount();
	}
	$detalle_atencion_list->StartRec = 1;
	if ($detalle_atencion_list->DisplayRecs <= 0 || ($detalle_atencion->Export <> "" && $detalle_atencion->ExportAll)) // Display all records
		$detalle_atencion_list->DisplayRecs = $detalle_atencion_list->TotalRecs;
	if (!($detalle_atencion->Export <> "" && $detalle_atencion->ExportAll))
		$detalle_atencion_list->SetUpStartRec(); // Set up start record position
	if ($bSelectLimit)
		$detalle_atencion_list->Recordset = $detalle_atencion_list->LoadRecordset($detalle_atencion_list->StartRec-1, $detalle_atencion_list->DisplayRecs);

	// Set no record found message
	if ($detalle_atencion->CurrentAction == "" && $detalle_atencion_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$detalle_atencion_list->setWarningMessage(ew_DeniedMsg());
		if ($detalle_atencion_list->SearchWhere == "0=101")
			$detalle_atencion_list->setWarningMessage($Language->Phrase("EnterSearchCriteria"));
		else
			$detalle_atencion_list->setWarningMessage($Language->Phrase("NoRecord"));
	}

	// Audit trail on search
	if ($detalle_atencion_list->AuditTrailOnSearch && $detalle_atencion_list->Command == "search" && !$detalle_atencion_list->RestoreSearch) {
		$searchparm = ew_ServerVar("QUERY_STRING");
		$searchsql = $detalle_atencion_list->getSessionWhere();
		$detalle_atencion_list->WriteAuditTrailOnSearch($searchparm, $searchsql);
	}
}
$detalle_atencion_list->RenderOtherOptions();
?>
<?php if ($Security->CanSearch()) { ?>
<?php if ($detalle_atencion->Export == "" && $detalle_atencion->CurrentAction == "") { ?>
<form name="fdetalle_atencionlistsrch" id="fdetalle_atencionlistsrch" class="form-inline ewForm" action="<?php echo ew_CurrentPage() ?>">
<?php $SearchPanelClass = ($detalle_atencion_list->SearchWhere <> "") ? " in" : " in"; ?>
<div id="fdetalle_atencionlistsrch_SearchPanel" class="ewSearchPanel collapse<?php echo $SearchPanelClass ?>">
<input type="hidden" name="cmd" value="search">
<input type="hidden" name="t" value="detalle_atencion">
	<div class="ewBasicSearch">
<div id="xsr_1" class="ewRow">
	<div class="ewQuickSearch input-group">
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo ew_HtmlEncode($detalle_atencion_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Search")) ?>">
	<input type="hidden" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" id="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="<?php echo ew_HtmlEncode($detalle_atencion_list->BasicSearch->getType()) ?>">
	<div class="input-group-btn">
		<button type="button" data-toggle="dropdown" class="btn btn-default"><span id="searchtype"><?php echo $detalle_atencion_list->BasicSearch->getTypeNameShort() ?></span><span class="caret"></span></button>
		<ul class="dropdown-menu pull-right" role="menu">
			<li<?php if ($detalle_atencion_list->BasicSearch->getType() == "") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this)"><?php echo $Language->Phrase("QuickSearchAuto") ?></a></li>
			<li<?php if ($detalle_atencion_list->BasicSearch->getType() == "=") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'=')"><?php echo $Language->Phrase("QuickSearchExact") ?></a></li>
			<li<?php if ($detalle_atencion_list->BasicSearch->getType() == "AND") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'AND')"><?php echo $Language->Phrase("QuickSearchAll") ?></a></li>
			<li<?php if ($detalle_atencion_list->BasicSearch->getType() == "OR") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'OR')"><?php echo $Language->Phrase("QuickSearchAny") ?></a></li>
		</ul>
...
<?php } ?>
<?php } ?>
<?php $detalle_atencion_list->ShowPageHeader(); ?>
<?php
$detalle_atencion_list->ShowMessage();
?>
<?php if ($detalle_atencion_list->TotalRecs > 0 || $detalle_atencion->CurrentAction <> "") { ?>
<div class="panel panel-default ewGrid detalle_atencion">
<?php if ($detalle_atencion->Export == "") { ?>
<div class="panel-heading ewGridUpperPanel">
<?php if ($detalle_atencion->CurrentAction <> "gridadd" && $detalle_atencion->CurrentAction <> "gridedit") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($detalle_atencion_list->Pager)) $detalle_atencion_list->Pager = new cPrevNextPager($detalle_atencion_list->StartRec, $detalle_atencion_list->DisplayRecs, $detalle_atencion_list->TotalRecs) ?>
<?php if ($detalle_atencion_list->Pager->RecordCount > 0 && $detalle_atencion_list->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($detalle_atencion_list->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $detalle_atencion_list->PageUrl() ?>start=<?php echo $detalle_atencion_list->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($detalle_atencion_list->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $detalle_atencion_list->PageUrl() ?>start=<?php echo $detalle_atencion_list->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $detalle_atencion_list->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($detalle_atencion_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $detalle_atencion_list->PageUrl() ?>start=<?php echo $detalle_atencion_list->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($detalle_atencion_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $detalle_atencion_list->PageUrl() ?>start=<?php echo $detalle_atencion_list->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $detalle_atencion_list->Pager->PageCount ?></span>
</div>
<div class="ewPager ewRec">
	<span><?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $detalle_atencion_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $detalle_atencion_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $detalle_atencion_list->Pager->RecordCount ?></span>
</div>
<?php } ?>
</form>
<?php } ?>
...
<?php
	foreach ($detalle_atencion_list->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<div class="clearfix"></div>
...
<?php } ?>
<form name="fdetalle_atencionlist" id="fdetalle_atencionlist" class="form-inline ewForm ewListForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($detalle_atencion_list->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $detalle_atencion_list->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="detalle_atencion">
<?php if ($detalle_atencion->getCurrentMasterTable() == "atencion_equipos" && $detalle_atencion->CurrentAction <> "") { ?>
...
<?php if ($detalle_atencion_list->TotalRecs > 0 || $detalle_atencion->CurrentAction == "add" || $detalle_atencion->CurrentAction == "copy") { ?>
<table id="tbl_detalle_atencionlist" class="table ewTable">
...
// Header row
$detalle_atencion_list->RowType = EW_ROWTYPE_HEADER;

// Render list options
$detalle_atencion_list->RenderListOptions();

// Render list options (header, left)
$detalle_atencion_list->ListOptions->Render("header", "left");
?>
<?php if ($detalle_atencion->Id_Atencion->Visible) { // Id_Atencion ?>
	...
	<?php } else { ?>
		<th data-name="Id_Atencion"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle_atencion->SortUrl($detalle_atencion->Id_Atencion) ?>',1);"><div id="elh_detalle_atencion_Id_Atencion" class="detalle_atencion_Id_Atencion">
...
<?php if ($detalle_atencion->NroSerie->Visible) { // NroSerie ?>
	...
	<?php } else { ?>
		<th data-name="NroSerie"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle_atencion->SortUrl($detalle_atencion->NroSerie) ?>',1);"><div id="elh_detalle_atencion_NroSerie" class="detalle_atencion_NroSerie">
...
<?php if ($detalle_atencion->Id_Tipo_Falla->Visible) { // Id_Tipo_Falla ?>
	...
	<?php } else { ?>
		<th data-name="Id_Tipo_Falla"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle_atencion->SortUrl($detalle_atencion->Id_Tipo_Falla) ?>',1);"><div id="elh_detalle_atencion_Id_Tipo_Falla" class="detalle_atencion_Id_Tipo_Falla">
...
<?php if ($detalle_atencion->Id_Problema->Visible) { // Id_Problema ?>
	...
	<?php } else { ?>
		<th data-name="Id_Problema"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle_atencion->SortUrl($detalle_atencion->Id_Problema) ?>',1);"><div id="elh_detalle_atencion_Id_Problema" class="detalle_atencion_Id_Problema">
...
<?php if ($detalle_atencion->Descripcion_Problema->Visible) { // Descripcion_Problema ?>
	...
	<?php } else { ?>
		<th data-name="Descripcion_Problema"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle_atencion->SortUrl($detalle_atencion->Descripcion_Problema) ?>',1);"><div id="elh_detalle_atencion_Descripcion_Problema" class="detalle_atencion_Descripcion_Problema">
...
<?php if ($detalle_atencion->Id_Tipo_Sol_Problem->Visible) { // Id_Tipo_Sol_Problem ?>
	...
	<?php } else { ?>
		<th data-name="Id_Tipo_Sol_Problem"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle_atencion->SortUrl($detalle_atencion->Id_Tipo_Sol_Problem) ?>',1);"><div id="elh_detalle_atencion_Id_Tipo_Sol_Problem" class="detalle_atencion_Id_Tipo_Sol_Problem">
...
<?php if ($detalle_atencion->Id_Estado_Atenc->Visible) { // Id_Estado_Atenc ?>
	...
	<?php } else { ?>
		<th data-name="Id_Estado_Atenc"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle_atencion->SortUrl($detalle_atencion->Id_Estado_Atenc) ?>',1);"><div id="elh_detalle_atencion_Id_Estado_Atenc" class="detalle_atencion_Id_Estado_Atenc">
...
<?php if ($detalle_atencion->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	...
	<?php } else { ?>
		<th data-name="Fecha_Actualizacion"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $detalle_atencion->SortUrl($detalle_atencion->Fecha_Actualizacion) ?>',1);"><div id="elh_detalle_atencion_Fecha_Actualizacion" class="detalle_atencion_Fecha_Actualizacion">
...
$detalle_atencion_list->ListOptions->Render("header", "right");
?>
	</tr>
</thead>
<tbody>
<?php
	if ($detalle_atencion->CurrentAction == "add" || $detalle_atencion->CurrentAction == "copy") {
		$detalle_atencion_list->RowIndex = 0;
		$detalle_atencion_list->KeyCount = $detalle_atencion_list->RowIndex;
		if ($detalle_atencion->CurrentAction == "add")
			$detalle_atencion_list->LoadDefaultValues();
		if ($detalle_atencion->EventCancelled) // Insert failed
			$detalle_atencion_list->RestoreFormValues(); // Restore form values

		// Set row properties
		$detalle_atencion->ResetAttrs();
		$detalle_atencion->RowAttrs = array_merge($detalle_atencion->RowAttrs, array('data-rowindex'=>0, 'id'=>'r0_detalle_atencion', 'data-rowtype'=>EW_ROWTYPE_ADD));
		$detalle_atencion->RowType = EW_ROWTYPE_ADD;

		// Render row
		$detalle_atencion_list->RenderRow();

		// Render list options
		$detalle_atencion_list->RenderListOptions();
		$detalle_atencion_list->StartRowCnt = 0;
?>
	<tr<?php echo $detalle_atencion->RowAttributes() ?>>
<?php

// Render list options (body, left)
$detalle_atencion_list->ListOptions->Render("body", "left", $detalle_atencion_list->RowCnt);
?>
	<?php if ($detalle_atencion->Id_Atencion->Visible) { // Id_Atencion ?>
		<td data-name="Id_Atencion">
<?php if ($detalle_atencion->Id_Atencion->getSessionValue() <> "") { ?>
<input type="hidden" id="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Atencion" name="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Atencion" value="<?php echo ew_HtmlEncode($detalle_atencion->Id_Atencion->CurrentValue) ?>">
<?php } else { ?>
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Id_Atencion" class="form-group detalle_atencion_Id_Atencion">
<input type="hidden" data-table="detalle_atencion" data-field="x_Id_Atencion" name="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Atencion" id="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Atencion" value="<?php echo ew_HtmlEncode($detalle_atencion->Id_Atencion->CurrentValue) ?>">
</span>
<?php } ?>
<input type="hidden" data-table="detalle_atencion" data-field="x_Id_Atencion" name="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Atencion" id="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Atencion" value="<?php echo ew_HtmlEncode($detalle_atencion->Id_Atencion->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($detalle_atencion->NroSerie->Visible) { // NroSerie ?>
		<td data-name="NroSerie">
<?php if ($detalle_atencion->NroSerie->getSessionValue() <> "") { ?>
<input type="hidden" id="x<?php echo $detalle_atencion_list->RowIndex ?>_NroSerie" name="x<?php echo $detalle_atencion_list->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($detalle_atencion->NroSerie->CurrentValue) ?>">
<?php } else { ?>
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_NroSerie" class="form-group detalle_atencion_NroSerie">
<input type="hidden" data-table="detalle_atencion" data-field="x_NroSerie" name="x<?php echo $detalle_atencion_list->RowIndex ?>_NroSerie" id="x<?php echo $detalle_atencion_list->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($detalle_atencion->NroSerie->CurrentValue) ?>">
</span>
<?php } ?>
<input type="hidden" data-table="detalle_atencion" data-field="x_NroSerie" name="o<?php echo $detalle_atencion_list->RowIndex ?>_NroSerie" id="o<?php echo $detalle_atencion_list->RowIndex ?>_NroSerie" value="<?php echo ew_HtmlEncode($detalle_atencion->NroSerie->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($detalle_atencion->Id_Tipo_Falla->Visible) { // Id_Tipo_Falla ?>
		<td data-name="Id_Tipo_Falla">
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Id_Tipo_Falla" class="form-group detalle_atencion_Id_Tipo_Falla">
<select data-table="detalle_atencion" data-field="x_Id_Tipo_Falla" data-value-separator="<?php echo $detalle_atencion->Id_Tipo_Falla->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Falla" name="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Falla"<?php echo $detalle_atencion->Id_Tipo_Falla->EditAttributes() ?>>
<?php echo $detalle_atencion->Id_Tipo_Falla->SelectOptionListHtml("x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Falla") ?>
</select>
<input type="hidden" name="s_x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Falla" id="s_x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Falla" value="<?php echo $detalle_atencion->Id_Tipo_Falla->LookupFilterQuery() ?>">
</span>
<input type="hidden" data-table="detalle_atencion" data-field="x_Id_Tipo_Falla" name="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Falla" id="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Falla" value="<?php echo ew_HtmlEncode($detalle_atencion->Id_Tipo_Falla->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($detalle_atencion->Id_Problema->Visible) { // Id_Problema ?>
		<td data-name="Id_Problema">
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Id_Problema" class="form-group detalle_atencion_Id_Problema">
<select data-table="detalle_atencion" data-field="x_Id_Problema" data-value-separator="<?php echo $detalle_atencion->Id_Problema->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Problema" name="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Problema"<?php echo $detalle_atencion->Id_Problema->EditAttributes() ?>>
<?php echo $detalle_atencion->Id_Problema->SelectOptionListHtml("x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Problema") ?>
</select>
<input type="hidden" name="s_x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Problema" id="s_x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Problema" value="<?php echo $detalle_atencion->Id_Problema->LookupFilterQuery() ?>">
</span>
<input type="hidden" data-table="detalle_atencion" data-field="x_Id_Problema" name="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Problema" id="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Problema" value="<?php echo ew_HtmlEncode($detalle_atencion->Id_Problema->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($detalle_atencion->Descripcion_Problema->Visible) { // Descripcion_Problema ?>
		<td data-name="Descripcion_Problema">
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Descripcion_Problema" class="form-group detalle_atencion_Descripcion_Problema">
<input type="text" data-table="detalle_atencion" data-field="x_Descripcion_Problema" name="x<?php echo $detalle_atencion_list->RowIndex ?>_Descripcion_Problema" id="x<?php echo $detalle_atencion_list->RowIndex ?>_Descripcion_Problema" maxlength="400" placeholder="<?php echo ew_HtmlEncode($detalle_atencion->Descripcion_Problema->getPlaceHolder()) ?>" value="<?php echo $detalle_atencion->Descripcion_Problema->EditValue ?>"<?php echo $detalle_atencion->Descripcion_Problema->EditAttributes() ?>>
</span>
<input type="hidden" data-table="detalle_atencion" data-field="x_Descripcion_Problema" name="o<?php echo $detalle_atencion_list->RowIndex ?>_Descripcion_Problema" id="o<?php echo $detalle_atencion_list->RowIndex ?>_Descripcion_Problema" value="<?php echo ew_HtmlEncode($detalle_atencion->Descripcion_Problema->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($detalle_atencion->Id_Tipo_Sol_Problem->Visible) { // Id_Tipo_Sol_Problem ?>
		<td data-name="Id_Tipo_Sol_Problem">
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Id_Tipo_Sol_Problem" class="form-group detalle_atencion_Id_Tipo_Sol_Problem">
<select data-table="detalle_atencion" data-field="x_Id_Tipo_Sol_Problem" data-value-separator="<?php echo $detalle_atencion->Id_Tipo_Sol_Problem->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Sol_Problem" name="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Sol_Problem"<?php echo $detalle_atencion->Id_Tipo_Sol_Problem->EditAttributes() ?>>
<?php echo $detalle_atencion->Id_Tipo_Sol_Problem->SelectOptionListHtml("x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Sol_Problem") ?>
</select>
<input type="hidden" name="s_x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Sol_Problem" id="s_x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Sol_Problem" value="<?php echo $detalle_atencion->Id_Tipo_Sol_Problem->LookupFilterQuery() ?>">
</span>
<input type="hidden" data-table="detalle_atencion" data-field="x_Id_Tipo_Sol_Problem" name="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Sol_Problem" id="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Tipo_Sol_Problem" value="<?php echo ew_HtmlEncode($detalle_atencion->Id_Tipo_Sol_Problem->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($detalle_atencion->Id_Estado_Atenc->Visible) { // Id_Estado_Atenc ?>
		<td data-name="Id_Estado_Atenc">
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Id_Estado_Atenc" class="form-group detalle_atencion_Id_Estado_Atenc">
<select data-table="detalle_atencion" data-field="x_Id_Estado_Atenc" data-value-separator="<?php echo $detalle_atencion->Id_Estado_Atenc->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Estado_Atenc" name="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Estado_Atenc"<?php echo $detalle_atencion->Id_Estado_Atenc->EditAttributes() ?>>
<?php echo $detalle_atencion->Id_Estado_Atenc->SelectOptionListHtml("x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Estado_Atenc") ?>
</select>
<input type="hidden" name="s_x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Estado_Atenc" id="s_x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Estado_Atenc" value="<?php echo $detalle_atencion->Id_Estado_Atenc->LookupFilterQuery() ?>">
</span>
<input type="hidden" data-table="detalle_atencion" data-field="x_Id_Estado_Atenc" name="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Estado_Atenc" id="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Estado_Atenc" value="<?php echo ew_HtmlEncode($detalle_atencion->Id_Estado_Atenc->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($detalle_atencion->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
		<td data-name="Fecha_Actualizacion">
<input type="hidden" data-table="detalle_atencion" data-field="x_Fecha_Actualizacion" name="o<?php echo $detalle_atencion_list->RowIndex ?>_Fecha_Actualizacion" id="o<?php echo $detalle_atencion_list->RowIndex ?>_Fecha_Actualizacion" value="<?php echo ew_HtmlEncode($detalle_atencion->Fecha_Actualizacion->OldValue) ?>">
</td>
	<?php } ?>
<?php

// Render list options (body, right)
$detalle_atencion_list->ListOptions->Render("body", "right", $detalle_atencion_list->RowCnt);
?>
<script type="text/javascript">
fdetalle_atencionlist.UpdateOpts(<?php echo $detalle_atencion_list->RowIndex ?>);
</script>
	</tr>
<?php
}
?>
<?php
if ($detalle_atencion->ExportAll && $detalle_atencion->Export <> "") {
	$detalle_atencion_list->StopRec = $detalle_atencion_list->TotalRecs;
} else {

	// Set the last record to display
	if ($detalle_atencion_list->TotalRecs > $detalle_atencion_list->StartRec + $detalle_atencion_list->DisplayRecs - 1)
		$detalle_atencion_list->StopRec = $detalle_atencion_list->StartRec + $detalle_atencion_list->DisplayRecs - 1;
	else
		$detalle_atencion_list->StopRec = $detalle_atencion_list->TotalRecs;
}
...
if ($objForm) {
	$objForm->Index = -1;
	if ($objForm->HasValue($detalle_atencion_list->FormKeyCountName) && ($detalle_atencion->CurrentAction == "gridadd" || $detalle_atencion->CurrentAction == "gridedit" || $detalle_atencion->CurrentAction == "F")) {
		$detalle_atencion_list->KeyCount = $objForm->GetValue($detalle_atencion_list->FormKeyCountName);
		$detalle_atencion_list->StopRec = $detalle_atencion_list->StartRec + $detalle_atencion_list->KeyCount - 1;
	}
}
$detalle_atencion_list->RecCnt = $detalle_atencion_list->StartRec - 1;
if ($detalle_atencion_list->Recordset && !$detalle_atencion_list->Recordset->EOF) {
	$detalle_atencion_list->Recordset->MoveFirst();
	$bSelectLimit = $detalle_atencion_list->UseSelectLimit;
	if (!$bSelectLimit && $detalle_atencion_list->StartRec > 1)
		$detalle_atencion_list->Recordset->Move($detalle_atencion_list->StartRec - 1);
} elseif (!$detalle_atencion->AllowAddDeleteRow && $detalle_atencion_list->StopRec == 0) {
	$detalle_atencion_list->StopRec = $detalle_atencion->GridAddRowCount;
}
...
$detalle_atencion->ResetAttrs();
$detalle_atencion_list->RenderRow();
$detalle_atencion_list->EditRowCnt = 0;
if ($detalle_atencion->CurrentAction == "edit")
	$detalle_atencion_list->RowIndex = 1;
if ($detalle_atencion->CurrentAction == "gridadd")
	$detalle_atencion_list->RowIndex = 0;
if ($detalle_atencion->CurrentAction == "gridedit")
	$detalle_atencion_list->RowIndex = 0;
while ($detalle_atencion_list->RecCnt < $detalle_atencion_list->StopRec) {
	$detalle_atencion_list->RecCnt++;
	if (intval($detalle_atencion_list->RecCnt) >= intval($detalle_atencion_list->StartRec)) {
		$detalle_atencion_list->RowCnt++;
		if ($detalle_atencion->CurrentAction == "gridadd" || $detalle_atencion->CurrentAction == "gridedit" || $detalle_atencion->CurrentAction == "F") {
			$detalle_atencion_list->RowIndex++;
			$objForm->Index = $detalle_atencion_list->RowIndex;
			if ($objForm->HasValue($detalle_atencion_list->FormActionName))
				$detalle_atencion_list->RowAction = strval($objForm->GetValue($detalle_atencion_list->FormActionName));
			elseif ($detalle_atencion->CurrentAction == "gridadd")
				$detalle_atencion_list->RowAction = "insert";
			else
				$detalle_atencion_list->RowAction = "";
		}
		...
		if ($detalle_atencion->CurrentAction == "gridadd") {
			$detalle_atencion_list->LoadDefaultValues(); // Load default values
		} else {
			$detalle_atencion_list->LoadRowValues($detalle_atencion_list->Recordset); // Load row values
		}
		...
		if ($detalle_atencion->CurrentAction == "gridadd" && $detalle_atencion->EventCancelled && !$objForm->HasValue("k_blankrow")) // Insert failed
			$detalle_atencion_list->RestoreCurrentRowFormValues($detalle_atencion_list->RowIndex); // Restore form values
		if ($detalle_atencion->CurrentAction == "edit") {
			if ($detalle_atencion_list->CheckInlineEditKey() && $detalle_atencion_list->EditRowCnt == 0) { // Inline edit
		...
		if ($detalle_atencion->CurrentAction == "gridedit") { // Grid edit
			...
			if ($detalle_atencion_list->RowAction == "insert")
				$detalle_atencion->RowType = EW_ROWTYPE_ADD; // Render add
			else
				$detalle_atencion->RowType = EW_ROWTYPE_EDIT; // Render edit
		}
		if ($detalle_atencion->CurrentAction == "edit" && $detalle_atencion->RowType == EW_ROWTYPE_EDIT && $detalle_atencion->EventCancelled) { // Update failed
			$objForm->Index = 1;
			$detalle_atencion_list->RestoreFormValues(); // Restore form values
		}
		...
		if ($detalle_atencion->RowType == EW_ROWTYPE_EDIT) // Edit row
			$detalle_atencion_list->EditRowCnt++;

		// Set up row id / data-rowindex
		$detalle_atencion->RowAttrs = array_merge($detalle_atencion->RowAttrs, array('data-rowindex'=>$detalle_atencion_list->RowCnt, 'id'=>'r' . $detalle_atencion_list->RowCnt . '_detalle_atencion', 'data-rowtype'=>$detalle_atencion->RowType));
		...
		if ($detalle_atencion_list->RowAction <> "delete" && $detalle_atencion_list->RowAction <> "insertdelete" && !($detalle_atencion_list->RowAction == "insert" && $detalle_atencion->CurrentAction == "F" && $detalle_atencion_list->EmptyRow())) {
?>
	<tr<?php echo $detalle_atencion->RowAttributes() ?>>
<?php
...
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Id_Atencion" class="detalle_atencion_Id_Atencion">
<span<?php echo $detalle_atencion->Id_Atencion->ViewAttributes() ?>>
<?php echo $detalle_atencion->Id_Atencion->ListViewValue() ?></span>
</span>
<?php } ?>
<a id="<?php echo $detalle_atencion_list->PageObjName . "_row_" . $detalle_atencion_list->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($detalle_atencion->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="detalle_atencion" data-field="x_Id_Detalle_Atencion" name="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Detalle_Atencion" id="x<?php echo $detalle_atencion_list->RowIndex ?>_Id_Detalle_Atencion" value="<?php echo ew_HtmlEncode($detalle_atencion->Id_Detalle_Atencion->CurrentValue) ?>">
<input type="hidden" data-table="detalle_atencion" data-field="x_Id_Detalle_Atencion" name="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Detalle_Atencion" id="o<?php echo $detalle_atencion_list->RowIndex ?>_Id_Detalle_Atencion" value="<?php echo ew_HtmlEncode($detalle_atencion->Id_Detalle_Atencion->OldValue) ?>">
<?php } ?>
...
<?php } ?>
<?php if ($detalle_atencion->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_NroSerie" class="detalle_atencion_NroSerie">
...
<?php } ?>
<?php if ($detalle_atencion->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Id_Tipo_Falla" class="detalle_atencion_Id_Tipo_Falla">
...
<?php } ?>
<?php if ($detalle_atencion->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Id_Problema" class="detalle_atencion_Id_Problema">
...
<?php } ?>
<?php if ($detalle_atencion->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Descripcion_Problema" class="detalle_atencion_Descripcion_Problema">
...
<?php } ?>
<?php if ($detalle_atencion->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Id_Tipo_Sol_Problem" class="detalle_atencion_Id_Tipo_Sol_Problem">
...
<?php } ?>
<?php if ($detalle_atencion->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Id_Estado_Atenc" class="detalle_atencion_Id_Estado_Atenc">
...
<?php } ?>
<?php if ($detalle_atencion->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $detalle_atencion_list->RowCnt ?>_detalle_atencion_Fecha_Actualizacion" class="detalle_atencion_Fecha_Actualizacion">
...
<?php
	...
	if ($detalle_atencion->CurrentAction <> "gridadd")
		if (!$detalle_atencion_list->Recordset->EOF) $detalle_atencion_list->Recordset->MoveNext();
}
?>
<?php
	if ($detalle_atencion->CurrentAction == "gridadd" || $detalle_atencion->CurrentAction == "gridedit") {
		$detalle_atencion_list->RowIndex = '$rowindex$';
		$detalle_atencion_list->LoadDefaultValues();

		// Set row properties
		$detalle_atencion->ResetAttrs();
		$detalle_atencion->RowAttrs = array_merge($detalle_atencion->RowAttrs, array('data-rowindex'=>$detalle_atencion_list->RowIndex, 'id'=>'r0_detalle_atencion', 'data-rowtype'=>EW_ROWTYPE_ADD));
...
// Render list options (body, left)
$detalle_atencion_list->ListOptions->Render("body", "left", $detalle_atencion_list->RowIndex);
?>
	<?php if ($detalle_atencion->Id_Atencion->Visible) { // Id_Atencion ?>
		<td data-name="Id_Atencion">
<?php if ($detalle_atencion->Id_Atencion->getSessionValue() <> "") { ?>
...
<?php } ?>
<?php if ($detalle_atencion->CurrentAction == "add" || $detalle_atencion->CurrentAction == "copy") { ?>
<input type="hidden" name="<?php echo $detalle_atencion_list->FormKeyCountName ?>" id="<?php echo $detalle_atencion_list->FormKeyCountName ?>" value="<?php echo $detalle_atencion_list->KeyCount ?>">
<?php } ?>
<?php if ($detalle_atencion->CurrentAction == "gridadd") { ?>
<input type="hidden" name="a_list" id="a_list" value="gridinsert">
<input type="hidden" name="<?php echo $detalle_atencion_list->FormKeyCountName ?>" id="<?php echo $detalle_atencion_list->FormKeyCountName ?>" value="<?php echo $detalle_atencion_list->KeyCount ?>">
<?php echo $detalle_atencion_list->MultiSelectKey ?>
<?php } ?>
<?php if ($detalle_atencion->CurrentAction == "edit") { ?>
<input type="hidden" name="<?php echo $detalle_atencion_list->FormKeyCountName ?>" id="<?php echo $detalle_atencion_list->FormKeyCountName ?>" value="<?php echo $detalle_atencion_list->KeyCount ?>">
<?php } ?>
<?php if ($detalle_atencion->CurrentAction == "gridedit") { ?>
<input type="hidden" name="a_list" id="a_list" value="gridupdate">
<input type="hidden" name="<?php echo $detalle_atencion_list->FormKeyCountName ?>" id="<?php echo $detalle_atencion_list->FormKeyCountName ?>" value="<?php echo $detalle_atencion_list->KeyCount ?>">
<?php echo $detalle_atencion_list->MultiSelectKey ?>
<?php } ?>
<?php if ($detalle_atencion->CurrentAction == "") { ?>
...
// Close recordset
if ($detalle_atencion_list->Recordset)
	$detalle_atencion_list->Recordset->Close();
?>
<?php if ($detalle_atencion->Export == "") { ?>
...
<?php } ?>
<?php if ($detalle_atencion_list->TotalRecs == 0 && $detalle_atencion->CurrentAction == "") { // Show other options ?>
<div class="ewListOtherOptions">
<?php
	foreach ($detalle_atencion_list->OtherOptions as &$option) {
		$option->ButtonClass = "";
...
<?php if ($detalle_atencion->Export == "") { ?>
<script type="text/javascript">
fdetalle_atencionlistsrch.FilterList = <?php echo $detalle_atencion_list->GetFilterList() ?>;
fdetalle_atencionlistsrch.Init();
fdetalle_atencionlist.Init();
</script>
<?php } ?>
<?php
$detalle_atencion_list->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($detalle_atencion->Export == "") { ?>
...
<?php
$detalle_atencion_list->Page_Terminate();
?>
