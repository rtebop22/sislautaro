...
$equipos_edit = NULL; // Initialize page object first

class cequipos_edit extends cequipos {
	...
	function Page_Main() {
		...
		if ($this->NroSerie->CurrentValue == "") {
			$this->Page_Terminate("equiposlist.php"); // Invalid key, return to list
		}
	...
	function ValidateForm() {
		...
		if (in_array("observacion_equipo", $DetailTblVar) && $GLOBALS["observacion_equipo"]->DetailEdit) {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// SpecialNumber
			$this->SpecialNumber->SetDbValueDef($rsnew, $this->SpecialNumber->CurrentValue, NULL, $this->SpecialNumber->ReadOnly);
			...
			// Tiene_Cargador
			$this->Tiene_Cargador->SetDbValueDef($rsnew, $this->Tiene_Cargador->CurrentValue, NULL, $this->Tiene_Cargador->ReadOnly);
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("observacion_equipo", $DetailTblVar) && $GLOBALS["observacion_equipo"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["observacion_equipo_grid"]->GridUpdate();
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("observacion_equipo", $DetailTblVar)) {
				...
				if ($GLOBALS["observacion_equipo_grid"]->DetailEdit) {
					$GLOBALS["observacion_equipo_grid"]->CurrentMode = "edit";
					$GLOBALS["observacion_equipo_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($equipos_edit)) $equipos_edit = new cequipos_edit();

// Page init
$equipos_edit->Page_Init();

// Page main
$equipos_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$equipos_edit->Page_Render();
?>
...
var CurrentForm = fequiposedit = new ew_Form("fequiposedit", "edit");

// Validate form
fequiposedit.Validate = function() {
...
fequiposedit.Form_CustomValidate = 
...
fequiposedit.ValidateRequired = true;
<?php } else { ?>
fequiposedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fequiposedit.Lists["x_Id_Ubicacion"] = {"LinkField":"x_Id_Ubicacion","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"ubicacion_equipo"};
fequiposedit.Lists["x_Id_Estado"] = {"LinkField":"x_Id_Estado","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_equipo"};
fequiposedit.Lists["x_Id_Sit_Estado"] = {"LinkField":"x_Id_Sit_Estado","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"situacion_estado"};
fequiposedit.Lists["x_Id_Marca"] = {"LinkField":"x_Id_Marca","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":["x_Id_Modelo"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"marca"};
fequiposedit.Lists["x_Id_Modelo"] = {"LinkField":"x_Id_Modelo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":["x_Id_Marca"],"ChildFields":[],"FilterFields":["x_Id_Marca"],"Options":[],"Template":"","LinkTable":"modelo"};
fequiposedit.Lists["x_Id_Ano"] = {"LinkField":"x_Id_Ano","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"ano_entrega"};
fequiposedit.Lists["x_Tiene_Cargador"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fequiposedit.Lists["x_Tiene_Cargador"].Options = <?php echo json_encode($equipos->Tiene_Cargador->Options()) ?>;
fequiposedit.Lists["x_Id_Tipo_Equipo"] = {"LinkField":"x_Id_Tipo_Equipo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Detalle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_equipo"};
...
<?php } ?>
<?php $equipos_edit->ShowPageHeader(); ?>
<?php
$equipos_edit->ShowMessage();
?>
<form name="fequiposedit" id="fequiposedit" class="<?php echo $equipos_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($equipos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $equipos_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="equipos" data-field="x_NroSerie" name="x_NroSerie" id="x_NroSerie" value="<?php echo ew_HtmlEncode($equipos->NroSerie->CurrentValue) ?>">
...
<?php
	if (in_array("observacion_equipo", explode(",", $equipos->getCurrentDetailTable())) && $observacion_equipo->DetailEdit) {
?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $equipos_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
