...
class cestablecimientos_educativos_pase_list extends cestablecimientos_educativos_pase {
	...
	function ClearInlineMode() {
		$this->setKey("Cue_Establecimiento", ""); // Clear inline edit key
	...
	function InlineEditMode() {
		...
		if ($bInlineEdit) {
			if ($this->LoadRow()) {
				$this->setKey("Cue_Establecimiento", $this->Cue_Establecimiento->CurrentValue); // Set up inline edit key
	...
	function CheckInlineEditKey() {
		...
		if (strval($this->getKey("Cue_Establecimiento")) <> strval($this->Cue_Establecimiento->CurrentValue))
			return FALSE;
		return TRUE;
	}
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			...
			if (!is_numeric($this->Cue_Establecimiento->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_Nombre_Establecimiento") && $objForm->HasValue("o_Nombre_Establecimiento") && $this->Nombre_Establecimiento->CurrentValue <> $this->Nombre_Establecimiento->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Nombre_Directivo") && $objForm->HasValue("o_Nombre_Directivo") && $this->Nombre_Directivo->CurrentValue <> $this->Nombre_Directivo->OldValue)
			return FALSE;
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->Nombre_Directivo->AdvancedSearch->ToJSON(), ","); // Field Nombre_Directivo
		$sFilterList = ew_Concat($sFilterList, $this->Cuil_Directivo->AdvancedSearch->ToJSON(), ","); // Field Cuil_Directivo
		$sFilterList = ew_Concat($sFilterList, $this->Nombre_Rte->AdvancedSearch->ToJSON(), ","); // Field Nombre_Rte
		$sFilterList = ew_Concat($sFilterList, $this->Tel_Rte->AdvancedSearch->ToJSON(), ","); // Field Tel_Rte
		$sFilterList = ew_Concat($sFilterList, $this->Email_Rte->AdvancedSearch->ToJSON(), ","); // Field Email_Rte
		...
		$sFilterList = ew_Concat($sFilterList, $this->Domicilio_Escuela->AdvancedSearch->ToJSON(), ","); // Field Domicilio_Escuela
	...
	function RestoreFilterList() {
		...
		// Field Nombre_Directivo
		$this->Nombre_Directivo->AdvancedSearch->SearchValue = @$filter["x_Nombre_Directivo"];
		$this->Nombre_Directivo->AdvancedSearch->SearchOperator = @$filter["z_Nombre_Directivo"];
		$this->Nombre_Directivo->AdvancedSearch->SearchCondition = @$filter["v_Nombre_Directivo"];
		$this->Nombre_Directivo->AdvancedSearch->SearchValue2 = @$filter["y_Nombre_Directivo"];
		$this->Nombre_Directivo->AdvancedSearch->SearchOperator2 = @$filter["w_Nombre_Directivo"];
		$this->Nombre_Directivo->AdvancedSearch->Save();

		// Field Cuil_Directivo
		$this->Cuil_Directivo->AdvancedSearch->SearchValue = @$filter["x_Cuil_Directivo"];
		$this->Cuil_Directivo->AdvancedSearch->SearchOperator = @$filter["z_Cuil_Directivo"];
		$this->Cuil_Directivo->AdvancedSearch->SearchCondition = @$filter["v_Cuil_Directivo"];
		$this->Cuil_Directivo->AdvancedSearch->SearchValue2 = @$filter["y_Cuil_Directivo"];
		$this->Cuil_Directivo->AdvancedSearch->SearchOperator2 = @$filter["w_Cuil_Directivo"];
		$this->Cuil_Directivo->AdvancedSearch->Save();
		...
		// Field Tel_Rte
		$this->Tel_Rte->AdvancedSearch->SearchValue = @$filter["x_Tel_Rte"];
		$this->Tel_Rte->AdvancedSearch->SearchOperator = @$filter["z_Tel_Rte"];
		$this->Tel_Rte->AdvancedSearch->SearchCondition = @$filter["v_Tel_Rte"];
		$this->Tel_Rte->AdvancedSearch->SearchValue2 = @$filter["y_Tel_Rte"];
		$this->Tel_Rte->AdvancedSearch->SearchOperator2 = @$filter["w_Tel_Rte"];
		$this->Tel_Rte->AdvancedSearch->Save();

		// Field Email_Rte
		$this->Email_Rte->AdvancedSearch->SearchValue = @$filter["x_Email_Rte"];
		$this->Email_Rte->AdvancedSearch->SearchOperator = @$filter["z_Email_Rte"];
		$this->Email_Rte->AdvancedSearch->SearchCondition = @$filter["v_Email_Rte"];
		$this->Email_Rte->AdvancedSearch->SearchValue2 = @$filter["y_Email_Rte"];
		$this->Email_Rte->AdvancedSearch->SearchOperator2 = @$filter["w_Email_Rte"];
		$this->Email_Rte->AdvancedSearch->Save();
		...
		// Field Domicilio_Escuela
		$this->Domicilio_Escuela->AdvancedSearch->SearchValue = @$filter["x_Domicilio_Escuela"];
		$this->Domicilio_Escuela->AdvancedSearch->SearchOperator = @$filter["z_Domicilio_Escuela"];
		$this->Domicilio_Escuela->AdvancedSearch->SearchCondition = @$filter["v_Domicilio_Escuela"];
		$this->Domicilio_Escuela->AdvancedSearch->SearchValue2 = @$filter["y_Domicilio_Escuela"];
		$this->Domicilio_Escuela->AdvancedSearch->SearchOperator2 = @$filter["w_Domicilio_Escuela"];
		$this->Domicilio_Escuela->AdvancedSearch->Save();
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->Nombre_Directivo, $Default, FALSE); // Nombre_Directivo
		$this->BuildSearchSql($sWhere, $this->Cuil_Directivo, $Default, FALSE); // Cuil_Directivo
		$this->BuildSearchSql($sWhere, $this->Nombre_Rte, $Default, FALSE); // Nombre_Rte
		$this->BuildSearchSql($sWhere, $this->Tel_Rte, $Default, FALSE); // Tel_Rte
		$this->BuildSearchSql($sWhere, $this->Email_Rte, $Default, FALSE); // Email_Rte
		...
		$this->BuildSearchSql($sWhere, $this->Domicilio_Escuela, $Default, FALSE); // Domicilio_Escuela
		...
		if (!$Default && $this->Command == "search") {
			...
			$this->Nombre_Directivo->AdvancedSearch->Save(); // Nombre_Directivo
			$this->Cuil_Directivo->AdvancedSearch->Save(); // Cuil_Directivo
			$this->Nombre_Rte->AdvancedSearch->Save(); // Nombre_Rte
			$this->Tel_Rte->AdvancedSearch->Save(); // Tel_Rte
			$this->Email_Rte->AdvancedSearch->Save(); // Email_Rte
			...
			$this->Domicilio_Escuela->AdvancedSearch->Save(); // Domicilio_Escuela
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->Cuil_Directivo, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->Nombre_Rte, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->Email_Rte, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->Domicilio_Escuela, $arKeywords, $type);
	...
	function CheckSearchParms() {
		...
		if ($this->Nombre_Establecimiento->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Nombre_Directivo->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Cuil_Directivo->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Nombre_Rte->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Tel_Rte->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Email_Rte->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Nro_Serie_Server_Escolar->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Contacto_Establecimiento->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->Domicilio_Escuela->AdvancedSearch->IssetSession())
			return TRUE;
	...
	function ResetAdvancedSearchParms() {
		...
		$this->Nombre_Directivo->AdvancedSearch->UnsetSession();
		$this->Cuil_Directivo->AdvancedSearch->UnsetSession();
		$this->Nombre_Rte->AdvancedSearch->UnsetSession();
		$this->Tel_Rte->AdvancedSearch->UnsetSession();
		$this->Email_Rte->AdvancedSearch->UnsetSession();
		$this->Nro_Serie_Server_Escolar->AdvancedSearch->UnsetSession();
		$this->Contacto_Establecimiento->AdvancedSearch->UnsetSession();
		$this->Domicilio_Escuela->AdvancedSearch->UnsetSession();
	...
	function RestoreSearchParms() {
		...
		$this->Nombre_Directivo->AdvancedSearch->Load();
		$this->Cuil_Directivo->AdvancedSearch->Load();
		$this->Nombre_Rte->AdvancedSearch->Load();
		$this->Tel_Rte->AdvancedSearch->Load();
		$this->Email_Rte->AdvancedSearch->Load();
		$this->Nro_Serie_Server_Escolar->AdvancedSearch->Load();
		$this->Contacto_Establecimiento->AdvancedSearch->Load();
		$this->Domicilio_Escuela->AdvancedSearch->Load();
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->Nombre_Directivo); // Nombre_Directivo
	...
	function RenderListOptions() {
		...
		if ($this->CurrentAction == "edit" && $this->RowType == EW_ROWTYPE_EDIT) { // Inline-Edit
			...
			$oListOpt->Body .= "<input type=\"hidden\" name=\"k" . $this->RowIndex . "_key\" id=\"k" . $this->RowIndex . "_key\" value=\"" . ew_HtmlEncode($this->Cue_Establecimiento->CurrentValue) . "\">";
			return;
		}
		...
		if ($Security->CanView()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewView\" title=\"" . $viewcaption . "\" data-table=\"establecimientos_educativos_pase\" data-caption=\"" . $viewcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->ViewUrl) . "'});\">" . $Language->Phrase("ViewLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
		...
		if ($Security->CanEdit()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewEdit\" title=\"" . $editcaption . "\" data-table=\"establecimientos_educativos_pase\" data-caption=\"" . $editcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->EditUrl) . "',caption:'" . $editcaption . "'});\">" . $Language->Phrase("EditLink") . "</a>";
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.festablecimientos_educativos_paselist,url:'" . $this->MultiDeleteUrl . "',msg:ewLanguage.Phrase('DeleteConfirmMsg')});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->CanDelete());

		// Add multi update
		$item = &$option->Add("multiupdate");
		$item->Body = "<a class=\"ewAction ewMultiUpdate\" title=\"" . ew_HtmlTitle($Language->Phrase("UpdateSelectedLink")) . "\" data-table=\"establecimientos_educativos_pase\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("UpdateSelectedLink")) . "\" href=\"\" onclick=\"ew_ModalDialogShow({lnk:this,f:document.festablecimientos_educativos_paselist,url:'" . $this->MultiUpdateUrl . "',caption:'" . $Language->Phrase("UpdateBtn") . "'});return false;\">" . $Language->Phrase("UpdateSelectedLink") . "</a>";
		$item->Visible = ($Security->CanEdit());
	...
	function LoadSearchValues() {
		...
		// Nombre_Directivo
		$this->Nombre_Directivo->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_Nombre_Directivo"]);
		if ($this->Nombre_Directivo->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->Nombre_Directivo->AdvancedSearch->SearchOperator = @$_GET["z_Nombre_Directivo"];

		// Cuil_Directivo
		$this->Cuil_Directivo->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_Cuil_Directivo"]);
		if ($this->Cuil_Directivo->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->Cuil_Directivo->AdvancedSearch->SearchOperator = @$_GET["z_Cuil_Directivo"];
		...
		// Tel_Rte
		$this->Tel_Rte->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_Tel_Rte"]);
		if ($this->Tel_Rte->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->Tel_Rte->AdvancedSearch->SearchOperator = @$_GET["z_Tel_Rte"];

		// Email_Rte
		$this->Email_Rte->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_Email_Rte"]);
		if ($this->Email_Rte->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->Email_Rte->AdvancedSearch->SearchOperator = @$_GET["z_Email_Rte"];
		...
		// Domicilio_Escuela
		$this->Domicilio_Escuela->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_Domicilio_Escuela"]);
		if ($this->Domicilio_Escuela->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->Domicilio_Escuela->AdvancedSearch->SearchOperator = @$_GET["z_Domicilio_Escuela"];
	...
	function LoadFormValues() {
		...
		$this->Nombre_Directivo->setOldValue($objForm->GetValue("o_Nombre_Directivo"));
...
festablecimientos_educativos_paselist.EmptyRow = function(infix) {
	...
	if (ew_ValueChanged(fobj, infix, "Nombre_Directivo", false)) return false;
...
festablecimientos_educativos_paselist.Lists["x_Id_Departamento"] = {"LinkField":"x_Id_Departamento","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":["x_Id_Localidad"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
...
if ($establecimientos_educativos_pase->CurrentAction == "gridadd") {
	...
	if ($establecimientos_educativos_pase->CurrentAction == "" && $establecimientos_educativos_pase_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$establecimientos_educativos_pase_list->setWarningMessage(ew_DeniedMsg());
	...
	if ($establecimientos_educativos_pase_list->AuditTrailOnSearch && $establecimientos_educativos_pase_list->Command == "search" && !$establecimientos_educativos_pase_list->RestoreSearch) {
		$searchparm = ew_ServerVar("QUERY_STRING");
		$searchsql = $establecimientos_educativos_pase_list->getSessionWhere();
		$establecimientos_educativos_pase_list->WriteAuditTrailOnSearch($searchparm, $searchsql);
	}
}
...
<?php if ($establecimientos_educativos_pase_list->TotalRecs > 0 || $establecimientos_educativos_pase->CurrentAction == "add" || $establecimientos_educativos_pase->CurrentAction == "copy") { ?>
...
<?php if ($establecimientos_educativos_pase->Nombre_Directivo->Visible) { // Nombre_Directivo ?>
	<?php if ($establecimientos_educativos_pase->SortUrl($establecimientos_educativos_pase->Nombre_Directivo) == "") { ?>
		<th data-name="Nombre_Directivo"><div id="elh_establecimientos_educativos_pase_Nombre_Directivo" class="establecimientos_educativos_pase_Nombre_Directivo"><div class="ewTableHeaderCaption" style="white-space: nowrap;"><?php echo $establecimientos_educativos_pase->Nombre_Directivo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Nombre_Directivo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $establecimientos_educativos_pase->SortUrl($establecimientos_educativos_pase->Nombre_Directivo) ?>',1);"><div id="elh_establecimientos_educativos_pase_Nombre_Directivo" class="establecimientos_educativos_pase_Nombre_Directivo">
			<div class="ewTableHeaderBtn" style="white-space: nowrap;"><span class="ewTableHeaderCaption"><?php echo $establecimientos_educativos_pase->Nombre_Directivo->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($establecimientos_educativos_pase->Nombre_Directivo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($establecimientos_educativos_pase->Nombre_Directivo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<tbody>
<?php
	if ($establecimientos_educativos_pase->CurrentAction == "add" || $establecimientos_educativos_pase->CurrentAction == "copy") {
		...
		if ($establecimientos_educativos_pase->CurrentAction == "add")
			$establecimientos_educativos_pase_list->LoadDefaultValues();
		if ($establecimientos_educativos_pase->EventCancelled) // Insert failed
			$establecimientos_educativos_pase_list->RestoreFormValues(); // Restore form values

		// Set row properties
		$establecimientos_educativos_pase->ResetAttrs();
		$establecimientos_educativos_pase->RowAttrs = array_merge($establecimientos_educativos_pase->RowAttrs, array('data-rowindex'=>0, 'id'=>'r0_establecimientos_educativos_pase', 'data-rowtype'=>EW_ROWTYPE_ADD));
...
<input type="text" data-table="establecimientos_educativos_pase" data-field="x_Cue_Establecimiento" name="x<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Cue_Establecimiento" id="x<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Cue_Establecimiento" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($establecimientos_educativos_pase->Cue_Establecimiento->getPlaceHolder()) ?>" value="<?php echo $establecimientos_educativos_pase->Cue_Establecimiento->EditValue ?>"<?php echo $establecimientos_educativos_pase->Cue_Establecimiento->EditAttributes() ?>>
</span>
...
<input type="hidden" data-table="establecimientos_educativos_pase" data-field="x_Nombre_Establecimiento" name="o<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Establecimiento" id="o<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Establecimiento" value="<?php echo ew_HtmlEncode($establecimientos_educativos_pase->Nombre_Establecimiento->OldValue) ?>">
	...
	<?php } ?>
	<?php if ($establecimientos_educativos_pase->Nombre_Directivo->Visible) { // Nombre_Directivo ?>
		<td data-name="Nombre_Directivo">
<span id="el<?php echo $establecimientos_educativos_pase_list->RowCnt ?>_establecimientos_educativos_pase_Nombre_Directivo" class="form-group establecimientos_educativos_pase_Nombre_Directivo">
<input type="text" data-table="establecimientos_educativos_pase" data-field="x_Nombre_Directivo" name="x<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Directivo" id="x<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Directivo" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($establecimientos_educativos_pase->Nombre_Directivo->getPlaceHolder()) ?>" value="<?php echo $establecimientos_educativos_pase->Nombre_Directivo->EditValue ?>"<?php echo $establecimientos_educativos_pase->Nombre_Directivo->EditAttributes() ?>>
</span>
<input type="hidden" data-table="establecimientos_educativos_pase" data-field="x_Nombre_Directivo" name="o<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Directivo" id="o<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Directivo" value="<?php echo ew_HtmlEncode($establecimientos_educativos_pase->Nombre_Directivo->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($establecimientos_educativos_pase->Nombre_Rte->Visible) { // Nombre_Rte ?>
...
$establecimientos_educativos_pase->ResetAttrs();
$establecimientos_educativos_pase_list->RenderRow();
$establecimientos_educativos_pase_list->EditRowCnt = 0;
if ($establecimientos_educativos_pase->CurrentAction == "edit")
	$establecimientos_educativos_pase_list->RowIndex = 1;
if ($establecimientos_educativos_pase->CurrentAction == "gridadd")
	$establecimientos_educativos_pase_list->RowIndex = 0;
...
while ($establecimientos_educativos_pase_list->RecCnt < $establecimientos_educativos_pase_list->StopRec) {
	...
	if (intval($establecimientos_educativos_pase_list->RecCnt) >= intval($establecimientos_educativos_pase_list->StartRec)) {
		...
		if ($establecimientos_educativos_pase->CurrentAction == "edit") {
			if ($establecimientos_educativos_pase_list->CheckInlineEditKey() && $establecimientos_educativos_pase_list->EditRowCnt == 0) { // Inline edit
		...
		if ($establecimientos_educativos_pase->CurrentAction == "edit" && $establecimientos_educativos_pase->RowType == EW_ROWTYPE_EDIT && $establecimientos_educativos_pase->EventCancelled) { // Update failed
			$objForm->Index = 1;
			$establecimientos_educativos_pase_list->RestoreFormValues(); // Restore form values
		}
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($establecimientos_educativos_pase->Nombre_Directivo->Visible) { // Nombre_Directivo ?>
		<td data-name="Nombre_Directivo"<?php echo $establecimientos_educativos_pase->Nombre_Directivo->CellAttributes() ?>>
<?php if ($establecimientos_educativos_pase->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $establecimientos_educativos_pase_list->RowCnt ?>_establecimientos_educativos_pase_Nombre_Directivo" class="form-group establecimientos_educativos_pase_Nombre_Directivo">
<input type="text" data-table="establecimientos_educativos_pase" data-field="x_Nombre_Directivo" name="x<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Directivo" id="x<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Directivo" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($establecimientos_educativos_pase->Nombre_Directivo->getPlaceHolder()) ?>" value="<?php echo $establecimientos_educativos_pase->Nombre_Directivo->EditValue ?>"<?php echo $establecimientos_educativos_pase->Nombre_Directivo->EditAttributes() ?>>
</span>
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $establecimientos_educativos_pase_list->RowCnt ?>_establecimientos_educativos_pase_Nombre_Directivo" class="establecimientos_educativos_pase_Nombre_Directivo">
<span<?php echo $establecimientos_educativos_pase->Nombre_Directivo->ViewAttributes() ?>>
<?php echo $establecimientos_educativos_pase->Nombre_Directivo->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
...
<input type="hidden" data-table="establecimientos_educativos_pase" data-field="x_Nombre_Establecimiento" name="o<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Establecimiento" id="o<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Establecimiento" value="<?php echo ew_HtmlEncode($establecimientos_educativos_pase->Nombre_Establecimiento->OldValue) ?>">
	...
	<?php if ($establecimientos_educativos_pase->Nombre_Directivo->Visible) { // Nombre_Directivo ?>
		<td data-name="Nombre_Directivo">
<span id="el$rowindex$_establecimientos_educativos_pase_Nombre_Directivo" class="form-group establecimientos_educativos_pase_Nombre_Directivo">
<input type="text" data-table="establecimientos_educativos_pase" data-field="x_Nombre_Directivo" name="x<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Directivo" id="x<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Directivo" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($establecimientos_educativos_pase->Nombre_Directivo->getPlaceHolder()) ?>" value="<?php echo $establecimientos_educativos_pase->Nombre_Directivo->EditValue ?>"<?php echo $establecimientos_educativos_pase->Nombre_Directivo->EditAttributes() ?>>
</span>
<input type="hidden" data-table="establecimientos_educativos_pase" data-field="x_Nombre_Directivo" name="o<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Directivo" id="o<?php echo $establecimientos_educativos_pase_list->RowIndex ?>_Nombre_Directivo" value="<?php echo ew_HtmlEncode($establecimientos_educativos_pase->Nombre_Directivo->OldValue) ?>">
</td>
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->CurrentAction == "add" || $establecimientos_educativos_pase->CurrentAction == "copy") { ?>
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->CurrentAction == "edit") { ?>
<input type="hidden" name="<?php echo $establecimientos_educativos_pase_list->FormKeyCountName ?>" id="<?php echo $establecimientos_educativos_pase_list->FormKeyCountName ?>" value="<?php echo $establecimientos_educativos_pase_list->KeyCount ?>">
<?php } ?>
