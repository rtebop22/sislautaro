...
<?php if ($detalle_atencion->NroSerie->Visible) { // NroSerie ?>
	<div id="r_NroSerie" class="form-group">
		<label class="<?php echo $detalle_atencion_search->SearchLabelClass ?>"><span id="elh_detalle_atencion_NroSerie"><?php echo $detalle_atencion->NroSerie->FldCaption() ?></span>	
		...
		<div class="<?php echo $detalle_atencion_search->SearchRightColumnClass ?>"><div<?php echo $detalle_atencion->NroSerie->CellAttributes() ?>>
			<span id="el_detalle_atencion_NroSerie">
<input type="text" data-table="detalle_atencion" data-field="x_NroSerie" name="x_NroSerie" id="x_NroSerie" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($detalle_atencion->NroSerie->getPlaceHolder()) ?>" value="<?php echo $detalle_atencion->NroSerie->EditValue ?>"<?php echo $detalle_atencion->NroSerie->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
...
<input type="text" data-table="detalle_atencion" data-field="x_Fecha_Actualizacion" data-format="7" name="x_Fecha_Actualizacion" id="x_Fecha_Actualizacion" size="30" maxlength="60" placeholder="<?php echo ew_HtmlEncode($detalle_atencion->Fecha_Actualizacion->getPlaceHolder()) ?>" value="<?php echo $detalle_atencion->Fecha_Actualizacion->EditValue ?>"<?php echo $detalle_atencion->Fecha_Actualizacion->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
