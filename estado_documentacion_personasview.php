...
$estado_documentacion_personas_view = NULL; // Initialize page object first

class cestado_documentacion_personas_view extends cestado_documentacion_personas {
	...
	// Page object name
	var $PageObjName = 'estado_documentacion_personas_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Dni"] <> "") {
				...
				$sReturnUrl = "estado_documentacion_personaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "estado_documentacion_personaslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "estado_documentacion_personaslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($estado_documentacion_personas_view)) $estado_documentacion_personas_view = new cestado_documentacion_personas_view();

// Page init
$estado_documentacion_personas_view->Page_Init();

// Page main
$estado_documentacion_personas_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$estado_documentacion_personas_view->Page_Render();
?>
...
var CurrentForm = festado_documentacion_personasview = new ew_Form("festado_documentacion_personasview", "view");

// Form_CustomValidate event
festado_documentacion_personasview.Form_CustomValidate = 
...
festado_documentacion_personasview.ValidateRequired = true;
<?php } else { ?>
festado_documentacion_personasview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
festado_documentacion_personasview.Lists["x_Id_Curso"] = {"LinkField":"x_Id_Curso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cursos"};
...
festado_documentacion_personasview.Lists["x_Certificado_Pase"].Options = <?php echo json_encode($estado_documentacion_personas->Certificado_Pase->Options()) ?>;
festado_documentacion_personasview.Lists["x_Tiene_DNI"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
festado_documentacion_personasview.Lists["x_Tiene_DNI"].Options = <?php echo json_encode($estado_documentacion_personas->Tiene_DNI->Options()) ?>;
festado_documentacion_personasview.Lists["x_Certificado_Medico"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
festado_documentacion_personasview.Lists["x_Certificado_Medico"].Options = <?php echo json_encode($estado_documentacion_personas->Certificado_Medico->Options()) ?>;
festado_documentacion_personasview.Lists["x_Posee_Autorizacion"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
festado_documentacion_personasview.Lists["x_Posee_Autorizacion"].Options = <?php echo json_encode($estado_documentacion_personas->Posee_Autorizacion->Options()) ?>;
festado_documentacion_personasview.Lists["x_Cooperadora"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
festado_documentacion_personasview.Lists["x_Cooperadora"].Options = <?php echo json_encode($estado_documentacion_personas->Cooperadora->Options()) ?>;
...
<?php if ($estado_documentacion_personas->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$estado_documentacion_personas_view->IsModal) { ?>
<?php if ($estado_documentacion_personas->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $estado_documentacion_personas_view->ExportOptions->Render("body") ?>
<?php
	foreach ($estado_documentacion_personas_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$estado_documentacion_personas_view->IsModal) { ?>
<?php if ($estado_documentacion_personas->Export == "") { ?>
...
<?php } ?>
<?php $estado_documentacion_personas_view->ShowPageHeader(); ?>
<?php
$estado_documentacion_personas_view->ShowMessage();
?>
<form name="festado_documentacion_personasview" id="festado_documentacion_personasview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($estado_documentacion_personas_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $estado_documentacion_personas_view->Token ?>">
<?php } ?>
...
<?php if ($estado_documentacion_personas->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
	<tr id="r_Apellidos_Nombres">
		<td><span id="elh_estado_documentacion_personas_Apellidos_Nombres"><?php echo $estado_documentacion_personas->Apellidos_Nombres->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Apellidos_Nombres->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Dni->Visible) { // Dni ?>
	<tr id="r_Dni">
		<td><span id="elh_estado_documentacion_personas_Dni"><?php echo $estado_documentacion_personas->Dni->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Dni->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Id_Curso->Visible) { // Id_Curso ?>
	<tr id="r_Id_Curso">
		<td><span id="elh_estado_documentacion_personas_Id_Curso"><?php echo $estado_documentacion_personas->Id_Curso->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Id_Curso->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Id_Division->Visible) { // Id_Division ?>
	<tr id="r_Id_Division">
		<td><span id="elh_estado_documentacion_personas_Id_Division"><?php echo $estado_documentacion_personas->Id_Division->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Id_Division->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Id_Turno->Visible) { // Id_Turno ?>
	<tr id="r_Id_Turno">
		<td><span id="elh_estado_documentacion_personas_Id_Turno"><?php echo $estado_documentacion_personas->Id_Turno->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Id_Turno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Id_Estado->Visible) { // Id_Estado ?>
	<tr id="r_Id_Estado">
		<td><span id="elh_estado_documentacion_personas_Id_Estado"><?php echo $estado_documentacion_personas->Id_Estado->FldCaption() ?></span></td>
		<td data-name="Id_Estado"<?php echo $estado_documentacion_personas->Id_Estado->CellAttributes() ?>>
<span id="el_estado_documentacion_personas_Id_Estado">
<span<?php echo $estado_documentacion_personas->Id_Estado->ViewAttributes() ?>>
<?php echo $estado_documentacion_personas->Id_Estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Id_Cargo->Visible) { // Id_Cargo ?>
	<tr id="r_Id_Cargo">
		<td><span id="elh_estado_documentacion_personas_Id_Cargo"><?php echo $estado_documentacion_personas->Id_Cargo->FldCaption() ?></span></td>
		<td data-name="Id_Cargo"<?php echo $estado_documentacion_personas->Id_Cargo->CellAttributes() ?>>
<span id="el_estado_documentacion_personas_Id_Cargo">
<span<?php echo $estado_documentacion_personas->Id_Cargo->ViewAttributes() ?>>
<?php echo $estado_documentacion_personas->Id_Cargo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Matricula->Visible) { // Matricula ?>
	<tr id="r_Matricula">
		<td><span id="elh_estado_documentacion_personas_Matricula"><?php echo $estado_documentacion_personas->Matricula->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Matricula->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Certificado_Pase->Visible) { // Certificado_Pase ?>
	<tr id="r_Certificado_Pase">
		<td><span id="elh_estado_documentacion_personas_Certificado_Pase"><?php echo $estado_documentacion_personas->Certificado_Pase->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Certificado_Pase->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Tiene_DNI->Visible) { // Tiene_DNI ?>
	<tr id="r_Tiene_DNI">
		<td><span id="elh_estado_documentacion_personas_Tiene_DNI"><?php echo $estado_documentacion_personas->Tiene_DNI->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Tiene_DNI->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Certificado_Medico->Visible) { // Certificado_Medico ?>
	<tr id="r_Certificado_Medico">
		<td><span id="elh_estado_documentacion_personas_Certificado_Medico"><?php echo $estado_documentacion_personas->Certificado_Medico->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Certificado_Medico->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Posee_Autorizacion->Visible) { // Posee_Autorizacion ?>
	<tr id="r_Posee_Autorizacion">
		<td><span id="elh_estado_documentacion_personas_Posee_Autorizacion"><?php echo $estado_documentacion_personas->Posee_Autorizacion->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Posee_Autorizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_documentacion_personas->Cooperadora->Visible) { // Cooperadora ?>
	<tr id="r_Cooperadora">
		<td><span id="elh_estado_documentacion_personas_Cooperadora"><?php echo $estado_documentacion_personas->Cooperadora->FldCaption() ?></span></td>
...
<?php echo $estado_documentacion_personas->Cooperadora->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($estado_documentacion_personas->Export == "") { ?>
<script type="text/javascript">
festado_documentacion_personasview.Init();
</script>
<?php } ?>
<?php
$estado_documentacion_personas_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($estado_documentacion_personas->Export == "") { ?>
...
<?php
$estado_documentacion_personas_view->Page_Terminate();
?>
