...
$datos_extras_escuela = NULL;

//
// Table class for datos_extras_escuela
//
class cdatos_extras_escuela extends cTable {
	var $Cue;
	var $Usuario_Conig;
	var $Password_Conig;
	var $Tiene_Internet;
	...
	function __construct() {
		...
		$this->TableVar = 'datos_extras_escuela';
		$this->TableName = 'datos_extras_escuela';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`datos_extras_escuela`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Cue
		$this->Cue = new cField('datos_extras_escuela', 'datos_extras_escuela', 'x_Cue', 'Cue', '`Cue`', '`Cue`', 200, -1, FALSE, '`Cue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
		$this->Cue->Sortable = TRUE; // Allow sort
		$this->fields['Cue'] = &$this->Cue;

		// Usuario_Conig
		$this->Usuario_Conig = new cField('datos_extras_escuela', 'datos_extras_escuela', 'x_Usuario_Conig', 'Usuario_Conig', '`Usuario_Conig`', '`Usuario_Conig`', 200, -1, FALSE, '`Usuario_Conig`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Usuario_Conig->Sortable = TRUE; // Allow sort
		$this->fields['Usuario_Conig'] = &$this->Usuario_Conig;

		// Password_Conig
		$this->Password_Conig = new cField('datos_extras_escuela', 'datos_extras_escuela', 'x_Password_Conig', 'Password_Conig', '`Password_Conig`', '`Password_Conig`', 200, -1, FALSE, '`Password_Conig`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Password_Conig->Sortable = TRUE; // Allow sort
		$this->fields['Password_Conig'] = &$this->Password_Conig;

		// Tiene_Internet
		$this->Tiene_Internet = new cField('datos_extras_escuela', 'datos_extras_escuela', 'x_Tiene_Internet', 'Tiene_Internet', '`Tiene_Internet`', '`Tiene_Internet`', 200, -1, FALSE, '`Tiene_Internet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->Tiene_Internet->Sortable = TRUE; // Allow sort
		$this->Tiene_Internet->OptionCount = 2;
		$this->fields['Tiene_Internet'] = &$this->Tiene_Internet;

		// Servicio_Internet
		$this->Servicio_Internet = new cField('datos_extras_escuela', 'datos_extras_escuela', 'x_Servicio_Internet', 'Servicio_Internet', '`Servicio_Internet`', '`Servicio_Internet`', 200, -1, FALSE, '`Servicio_Internet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Servicio_Internet->Sortable = TRUE; // Allow sort
		$this->fields['Servicio_Internet'] = &$this->Servicio_Internet;

		// Estado_Internet
		$this->Estado_Internet = new cField('datos_extras_escuela', 'datos_extras_escuela', 'x_Estado_Internet', 'Estado_Internet', '`Estado_Internet`', '`Estado_Internet`', 3, -1, FALSE, '`Estado_Internet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->Estado_Internet->OptionCount = 4;
		$this->fields['Estado_Internet'] = &$this->Estado_Internet;

		// Quien_Paga
		$this->Quien_Paga = new cField('datos_extras_escuela', 'datos_extras_escuela', 'x_Quien_Paga', 'Quien_Paga', '`Quien_Paga`', '`Quien_Paga`', 200, -1, FALSE, '`Quien_Paga`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Quien_Paga->Sortable = TRUE; // Allow sort
		$this->fields['Quien_Paga'] = &$this->Quien_Paga;

		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('datos_extras_escuela', 'datos_extras_escuela', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 0, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Usuario
		$this->Usuario = new cField('datos_extras_escuela', 'datos_extras_escuela', 'x_Usuario', 'Usuario', '`Usuario`', '`Usuario`', 201, -1, FALSE, '`Usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`datos_extras_escuela`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "datos_extras_escuelalist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("datos_extras_escuelaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("datos_extras_escuelaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "datos_extras_escuelaadd.php?" . $this->UrlParm($parm);
		else
			$url = "datos_extras_escuelaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("datos_extras_escuelaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("datos_extras_escuelaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("datos_extras_escueladelete.php", $this->UrlParm());
	}
