...
class clocalidades_edit extends clocalidades {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->Id_Localidad->CurrentValue == "") {
			$this->Page_Terminate("localidadeslist.php"); // Invalid key, return to list
		}
...
flocalidadesedit.Lists["x_Id_Departamento"] = {"LinkField":"x_Id_Departamento","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
...
<?php if ($localidades->Nombre->Visible) { // Nombre ?>
	<div id="r_Nombre" class="form-group">
		<label id="elh_localidades_Nombre" for="x_Nombre" class="col-sm-2 control-label ewLabel"><?php echo $localidades->Nombre->FldCaption() ?></label>
...
<?php if ($localidades->Id_Departamento->Visible) { // Id_Departamento ?>
	<div id="r_Id_Departamento" class="form-group">
		<label id="elh_localidades_Id_Departamento" for="x_Id_Departamento" class="col-sm-2 control-label ewLabel"><?php echo $localidades->Id_Departamento->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<input type="hidden" data-table="localidades" data-field="x_Id_Localidad" name="x_Id_Localidad" id="x_Id_Localidad" value="<?php echo ew_HtmlEncode($localidades->Id_Localidad->CurrentValue) ?>">
<?php if (!$localidades_edit->IsModal) { ?>
