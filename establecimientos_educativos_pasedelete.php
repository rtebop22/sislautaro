...
<?php if ($establecimientos_educativos_pase->Nombre_Directivo->Visible) { // Nombre_Directivo ?>
		<th><span id="elh_establecimientos_educativos_pase_Nombre_Directivo" class="establecimientos_educativos_pase_Nombre_Directivo"><?php echo $establecimientos_educativos_pase->Nombre_Directivo->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($establecimientos_educativos_pase->Nombre_Directivo->Visible) { // Nombre_Directivo ?>
		<td<?php echo $establecimientos_educativos_pase->Nombre_Directivo->CellAttributes() ?>>
<span id="el<?php echo $establecimientos_educativos_pase_delete->RowCnt ?>_establecimientos_educativos_pase_Nombre_Directivo" class="establecimientos_educativos_pase_Nombre_Directivo">
