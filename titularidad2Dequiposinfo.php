...
$titularidad2Dequipos = NULL;

//
// Table class for titularidad-equipos
//
class ctitularidad2Dequipos extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'titularidad2Dequipos';
		$this->TableName = 'titularidad-equipos';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`titularidad-equipos`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Apellidos_Nombres
		$this->Apellidos_Nombres = new cField('titularidad2Dequipos', 'titularidad-equipos', 'x_Apellidos_Nombres', 'Apellidos_Nombres', '`Apellidos_Nombres`', '`Apellidos_Nombres`', 201, -1, FALSE, '`Apellidos_Nombres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellidos_Nombres->Sortable = TRUE; // Allow sort
		$this->fields['Apellidos_Nombres'] = &$this->Apellidos_Nombres;

		// Dni
		$this->Dni = new cField('titularidad2Dequipos', 'titularidad-equipos', 'x_Dni', 'Dni', '`Dni`', '`Dni`', 3, -1, FALSE, '`Dni`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Dni->Sortable = TRUE; // Allow sort
		$this->Dni->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Dni'] = &$this->Dni;

		// Cuil
		$this->Cuil = new cField('titularidad2Dequipos', 'titularidad-equipos', 'x_Cuil', 'Cuil', '`Cuil`', '`Cuil`', 200, -1, FALSE, '`Cuil`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cuil->Sortable = TRUE; // Allow sort
		$this->fields['Cuil'] = &$this->Cuil;

		// Id_Curso
		$this->Id_Curso = new cField('titularidad2Dequipos', 'titularidad-equipos', 'x_Id_Curso', 'Id_Curso', '`Id_Curso`', '`Id_Curso`', 3, -1, FALSE, '`Id_Curso`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Division
		$this->Id_Division = new cField('titularidad2Dequipos', 'titularidad-equipos', 'x_Id_Division', 'Id_Division', '`Id_Division`', '`Id_Division`', 3, -1, FALSE, '`Id_Division`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Turno
		$this->Id_Turno = new cField('titularidad2Dequipos', 'titularidad-equipos', 'x_Id_Turno', 'Id_Turno', '`Id_Turno`', '`Id_Turno`', 3, -1, FALSE, '`Id_Turno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Cargo
		$this->Id_Cargo = new cField('titularidad2Dequipos', 'titularidad-equipos', 'x_Id_Cargo', 'Id_Cargo', '`Id_Cargo`', '`Id_Cargo`', 3, -1, FALSE, '`Id_Cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Estado
		$this->Id_Estado = new cField('titularidad2Dequipos', 'titularidad-equipos', 'x_Id_Estado', 'Id_Estado', '`Id_Estado`', '`Id_Estado`', 3, -1, FALSE, '`Id_Estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// NroSerie
		$this->NroSerie = new cField('titularidad2Dequipos', 'titularidad-equipos', 'x_NroSerie', 'NroSerie', '`NroSerie`', '`NroSerie`', 200, -1, FALSE, '`NroSerie`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`titularidad-equipos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "titularidad2Dequiposlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("titularidad2Dequiposview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("titularidad2Dequiposview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "titularidad2Dequiposadd.php?" . $this->UrlParm($parm);
		else
			$url = "titularidad2Dequiposadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("titularidad2Dequiposedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("titularidad2Dequiposadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("titularidad2Dequiposdelete.php", $this->UrlParm());
	}
