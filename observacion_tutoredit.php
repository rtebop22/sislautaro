...
$observacion_tutor_edit = NULL; // Initialize page object first

class cobservacion_tutor_edit extends cobservacion_tutor {
	...
	// Page object name
	var $PageObjName = 'observacion_tutor_edit';
	...
	function Page_Main() {
		...
		if ($this->Id_Observacion->CurrentValue == "") {
			$this->Page_Terminate("observacion_tutorlist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($observacion_tutor_edit)) $observacion_tutor_edit = new cobservacion_tutor_edit();

// Page init
$observacion_tutor_edit->Page_Init();

// Page main
$observacion_tutor_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$observacion_tutor_edit->Page_Render();
?>
...
var CurrentForm = fobservacion_tutoredit = new ew_Form("fobservacion_tutoredit", "edit");

// Validate form
fobservacion_tutoredit.Validate = function() {
...
fobservacion_tutoredit.Form_CustomValidate = 
...
fobservacion_tutoredit.ValidateRequired = true;
<?php } else { ?>
fobservacion_tutoredit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$observacion_tutor_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $observacion_tutor_edit->ShowPageHeader(); ?>
<?php
$observacion_tutor_edit->ShowMessage();
?>
<form name="fobservacion_tutoredit" id="fobservacion_tutoredit" class="<?php echo $observacion_tutor_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($observacion_tutor_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $observacion_tutor_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<input type="hidden" data-table="observacion_tutor" data-field="x_Id_Observacion" name="x_Id_Observacion" id="x_Id_Observacion" value="<?php echo ew_HtmlEncode($observacion_tutor->Id_Observacion->CurrentValue) ?>">
<?php if (!$observacion_tutor_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $observacion_tutor_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fobservacion_tutoredit.Init();
</script>
<?php
$observacion_tutor_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$observacion_tutor_edit->Page_Terminate();
?>
