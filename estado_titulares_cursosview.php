...
$estado_titulares_cursos_view = NULL; // Initialize page object first

class cestado_titulares_cursos_view extends cestado_titulares_cursos {
	...
	// Page object name
	var $PageObjName = 'estado_titulares_cursos_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Dni"] <> "") {
				...
				$sReturnUrl = "estado_titulares_cursoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "estado_titulares_cursoslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "estado_titulares_cursoslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($estado_titulares_cursos_view)) $estado_titulares_cursos_view = new cestado_titulares_cursos_view();

// Page init
$estado_titulares_cursos_view->Page_Init();

// Page main
$estado_titulares_cursos_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$estado_titulares_cursos_view->Page_Render();
?>
...
var CurrentForm = festado_titulares_cursosview = new ew_Form("festado_titulares_cursosview", "view");

// Form_CustomValidate event
festado_titulares_cursosview.Form_CustomValidate = 
...
festado_titulares_cursosview.ValidateRequired = true;
<?php } else { ?>
festado_titulares_cursosview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
festado_titulares_cursosview.Lists["x_Id_Curso"] = {"LinkField":"x_Id_Curso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cursos"};
festado_titulares_cursosview.Lists["x_Id_Division"] = {"LinkField":"x_Id_Division","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"division"};
festado_titulares_cursosview.Lists["x_Id_Turno"] = {"LinkField":"x_Id_Turno","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"turno"};
festado_titulares_cursosview.Lists["x_Id_Cargo"] = {"LinkField":"x_Id_Cargo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cargo_persona"};
festado_titulares_cursosview.Lists["x_Id_Estado"] = {"LinkField":"x_Id_Estado","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_persona"};
...
<?php if ($estado_titulares_cursos->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$estado_titulares_cursos_view->IsModal) { ?>
<?php if ($estado_titulares_cursos->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $estado_titulares_cursos_view->ExportOptions->Render("body") ?>
<?php
	foreach ($estado_titulares_cursos_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$estado_titulares_cursos_view->IsModal) { ?>
<?php if ($estado_titulares_cursos->Export == "") { ?>
...
<?php } ?>
<?php $estado_titulares_cursos_view->ShowPageHeader(); ?>
<?php
$estado_titulares_cursos_view->ShowMessage();
?>
<form name="festado_titulares_cursosview" id="festado_titulares_cursosview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($estado_titulares_cursos_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $estado_titulares_cursos_view->Token ?>">
<?php } ?>
...
<?php if ($estado_titulares_cursos->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
	<tr id="r_Apellidos_Nombres">
		<td><span id="elh_estado_titulares_cursos_Apellidos_Nombres"><?php echo $estado_titulares_cursos->Apellidos_Nombres->FldCaption() ?></span></td>
...
<?php echo $estado_titulares_cursos->Apellidos_Nombres->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_titulares_cursos->Dni->Visible) { // Dni ?>
	<tr id="r_Dni">
		<td><span id="elh_estado_titulares_cursos_Dni"><?php echo $estado_titulares_cursos->Dni->FldCaption() ?></span></td>
...
<?php echo $estado_titulares_cursos->Dni->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_titulares_cursos->Cuil->Visible) { // Cuil ?>
	<tr id="r_Cuil">
		<td><span id="elh_estado_titulares_cursos_Cuil"><?php echo $estado_titulares_cursos->Cuil->FldCaption() ?></span></td>
...
<?php echo $estado_titulares_cursos->Cuil->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_titulares_cursos->Id_Curso->Visible) { // Id_Curso ?>
	<tr id="r_Id_Curso">
		<td><span id="elh_estado_titulares_cursos_Id_Curso"><?php echo $estado_titulares_cursos->Id_Curso->FldCaption() ?></span></td>
...
<?php echo $estado_titulares_cursos->Id_Curso->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_titulares_cursos->Id_Division->Visible) { // Id_Division ?>
	<tr id="r_Id_Division">
		<td><span id="elh_estado_titulares_cursos_Id_Division"><?php echo $estado_titulares_cursos->Id_Division->FldCaption() ?></span></td>
...
<?php echo $estado_titulares_cursos->Id_Division->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_titulares_cursos->Id_Turno->Visible) { // Id_Turno ?>
	<tr id="r_Id_Turno">
		<td><span id="elh_estado_titulares_cursos_Id_Turno"><?php echo $estado_titulares_cursos->Id_Turno->FldCaption() ?></span></td>
...
<?php echo $estado_titulares_cursos->Id_Turno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_titulares_cursos->Id_Cargo->Visible) { // Id_Cargo ?>
	<tr id="r_Id_Cargo">
		<td><span id="elh_estado_titulares_cursos_Id_Cargo"><?php echo $estado_titulares_cursos->Id_Cargo->FldCaption() ?></span></td>
...
<?php echo $estado_titulares_cursos->Id_Cargo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_titulares_cursos->Id_Estado->Visible) { // Id_Estado ?>
	<tr id="r_Id_Estado">
		<td><span id="elh_estado_titulares_cursos_Id_Estado"><?php echo $estado_titulares_cursos->Id_Estado->FldCaption() ?></span></td>
...
<?php echo $estado_titulares_cursos->Id_Estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_titulares_cursos->Repitente->Visible) { // Repitente ?>
	<tr id="r_Repitente">
		<td><span id="elh_estado_titulares_cursos_Repitente"><?php echo $estado_titulares_cursos->Repitente->FldCaption() ?></span></td>
...
<?php echo $estado_titulares_cursos->Repitente->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($estado_titulares_cursos->Fecha_Actualizacion->Visible) { // Fecha_Actualizacion ?>
	<tr id="r_Fecha_Actualizacion">
		<td><span id="elh_estado_titulares_cursos_Fecha_Actualizacion"><?php echo $estado_titulares_cursos->Fecha_Actualizacion->FldCaption() ?></span></td>
...
<?php echo $estado_titulares_cursos->Fecha_Actualizacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($estado_titulares_cursos->Export == "") { ?>
<script type="text/javascript">
festado_titulares_cursosview.Init();
</script>
<?php } ?>
<?php
$estado_titulares_cursos_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($estado_titulares_cursos->Export == "") { ?>
...
<?php
$estado_titulares_cursos_view->Page_Terminate();
?>
