...
$lista_espera_prestamo_add = NULL; // Initialize page object first

class clista_espera_prestamo_add extends clista_espera_prestamo {
	...
	// Page object name
	var $PageObjName = 'lista_espera_prestamo_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "lista_espera_prestamoview.php")
...
// Create page object
if (!isset($lista_espera_prestamo_add)) $lista_espera_prestamo_add = new clista_espera_prestamo_add();

// Page init
$lista_espera_prestamo_add->Page_Init();

// Page main
$lista_espera_prestamo_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$lista_espera_prestamo_add->Page_Render();
?>
...
var CurrentForm = flista_espera_prestamoadd = new ew_Form("flista_espera_prestamoadd", "add");

// Validate form
flista_espera_prestamoadd.Validate = function() {
...
flista_espera_prestamoadd.Form_CustomValidate = 
...
flista_espera_prestamoadd.ValidateRequired = true;
<?php } else { ?>
flista_espera_prestamoadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
flista_espera_prestamoadd.Lists["x_Apellidos_Nombres"] = {"LinkField":"x_Apellidos_Nombres","Ajax":true,"AutoFill":true,"DisplayFields":["x_Apellidos_Nombres","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
flista_espera_prestamoadd.Lists["x_Id_Motivo_Prestamo"] = {"LinkField":"x_Id_Motivo_Prestamo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"motivo_prestamo_equipo"};
flista_espera_prestamoadd.Lists["x_Id_Curso"] = {"LinkField":"x_Id_Curso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cursos"};
flista_espera_prestamoadd.Lists["x_Id_Division"] = {"LinkField":"x_Id_Division","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"division"};
...
<?php if (!$lista_espera_prestamo_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $lista_espera_prestamo_add->ShowPageHeader(); ?>
<?php
$lista_espera_prestamo_add->ShowMessage();
?>
<form name="flista_espera_prestamoadd" id="flista_espera_prestamoadd" class="<?php echo $lista_espera_prestamo_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($lista_espera_prestamo_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $lista_espera_prestamo_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $lista_espera_prestamo_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
flista_espera_prestamoadd.Init();
</script>
<?php
$lista_espera_prestamo_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$lista_espera_prestamo_add->Page_Terminate();
?>
