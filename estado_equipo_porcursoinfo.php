...
$estado_equipo_porcurso = NULL;

//
// Table class for estado_equipo_porcurso
//
class cestado_equipo_porcurso extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'estado_equipo_porcurso';
		$this->TableName = 'estado_equipo_porcurso';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`estado_equipo_porcurso`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Apellidos_Nombres
		$this->Apellidos_Nombres = new cField('estado_equipo_porcurso', 'estado_equipo_porcurso', 'x_Apellidos_Nombres', 'Apellidos_Nombres', '`Apellidos_Nombres`', '`Apellidos_Nombres`', 201, -1, FALSE, '`Apellidos_Nombres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellidos_Nombres->Sortable = TRUE; // Allow sort
		$this->fields['Apellidos_Nombres'] = &$this->Apellidos_Nombres;

		// Dni
		$this->Dni = new cField('estado_equipo_porcurso', 'estado_equipo_porcurso', 'x_Dni', 'Dni', '`Dni`', '`Dni`', 3, -1, FALSE, '`Dni`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Dni->Sortable = TRUE; // Allow sort
		$this->Dni->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Dni'] = &$this->Dni;

		// Id_Curso
		$this->Id_Curso = new cField('estado_equipo_porcurso', 'estado_equipo_porcurso', 'x_Id_Curso', 'Id_Curso', '`Id_Curso`', '`Id_Curso`', 3, -1, FALSE, '`Id_Curso`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Division
		$this->Id_Division = new cField('estado_equipo_porcurso', 'estado_equipo_porcurso', 'x_Id_Division', 'Id_Division', '`Id_Division`', '`Id_Division`', 3, -1, FALSE, '`Id_Division`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Turno
		$this->Id_Turno = new cField('estado_equipo_porcurso', 'estado_equipo_porcurso', 'x_Id_Turno', 'Id_Turno', '`Id_Turno`', '`Id_Turno`', 3, -1, FALSE, '`Id_Turno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Cargo
		$this->Id_Cargo = new cField('estado_equipo_porcurso', 'estado_equipo_porcurso', 'x_Id_Cargo', 'Id_Cargo', '`Id_Cargo`', '`Id_Cargo`', 3, -1, FALSE, '`Id_Cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Id_Estado
		$this->Id_Estado = new cField('estado_equipo_porcurso', 'estado_equipo_porcurso', 'x_Id_Estado', 'Id_Estado', '`Id_Estado`', '`Id_Estado`', 3, -1, FALSE, '`Id_Estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// NroSerie
		$this->NroSerie = new cField('estado_equipo_porcurso', 'estado_equipo_porcurso', 'x_NroSerie', 'NroSerie', '`NroSerie`', '`NroSerie`', 200, -1, FALSE, '`NroSerie`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NroSerie->Sortable = TRUE; // Allow sort
		$this->fields['NroSerie'] = &$this->NroSerie;

		// Id_Sit_Estado
		$this->Id_Sit_Estado = new cField('estado_equipo_porcurso', 'estado_equipo_porcurso', 'x_Id_Sit_Estado', 'Id_Sit_Estado', '`Id_Sit_Estado`', '`Id_Sit_Estado`', 3, -1, FALSE, '`Id_Sit_Estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Fecha_Actualizacion
		$this->Fecha_Actualizacion = new cField('estado_equipo_porcurso', 'estado_equipo_porcurso', 'x_Fecha_Actualizacion', 'Fecha_Actualizacion', '`Fecha_Actualizacion`', 'DATE_FORMAT(`Fecha_Actualizacion`, \'\')', 133, 7, FALSE, '`Fecha_Actualizacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`estado_equipo_porcurso`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "estado_equipo_porcursolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("estado_equipo_porcursoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("estado_equipo_porcursoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "estado_equipo_porcursoadd.php?" . $this->UrlParm($parm);
		else
			$url = "estado_equipo_porcursoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("estado_equipo_porcursoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("estado_equipo_porcursoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("estado_equipo_porcursodelete.php", $this->UrlParm());
	}
