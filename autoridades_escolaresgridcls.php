...
$autoridades_escolares_grid = NULL; // Initialize page object first

class cautoridades_escolares_grid extends cautoridades_escolares {
	...
	// Page object name
	var $PageObjName = 'autoridades_escolares_grid';

	// Grid form hidden field names
	var $FormName = 'fautoridades_escolaresgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["autoridades_escolares"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 1) {
			if (strval($arKeys[0]) <> "")
				$this->Id_Autoridad->CurrentValue = strval($arKeys[0]); // Id_Autoridad
			else
				$bValidKey = FALSE;
		} else {
			$bValidKey = FALSE;
