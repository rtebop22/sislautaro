...
$titularidad2Dequipos_search = NULL; // Initialize page object first

class ctitularidad2Dequipos_search extends ctitularidad2Dequipos {
	...
	// Page object name
	var $PageObjName = 'titularidad2Dequipos_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "titularidad2Dequiposlist.php" . "?" . $sSrchStr;
...
// Create page object
if (!isset($titularidad2Dequipos_search)) $titularidad2Dequipos_search = new ctitularidad2Dequipos_search();

// Page init
$titularidad2Dequipos_search->Page_Init();

// Page main
$titularidad2Dequipos_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$titularidad2Dequipos_search->Page_Render();
?>
...
<?php if ($titularidad2Dequipos_search->IsModal) { ?>
var CurrentAdvancedSearchForm = ftitularidad2Dequipossearch = new ew_Form("ftitularidad2Dequipossearch", "search");
<?php } else { ?>
var CurrentForm = ftitularidad2Dequipossearch = new ew_Form("ftitularidad2Dequipossearch", "search");
<?php } ?>

// Form_CustomValidate event
ftitularidad2Dequipossearch.Form_CustomValidate = 
...
ftitularidad2Dequipossearch.ValidateRequired = true;
<?php } else { ?>
ftitularidad2Dequipossearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftitularidad2Dequipossearch.Lists["x_Id_Curso"] = {"LinkField":"x_Id_Curso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cursos"};
ftitularidad2Dequipossearch.Lists["x_Id_Division"] = {"LinkField":"x_Id_Division","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"division"};
ftitularidad2Dequipossearch.Lists["x_Id_Turno"] = {"LinkField":"x_Id_Turno","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"turno"};
ftitularidad2Dequipossearch.Lists["x_Id_Cargo"] = {"LinkField":"x_Id_Cargo","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cargo_persona"};
ftitularidad2Dequipossearch.Lists["x_Id_Estado"] = {"LinkField":"x_Id_Estado","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_persona"};
ftitularidad2Dequipossearch.Lists["x_NroSerie"] = {"LinkField":"x_NroSerie","Ajax":true,"AutoFill":false,"DisplayFields":["x_NroSerie","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"equipos"};

// Form object for search
// Validate function for search

ftitularidad2Dequipossearch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($titularidad2Dequipos->Dni->FldErrMsg()) ?>");
...
<?php } ?>
<?php $titularidad2Dequipos_search->ShowPageHeader(); ?>
<?php
$titularidad2Dequipos_search->ShowMessage();
?>
<form name="ftitularidad2Dequipossearch" id="ftitularidad2Dequipossearch" class="<?php echo $titularidad2Dequipos_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($titularidad2Dequipos_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $titularidad2Dequipos_search->Token ?>">
<?php } ?>
...
<?php if ($titularidad2Dequipos->Apellidos_Nombres->Visible) { // Apellidos_Nombres ?>
	<div id="r_Apellidos_Nombres" class="form-group">
		<label for="x_Apellidos_Nombres" class="<?php echo $titularidad2Dequipos_search->SearchLabelClass ?>"><span id="elh_titularidad2Dequipos_Apellidos_Nombres"><?php echo $titularidad2Dequipos->Apellidos_Nombres->FldCaption() ?></span>	
		...
		<div class="<?php echo $titularidad2Dequipos_search->SearchRightColumnClass ?>"><div<?php echo $titularidad2Dequipos->Apellidos_Nombres->CellAttributes() ?>>
			<span id="el_titularidad2Dequipos_Apellidos_Nombres">
<input type="text" data-table="titularidad2Dequipos" data-field="x_Apellidos_Nombres" name="x_Apellidos_Nombres" id="x_Apellidos_Nombres" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($titularidad2Dequipos->Apellidos_Nombres->getPlaceHolder()) ?>" value="<?php echo $titularidad2Dequipos->Apellidos_Nombres->EditValue ?>"<?php echo $titularidad2Dequipos->Apellidos_Nombres->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($titularidad2Dequipos->Dni->Visible) { // Dni ?>
	<div id="r_Dni" class="form-group">
		<label for="x_Dni" class="<?php echo $titularidad2Dequipos_search->SearchLabelClass ?>"><span id="elh_titularidad2Dequipos_Dni"><?php echo $titularidad2Dequipos->Dni->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_Dni" id="z_Dni" value="="></p>
		</label>
		<div class="<?php echo $titularidad2Dequipos_search->SearchRightColumnClass ?>"><div<?php echo $titularidad2Dequipos->Dni->CellAttributes() ?>>
			<span id="el_titularidad2Dequipos_Dni">
<input type="text" data-table="titularidad2Dequipos" data-field="x_Dni" name="x_Dni" id="x_Dni" size="30" placeholder="<?php echo ew_HtmlEncode($titularidad2Dequipos->Dni->getPlaceHolder()) ?>" value="<?php echo $titularidad2Dequipos->Dni->EditValue ?>"<?php echo $titularidad2Dequipos->Dni->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($titularidad2Dequipos->Cuil->Visible) { // Cuil ?>
	<div id="r_Cuil" class="form-group">
		<label for="x_Cuil" class="<?php echo $titularidad2Dequipos_search->SearchLabelClass ?>"><span id="elh_titularidad2Dequipos_Cuil"><?php echo $titularidad2Dequipos->Cuil->FldCaption() ?></span>	
		...
		<div class="<?php echo $titularidad2Dequipos_search->SearchRightColumnClass ?>"><div<?php echo $titularidad2Dequipos->Cuil->CellAttributes() ?>>
			<span id="el_titularidad2Dequipos_Cuil">
<input type="text" data-table="titularidad2Dequipos" data-field="x_Cuil" name="x_Cuil" id="x_Cuil" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($titularidad2Dequipos->Cuil->getPlaceHolder()) ?>" value="<?php echo $titularidad2Dequipos->Cuil->EditValue ?>"<?php echo $titularidad2Dequipos->Cuil->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($titularidad2Dequipos->Id_Curso->Visible) { // Id_Curso ?>
	<div id="r_Id_Curso" class="form-group">
		<label for="x_Id_Curso" class="<?php echo $titularidad2Dequipos_search->SearchLabelClass ?>"><span id="elh_titularidad2Dequipos_Id_Curso"><?php echo $titularidad2Dequipos->Id_Curso->FldCaption() ?></span>	
		...
		<div class="<?php echo $titularidad2Dequipos_search->SearchRightColumnClass ?>"><div<?php echo $titularidad2Dequipos->Id_Curso->CellAttributes() ?>>
			<span id="el_titularidad2Dequipos_Id_Curso">
<select data-table="titularidad2Dequipos" data-field="x_Id_Curso" data-value-separator="<?php echo $titularidad2Dequipos->Id_Curso->DisplayValueSeparatorAttribute() ?>" id="x_Id_Curso" name="x_Id_Curso"<?php echo $titularidad2Dequipos->Id_Curso->EditAttributes() ?>>
<?php echo $titularidad2Dequipos->Id_Curso->SelectOptionListHtml("x_Id_Curso") ?>
</select>
<input type="hidden" name="s_x_Id_Curso" id="s_x_Id_Curso" value="<?php echo $titularidad2Dequipos->Id_Curso->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($titularidad2Dequipos->Id_Division->Visible) { // Id_Division ?>
	<div id="r_Id_Division" class="form-group">
		<label for="x_Id_Division" class="<?php echo $titularidad2Dequipos_search->SearchLabelClass ?>"><span id="elh_titularidad2Dequipos_Id_Division"><?php echo $titularidad2Dequipos->Id_Division->FldCaption() ?></span>	
		...
		<div class="<?php echo $titularidad2Dequipos_search->SearchRightColumnClass ?>"><div<?php echo $titularidad2Dequipos->Id_Division->CellAttributes() ?>>
			<span id="el_titularidad2Dequipos_Id_Division">
<select data-table="titularidad2Dequipos" data-field="x_Id_Division" data-value-separator="<?php echo $titularidad2Dequipos->Id_Division->DisplayValueSeparatorAttribute() ?>" id="x_Id_Division" name="x_Id_Division"<?php echo $titularidad2Dequipos->Id_Division->EditAttributes() ?>>
<?php echo $titularidad2Dequipos->Id_Division->SelectOptionListHtml("x_Id_Division") ?>
</select>
<input type="hidden" name="s_x_Id_Division" id="s_x_Id_Division" value="<?php echo $titularidad2Dequipos->Id_Division->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($titularidad2Dequipos->Id_Turno->Visible) { // Id_Turno ?>
	<div id="r_Id_Turno" class="form-group">
		<label for="x_Id_Turno" class="<?php echo $titularidad2Dequipos_search->SearchLabelClass ?>"><span id="elh_titularidad2Dequipos_Id_Turno"><?php echo $titularidad2Dequipos->Id_Turno->FldCaption() ?></span>	
		...
		<div class="<?php echo $titularidad2Dequipos_search->SearchRightColumnClass ?>"><div<?php echo $titularidad2Dequipos->Id_Turno->CellAttributes() ?>>
			<span id="el_titularidad2Dequipos_Id_Turno">
<select data-table="titularidad2Dequipos" data-field="x_Id_Turno" data-value-separator="<?php echo $titularidad2Dequipos->Id_Turno->DisplayValueSeparatorAttribute() ?>" id="x_Id_Turno" name="x_Id_Turno"<?php echo $titularidad2Dequipos->Id_Turno->EditAttributes() ?>>
<?php echo $titularidad2Dequipos->Id_Turno->SelectOptionListHtml("x_Id_Turno") ?>
</select>
<input type="hidden" name="s_x_Id_Turno" id="s_x_Id_Turno" value="<?php echo $titularidad2Dequipos->Id_Turno->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($titularidad2Dequipos->Id_Cargo->Visible) { // Id_Cargo ?>
	<div id="r_Id_Cargo" class="form-group">
		<label for="x_Id_Cargo" class="<?php echo $titularidad2Dequipos_search->SearchLabelClass ?>"><span id="elh_titularidad2Dequipos_Id_Cargo"><?php echo $titularidad2Dequipos->Id_Cargo->FldCaption() ?></span>	
		...
		<div class="<?php echo $titularidad2Dequipos_search->SearchRightColumnClass ?>"><div<?php echo $titularidad2Dequipos->Id_Cargo->CellAttributes() ?>>
			<span id="el_titularidad2Dequipos_Id_Cargo">
<select data-table="titularidad2Dequipos" data-field="x_Id_Cargo" data-value-separator="<?php echo $titularidad2Dequipos->Id_Cargo->DisplayValueSeparatorAttribute() ?>" id="x_Id_Cargo" name="x_Id_Cargo"<?php echo $titularidad2Dequipos->Id_Cargo->EditAttributes() ?>>
<?php echo $titularidad2Dequipos->Id_Cargo->SelectOptionListHtml("x_Id_Cargo") ?>
</select>
<input type="hidden" name="s_x_Id_Cargo" id="s_x_Id_Cargo" value="<?php echo $titularidad2Dequipos->Id_Cargo->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($titularidad2Dequipos->Id_Estado->Visible) { // Id_Estado ?>
	<div id="r_Id_Estado" class="form-group">
		<label for="x_Id_Estado" class="<?php echo $titularidad2Dequipos_search->SearchLabelClass ?>"><span id="elh_titularidad2Dequipos_Id_Estado"><?php echo $titularidad2Dequipos->Id_Estado->FldCaption() ?></span>	
		...
		<div class="<?php echo $titularidad2Dequipos_search->SearchRightColumnClass ?>"><div<?php echo $titularidad2Dequipos->Id_Estado->CellAttributes() ?>>
			<span id="el_titularidad2Dequipos_Id_Estado">
<select data-table="titularidad2Dequipos" data-field="x_Id_Estado" data-value-separator="<?php echo $titularidad2Dequipos->Id_Estado->DisplayValueSeparatorAttribute() ?>" id="x_Id_Estado" name="x_Id_Estado"<?php echo $titularidad2Dequipos->Id_Estado->EditAttributes() ?>>
<?php echo $titularidad2Dequipos->Id_Estado->SelectOptionListHtml("x_Id_Estado") ?>
</select>
<input type="hidden" name="s_x_Id_Estado" id="s_x_Id_Estado" value="<?php echo $titularidad2Dequipos->Id_Estado->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($titularidad2Dequipos->NroSerie->Visible) { // NroSerie ?>
	<div id="r_NroSerie" class="form-group">
		<label class="<?php echo $titularidad2Dequipos_search->SearchLabelClass ?>"><span id="elh_titularidad2Dequipos_NroSerie"><?php echo $titularidad2Dequipos->NroSerie->FldCaption() ?></span>	
		...
		<div class="<?php echo $titularidad2Dequipos_search->SearchRightColumnClass ?>"><div<?php echo $titularidad2Dequipos->NroSerie->CellAttributes() ?>>
			<span id="el_titularidad2Dequipos_NroSerie">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_NroSerie"><?php echo (strval($titularidad2Dequipos->NroSerie->AdvancedSearch->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $titularidad2Dequipos->NroSerie->AdvancedSearch->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($titularidad2Dequipos->NroSerie->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_NroSerie',m:0,n:10});" class="ewLookupBtn btn btn-default btn-sm"><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="titularidad2Dequipos" data-field="x_NroSerie" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $titularidad2Dequipos->NroSerie->DisplayValueSeparatorAttribute() ?>" name="x_NroSerie" id="x_NroSerie" value="<?php echo $titularidad2Dequipos->NroSerie->AdvancedSearch->SearchValue ?>"<?php echo $titularidad2Dequipos->NroSerie->EditAttributes() ?>>
<input type="hidden" name="s_x_NroSerie" id="s_x_NroSerie" value="<?php echo $titularidad2Dequipos->NroSerie->LookupFilterQuery() ?>">
</span>
		</div></div>
	</div>
<?php } ?>
...
<script type="text/javascript">
ftitularidad2Dequipossearch.Init();
</script>
<?php
$titularidad2Dequipos_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$titularidad2Dequipos_search->Page_Terminate();
?>
