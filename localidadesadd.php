	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["Id_Localidad"] != "") {
				...
				$this->setKey("Id_Localidad", $this->Id_Localidad->CurrentValue); // Set up key
			} else {
				$this->setKey("Id_Localidad", ""); // Clear key
...
flocalidadesadd.Lists["x_Id_Departamento"] = {"LinkField":"x_Id_Departamento","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
