...
class cusuarios_view extends cusuarios {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["Nombre"] <> "") {
			$this->RecKey["Nombre"] = $_GET["Nombre"];
			$KeyUrl .= "&amp;Nombre=" . urlencode($this->RecKey["Nombre"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["Nombre"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["Nombre"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Nombre"] <> "") {
				...
				$this->RecKey["Nombre"] = $this->Nombre->QueryStringValue;
			} elseif (@$_POST["Nombre"] <> "") {
				$this->Nombre->setFormValue($_POST["Nombre"]);
				$this->RecKey["Nombre"] = $this->Nombre->FormValue;
			} else {
...
fusuariosview.Lists["x_NombreTitular"] = {"LinkField":"x_Apellidos_Nombres","Ajax":true,"AutoFill":false,"DisplayFields":["x_Apellidos_Nombres","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
fusuariosview.Lists["x_Nivel_Usuario"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fusuariosview.Lists["x_Curso"] = {"LinkField":"x_Id_Curso","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cursos"};
fusuariosview.Lists["x_Turno"] = {"LinkField":"x_Id_Turno","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"turno"};
fusuariosview.Lists["x_Division"] = {"LinkField":"x_Id_Division","Ajax":true,"AutoFill":false,"DisplayFields":["x_Descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"division"};
...
<?php if ($usuarios->NombreTitular->Visible) { // NombreTitular ?>
	<tr id="r_NombreTitular">
		<td><span id="elh_usuarios_NombreTitular"><?php echo $usuarios->NombreTitular->FldCaption() ?></span></td>
...
<?php echo $usuarios->NombreTitular->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($usuarios->Nivel_Usuario->Visible) { // Nivel_Usuario ?>
	<tr id="r_Nivel_Usuario">
		<td><span id="elh_usuarios_Nivel_Usuario"><?php echo $usuarios->Nivel_Usuario->FldCaption() ?></span></td>
...
<?php echo $usuarios->Nivel_Usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->Curso->Visible) { // Curso ?>
	<tr id="r_Curso">
		<td><span id="elh_usuarios_Curso"><?php echo $usuarios->Curso->FldCaption() ?></span></td>
...
<?php echo $usuarios->Curso->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->Turno->Visible) { // Turno ?>
	<tr id="r_Turno">
		<td><span id="elh_usuarios_Turno"><?php echo $usuarios->Turno->FldCaption() ?></span></td>
...
<?php echo $usuarios->Turno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->Division->Visible) { // Division ?>
	<tr id="r_Division">
		<td><span id="elh_usuarios_Division"><?php echo $usuarios->Division->FldCaption() ?></span></td>
...
<?php echo $usuarios->Division->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
